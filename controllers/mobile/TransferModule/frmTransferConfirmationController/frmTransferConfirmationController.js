define({
  ...
  getData:function()
  {
    ...
    if(this.data.transactionType=="InternalTransfer"){
     if(this.data.toAccountNickName)
     	this.view.lblPayeeNameValue.text=applicationManager.getPresentationUtility().formatText(this.data.toAccountNickName, 10, this.data.toAccountNumber, 4);
      else
     	this.view.lblPayeeNameValue.text=applicationManager.getPresentationUtility().formatText(this.data.toAccountName, 10, this.data.toAccountNumber, 4);
    }
    else{
