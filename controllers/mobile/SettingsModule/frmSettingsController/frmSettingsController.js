  ...
  setAccountSettings :function(){
    ...
    setDeviceManagementData: function(){
      const segRowData = [
        ...
        {"lblTitle":kony.i18n.getLocalizedString("kony.mb.Settings.OfflineSignature"),"lblValue":"","imgArrow":"chevron.png"}
      ];
      const data=[
        [
...
//       tempData.push({"lblTitle":kony.i18n.getLocalizedString("kony.mb.Settings.ChangePassword"),"lblValue":"","imgArrow":"chevron.png"});      
      tempData.push({"lblTitle":kony.i18n.getLocalizedString("kony.mb.Settings.ChangeSlashCreatePassword"),"lblValue":"","imgArrow":"chevron.png"});
    }
    var data = [
      [
