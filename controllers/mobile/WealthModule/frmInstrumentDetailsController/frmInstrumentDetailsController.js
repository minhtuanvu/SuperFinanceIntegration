  ...
  return{
    ...
    setUiData:function(){
      ...
      if(data1.instrumentDetails)
        this.view.investmentLineChart.currencySymbol = formatUtil.getCurrencySymbol(data1.instrumentDetails.referenceCurrency);
    ...
    backOnClick:function(){
      ...
      if(scope_WealthPresentationController.searchEntryPoint===true){
        let params = {"portfolioId":scope_WealthPresentationController.portfolioId,"navPage":"Portfolio","graphDuration":"OneY"};
