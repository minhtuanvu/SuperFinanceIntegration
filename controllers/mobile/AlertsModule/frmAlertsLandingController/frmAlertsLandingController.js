    ...
    if(data.length === 0){
      ...
      for(var i = 0; i<data.length;i++)
      {
         ...
         if(data[i].isRead === "0"){
          ...
          data[i].flxMain={"skin" : "sknFlxBgF3F3F3", "focusSkin" : "sknFlxBgFFFFFF"};
         }
         else{
          data[i].lblTitle = {"skin" :"sknLbl424242SSPRegular26px", "text": data[i].notificationSubject};
          data[i].flxMain={"skin" : "sknFlxBgFFFFFF", "focusSkin" : "sknFlxBgFFFFFF"};
         }
