  ...
  return{
    ...
    frmAccountDetailsPreshow: function() {
      ...
      if(applicationManager.getPresentationFormUtility().getDeviceName() !== "iPhone"){
        ...
        this.view.flxHeader.isVisible = true;
        //this.view.flxHeader.isVisible = false;//by vineela
        this.view.flxFooter.isVisible = false;
        //this.view.flxFooter.isVisible = true;//by vineela
        this.view.flxMainContainer.top = "7%";
        //this.view.flxMainContainer.top = "0%";//by vineela
        //this.view.title = "";//by vineela
      }
