define(['CampaignUtility','CommonUtilities'], function(CampaignUtility,CommonUtilities){
  return{
    ...
    //by vineela
    accountsLstSF : [],
    selectedAccountIndexSF:0, //by Prasad
    ...
    preshow: function () {
      ...
      try {
        ...
        if ( this.combinedFlowName === this.flowConstants.combinedBanking) {
          ...
          if(internalAccounts.length > 0){
            ...
            //by Prasad
            this.view.lblAccBalValSF.text = formatUtility.formatAmountandAppendCurrencySymbol(totalAvlFloat - totalDebtFloat,currencyCode);
          }else{
            //this.view.lblBankName.text = formatUtility.formatAmountandAppendCurrencySymbol(totalAvlFloat - totalDebtFloat);
            //by Prasad
            this.view.lblAccBalValSF.text = formatUtility.formatAmountandAppendCurrencySymbol(totalAvlFloat - totalDebtFloat);
          }
          this.view.lblAssetsValue.text = totalAvaBal;
          this.view.lblDebtValue.text = totalDebt;
      ...
      //Below code added by Prasad Atikala
      this.view.flxAccountsLstSF.removeAll();
      this.setDynamicWidget();

      var userPreferencesManager = applicationManager.getUserPreferencesManager();
      var firstname = userPreferencesManager.getUserFirstName();
      var lastname = userPreferencesManager.getUserLastName();
      this.view.lblMikeSF.text = firstname+" "+lastname;
      ...
      this.view.brwsrChartsSF.cacheConfig = {
    ...
    mapInternalAccounts: function () {
      ...
      //by vineela
      var allAccountsFitness = processedAccountsData;
      var combinedAccountsFitness = [];

      for(const [key, value] of Object.entries(allAccountsFitness)){
        combinedAccountsFitness.push(...this.mergeArr(value));  
      }
      combinedAccountsFitness.map(acc=>{
        if(acc.lblAccountTypeFitness === "Regular Savings Account"){
          acc.imgBankSF = "maskgroup1.png";
          acc.sknLogoBg = "sknFlxAccLogoSF";
        }else if(acc.lblAccountTypeFitness === "Savings Account"){
          acc.imgBankSF = "maskgroup1.png";
          acc.sknLogoBg = "sknFlxAccLogoSF";
        }else if(acc.lblAccountTypeFitness === "Preferential Current Account"){
          acc.imgBankSF = "bitmap1.png";
          acc.sknLogoBg = "sknFlxAccLogoSF";
        }else if(acc.lblAccountTypeFitness === "Fixed Term 3 Year - Bond"){
          acc.imgBankSF = "bitmap1.png";
          acc.sknAccBg = "";
          acc.sknLogoBg = "sknFlxAccLogoSF";
        }else if(acc.lblAccountTypeFitness === "Loan Term Deposit"){
          acc.imgBankSF = "bitmap1.png";
          acc.sknLogoBg = "sknFlxAccLogoSF";
        }else if(acc.lblAccountTypeFitness === "Personal Loan"){
          acc.imgBankSF = "bitmap1.png";
          acc.sknLogoBg = "sknFlxAccLogoSF";
        }else if(acc.lblAccountTypeFitness === "Standard Mortgage"){
          acc.imgBankSF = "bitmap1.png";
          acc.sknLogoBg = "sknFlxAccLogoSF";
        }else{
          acc.imgBankSF = "bitmap1.png";
      ...
      for(var a =0;a<combinedAccountsFitness.length;a++){
        if(a==0){
          combinedAccountsFitness[a].sknAccBg = "sknFlxAccBg1SF";
        }else if(a%2 === 0){
          combinedAccountsFitness[a].sknAccBg = "sknFlxAccBg1SF";
        }
        else{
          combinedAccountsFitness[a].sknAccBg = "sknFlxAcc2BgSF";
        }
      }
      this.accountsLstSF = combinedAccountsFitness;
      kony.print("accountsLstSF value is ::::: "+this.accountsLstSF);
      kony.print("accountsLstSF value JSON is ::::: "+JSON.stringify(this.accountsLstSF));
      this.removeBlueScreen(processedAccountsData);
    },
    //by vineela
    mergeArr: function(value){
      let newAccTypeObj = {};
      return value.map(newSavingsAcc=>{
        return newAccTypeObj = {
          lblAccountTypeSF: newSavingsAcc.accountName,
          lblAccountNameSF: newSavingsAcc.MembershipName,
          lblAccountNumberSF: newSavingsAcc.accountID,
          lblAccountBalValSF : newSavingsAcc.availableBalance,
          lblAvailableBalSF : newSavingsAcc.accountBalanceType,
          lblAccountIdSF : newSavingsAcc.accountID,
          lblAccountTypeSF1: newSavingsAcc.accountType,
          lblIsBusinessAccountSF: newSavingsAcc.isBusinessAccount,
          lblCurrencyCodeSF: newSavingsAcc.currencyCode,
          imgBankSF : "",
          sknAccBg:"",
          sknLogoBg:""
        };
    ...
    updateForEngageFeatureAnnouncement: function(accountsData) {
      ...
      var advertEnabled = null, insertEnabled = false, insertLocation = null;
    ...
    */
    ...
    setAccountsInfo: function (internalAccounts, externalAccounts, bankName) {
      ...
      this.view.lblAccBalValSF.text = formatUtility.formatAmountandAppendCurrencySymbol(totalBalance.toFixed(2)); 
            ...
            "onClick" : function(eventobject, context){
              ...
              if(segData[selecteIndex][0].imgArrow.src === "whitearrowdown.png"){
                if(this.prevIndex !==selecteIndex){
                  if(this.prevIndex===null || this.prevIndex===undefined || this.prevIndex===""){
                  }else{
...
*/
    ...
    accountSegmentOnClick: function () {
      ...
      kony.print("rowid.Membership_id is ::::: "+rowid.Membership_id);
    ...
    getCountsSuccessCB:function(singleApprovalsPendingCount,bulkApprovalsPendingCount,
      ...
      if(isApprovalPermissionAccessible && isRequestPermissionAccessible){
        ...
        pendingApprovalsArr.push({
          "lblSpendingCategory":{"text":kony.i18n.getLocalizedString("kony.mb.approvalsAndRequest.filter.SingleTransactions")
                                },
          "lblTotalAmount":""+singleApprovalsPendingCount,
          "flxSeperator":{"isVisible":true}
        },
                                 {
          "lblSpendingCategory":{"text":kony.i18n.getLocalizedString("kony.mb.approvalsAndRequest.filter.bulkTransactions")
                                },
          "lblTotalAmount":""+bulkApprovalsPendingCount,
          "flxSeperator":{"isVisible":true}
        },
                                 {
          "lblSpendingCategory":{"text":kony.i18n.getLocalizedString("kony.mb.approvalsAndRequest.filter.sameBank")
                                },
          "lblTotalAmount":""+sameBankCount,
          "flxSeperator":{"isVisible":true}
        },
                                 {
          "lblSpendingCategory":{"text":kony.i18n.getLocalizedString("kony.mb.approvalsAndRequest.filter.otherRequests")
                                },
    ...
    //by vineela
    setDynamicWidget:function(){
      for(var i in this.accountsLstSF){
        //alert("accounts ----> "+JSON.stringify(i));
        ...
        var imgAccountsLogo = new kony.ui.Image2({
          "centerX": "50%",
          "centerY": "50%",
          "height": "45dp",
          "id": "imgAccountsLogo"+i,
          "isVisible": true,
          "skin": "slImage",
          "src": this.accountsLstSF[i].imgBankSF,
          "width": "45dp",
          "zIndex": 1
        }, {
        ...
        flxAccountsLogo.add(imgAccountsLogo);
        ...
        var flxAccBalValue = new kony.ui.FlexContainer({
          "autogrowMode": kony.flex.AUTOGROW_NONE,
          "clipBounds": true,
          "id": "flxAccBalValue"+i,
          "isVisible": true,
        ...
        flxAccBalValue.setDefaultUnit(kony.flex.DP);
        ...
        this.view.flxAccountsLstSF.add(flxAccTypeDetails);
        this.view["flxAccTypeDetails"+i].add(flxAccountsLogo, lblAccType, lblAccBal, flxAccBalValue);
        //this.view["flxAccBalValue"+i].add(lblAccCurrency, lblAccValue);
        this.view["flxAccBalValue"+i].add(lblAccValue);
      }
    },

    accountDetailsClick:function(index,dynWidget){
      kony.print("inside accountDetailsClick ::::: ");
      this.view.flxOverlaySF.onClick = this.doNothing.bind();
      this.view.flxOverlaySF.setVisibility(true);

      kony.print("dynWidget ::::: "+dynWidget);
      kony.print("index ::::: "+index);

      this.selectedAccountIndexSF = index;
      this.view.lblAccountTypeSF.text = this.accountsLstSF[index].lblAccountTypeSF;
      this.view.lblBalanceAmountSF.text = this.accountsLstSF[index].lblAccountBalValSF;

      kony.print("After set visibility true ::::: ");
    },

    doNothing:function(){
      kony.print("Inside doNothing ::::: ");
    },

    closeOverlayPopup: function() {
      kony.print("inside closeOverlayPopup ::::: ");
      this.view.flxOverlaySF.setVisibility(false);
      kony.print("After set visibility false ::::: ");
    },

    onclickManageAccount: function() {

      var index = this.selectedAccountIndexSF;
      var contextData = {
        "accountID": this.accountsLstSF[index]["lblAccountIdSF"],
        "accountType": this.accountsLstSF[index]["lblAccountTypeSF"],
        "currencyCode": this.accountsLstSF[index]["lblCurrencyCodeSF"],
        "isBusinessAccount": this.accountsLstSF[index]["lblIsBusinessAccountSF"]
      }
      var accountMod = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("AccountModule");
      var navManager = applicationManager.getNavigationManager();
      navManager.setCustomInfo("frmAccountDetails", contextData);
    ...
    initialChartData: function(){
      ...
      var tempData = [];
      for(var i in chartData1.records){
        tempData.push({
          "label": kony.i18n.getLocalizedString("kony.mb.PFM."+chartData1.records.categoryName),
          "value": chartData1.records.cashSpent,
          "color": this.hexToRgbA(this.chartColors[chartData1.records.cateforyId])
        })
      }
      var stringifiedData = "generateDoughnutChart(" + JSON.stringify(tempData) + ");";
      this.view.brwsrChartsSF.evaluateJavaScript(stringifiedData);
      this.view.brwsrChartsSF.isVisible = true;
      this.view.lblNoDataSF.isVisible = false;
    },

    displayPFMCharts : function(){
      var client = kony.sdk.getCurrentInstance();
      var integrationObj;
      var todayDate = new Date();
      var crntMonth = todayDate.getMonth();
      var crntYear = todayDate.getFullYear();

      integrationObj = client.getIntegrationService("PFMDataTables");
      ///   integrationObj = kony.sdk.getCurrentInstance().getIntegration    
      operationName =  "dbxdb_pfmpiechart_get";
      data= {"$filter": "year eq "+crntYear+" and monthId eq "+(crntMonth+1)};
      headers= {};
      integrationObj.invokeOperation(operationName, headers, data, this.operationSuccess1, this.operationFailure);
    },
    operationSuccess1:function(res){
      kony.print("res----> "+JSON.stringify(res));
      var self = this;
      var chartData = [];
      var PFMdata = res.pfmpiechart;
      var budgetType = ["None", "Home","Utilities","Financial","Education","Transportation","Health","Travel","Food","Uncategorised","Other"];
      var todayDate = new Date();
      var crntMonth = todayDate.getMonth();
      var MON_NAMES = ["None", "January", "February", "March", "April", "May", "June", "July", "August", "September", "October", "November", "December"];
      var monthName = MON_NAMES[crntMonth+1];
      self.view.lblCrntMonthSF.text = monthName;
      PFMdata.forEach(function(record) {
        kony.print("record---> "+self.hexToRgbA(self.chartColors[record.categoryId]));
        chartData.push({
          "label": kony.i18n.getLocalizedString("kony.mb.PFM."+budgetType[record.categoryId]),
      ...
      self.view.brwsrChartsSF.isVisible = true;
      self.view.lblNoDataSF.isVisible = false;
    },
    operationFailure:function(res){
      var self = this;
      self.view.lblCrntMonthSF.text = "";
      self.view.brwsrChartsSF.isVisible = false;
      self.view.lblNoDataSF.isVisible = true;
    },
