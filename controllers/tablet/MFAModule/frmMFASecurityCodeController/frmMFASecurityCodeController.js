...
//       this.view.lblEmailIdValue.text = mfaResponse.MFAAttributes.customerCommunication.email[0].masked;
      ...
      this.view.lblPhoneAndEmail.text = "Enter Secure Access Code sent on your "+mfaResponse.MFAAttributes.customerCommunication.phone[0].masked+" & "+mfaResponse.MFAAttributes.customerCommunication.email[0].masked;
