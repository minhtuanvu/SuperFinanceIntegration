define({
  ...
  onConfirmAddAddress: function() {
    ...
    var data={"isPreferredAddress": self.getPreferredAddress()};
	this.getSettingsModule().presentationController.updateUserSelectedAddressData(data);
  ...
  setDataToForm: function() {
    ...
    var prefAddr="";
    if(data.isPreferredAddress=="true"){
    	prefAddr="1";
    }
    else{
        prefAddr="0";
    }
	this.updateCheckboxes(prefAddr);
  },
