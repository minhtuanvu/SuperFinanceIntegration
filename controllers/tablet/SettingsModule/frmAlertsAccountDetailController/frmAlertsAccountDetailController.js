  ...
  backNavigation: function(){
    ...
    toggleSingleAccountAlertsRequired: function() {
        try {
            ...
            var navManager = applicationManager.getNavigationManager();
          	navManager.setCustomInfo("updateUserAccountAlerts", "toggleSingleAccountAlertsRequired");
            settingsModule.presentationController.updateUserAccountAlerts(inputParams);
        }
        catch(err) {
          applicationManager.getPresentationUtility().dismissLoadingScreen();
    ...
    toggleSegAlertSettingListRowFlag: function() {
        try {
            ...
            inputParams[rowItem] = toggle;
          	var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
            var navManager = applicationManager.getNavigationManager();
          	navManager.setCustomInfo("updateUserAccountAlerts", "toggleSegAlertSettingListRowFlag");
            settingsModule.presentationController.updateUserAccountAlerts(inputParams);
        }
        catch(err) {
          applicationManager.getPresentationUtility().dismissLoadingScreen();
