	define({
	    ...
	    toggleBtnActionBankIDChange: function() {
	        try {
                ...
                var navManager = applicationManager.getNavigationManager();
      			navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "bankingIDChange");
                var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
      			settingsModule.presentationController.updateUserAlerts(inputParams);
            }
            catch(err) {
              applicationManager.getPresentationUtility().dismissLoadingScreen();
	    ...
	    toggleBtnActionPasswordChange: function() {
	        try {
                ...
                var navManager = applicationManager.getNavigationManager();
      			navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "passwordChange");
              	var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
      			settingsModule.presentationController.updateUserAlerts(inputParams);
            }
            catch(err) {
      ...
      /**
	    ...
	    toggleBtnActionPasswordExpired: function() {
	        try {
	            ...
	            var inputParams = {
                 ...
                 var navManager = applicationManager.getNavigationManager();
      			navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "passwordExpired");
                var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
      			settingsModule.presentationController.updateUserAlerts(inputParams);
            }
            catch(err) {
	    ...
	    toggleBtnActionAddressOrPhoneChange: function() {
	        try {
	            ...
	            var inputParams = {
                 ...
                 var navManager = applicationManager.getNavigationManager();
      			navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "communicationChange");
               	var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
   			   	settingsModule.presentationController.updateUserAlerts(inputParams);
            }
            catch(err) {
	    ...
	    toggleBtnActionNewPayeeAdded: function() {
	        try {
              ...
              var navManager = applicationManager.getNavigationManager();
      		  navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "newPayeeAdded");
              var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
              settingsModule.presentationController.updateUserAlerts(inputParams);
            }
            catch(err) {
	    ...
	    toggleBtnActionPayeeDetailsUpdated: function() {
	        try {
                ...
                var navManager = applicationManager.getNavigationManager();
      			navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "payeeDetailsUpdated");
				var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
      			settingsModule.presentationController.updateUserAlerts(inputParams);
            }
            catch(err) {
	    ...
	    toggleBtnActionNewDealsAvailable: function() {
	        try {
	            ...
	            var inputParams = {
              	...
              	var navManager = applicationManager.getNavigationManager();
      			navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "newDealsAvailable");
              	var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
      			settingsModule.presentationController.updateUserAlerts(inputParams);
            }
            catch(err) {
	     ...
	     * @return
	     */
	    updateNewDealsAvailableSuccess: function(response) {
          try {
	        applicationManager.getPresentationUtility().dismissLoadingScreen();
	        if(this.view.imgSwitchNewDealsAvailable.src === "active.png") {
	            this.view.imgSwitchNewDealsAvailable.src = "inactive.png";
	     ...
	     * @return
	     */
	    updateNewDealsAvailableFailure: function(response) {
	        applicationManager.getPresentationUtility().dismissLoadingScreen();
	    },
	    /**
	     * Description
	    ...
	    toggleBtnActionDealsExpiringInOneDay: function() {
	        try {
	            ...
	            var inputParams = {
              	 ...
              	 var navManager = applicationManager.getNavigationManager();
      			navManager.setCustomInfo("DealsAndSecurityAlertsToggle", "dealsExpiring");
              	var settingsModule = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("SettingsModule");
