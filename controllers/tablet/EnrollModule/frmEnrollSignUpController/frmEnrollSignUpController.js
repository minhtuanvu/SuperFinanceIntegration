define({
  ...
  initAction: function() {
	...
	this.view.txtEnterUsername.onEndEditing = this.txtEnterUsernameOnEndEditing;
    this.view.txtPassword.onTextChange = function() {
      self.txtReEnterPassOnTextChange();
      self.validatePassword();
    };
    this.view.txtEnterUsername.onTouchStart = function(){
      self.hideFlxRequirementsUsername();
      self.hideFlxRequirements();
    };
    ...
    enrollMod.presentationController.getUsernameRulesAndPolicy();
    enrollMod.presentationController.getPasswordRulesAndPolicy();
    var navManager = applicationManager.getNavigationManager();
  ...
  txtEnterUsernameOnEndEditing: function() {
    ...
    if (userName) {
      ...
      if (validationManager.isUsernameValidForPolicy(userName)) {
        ...
        self.showFlxSecurityRequirementsUsername();
