it("ExternalAcc_VerifyTranscationUnderTransferActivites", async function() {
	// :User Injected Code Snippet [// - [3 lines]]
	await openMenu("Manage Transactions");
	await VerifyTransferUnderActivities(ManageRecipient.recipientName.externalAccount);
