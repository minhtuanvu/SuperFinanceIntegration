it("TC03_ManageRecipient_AddaRecipient_Samebank", async function() {
	...
	await kony.automation.playback.waitFor(["frmEnterBenAccNo","keypad","btnTwo"]);
	...
	await kony.automation.playback.waitFor(["frmReEnterBenAccNo","keypad","btnTwo"]);
	...
	kony.automation.textbox.enterText(["frmBenName","txtRecipientName"],"samebank2");
