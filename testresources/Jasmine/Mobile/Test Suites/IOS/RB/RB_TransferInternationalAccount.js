describe("RB_TransferInternationalAccount", function() {
	...
	it("SearchInternationalAccount", async function() {
	...
	it("TransferInternationalAccSchedule_DailyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
			await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
			await enterAmount();
	...
	it("TransferInternationalAccSchedule_HalfYearlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_MonhtlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_MonthlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_QuarterlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_QuarterlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_WeeklyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_WeeklyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_YearlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
	...
	it("TransferInternationalAccSchedule_YearlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.internationalAccount.fromAccount , Transfers.internationalAccount.toAccount);
		await enterAmount();
