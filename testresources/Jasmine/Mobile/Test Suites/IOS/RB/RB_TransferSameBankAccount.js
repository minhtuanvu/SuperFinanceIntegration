describe("RB_TransferSameBankAccount", function() {
	...
	it("SearchSameBankAccount", async function() {
	...
	it("TransferSameBankAccountSchedule_DailyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
			await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
			await enterAmount();
	...
	it("TransferSameBankAccountSchedule_HalfYearlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
	...
	it("TransferSameBankAccountSchedule_HalfYearlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
	...
	it("TransferSameBankAccountSchedule_MonthlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
	...
	it("TransferSameBankAccountSchedule_QuarterlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
	...
	it("TransferSameBankAccountSchedule_QuarterlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
	...
	it("TransferSameBankAccountSchedule_WeeklyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
	...
	it("TransferSameBankAccountSchedule_WeeklyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
	...
	it("TransferSameBankAccountSchedule_YearlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.sameBankAccount.fromAccount , Transfers.sameBankAccount.toAccount);
		await enterAmount();
