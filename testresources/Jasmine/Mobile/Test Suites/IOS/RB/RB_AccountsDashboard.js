describe("RB_AccountsDashboard", function() {
	...
	it("collapseAccounts", async function() {
		// :User Injected Code Snippet [// - [1 lines]]
		await collapseAccounts();
		// :End User Injected Code Snippet {288ad6d3-001b-76d0-a4f9-47d3928d755a}
	});
	
	it("swipeOnDashboard", async function() {
		// :User Injected Code Snippet [// - [1 lines]]
		await swipeOnDashboard();
		// :End User Injected Code Snippet {e35c7a80-3268-b1c6-0882-45157c8f3b4d}
	});
	...
	it("searchTransaction", async function() {
		// :User Injected Code Snippet [// - [1 lines]]
		await searchStransaction();
		// :End User Injected Code Snippet {2a8b2e75-0224-ddcb-e559-8c34e436e500}
	});
	
	it("AdvanceSearch", async function() {
		// :User Injected Code Snippet [// - [4 lines]]
		await collapseAccounts();
		await goToViewAllTransactions();
		await advanceSearch();
		await goBackToDashboard();
		// :End User Injected Code Snippet {d6c4e689-584c-703b-0a47-f05d13bd91f9}
	});
});