describe("RB_TransferOwnAccount", function() {
	...
	it("SearchOwnAccount", async function() {
	...
	it("TransferOwnAccountSchedule_DailyNumberOfTransfers", async function() {
	...
	it("TransferOwnAccountSchedule_HalfYearlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_HalfYearlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_MonhtlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_MonthlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_QuarterlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_WeeklyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_WeeklyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_YearlyDateRange", async function() {
		// :User Injected Code Snippet [// - [6 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
	...
	it("TransferOwnAccountSchedule_YearlyNumberOfTransfers", async function() {
		// :User Injected Code Snippet [// - [8 lines]]
		await goToTransfers();
		await searchInFromAndToScreen(Transfers.ownAccount.fromAccount , Transfers.ownAccount.toAccount);
		await enterAmount();
