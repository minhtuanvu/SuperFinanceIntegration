describe("RB_ManageRecipientP2P", function() {
	...
	it("ListOfRecipientsP2P", async function() {
		...
		listOfRecipients("PToP");
		// :End User Injected Code Snippet {d3cf1f1e-c5c7-0f45-5e32-70594b6622eb}
	});
	
	it("AddRecipientP2P", async function() {
		// :User Injected Code Snippet [// - [1 lines]]
		await addRecipientPToP(ManageRecipient.recipientName.p2pRecipient);
		// :End User Injected Code Snippet {0f3b7132-221d-b82e-3e20-259f1bf94b78}
	});
	...
	it("AddRecipientP2PUsingEmail", async function() {
		// :User Injected Code Snippet [// - [1 lines]]
		await addRecipientPToPWithEmail(ManageRecipient.recipientName.p2pRecipient);
		// :End User Injected Code Snippet {0f3b7132-221d-b82e-3e20-259f1bf94b78}
	});
