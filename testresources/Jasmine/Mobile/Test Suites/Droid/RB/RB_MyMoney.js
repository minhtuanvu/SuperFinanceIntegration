describe("RB_MyMoney", function() {
	...
	it("MyMoney_SearchFunctionality", async function() {
	  
	  NavigateToMyMoney();
	  VerifyMymoneySearchTranscation();
	...
	it("MyMoney_VerifyViewAllTranscation", async function() {
	  
	  NavigateToMyMoney();
	  VerifyMyMoneyViewAllTranscation();
