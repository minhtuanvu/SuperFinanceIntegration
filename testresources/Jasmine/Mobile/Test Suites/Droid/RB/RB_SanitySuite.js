describe("RB_SanitySuite", function() {
	...
	it("PreLogin_VerifyAppVersion", async function() {
	
	 clickOnPreLogin_SupportBtn();
	 verifyAppVersion();
	...
	it("MyMoney_TranscationDetails", async function() {
	  
	  NavigateToMyMoney();
	  VerifyMyMoneyTranscationDetails();
	...
	it("APreRequisiteTo_AddPTOPreciptent", async function() {
	...
	it("APreRequisiteTo_AddExternalbankreciptent", async function() {
	...
	it("APreRequisiteTo_AddInternationalbankreciptent", async function() {
