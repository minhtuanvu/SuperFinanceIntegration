describe("RB_TransferActivities", function() {
	...
	it("ExternalBank_VerifyTranscationUnderAccounts", async function() {
	...
	it("OwnAcc_VerifyTranscationUnderAccounts", async function() {
	...
	it("SameBank_VerifyTranscationUnderAccounts", async function() {
	...
	it("VerifySheduledTranscationDetails", async function() {
	  ...
	  navigateToTransferActivities();
	  VerifySheduledTranscationDetails();
	  VerifyAccountsDashBoard();
