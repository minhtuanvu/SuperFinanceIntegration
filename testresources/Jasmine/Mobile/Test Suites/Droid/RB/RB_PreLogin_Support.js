describe("RB_PreLogin_Support", function() {
	...
	it("PreLogin_VerifyFAQ", async function() {
	  
	  clickOnPreLogin_SupportBtn();
	  VerifyPreLogin_FAQLink();
	  MoveBackFrom_Support();
	  
	},60000);
	
	it("PreLogin_VerifyPrivacyPolicy", async function() {
	
	  clickOnPreLogin_SupportBtn();
	  VerifyPreLogin_PrivacyPolicy();
	  MoveBackFrom_Support();
	  
	},60000);
	
	it("PreLogin_VerifyTermsnConditions", async function() {
	  
	  clickOnPreLogin_SupportBtn();
	  VerifyPreLogin_TermsConditions();
	  MoveBackFrom_Support();
