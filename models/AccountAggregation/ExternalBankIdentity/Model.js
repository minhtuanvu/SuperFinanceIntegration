...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ExternalBankIdentity", "objectService" : "AccountAggregation"};
    ...
    function ExternalBankIdentity(defaultValues) {
        ...
        context["field"] = "SessionToken";
        context["metadata"] = (objectMetadata ? objectMetadata["SessionToken"] : null);
        privateState.SessionToken = defaultValues ?
            (defaultValues["SessionToken"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["SessionToken"], context) :
                null) :
            null;
