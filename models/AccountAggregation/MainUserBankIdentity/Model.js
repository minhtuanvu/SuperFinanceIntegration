...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "MainUserBankIdentity", "objectService" : "AccountAggregation"};
     ...
     */
    MainUserBankIdentity.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("AccountAggregation", "MainUserBankIdentity", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    MainUserBankIdentity.clone = function(objectToClone) {
        var clonedObj = new MainUserBankIdentity();
