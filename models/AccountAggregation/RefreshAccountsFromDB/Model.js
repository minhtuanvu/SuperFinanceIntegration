...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "RefreshAccountsFromDB", "objectService" : "AccountAggregation"};
    ...
    function RefreshAccountsFromDB(defaultValues) {
        ...
        context["field"] = "InternalAccount";
        context["metadata"] = (objectMetadata ? objectMetadata["InternalAccount"] : null);
        privateState.InternalAccount = defaultValues ?
            (defaultValues["InternalAccount"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["InternalAccount"], context) :
                null) :
            null;
