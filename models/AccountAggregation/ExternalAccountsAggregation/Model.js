...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ExternalAccountsAggregation", "objectService" : "AccountAggregation"};
    ...
    function ExternalAccountsAggregation(defaultValues) {
        ...
        context["field"] = "label";
        context["metadata"] = (objectMetadata ? objectMetadata["label"] : null);
        privateState.label = defaultValues ?
            (defaultValues["label"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["label"], context) :
                null) :
            null;
