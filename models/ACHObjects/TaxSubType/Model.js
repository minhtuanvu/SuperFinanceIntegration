...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "TaxSubType", "objectService" : "ACHObjects"};
    ...
    TaxSubType.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ACHObjects", "TaxSubType", options, metaDataSuccess, metaDataFailure);
    };
