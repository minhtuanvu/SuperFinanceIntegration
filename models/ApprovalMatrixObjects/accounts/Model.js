...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "accounts", "objectService" : "ApprovalMatrixObjects"};
    ...
    accounts.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ApprovalMatrixObjects", "accounts", options, metaDataSuccess, metaDataFailure);
    };
