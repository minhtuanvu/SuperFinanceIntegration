...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "approvers", "objectService" : "ApprovalMatrixObjects"};
    ...
    function approvers(defaultValues) {
        ...
        context["field"] = "approverId";
        context["metadata"] = (objectMetadata ? objectMetadata["approverId"] : null);
        privateState.approverId = defaultValues ?
            (defaultValues["approverId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["approverId"], context) :
                null) :
            null;

        context["field"] = "approverName";
        context["metadata"] = (objectMetadata ? objectMetadata["approverName"] : null);
        privateState.approverName = defaultValues ?
            (defaultValues["approverName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["approverName"], context) :
                null) :
            null;
