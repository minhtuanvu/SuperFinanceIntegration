...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "DailyMarket", "objectService" : "WealthObjects"};
    ...
    DailyMarket.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("WealthObjects", "DailyMarket", options, metaDataSuccess, metaDataFailure);
    };
