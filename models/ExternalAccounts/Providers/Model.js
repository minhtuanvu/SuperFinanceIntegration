...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Providers", "objectService" : "ExternalAccounts"};
    ...
    function Providers(defaultValues) {
        ...
        context["field"] = "country_code";
        context["metadata"] = (objectMetadata ? objectMetadata["country_code"] : null);
        privateState.country_code = defaultValues ?
            (defaultValues["country_code"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["country_code"], context) :
                null) :
            null;

        context["field"] = "home_url";
        context["metadata"] = (objectMetadata ? objectMetadata["home_url"] : null);
        privateState.home_url = defaultValues ?
            (defaultValues["home_url"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["home_url"], context) :
                null) :
            null;
        ...
        context["field"] = "login_url";
        context["metadata"] = (objectMetadata ? objectMetadata["login_url"] : null);
        privateState.login_url = defaultValues ?
            (defaultValues["login_url"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["login_url"], context) :
                null) :
            null;

        context["field"] = "logo_url";
        context["metadata"] = (objectMetadata ? objectMetadata["logo_url"] : null);
        privateState.logo_url = defaultValues ?
            (defaultValues["logo_url"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["logo_url"], context) :
                null) :
            null;

        context["field"] = "max_consent_days";
        context["metadata"] = (objectMetadata ? objectMetadata["max_consent_days"] : null);
        privateState.max_consent_days = defaultValues ?
            (defaultValues["max_consent_days"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["max_consent_days"], context) :
                null) :
            null;

        context["field"] = "max_fetch_interval";
        context["metadata"] = (objectMetadata ? objectMetadata["max_fetch_interval"] : null);
        privateState.max_fetch_interval = defaultValues ?
            (defaultValues["max_fetch_interval"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["max_fetch_interval"], context) :
                null) :
            null;
        ...
        context["field"] = "providerName";
        context["metadata"] = (objectMetadata ? objectMetadata["providerName"] : null);
        privateState.providerName = defaultValues ?
            (defaultValues["providerName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["providerName"], context) :
                null) :
            null;

        context["field"] = "refresh_timeout";
        context["metadata"] = (objectMetadata ? objectMetadata["refresh_timeout"] : null);
        privateState.refresh_timeout = defaultValues ?
            (defaultValues["refresh_timeout"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["refresh_timeout"], context) :
                null) :
            null;
        ...
        context["field"] = "supported_account_extra_fields";
        context["metadata"] = (objectMetadata ? objectMetadata["supported_account_extra_fields"] : null);
        privateState.supported_account_extra_fields = defaultValues ?
            (defaultValues["supported_account_extra_fields"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supported_account_extra_fields"], context) :
                null) :
            null;

        context["field"] = "supported_account_natures";
        context["metadata"] = (objectMetadata ? objectMetadata["supported_account_natures"] : null);
        privateState.supported_account_natures = defaultValues ?
            (defaultValues["supported_account_natures"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supported_account_natures"], context) :
                null) :
            null;

        context["field"] = "supported_account_types";
        context["metadata"] = (objectMetadata ? objectMetadata["supported_account_types"] : null);
        privateState.supported_account_types = defaultValues ?
            (defaultValues["supported_account_types"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supported_account_types"], context) :
                null) :
            null;

        context["field"] = "supported_fetch_scopes";
        context["metadata"] = (objectMetadata ? objectMetadata["supported_fetch_scopes"] : null);
        privateState.supported_fetch_scopes = defaultValues ?
            (defaultValues["supported_fetch_scopes"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supported_fetch_scopes"], context) :
                null) :
            null;

        context["field"] = "supported_transaction_extra_fields";
        context["metadata"] = (objectMetadata ? objectMetadata["supported_transaction_extra_fields"] : null);
        privateState.supported_transaction_extra_fields = defaultValues ?
            (defaultValues["supported_transaction_extra_fields"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supported_transaction_extra_fields"], context) :
                null) :
            null;
