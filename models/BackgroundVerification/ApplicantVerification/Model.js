...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ApplicantVerification", "objectService" : "BackgroundVerification"};
    ...
    function ApplicantVerification(defaultValues) {
        ...
        context["field"] = "id_number";
        context["metadata"] = (objectMetadata ? objectMetadata["id_number"] : null);
        privateState.id_number = defaultValues ?
            (defaultValues["id_number"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["id_number"], context) :
                null) :
            null;

        context["field"] = "results_message";
        context["metadata"] = (objectMetadata ? objectMetadata["results_message"] : null);
        privateState.results_message = defaultValues ?
            (defaultValues["results_message"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["results_message"], context) :
                null) :
            null;

        context["field"] = "summary_result_message";
        context["metadata"] = (objectMetadata ? objectMetadata["summary_result_message"] : null);
        privateState.summary_result_message = defaultValues ?
            (defaultValues["summary_result_message"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["summary_result_message"], context) :
                null) :
            null;

        context["field"] = "results_key";
        context["metadata"] = (objectMetadata ? objectMetadata["results_key"] : null);
        privateState.results_key = defaultValues ?
            (defaultValues["results_key"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["results_key"], context) :
                null) :
            null;

        context["field"] = "summary_result_key";
        context["metadata"] = (objectMetadata ? objectMetadata["summary_result_key"] : null);
        privateState.summary_result_key = defaultValues ?
            (defaultValues["summary_result_key"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["summary_result_key"], context) :
                null) :
            null;

        context["field"] = "invoice";
        context["metadata"] = (objectMetadata ? objectMetadata["invoice"] : null);
        privateState.invoice = defaultValues ?
            (defaultValues["invoice"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["invoice"], context) :
                null) :
            null;

        context["field"] = "restriction_key";
        context["metadata"] = (objectMetadata ? objectMetadata["restriction_key"] : null);
        privateState.restriction_key = defaultValues ?
            (defaultValues["restriction_key"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["restriction_key"], context) :
                null) :
            null;

        context["field"] = "restriction_message";
        context["metadata"] = (objectMetadata ? objectMetadata["restriction_message"] : null);
        privateState.restriction_message = defaultValues ?
            (defaultValues["restriction_message"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["restriction_message"], context) :
                null) :
            null;

        context["field"] = "pa_list";
        context["metadata"] = (objectMetadata ? objectMetadata["pa_list"] : null);
        privateState.pa_list = defaultValues ?
            (defaultValues["pa_list"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["pa_list"], context) :
                null) :
            null;

        context["field"] = "pa_score";
        context["metadata"] = (objectMetadata ? objectMetadata["pa_score"] : null);
        privateState.pa_score = defaultValues ?
            (defaultValues["pa_score"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["pa_score"], context) :
                null) :
            null;
