define([], function(){
	...
	OrganizationRepository.prototype.CreateMicroOrganizationEmployeeForAdmin = function(params, onCompletion){
		return OrganizationRepository.prototype.customVerb('CreateMicroOrganizationEmployeeForAdmin', params, onCompletion);
	};

	//For Operation 'getOrganizationGroupActionLimits' with service id 'getOrganizationGroupActionLimits5285'
	OrganizationRepository.prototype.getOrganizationGroupActionLimits = function(params, onCompletion){
		return OrganizationRepository.prototype.customVerb('getOrganizationGroupActionLimits', params, onCompletion);
	};
	...
	OrganizationRepository.prototype.enrollOrganization = function(params, onCompletion){
		return OrganizationRepository.prototype.customVerb('enrollOrganization', params, onCompletion);
	};
	...
	OrganizationRepository.prototype.CreateSmallOrganizationEmployeeForAdmin = function(params, onCompletion){
		return OrganizationRepository.prototype.customVerb('CreateSmallOrganizationEmployeeForAdmin', params, onCompletion);
	};
