...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Organization", "objectService" : "RBObjects"};
    ...
    function Organization(defaultValues) {
        ...
        context["field"] = "Sequence";
        context["metadata"] = (objectMetadata ? objectMetadata["Sequence"] : null);
        privateState.Sequence = defaultValues ?
            (defaultValues["Sequence"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Sequence"], context) :
                null) :
            null;
        ...
        context["field"] = "Tin";
        context["metadata"] = (objectMetadata ? objectMetadata["Tin"] : null);
        privateState.Tin = defaultValues ?
            (defaultValues["Tin"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Tin"], context) :
                null) :
            null;
        ...
        context["field"] = "Membership";
        context["metadata"] = (objectMetadata ? objectMetadata["Membership"] : null);
        privateState.Membership = defaultValues ?
            (defaultValues["Membership"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Membership"], context) :
                null) :
            null;

        context["field"] = "AccountsList";
        context["metadata"] = (objectMetadata ? objectMetadata["AccountsList"] : null);
        privateState.AccountsList = defaultValues ?
            (defaultValues["AccountsList"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["AccountsList"], context) :
                null) :
            null;
        ...
        context["field"] = "TypeName";
        context["metadata"] = (objectMetadata ? objectMetadata["TypeName"] : null);
        privateState.TypeName = defaultValues ?
            (defaultValues["TypeName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TypeName"], context) :
                null) :
            null;
        ...
        context["field"] = "isExists";
        context["metadata"] = (objectMetadata ? objectMetadata["isExists"] : null);
        privateState.isExists = defaultValues ?
            (defaultValues["isExists"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isExists"], context) :
                null) :
            null;
        ...
        context["field"] = "organizationId";
        context["metadata"] = (objectMetadata ? objectMetadata["organizationId"] : null);
        privateState.organizationId = defaultValues ?
            (defaultValues["organizationId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["organizationId"], context) :
                null) :
            null;
        ...
        context["field"] = "AuthorizedSignatoryGroupId";
        context["metadata"] = (objectMetadata ? objectMetadata["AuthorizedSignatoryGroupId"] : null);
        privateState.AuthorizedSignatoryGroupId = defaultValues ?
            (defaultValues["AuthorizedSignatoryGroupId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["AuthorizedSignatoryGroupId"], context) :
                null) :
            null;
