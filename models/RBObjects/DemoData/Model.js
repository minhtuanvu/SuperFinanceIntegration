...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "DemoData", "objectService" : "RBObjects"};
    ...
    function DemoData(defaultValues) {
        ...
        context["field"] = "adminUsername";
        context["metadata"] = (objectMetadata ? objectMetadata["adminUsername"] : null);
        privateState.adminUsername = defaultValues ?
            (defaultValues["adminUsername"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["adminUsername"], context) :
                null) :
            null;

        context["field"] = "adminPassword";
        context["metadata"] = (objectMetadata ? objectMetadata["adminPassword"] : null);
        privateState.adminPassword = defaultValues ?
            (defaultValues["adminPassword"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["adminPassword"], context) :
                null) :
            null;
