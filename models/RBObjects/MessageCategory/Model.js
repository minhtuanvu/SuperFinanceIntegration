...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "MessageCategory", "objectService" : "RBObjects"};
     ...
     */
    MessageCategory.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RBObjects", "MessageCategory", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    MessageCategory.clone = function(objectToClone) {
        var clonedObj = new MessageCategory();
