...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "UserAlerts", "objectService" : "RBObjects"};
    ...
    function UserAlerts(defaultValues) {
        ...
        context["field"] = "alertid";
        context["metadata"] = (objectMetadata ? objectMetadata["alertid"] : null);
        privateState.alertid = defaultValues ?
            (defaultValues["alertid"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["alertid"], context) :
                null) :
            null;

        context["field"] = "bankingIDChange";
        context["metadata"] = (objectMetadata ? objectMetadata["bankingIDChange"] : null);
        privateState.bankingIDChange = defaultValues ?
            (defaultValues["bankingIDChange"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["bankingIDChange"], context) :
                null) :
            null;

        context["field"] = "communicationChange";
        context["metadata"] = (objectMetadata ? objectMetadata["communicationChange"] : null);
        privateState.communicationChange = defaultValues ?
            (defaultValues["communicationChange"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["communicationChange"], context) :
                null) :
            null;

        context["field"] = "dealsExpiring";
        context["metadata"] = (objectMetadata ? objectMetadata["dealsExpiring"] : null);
        privateState.dealsExpiring = defaultValues ?
            (defaultValues["dealsExpiring"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["dealsExpiring"], context) :
                null) :
            null;
        ...
        context["field"] = "newDealsAvailable";
        context["metadata"] = (objectMetadata ? objectMetadata["newDealsAvailable"] : null);
        privateState.newDealsAvailable = defaultValues ?
            (defaultValues["newDealsAvailable"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["newDealsAvailable"], context) :
                null) :
            null;

        context["field"] = "newPayeeAdded";
        context["metadata"] = (objectMetadata ? objectMetadata["newPayeeAdded"] : null);
        privateState.newPayeeAdded = defaultValues ?
            (defaultValues["newPayeeAdded"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["newPayeeAdded"], context) :
                null) :
            null;

        context["field"] = "passwordChange";
        context["metadata"] = (objectMetadata ? objectMetadata["passwordChange"] : null);
        privateState.passwordChange = defaultValues ?
            (defaultValues["passwordChange"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["passwordChange"], context) :
                null) :
            null;

        context["field"] = "passwordExpired";
        context["metadata"] = (objectMetadata ? objectMetadata["passwordExpired"] : null);
        privateState.passwordExpired = defaultValues ?
            (defaultValues["passwordExpired"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["passwordExpired"], context) :
                null) :
            null;

        context["field"] = "payeeDetailsUpdated";
        context["metadata"] = (objectMetadata ? objectMetadata["payeeDetailsUpdated"] : null);
        privateState.payeeDetailsUpdated = defaultValues ?
            (defaultValues["payeeDetailsUpdated"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["payeeDetailsUpdated"], context) :
                null) :
            null;
        ...
        context["field"] = "canBeSelected";
        context["metadata"] = (objectMetadata ? objectMetadata["canBeSelected"] : null);
        privateState.canBeSelected = defaultValues ?
            (defaultValues["canBeSelected"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["canBeSelected"], context) :
                null) :
            null;

        context["field"] = "alertTypes";
        context["metadata"] = (objectMetadata ? objectMetadata["alertTypes"] : null);
        privateState.alertTypes = defaultValues ?
            (defaultValues["alertTypes"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["alertTypes"], context) :
                null) :
            null;

        context["field"] = "isSelected";
        context["metadata"] = (objectMetadata ? objectMetadata["isSelected"] : null);
        privateState.isSelected = defaultValues ?
            (defaultValues["isSelected"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isSelected"], context) :
                null) :
            null;

        context["field"] = "canSmsBeSelected";
        context["metadata"] = (objectMetadata ? objectMetadata["canSmsBeSelected"] : null);
        privateState.canSmsBeSelected = defaultValues ?
            (defaultValues["canSmsBeSelected"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["canSmsBeSelected"], context) :
                null) :
            null;
        ...
        context["field"] = "isSmsActive";
        context["metadata"] = (objectMetadata ? objectMetadata["isSmsActive"] : null);
        privateState.isSmsActive = defaultValues ?
            (defaultValues["isSmsActive"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isSmsActive"], context) :
                null) :
            null;

        context["field"] = "canPushBeSelected";
        context["metadata"] = (objectMetadata ? objectMetadata["canPushBeSelected"] : null);
        privateState.canPushBeSelected = defaultValues ?
            (defaultValues["canPushBeSelected"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["canPushBeSelected"], context) :
                null) :
            null;

        context["field"] = "isEmailActive";
        context["metadata"] = (objectMetadata ? objectMetadata["isEmailActive"] : null);
        privateState.isEmailActive = defaultValues ?
            (defaultValues["isEmailActive"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isEmailActive"], context) :
                null) :
            null;

        context["field"] = "isPushActive";
        context["metadata"] = (objectMetadata ? objectMetadata["isPushActive"] : null);
        privateState.isPushActive = defaultValues ?
            (defaultValues["isPushActive"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isPushActive"], context) :
                null) :
            null;
        ...
        context["field"] = "canEmailBeSelected";
        context["metadata"] = (objectMetadata ? objectMetadata["canEmailBeSelected"] : null);
        privateState.canEmailBeSelected = defaultValues ?
            (defaultValues["canEmailBeSelected"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["canEmailBeSelected"], context) :
                null) :
            null;

        context["field"] = "alertTypeName";
        context["metadata"] = (objectMetadata ? objectMetadata["alertTypeName"] : null);
        privateState.alertTypeName = defaultValues ?
            (defaultValues["alertTypeName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["alertTypeName"], context) :
                null) :
            null;

        context["field"] = "alertTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["alertTypeId"] : null);
        privateState.alertTypeId = defaultValues ?
            (defaultValues["alertTypeId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["alertTypeId"], context) :
                null) :
            null;

        context["field"] = "alerts";
        context["metadata"] = (objectMetadata ? objectMetadata["alerts"] : null);
        privateState.alerts = defaultValues ?
            (defaultValues["alerts"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["alerts"], context) :
                null) :
            null;
