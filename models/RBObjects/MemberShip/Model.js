...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "MemberShip", "objectService" : "RBObjects"};
    ...
    function MemberShip(defaultValues) {
        ...
        context["field"] = "MemberType";
        context["metadata"] = (objectMetadata ? objectMetadata["MemberType"] : null);
        privateState.MemberType = defaultValues ?
            (defaultValues["MemberType"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["MemberType"], context) :
                null) :
            null;
     ...
     */
    MemberShip.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RBObjects", "MemberShip", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    MemberShip.clone = function(objectToClone) {
        var clonedObj = new MemberShip();
