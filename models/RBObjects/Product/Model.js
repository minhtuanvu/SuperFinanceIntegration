...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Product", "objectService" : "RBObjects"};
    ...
    function Product(defaultValues) {
        ...
        context["field"] = "MarketingStateId";
        context["metadata"] = (objectMetadata ? objectMetadata["MarketingStateId"] : null);
        privateState.MarketingStateId = defaultValues ?
            (defaultValues["MarketingStateId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["MarketingStateId"], context) :
                null) :
            null;
        ...
        context["field"] = "otherproducttype_Name";
        context["metadata"] = (objectMetadata ? objectMetadata["otherproducttype_Name"] : null);
        privateState.otherproducttype_Name = defaultValues ?
            (defaultValues["otherproducttype_Name"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["otherproducttype_Name"], context) :
                null) :
            null;
        ...
        context["field"] = "otherproducttype_Description";
        context["metadata"] = (objectMetadata ? objectMetadata["otherproducttype_Description"] : null);
        privateState.otherproducttype_Description = defaultValues ?
            (defaultValues["otherproducttype_Description"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["otherproducttype_Description"], context) :
                null) :
            null;

        context["field"] = "SecondaryProduct_id";
        context["metadata"] = (objectMetadata ? objectMetadata["SecondaryProduct_id"] : null);
        privateState.SecondaryProduct_id = defaultValues ?
            (defaultValues["SecondaryProduct_id"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["SecondaryProduct_id"], context) :
                null) :
            null;
        ...
        context["field"] = "otherproducttype_id";
        context["metadata"] = (objectMetadata ? objectMetadata["otherproducttype_id"] : null);
        privateState.otherproducttype_id = defaultValues ?
            (defaultValues["otherproducttype_id"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["otherproducttype_id"], context) :
                null) :
            null;
