define([], function(){
	...
	SecurityQuestionsRepository.prototype.resetSecurityQuestions = function(params, onCompletion){
		return SecurityQuestionsRepository.prototype.customVerb('resetSecurityQuestions', params, onCompletion);
	};
