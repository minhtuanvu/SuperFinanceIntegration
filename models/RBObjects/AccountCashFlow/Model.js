...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "AccountCashFlow", "objectService" : "RBObjects"};
    ...
    function AccountCashFlow(defaultValues) {
        ...
        context["field"] = "monthCash";
        context["metadata"] = (objectMetadata ? objectMetadata["monthCash"] : null);
        privateState.monthCash = defaultValues ?
            (defaultValues["monthCash"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["monthCash"], context) :
                null) :
            null;

        context["field"] = "monthCredit";
        context["metadata"] = (objectMetadata ? objectMetadata["monthCredit"] : null);
        privateState.monthCredit = defaultValues ?
            (defaultValues["monthCredit"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["monthCredit"], context) :
                null) :
            null;

        context["field"] = "totalCash";
        context["metadata"] = (objectMetadata ? objectMetadata["totalCash"] : null);
        privateState.totalCash = defaultValues ?
            (defaultValues["totalCash"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["totalCash"], context) :
                null) :
            null;

        context["field"] = "totalCreditDebt";
        context["metadata"] = (objectMetadata ? objectMetadata["totalCreditDebt"] : null);
        privateState.totalCreditDebt = defaultValues ?
            (defaultValues["totalCreditDebt"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["totalCreditDebt"], context) :
                null) :
            null;
