...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "UserSecurityQuestions", "objectService" : "RBObjects"};
    ...
    function UserSecurityQuestions(defaultValues) {
        ...
        context["field"] = "question_id";
        context["metadata"] = (objectMetadata ? objectMetadata["question_id"] : null);
        privateState.question_id = defaultValues ?
            (defaultValues["question_id"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["question_id"], context) :
                null) :
            null;
        ...
        context["field"] = "usersecurityli";
        context["metadata"] = (objectMetadata ? objectMetadata["usersecurityli"] : null);
        privateState.usersecurityli = defaultValues ?
            (defaultValues["usersecurityli"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["usersecurityli"], context) :
                null) :
            null;
