define([], function(){
	...
	ApplicantRepository.prototype.createApplicantForAdmin = function(params, onCompletion){
		return ApplicantRepository.prototype.customVerb('createApplicantForAdmin', params, onCompletion);
	};
