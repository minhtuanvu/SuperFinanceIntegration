...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Messages", "objectService" : "RBObjects"};
    ...
    function Messages(defaultValues) {
        ...
        context["field"] = "count";
        context["metadata"] = (objectMetadata ? objectMetadata["count"] : null);
        privateState.count = defaultValues ?
            (defaultValues["count"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["count"], context) :
                null) :
            null;
        ...
        context["field"] = "deletedDate";
        context["metadata"] = (objectMetadata ? objectMetadata["deletedDate"] : null);
        privateState.deletedDate = defaultValues ?
            (defaultValues["deletedDate"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["deletedDate"], context) :
                null) :
            null;
        ...
        context["field"] = "messageId";
        context["metadata"] = (objectMetadata ? objectMetadata["messageId"] : null);
        privateState.messageId = defaultValues ?
            (defaultValues["messageId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["messageId"], context) :
                null) :
            null;
        ...
        context["field"] = "recordNumber";
        context["metadata"] = (objectMetadata ? objectMetadata["recordNumber"] : null);
        privateState.recordNumber = defaultValues ?
            (defaultValues["recordNumber"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["recordNumber"], context) :
                null) :
            null;
        ...
        context["field"] = "subcategoryId";
        context["metadata"] = (objectMetadata ? objectMetadata["subcategoryId"] : null);
        privateState.subcategoryId = defaultValues ?
            (defaultValues["subcategoryId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["subcategoryId"], context) :
                null) :
            null;

        context["field"] = "subcategoryName";
        context["metadata"] = (objectMetadata ? objectMetadata["subcategoryName"] : null);
        privateState.subcategoryName = defaultValues ?
            (defaultValues["subcategoryName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["subcategoryName"], context) :
                null) :
            null;

        context["field"] = "subject";
        context["metadata"] = (objectMetadata ? objectMetadata["subject"] : null);
        privateState.subject = defaultValues ?
            (defaultValues["subject"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["subject"], context) :
                null) :
            null;
