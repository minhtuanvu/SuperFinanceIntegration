...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Campaign", "objectService" : "RBObjects"};
    ...
    function Campaign(defaultValues) {
        ...
        context["field"] = "screenName";
        context["metadata"] = (objectMetadata ? objectMetadata["screenName"] : null);
        privateState.screenName = defaultValues ?
            (defaultValues["screenName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["screenName"], context) :
                null) :
            null;
