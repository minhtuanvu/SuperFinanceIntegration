...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "CheckOrder", "objectService" : "RBObjects"};
    ...
    function CheckOrder(defaultValues) {
        ...
        context["field"] = "checkOrderID";
        context["metadata"] = (objectMetadata ? objectMetadata["checkOrderID"] : null);
        privateState.checkOrderID = defaultValues ?
            (defaultValues["checkOrderID"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["checkOrderID"], context) :
                null) :
            null;
        ...
        context["field"] = "leafCount";
        context["metadata"] = (objectMetadata ? objectMetadata["leafCount"] : null);
        privateState.leafCount = defaultValues ?
            (defaultValues["leafCount"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["leafCount"], context) :
                null) :
            null;
        ...
        context["field"] = "orderTime";
        context["metadata"] = (objectMetadata ? objectMetadata["orderTime"] : null);
        privateState.orderTime = defaultValues ?
            (defaultValues["orderTime"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["orderTime"], context) :
                null) :
            null;

        context["field"] = "postboxNumber";
        context["metadata"] = (objectMetadata ? objectMetadata["postboxNumber"] : null);
        privateState.postboxNumber = defaultValues ?
            (defaultValues["postboxNumber"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["postboxNumber"], context) :
                null) :
            null;
