...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Currency", "objectService" : "RBObjects"};
    ...
    Currency.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RBObjects", "Currency", options, metaDataSuccess, metaDataFailure);
    };
