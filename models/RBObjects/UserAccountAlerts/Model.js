...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "UserAccountAlerts", "objectService" : "RBObjects"};
    ...
    function UserAccountAlerts(defaultValues) {
        ...
        context["field"] = "balanceUpdate";
        context["metadata"] = (objectMetadata ? objectMetadata["balanceUpdate"] : null);
        privateState.balanceUpdate = defaultValues ?
            (defaultValues["balanceUpdate"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["balanceUpdate"], context) :
                null) :
            null;

        context["field"] = "balanceUpdateTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["balanceUpdateTypeId"] : null);
        privateState.balanceUpdateTypeId = defaultValues ?
            (defaultValues["balanceUpdateTypeId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["balanceUpdateTypeId"], context) :
                null) :
            null;

        context["field"] = "checkClearance";
        context["metadata"] = (objectMetadata ? objectMetadata["checkClearance"] : null);
        privateState.checkClearance = defaultValues ?
            (defaultValues["checkClearance"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["checkClearance"], context) :
                null) :
            null;
        ...
        context["field"] = "debitLimit";
        context["metadata"] = (objectMetadata ? objectMetadata["debitLimit"] : null);
        privateState.debitLimit = defaultValues ?
            (defaultValues["debitLimit"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["debitLimit"], context) :
                null) :
            null;

        context["field"] = "depositDueReminder";
        context["metadata"] = (objectMetadata ? objectMetadata["depositDueReminder"] : null);
        privateState.depositDueReminder = defaultValues ?
            (defaultValues["depositDueReminder"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["depositDueReminder"], context) :
                null) :
            null;

        context["field"] = "depositDueReminderTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["depositDueReminderTypeId"] : null);
        privateState.depositDueReminderTypeId = defaultValues ?
            (defaultValues["depositDueReminderTypeId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["depositDueReminderTypeId"], context) :
                null) :
            null;
        ...
        context["field"] = "minimumBalance";
        context["metadata"] = (objectMetadata ? objectMetadata["minimumBalance"] : null);
        privateState.minimumBalance = defaultValues ?
            (defaultValues["minimumBalance"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["minimumBalance"], context) :
                null) :
            null;

        context["field"] = "paymentDueReminder";
        context["metadata"] = (objectMetadata ? objectMetadata["paymentDueReminder"] : null);
        privateState.paymentDueReminder = defaultValues ?
            (defaultValues["paymentDueReminder"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["paymentDueReminder"], context) :
                null) :
            null;

        context["field"] = "paymentDueReminderTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["paymentDueReminderTypeId"] : null);
        privateState.paymentDueReminderTypeId = defaultValues ?
            (defaultValues["paymentDueReminderTypeId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["paymentDueReminderTypeId"], context) :
                null) :
            null;
        ...
        context["field"] = "successfulTransfer";
        context["metadata"] = (objectMetadata ? objectMetadata["successfulTransfer"] : null);
        privateState.successfulTransfer = defaultValues ?
            (defaultValues["successfulTransfer"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["successfulTransfer"], context) :
                null) :
            null;
