...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "AccountFeatures", "objectService" : "RBObjects"};
    ...
    function AccountFeatures(defaultValues) {
        ...
        context["field"] = "accountTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["accountTypeId"] : null);
        privateState.accountTypeId = defaultValues ?
            (defaultValues["accountTypeId"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["accountTypeId"], context) :
                null) :
            null;
