define([], function(){
	...
	PayPersonRepository.prototype.LinkPayPersonToTransaction = function(params, onCompletion){
		return PayPersonRepository.prototype.customVerb('LinkPayPersonToTransaction', params, onCompletion);
	};
