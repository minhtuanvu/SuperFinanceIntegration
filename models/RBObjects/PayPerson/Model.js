...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "PayPerson", "objectService" : "RBObjects"};
    ...
    function PayPerson(defaultValues) {
        ...
        context["field"] = "secondaryPhoneNumber";
        context["metadata"] = (objectMetadata ? objectMetadata["secondaryPhoneNumber"] : null);
        privateState.secondaryPhoneNumber = defaultValues ?
            (defaultValues["secondaryPhoneNumber"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["secondaryPhoneNumber"], context) :
                null) :
            null;
