...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "NewUserSecurityQuestions", "objectService" : "RBObjects"};
    ...
    function NewUserSecurityQuestions(defaultValues) {
        ...
        context["field"] = "userSecurityQuestionsList";
        context["metadata"] = (objectMetadata ? objectMetadata["userSecurityQuestionsList"] : null);
        privateState.userSecurityQuestionsList = defaultValues ?
            (defaultValues["userSecurityQuestionsList"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["userSecurityQuestionsList"], context) :
                null) :
            null;
