...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "OFACAndCIPChecks", "objectService" : "RBObjects"};
     ...
     */
    OFACAndCIPChecks.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RBObjects", "OFACAndCIPChecks", options, metaDataSuccess, metaDataFailure);
    };

    //clone the object provided in argument.
    OFACAndCIPChecks.clone = function(objectToClone) {
        var clonedObj = new OFACAndCIPChecks();
