...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ExternalAccounts", "objectService" : "RBObjects"};
    ...
    function ExternalAccounts(defaultValues) {
        ...
        context["field"] = "addressNickName";
        context["metadata"] = (objectMetadata ? objectMetadata["addressNickName"] : null);
        privateState.addressNickName = defaultValues ?
            (defaultValues["addressNickName"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["addressNickName"], context) :
                null) :
            null;
