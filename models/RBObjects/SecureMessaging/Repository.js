define([], function(){
	...
	SecureMessagingRepository.prototype.discardMessageAttachments = function(params, onCompletion){
		return SecureMessagingRepository.prototype.customVerb('discardMessageAttachments', params, onCompletion);
	};
	...
	SecureMessagingRepository.prototype.uploadMessageBinary = function(params, onCompletion){
		return SecureMessagingRepository.prototype.customVerb('uploadMessageBinary', params, onCompletion);
	};
