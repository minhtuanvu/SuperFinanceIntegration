...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "ChartTransactions", "objectService" : "RBObjects"};
    ...
    function ChartTransactions(defaultValues) {
        ...
        context["field"] = "closingBalanceAmount";
        context["metadata"] = (objectMetadata ? objectMetadata["closingBalanceAmount"] : null);
        privateState.closingBalanceAmount = defaultValues ?
            (defaultValues["closingBalanceAmount"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["closingBalanceAmount"], context) :
                null) :
            null;

        context["field"] = "depositAmount";
        context["metadata"] = (objectMetadata ? objectMetadata["depositAmount"] : null);
        privateState.depositAmount = defaultValues ?
            (defaultValues["depositAmount"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["depositAmount"], context) :
                null) :
            null;
        ...
        context["field"] = "transAmount";
        context["metadata"] = (objectMetadata ? objectMetadata["transAmount"] : null);
        privateState.transAmount = defaultValues ?
            (defaultValues["transAmount"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transAmount"], context) :
                null) :
            null;

        context["field"] = "transDate";
        context["metadata"] = (objectMetadata ? objectMetadata["transDate"] : null);
        privateState.transDate = defaultValues ?
            (defaultValues["transDate"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transDate"], context) :
                null) :
            null;

        context["field"] = "transDesc";
        context["metadata"] = (objectMetadata ? objectMetadata["transDesc"] : null);
        privateState.transDesc = defaultValues ?
            (defaultValues["transDesc"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transDesc"], context) :
                null) :
            null;

        context["field"] = "transType";
        context["metadata"] = (objectMetadata ? objectMetadata["transType"] : null);
        privateState.transType = defaultValues ?
            (defaultValues["transType"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transType"], context) :
                null) :
            null;
