...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Holidays", "objectService" : "RBObjects"};
    ...
    function Holidays(defaultValues) {
        ...
        context["field"] = "holidays";
        context["metadata"] = (objectMetadata ? objectMetadata["holidays"] : null);
        privateState.holidays = defaultValues ?
            (defaultValues["holidays"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["holidays"], context) :
                null) :
            null;
        ...
        context["field"] = "holidayDate";
        context["metadata"] = (objectMetadata ? objectMetadata["holidayDate"] : null);
        privateState.holidayDate = defaultValues ?
            (defaultValues["holidayDate"] ?
                kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["holidayDate"], context) :
                null) :
            null;
