...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "User", "objectService" : "SCAActivationObjects"};
    ...
    //For Operation 'lostDevice' with service id 'validateLostDevice3437'
     User.lostDevice = function(params, onCompletion){
        return User.customVerb('lostDevice', params, onCompletion);
     };
    ...
    User.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("SCAActivationObjects", "User", options, metaDataSuccess, metaDataFailure);
    };
