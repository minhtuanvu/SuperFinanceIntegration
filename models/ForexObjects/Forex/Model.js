...
define([], function() {
    ...
    var objectMetadata;
    var context = {"object" : "Forex", "objectService" : "ForexObjects"};
    ...
    Forex.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("ForexObjects", "Forex", options, metaDataSuccess, metaDataFailure);
    };
