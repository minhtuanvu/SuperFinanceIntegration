...
define([], function() {
    ...
    function PortfolioPerformance(defaultValues) {
        ...
        context["field"] = "initialValue";
        context["metadata"] = (objectMetadata ? objectMetadata["initialValue"] : null);
        privateState.initialValue = defaultValues ? (defaultValues["initialValue"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["initialValue"], context) : null) : null;
        context["field"] = "netDeposit";
        context["metadata"] = (objectMetadata ? objectMetadata["netDeposit"] : null);
        privateState.netDeposit = defaultValues ? (defaultValues["netDeposit"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["netDeposit"], context) : null) : null;
        context["field"] = "benchMarkIndex";
        context["metadata"] = (objectMetadata ? objectMetadata["benchMarkIndex"] : null);
        ...
        context["field"] = "pl";
        context["metadata"] = (objectMetadata ? objectMetadata["pl"] : null);
        privateState.pl = defaultValues ? (defaultValues["pl"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["pl"], context) : null) : null;
        context["field"] = "feesAndTax";
        context["metadata"] = (objectMetadata ? objectMetadata["feesAndTax"] : null);
        privateState.feesAndTax = defaultValues ? (defaultValues["feesAndTax"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["feesAndTax"], context) : null) : null;
        context["field"] = "timeWeighted";
        context["metadata"] = (objectMetadata ? objectMetadata["timeWeighted"] : null);
        privateState.timeWeighted = defaultValues ? (defaultValues["timeWeighted"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["timeWeighted"], context) : null) : null;
        context["field"] = "moneyWeighted";
        context["metadata"] = (objectMetadata ? objectMetadata["moneyWeighted"] : null);
        privateState.moneyWeighted = defaultValues ? (defaultValues["moneyWeighted"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["moneyWeighted"], context) : null) : null;
        context["field"] = "portfolioReturn";
        context["metadata"] = (objectMetadata ? objectMetadata["portfolioReturn"] : null);
        privateState.portfolioReturn = defaultValues ? (defaultValues["portfolioReturn"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["portfolioReturn"], context) : null) : null;
        context["field"] = "dateTime";
        context["metadata"] = (objectMetadata ? objectMetadata["dateTime"] : null);
        privateState.dateTime = defaultValues ? (defaultValues["dateTime"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["dateTime"], context) : null) : null;
        context["field"] = "referenceCurrency";
        context["metadata"] = (objectMetadata ? objectMetadata["referenceCurrency"] : null);
        ...
        context["field"] = "currentValue";
        context["metadata"] = (objectMetadata ? objectMetadata["currentValue"] : null);
        privateState.currentValue = defaultValues ? (defaultValues["currentValue"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["currentValue"], context) : null) : null;
        context["field"] = "sortBy";
        context["metadata"] = (objectMetadata ? objectMetadata["sortBy"] : null);
