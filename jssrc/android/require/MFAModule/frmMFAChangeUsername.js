define("MFAModule/frmMFAChangeUsername", function() {
    return function(controller) {
        function addWidgetsfrmMFAChangeUsername() {
            ...
            flxSecurityRequirementsUsername.add(lblSecurityRequirementsUsername, rtxRulesPwd);
            flxMainContainer.add(flxUsername, lblLastName, flxTbxUsername, flxSecurityRequirementsUsername);
            ...
            this.add(flxHeader, flxMainContainer, flxPopup, flxButton);
        };
        return [{
            "addWidgets": addWidgetsfrmMFAChangeUsername,
            "enabledForIdleTimeout": true,
            "id": "frmMFAChangeUsername",
            "init": controller.AS_Form_a76a59d48882421da82ee65649383478,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": function(eventobject) {
                controller.AS_Form_def7973444104605876b6edbb9eefd02(eventobject);
            },
            "skin": "sknFrmffffff",
