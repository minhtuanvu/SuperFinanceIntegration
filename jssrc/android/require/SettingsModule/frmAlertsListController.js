define("SettingsModule/userfrmAlertsListController", {
    init: function() {},
    preShow: function() {
    ...
    setAlertsData: function(alertsData) {
        ...
        for (var i = 0; i < alertsList.length; i++) {
            ...
            } else this.view[i + "lblAlertValue"].text = alertsList[i].alertAttribute ? alertsList[i].alertsubtype_value1 : "";
            this.view[i + "flxAlertRowDummy"].onClick = this.onNavToAlertPreferencesScreen.bind(this, alertsList[i]);
        }
    },
});
define("SettingsModule/frmAlertsListControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_b25443e855b441029bcc3b79e3377a6d: function AS_Form_b25443e855b441029bcc3b79e3377a6d(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_b7c4ed74e6bf4b5da2dd5cd8a8638b6a: function AS_Form_b7c4ed74e6bf4b5da2dd5cd8a8638b6a(eventobject) {
        var self = this;
        this.preShow();
    }
});
define("SettingsModule/frmAlertsListController", ["SettingsModule/userfrmAlertsListController", "SettingsModule/frmAlertsListControllerActions"], function() {
    var controller = require("SettingsModule/userfrmAlertsListController");
    var controllerActions = ["SettingsModule/frmAlertsListControllerActions"];
