define("SettingsModule/userfrmAlertGroupsListController", {
    ...
    setAlertGroupsData: function(alertsData) {
        ...
        for (var i = 0; i < alertGroups.length; i++) {
            ...
            this.view[i + "flxAlertGroupRowDummy"].info = {
                "data": currGroupJSON
            };
    ...
    getAlertGroupForSetPreferences: function(alertData) {
        ...
        for (var i = 0; i < alertData.alertTypes.length; i++) {
            ...
            var alertsArr = alertsOfGroup.map(function(alert) {
                ...
                alertObj.isSub = (alertData.categorySubscription.isInitialLoad === "true") ? true : alertObj.isSub;
                if (alert.alertCondition && alert.alertCondition.NoOfFields && alert.alertCondition.NoOfFields === "2") alertObj["value2"] = alert.alertsubtype_value2;
...
define("SettingsModule/frmAlertGroupsListControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_j88312c51e7344faa2134bd122922d87: function AS_Form_j88312c51e7344faa2134bd122922d87(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_i899c3e09f2e48a4973fa496bd295c45: function AS_Form_i899c3e09f2e48a4973fa496bd295c45(eventobject) {
        var self = this;
        this.preShow();
    }
});
define("SettingsModule/frmAlertGroupsListController", ["SettingsModule/userfrmAlertGroupsListController", "SettingsModule/frmAlertGroupsListControllerActions"], function() {
    var controller = require("SettingsModule/userfrmAlertGroupsListController");
    var controllerActions = ["SettingsModule/frmAlertGroupsListControllerActions"];
