define("SettingsModule/userfrmConsentManagementController", {
    ...
    setSegmentData: function(consentData) {
        ...
        for (i = 0; i < allConsent.length; i++) {
            ...
            for (j = 0; j < rowLen; j++) {
                ...
                allConsent[i][1][j].switchSelectIndex = {
                    "isVisible": true,
                    "selectedIndex": index,
                    "enable": enable,
                    "onSlide": this.onSlideCallback
                };
            }
        }
...
define("SettingsModule/frmConsentManagementControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_a4798e7ab2cb46a787ebaaf75a2f670c: function AS_Form_a4798e7ab2cb46a787ebaaf75a2f670c(eventobject) {
        var self = this;
        return self.initActions.call(this);
    },
    AS_Form_a2167171d2ad4a25894c0f58c53453b5: function AS_Form_a2167171d2ad4a25894c0f58c53453b5(eventobject) {
        var self = this;
        return self.preShow.call(this);
    }
});
define("SettingsModule/frmConsentManagementController", ["SettingsModule/userfrmConsentManagementController", "SettingsModule/frmConsentManagementControllerActions"], function() {
    var controller = require("SettingsModule/userfrmConsentManagementController");
    var controllerActions = ["SettingsModule/frmConsentManagementControllerActions"];
