define("SettingsModule/userfrmAlertsMinimumBalanceController", {
    keypadString: '0.00',
    keypadString2: '0.00',
    isPeriodUsed: false,
                    ...
                    for (var j = 0; j < setPreferenceData.alertSubscription.groups[i].alerts.length; j++) {
                        if (setPreferenceData.alertSubscription.groups[i].alerts[j].id === alertId) {
                            if (option === 1) { //update only subscriptions
                                ...
                                updatedPayload.alertSubscription.groups[i].alerts[j] = (isValid === true) ? this.updateAlertAttributeValue(setPreferenceData.alertSubscription.groups[i].alerts[j]) : setPreferenceData.alertSubscription.groups[i].alerts[j];
                            }
                            break;
                        }
                    }
...
define("SettingsModule/frmAlertsMinimumBalanceControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_hdd4f947c1b2403aa34f842d8e01696a: function AS_Form_hdd4f947c1b2403aa34f842d8e01696a(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_f7b07ab94bdd47cbb4edb84cf5932043: function AS_Form_f7b07ab94bdd47cbb4edb84cf5932043(eventobject) {
        var self = this;
        this.preShow();
    }
});
define("SettingsModule/frmAlertsMinimumBalanceController", ["SettingsModule/userfrmAlertsMinimumBalanceController", "SettingsModule/frmAlertsMinimumBalanceControllerActions"], function() {
