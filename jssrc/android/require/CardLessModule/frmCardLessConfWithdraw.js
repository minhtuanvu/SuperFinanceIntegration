    ...
    return function(controller) {
        function addWidgetsfrmCardLessConfWithdraw() {
            ...
            var customHeader = new com.kmb.common.customHeader({
                ...
                "overrides": {
                    ...
                    "lblLocateUs": {
                        "text": kony.i18n.getLocalizedString("kony.mb.cardLess.confirmWIthdrawal")
                    }
                }
            }, {
                "overrides": {}
            ...
            var flxBankNameAndType = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "clipBounds": true,
                "height": "40dp",
                "id": "flxBankNameAndType",
                "isVisible": true,
            ...
            flxBankNameAndType.setDefaultUnit(kony.flex.DP);
            ...
            flxBankNameAndType.add(imgBankType, lblToAccountValue);
            ...
            flxFromAccount.add(lblFromAccount, flxBankNameAndType, lblBankName);
            ...
            flxMain.add(lblTransferAmount, lblAmountValue, flxSeperator1, flxFromAccount, flxSeperator2, flxForCollectionBy, flxSeperator3, flxTransactionDate, flxSeperator4, flxDescription);
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_h216f428145f435fb1c788a0b8ae8ced(eventobject);
            },
            "skin": "sknFrmffffff",
