define("CardLessModule/userfrmCardLessWithdrawController", {
    keypadString: '0.00',
    isPeriodUsed: false,
    navigateTo: '',
    previousForm: '',
    ...
    getDenominationString: function() {
        ...
        for (var i in denominations) {
            if (i == denominations.length - 1) str += (" " + denominations[i] + ".");
            else str += (" " + denominations[i] + ",");
        }
        return str;
    },
...
define("CardLessModule/frmCardLessWithdrawControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Button_cfd63c1bccba4901aa3eb8619bf41bf7: function AS_Button_cfd63c1bccba4901aa3eb8619bf41bf7(eventobject) {
        var self = this;
        return self.btnContinueOnClick.call(this);
    },
    AS_Form_f2b89c733c63421b9334c87d71e7a6ff: function AS_Form_f2b89c733c63421b9334c87d71e7a6ff(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_ebca9cba3258447983cbcce924d2974e: function AS_Form_ebca9cba3258447983cbcce924d2974e(eventobject) {
        var self = this;
        return self.preShow.call(this);
    },
    AS_BarButtonItem_b59e846c447046a2bdec65e17fecdf0d: function AS_BarButtonItem_b59e846c447046a2bdec65e17fecdf0d(eventobject) {
        var self = this;
        this.btnRightOnClick();
    }
});
define("CardLessModule/frmCardLessWithdrawController", ["CardLessModule/userfrmCardLessWithdrawController", "CardLessModule/frmCardLessWithdrawControllerActions"], function() {
