define(["AsyncManager/BusinessControllers/BusinessController"], function(AsyncManager) {
    ...
    PayAPerson_PresentationController.prototype.fetchAllP2PRecipientsPresentationSuccess = function(successResponse) {
        ...
        } else scope_PayAPersonPresentationController.commonFunctionForNavigation("frmManageRecipientList");
    };
    ...
    PayAPerson_PresentationController.prototype.goToAmountForm = function() {
        ...
        if (amount !== null) amount = forUtility.deFormatAmount(amount);
    ...
    PayAPerson_PresentationController.prototype.createP2pSuccCallback = function(res) {
        if (res.MFAAttributes && res.MFAAttributes.isMFARequired == "true") {
            ...
            if (navigateToForm === "frmAccountDetails") {
                ...
                } else accountsManager.fetchInternalAccounts(scope_PayAPersonPresentationController.fetchAccountsSuccCallBackNew, scope_PayAPersonPresentationController.fetchAccountsErrCallBackNew);
            } else {
    ...
    PayAPerson_PresentationController.prototype.setTransactionObject = function(transactionData) {
        ...
        } else scope_PayAPersonPresentationController.getP2pAccounts();
    };
    ...
    PayAPerson_PresentationController.prototype.pickContact = function() {
        ...
        var cntType = scope_PayAPersonPresentationController.contactTypeForContacts;
        if (cntType === "phone") scope_PayAPersonPresentationController.contactPickerObject.selectSinglePhoneNumber(scope_PayAPersonPresentationController.contactCallBack);
        else scope_PayAPersonPresentationController.contactPickerObject.selectSingleEmail(scope_PayAPersonPresentationController.contactCallBack);
    };
