define("PayAPersonModule/userfrmP2pSelectRecipientController", {
    init: function() {
    ...
    preShow: function() {
        ...
        this.view.customSearchbox.text = "";
    ...
    setSegment: function() {
        ...
        if (recentPayees.length > 0 && allPayees.length > 0) {
            var data = [
                [{
                    "lblHeader": "Recent Recipients"
                }, recentPayees],
                [{
                    "lblHeader": "All Recipients"
                }, allPayees]
            ];
...
define("PayAPersonModule/frmP2pSelectRecipientControllerActions", {
    /*
...
define("PayAPersonModule/frmP2pSelectRecipientController", ["PayAPersonModule/userfrmP2pSelectRecipientController", "PayAPersonModule/frmP2pSelectRecipientControllerActions"], function() {
