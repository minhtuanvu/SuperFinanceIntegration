define("PayAPersonModule/userfrmP2pConfirmationController", {
    init: function() {
    ...
    getData: function() {
        ...
        var name = "";
        if (this.data.fromAccountNickName === null || this.data.fromAccountNickName === undefined) {
            name = this.data.fromAccountName;
        } else {
            name = this.data.fromAccountNickName;
        }
...
define("PayAPersonModule/frmP2pConfirmationControllerActions", {
    /*
...
define("PayAPersonModule/frmP2pConfirmationController", ["PayAPersonModule/userfrmP2pConfirmationController", "PayAPersonModule/frmP2pConfirmationControllerActions"], function() {
