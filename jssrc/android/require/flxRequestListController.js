define("userflxRequestListController", {
    ...
    btnWithdrawOnClick: function(eventobject, context) {
        try {
            ...
            this.executeOnParent("withdrawBtnOnClick", {
                section: secIndex,
                row: rowIndex
            });
        } catch (e) {
...
define("flxRequestListControllerActions", {
    /* 
    This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("flxRequestListController", ["userflxRequestListController", "flxRequestListControllerActions"], function() {
    var controller = require("userflxRequestListController");
    var controllerActions = ["flxRequestListControllerActions"];
