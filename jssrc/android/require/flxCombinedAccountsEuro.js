define("flxCombinedAccountsEuro", function() {
    return function(controller) {
        var flxCombinedAccountsEuro = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "focusSkin": "f9f9",
            "height": "100dp",
            "id": "flxCombinedAccountsEuro",
            "isVisible": true,
            "layoutType": kony.flex.FLOW_HORIZONTAL,
            "isModalContainer": false,
            "skin": "f9f9"
        }, {}, {});
        flxCombinedAccountsEuro.setDefaultUnit(kony.flex.DP);
        ...
        flxCombinedAccountsEuro.add(flxMain, flxDelete, flxRefresh);
        return flxCombinedAccountsEuro;
    }
})