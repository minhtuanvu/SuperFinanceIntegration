define("DisputeTransactions/userfrmDTConfirmController", {
    init: function() {
    ...
    populateData: function() {
        ...
        if (transactionData.transactionType == "P2P") {
            if (transactionData.payPersonName) this.view.lblToAccountValue.text = transactionData.payPersonName;
            else this.view.lblToAccountValue.text = '-';
            if (transactionData.toAccountType) this.view.lblToBankType.text = transactionData.toAccountType;
            else this.view.lblToBankType.text = "";
        } else {
            if (transactionData.toAccountNumber) toAcc = applicationManager.getPresentationUtility().formatText(transactionData.toAccountName, 10, transactionData.toAccountNumber, 4);
            else toAcc = applicationManager.getPresentationUtility().formatText(transactionData.toAccountName, 10, transactionData.ExternalAccountNumber, 4);
            if (toAcc) this.view.lblToAccountValue.text = toAcc;
            else this.view.lblToAccountValue.text = '-';
            if (transactionData.toAccountType) this.view.lblToBankType.text = transactionData.toAccountType;
            else this.view.lblToBankType.text = "";
        }
...
define("DisputeTransactions/frmDTConfirmControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_h04e58ff2f764f50aeed81dd5c2c0267: function AS_Form_h04e58ff2f764f50aeed81dd5c2c0267(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_f126f98c53c648d4a58090b2c0ec2fd9: function AS_Form_f126f98c53c648d4a58090b2c0ec2fd9(eventobject) {
        var self = this;
        this.preShow();
    }
});
define("DisputeTransactions/frmDTConfirmController", ["DisputeTransactions/userfrmDTConfirmController", "DisputeTransactions/frmDTConfirmControllerActions"], function() {
    var controller = require("DisputeTransactions/userfrmDTConfirmController");
    var controllerActions = ["DisputeTransactions/frmDTConfirmControllerActions"];
