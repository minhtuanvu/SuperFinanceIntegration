define("CampaignManagement/frmDepositToAccount", function() {
    return function(controller) {
        function addWidgetsfrmDepositToAccount() {
            ...
            var segTransactions = new kony.ui.SegmentedUI2({
                ...
                "onRowClick": controller.AS_Segment_b6005b01c10b4697824721a7cee660f3,
            ...
            var lblDescription = new kony.ui.Label({
                ...
                "text": "Choose an account to credit interest/principal.",
                "textStyle": {
                    "letterSpacing": 0,
                    "strikeThrough": false
                },
        ...
        return [{
            "addWidgets": addWidgetsfrmDepositToAccount,
            "allowHorizontalBounce": false,
            "bounces": false,
            "enableScrolling": false,
            "enabledForIdleTimeout": true,
            "id": "frmDepositToAccount",
            "init": controller.AS_Form_a076778dbe3c4085b35d5a343c6720b9,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "postShow": controller.AS_Form_ab8702701a114738abd043ad490e4b3c,
            "preShow": function(eventobject) {
                controller.AS_Form_dfb84d6ac2e04fd691006426dbcc496f(eventobject);
            },
            "skin": "sknFrmffffff",
