define("TransactionModule/userfrmTransfersEuropeController", {
    popupMsg: '',
    timerCounter: 0,
    ...
    transactionsSegmentOnScrolling: function() {
        ...
        if (this.view.flxHeaderSearchbox.isVisible) this.view.flxTransferOptions.top = 40 - (yOffset * parallaxSpeed) + "dp";
    ...
    newRecipient: function() {
        ...
        } else navMan.setCustomInfo("frmTransfersToAccount", {});
    },
    ...
    showSuccessMessage: function() {
        var transferModulePresentationController = applicationManager.getModulesPresentationController("TransferModule")
        if (transferModulePresentationController.internationalBenificiaryAdded && transferModulePresentationController.getFlowType() === "InternationalTransferCreateTransfer") {
            ...
            transferModulePresentationController.internationalBenificiaryAdded = false;
        } else if (transferModulePresentationController.otherBankBenificiaryAdded && transferModulePresentationController.getFlowType() === "OtherBankAccountsCreateTransfer") {
            applicationManager.getDataProcessorUtility().showToastMessageSuccess(this, applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.Transfers.addBenificiary", "Successfully recipient was added"));
    ...
    showSuccessPopup: function(refID, type) {
        ...
        if (type === "delete") {
            ...
            msg = applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.transfers.paymentInitiationSuccessMessage") + "\n" + applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.transfers.ReferenceID") + (refID.referenceId || refID.transactionId);
        }
...
define("TransactionModule/frmTransfersEuropeControllerActions", {
    /*
    ...
    */
    ...
    AS_Form_f9900be3f3c04857b997b690740171e6: function AS_Form_f9900be3f3c04857b997b690740171e6(eventobject) {
        var self = this;
        applicationManager.getPresentationUtility().dismissLoadingScreen();
        this.postShow();
    },
...
define("TransactionModule/frmTransfersEuropeController", ["TransactionModule/userfrmTransfersEuropeController", "TransactionModule/frmTransfersEuropeControllerActions"], function() {
    var controller = require("TransactionModule/userfrmTransfersEuropeController");
    var controllerActions = ["TransactionModule/frmTransfersEuropeControllerActions"];
