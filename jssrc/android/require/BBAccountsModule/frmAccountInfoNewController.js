define("BBAccountsModule/userfrmAccountInfoNewController", {
    objRec: '',
    init: function() {
        var scope = this;
    ...
    PopulateCheckingAccount: function() {
        try {
            ...
            var bankdetails = [{
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accounts.AvailableBalance") + ":",
                    "lblValue": availBalValue
                }, {
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accounts.CurrentBalance") + ":",
                    "lblValue": currBalValue
                }, {
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accountdetails.pendingdeposit") + ":",
                    "lblValue": pendingDepValue
                }, {
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accountdetails.pendingWithdrawal") + ":",
                    "lblValue": withdrawValue
                },
            ...
            if (this.accDetails.MembershipName) {
                bankdetails.push({
                    "lblTitle": kony.i18n.getLocalizedString("kony.tab.OBEmployment.CompanyName") + ":",
                    "lblValue": this.accDetails.MembershipName
                });
            }
            var scope = this;
            var bankData = [
                [{
                    "lblHeader": kony.i18n.getLocalizedString("kony.mb.accdetails.accountSummary")
                }, bankdetails],
            ];
            var accountdetails = [];
            ...
            if (!kony.sdk.isNullOrUndefined(routingNumber) && routingNumber !== '') {
                ...
                accountdetails.push({
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accountdetails.routingNumber") + ":",
                    "lblValue": routingNumber,
                    "imgAccNoToggle": {
                        "isVisible": false
                    }
                });
            ...
            if (!kony.sdk.isNullOrUndefined(swiftCode) && swiftCode !== '') {
                accountdetails.push({
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accountdetails.swiftCode") + ":",
                    "lblValue": swiftCode,
                    "imgAccNoToggle": {
                        "isVisible": false
                    }
            ...
            if (!kony.sdk.isNullOrUndefined(accTypeValue) && accTypeValue !== '') {
                accountdetails.push({
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accountdetails.accountType") + ":",
                    "lblValue": accTypeValue,
                    "imgAccNoToggle": {
                        "isVisible": false
                    }
                });
            ...
            if (!kony.sdk.isNullOrUndefined(customerNameValue) && customerNameValue !== '') {
                accountdetails.push({
                    "lblTitle": kony.i18n.getLocalizedString("kony.mb.accountdetails.accountHolder") + ":",
                    "lblValue": customerNameValue,
                    "imgAccNoToggle": {
                        "isVisible": false
                    }
                });
...
define("BBAccountsModule/frmAccountInfoNewControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_abe7c5dc28714f9084b2841a6c7567a5: function AS_Form_abe7c5dc28714f9084b2841a6c7567a5(eventobject) {
        var self = this;
        this.preshowAccInfo();
    },
    AS_BarButtonItem_e773273879fc4a22b5af46c01ff14310: function AS_BarButtonItem_e773273879fc4a22b5af46c01ff14310(eventobject) {
        var self = this;
        this.customHeaderBtnRightOnClick();
    }
});
define("BBAccountsModule/frmAccountInfoNewController", ["BBAccountsModule/userfrmAccountInfoNewController", "BBAccountsModule/frmAccountInfoNewControllerActions"], function() {
    var controller = require("BBAccountsModule/userfrmAccountInfoNewController");
    var controllerActions = ["BBAccountsModule/frmAccountInfoNewControllerActions"];
