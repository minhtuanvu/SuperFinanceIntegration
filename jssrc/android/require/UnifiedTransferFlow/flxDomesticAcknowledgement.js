define("UnifiedTransferFlow/flxDomesticAcknowledgement", function() {
    return function(controller) {
        function addWidgetsflxDomesticAcknowledgement() {
            this.setDefaultUnit(kony.flex.DP);
            var flxDomesticAckMainContainer = new kony.ui.FlexScrollContainer({
                ...
                "id": "flxDomesticAckMainContainer",
                "isVisible": true,
            ...
            flxDomesticAckMainContainer.setDefaultUnit(kony.flex.DP);
            ...
            Acknowledgement.field7Label = "{i.kony.mb.transaction.frequency}:";
            Acknowledgement.field7Value = "{ \"text\": \"{$.c.frequencyType}\", \"fieldType\": \"label\" }";
            Acknowledgement.stateValue = "{ \"text\": \"{$.c.state}\", \"fieldType\": \"label\" }";
            Acknowledgement.field8Label = "{i.kony.i18n.verifyDetails.sendOn}:";
            Acknowledgement.field8Value = "{ \"text\": \"{$.c.sendOnUI}\", \"fieldType\": \"label\" }";
            Acknowledgement.countryValue = "{ \"text\": \"{$.c.country}\", \"fieldType\": \"label\" }";
            Acknowledgement.field9Label = "{i.kony.mb.common.StartDate}:";
            Acknowledgement.field9Value = "{ \"text\": \"{$.c.startDateUI}\", \"fieldType\": \"date\" }";
            Acknowledgement.postalCodeValue = "{ \"text\": \"{$.c.zipcode}\", \"fieldType\": \"label\" }";
            Acknowledgement.field10Label = "{i.i18n.transfers.end_date}:";
            Acknowledgement.field10Value = "{ \"text\": \"{$.c.endDateUI}\", \"fieldType\": \"date\"}";
            Acknowledgement.field11Label = "{i.i18n.TransfersEur.FeesPaidBy}:";
            Acknowledgement.field11Value = "{ \"text\": \"{$.c.selectedFeesPaidBy}\", \"fieldType\": \"label\" }";
            ...
            Acknowledgement.field13Label = "{i.i18n.TransfersEur.BICSWIFT}:";
            Acknowledgement.field13Value = "{\"text\":\"{$.c.swiftCode}\",\"fieldType\":\"label\"}";
            Acknowledgement.field14Label = "{i.kony.i18n.verifyDetails.exchangeRate}:";
            Acknowledgement.field14Value = "{\"text\":\"{$.c.exchangeRate}\",\"fieldType\":\"label\"}";
            Acknowledgement.field15Label = "{i.kony.i18n.verifyDetails.e2eReference}:";
            Acknowledgement.field15Value = "{ \"text\": \"{$.c.e2eReference}\", \"fieldType\": \"label\" }";
            Acknowledgement.field16Label = "Payment Method:";
            Acknowledgement.field16Value = "{ \"text\": \"{$.c.paymentMethod}\", \"fieldType\": \"label\" }";
            ...
            Acknowledgement.field18Label = "{i.kony.i18n.verifyDetails.clearingCode1}:";
            Acknowledgement.field18Value = "{\"text\":\"{$.c.clearingCode1}\",\"fieldType\":\"label\"}";
            Acknowledgement.field19Label = "{i.kony.i18n.verifyDetails.clearingCode2}:";
            Acknowledgement.field19Value = "{\"text\":\"{$.c.clearingCode2}\",\"fieldType\":\"label\"}";
            ...
            flxDomesticAckMainContainer.add(flxContents);
            ...
            flxBlue.add();
            this.add(flxDomesticAckMainContainer, flxBlue);
        };
        return [{
            "addWidgets": addWidgetsflxDomesticAcknowledgement,
            "enabledForIdleTimeout": false,
            "id": "flxDomesticAcknowledgement",
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false
        }, {
            ...
            "onDeviceBack": controller.AS_Form_e1057dea752640aeb5cfc761a35fea40,
