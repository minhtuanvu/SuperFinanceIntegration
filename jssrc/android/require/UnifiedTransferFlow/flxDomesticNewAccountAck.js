define("UnifiedTransferFlow/flxDomesticNewAccountAck", function() {
    return function(controller) {
        function addWidgetsflxDomesticNewAccountAck() {
            ...
            Acknowledgement.field3Label = "{i.kony.i18n.verifyDetails.bicSwift}";
            ...
            Acknowledgement.field3Value = "{ \"text\": \"{$.c.swiftCode}\", \"fieldType\": \"label\" }";
            ...
            Acknowledgement.field4Label = "{i.kony.i18n.verifyDetails.clearingCode1}";
            ...
            Acknowledgement.field4Value = "{ \"text\": \"{$.c.clearingCode1}\", \"fieldType\": \"amount\" }";
            ...
            Acknowledgement.field5Label = "{i.kony.i18n.verifyDetails.clearingCode2}";
            Acknowledgement.field5Value = "{ \"text\": \"{$.c.clearingCode2}\", \"fieldType\": \"amount\" }";
            Acknowledgement.emailLabel = "{i.i18n.ProfileManagement.EmailId}:";
            Acknowledgement.emailValue = "{ \"text\": \"{$.c.email}\", \"fieldType\": \"label\" }";
            Acknowledgement.field6Label = "{i.i18n.verifyDetails.payeeName}:";
            Acknowledgement.field6Value = "{\"text\":\"{$.c.payeeName}\",\"fieldType\":\"label\"}";
        ...
        return [{
            "addWidgets": addWidgetsflxDomesticNewAccountAck,
            "enabledForIdleTimeout": false,
            "id": "flxDomesticNewAccountAck",
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false
        }, {
            ...
            "onDeviceBack": controller.AS_Form_c679cfd65d044653b28446e8291aa13c,
