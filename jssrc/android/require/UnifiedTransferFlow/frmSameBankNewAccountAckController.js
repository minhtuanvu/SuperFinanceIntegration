define("UnifiedTransferFlow/userfrmSameBankNewAccountAckController", {
    onNavigate: function() {
        var scope = this;
...
define("UnifiedTransferFlow/frmSameBankNewAccountAckControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("UnifiedTransferFlow/frmSameBankNewAccountAckController", ["UnifiedTransferFlow/userfrmSameBankNewAccountAckController", "UnifiedTransferFlow/frmSameBankNewAccountAckControllerActions"], function() {
    var controller = require("UnifiedTransferFlow/userfrmSameBankNewAccountAckController");
    var controllerActions = ["UnifiedTransferFlow/frmSameBankNewAccountAckControllerActions"];
