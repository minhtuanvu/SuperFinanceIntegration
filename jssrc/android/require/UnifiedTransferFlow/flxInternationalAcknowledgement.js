define("UnifiedTransferFlow/flxInternationalAcknowledgement", function() {
    return function(controller) {
        function addWidgetsflxInternationalAcknowledgement() {
            ...
            Acknowledgement.field6Label = "";
            Acknowledgement.field6Value = "";
            Acknowledgement.cityValue = "{ \"text\": \"{$.c.city}\", \"fieldType\": \"label\" }";
            Acknowledgement.field7Label = "{i.kony.i18n.verifyDetails.accountNumber}";
            Acknowledgement.field7Value = "{ \"text\": \"{$.c.accountNumber}\", \"fieldType\": \"label\" }";
            ...
            Acknowledgement.field12Label = "{i.kony.i18n.verifyDetails.exchangeRate}:";
            Acknowledgement.field12Value = "{\"text\":\"{$.c.exchangeRate}\",\"fieldType\":\"label\"}";
            ...
            Acknowledgement.field14Label = "{i.kony.i18n.verifyDetails.totalDebitAmount}:";
            Acknowledgement.field14Value = "{\"text\":\"{$.c.totalAmount}\",\"fieldType\":\"label\"}";
            ...
            Acknowledgement.field16Value = "{ \"text\": \"{$.c.paymentType}\", \"fieldType\": \"label\" }";
            Acknowledgement.field17Label = "{i.i18n.TransfersEur.BICSWIFT}:";
            Acknowledgement.field17Value = "{\"text\":\"{$.c.swiftCode}\",\"fieldType\":\"label\"}";
        ...
        return [{
            "addWidgets": addWidgetsflxInternationalAcknowledgement,
            "enabledForIdleTimeout": false,
            "id": "flxInternationalAcknowledgement",
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false
        }, {
            ...
            "onDeviceBack": controller.AS_Form_ad41a58c58f2408ba655647861e1aa87,
