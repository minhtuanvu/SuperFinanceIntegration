define(function() {
    ...
    ParserUtilsManager.prototype.getParsedValue = function(value) {
        ...
        if (JSONValue && Object.keys(JSONValue).length > 0) return JSON.stringify(this.processJSON(JSONValue));
    ...
    ParserUtilsManager.prototype.getDecoratorText = function(decoratorText) {
        if (decoratorText.indexOf("{i.") != -1) return this.geti18nText(decoratorText.substring(decoratorText.indexOf("{i.") + 3, decoratorText.length - 1));
    ...
    ParserUtilsManager.prototype.getFlowTypeValue = function(text) {
        ...
        if (flowTypeConfigValue != "" && flowTypeConfigValue != undefined && flowTypeConfigValue != null) return flowTypeConfigValue;
        return text;
    };
    /**
    ...
    ParserUtilsManager.prototype.geti18nText = function(text) {
        ...
        if (i18ntext != "" && i18ntext != undefined && i18ntext != null) return i18ntext;
        return text;
    };
    /**
    ...
    ParserUtilsManager.prototype.getContextValue = function(text) {
        ...
        else if (context !== undefined && context !== null) return context;
        return text;
    };
    /**
    ...
    ParserUtilsManager.prototype.getResponseValue = function(text, unicode) {
        ...
        if (responseValue != "" && responseValue != undefined && responseValue != null) return responseValue;
        return text;
    };
