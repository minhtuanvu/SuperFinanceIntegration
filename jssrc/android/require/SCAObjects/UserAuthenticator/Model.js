...
define([], function() {
    ...
    function UserAuthenticator(defaultValues) {
        ...
        context["field"] = "display";
        context["metadata"] = (objectMetadata ? objectMetadata["display"] : null);
        privateState.display = defaultValues ? (defaultValues["display"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["display"], context) : null) : null;
        context["field"] = "value";
        context["metadata"] = (objectMetadata ? objectMetadata["value"] : null);
        ...
        context["field"] = "ref";
        context["metadata"] = (objectMetadata ? objectMetadata["ref"] : null);
        privateState.ref = defaultValues ? (defaultValues["ref"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["ref"], context) : null) : null;
