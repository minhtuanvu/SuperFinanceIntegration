...
define([], function() {
    ...
    function User(defaultValues) {
        ...
        context["field"] = "authenticationMethod";
        context["metadata"] = (objectMetadata ? objectMetadata["authenticationMethod"] : null);
        privateState.authenticationMethod = defaultValues ? (defaultValues["authenticationMethod"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["authenticationMethod"], context) : null) : null;
    ...
    User.verifyUserId = function(params, onCompletion) {
        return User.customVerb('verifyUserId', params, onCompletion);
    };
    var relations = [];
    ...
    User.registerProcessors = function(options, successCallback, failureCallback) {
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("SCAObjects", "User", options, metaDataSuccess, metaDataFailure);
    };
