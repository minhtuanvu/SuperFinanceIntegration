...
define([], function() {
    ...
    /**
     * returns TermsAndConditionsManager object
    ...
    ApplicationManager.prototype.getForeignExchangeManager = function() {
        return kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('ForeignExchangeManager').businessController;
    }
