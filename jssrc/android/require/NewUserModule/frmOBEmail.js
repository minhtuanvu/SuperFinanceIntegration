define("NewUserModule/frmOBEmail", function() {
    return function(controller) {
        function addWidgetsfrmOBEmail() {
            ...
            flxEnterEmailWrapper.add(flxEnterPersonalInfoHeader, txtEnterEmail, imgCheckbox, rtxAgreeTermsConditions, btnContinueEmail);
            flxMainContainer.add(flxEnterEmailWrapper);
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_ce39270c9af644ffad4236dcc4710ab0(eventobject);
            },
            "skin": "sknFrmffffff",
