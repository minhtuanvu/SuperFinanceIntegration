define("flxApprovalListHead", function() {
    return function(controller) {
        var flxApprovalListHead = new kony.ui.FlexContainer({
            "clipBounds": true,
            "height": "80dp",
            "id": "flxApprovalListHead",
            "isVisible": true,
        ...
        flxApprovalListHead.setDefaultUnit(kony.flex.DP);
        ...
        flxApprovalListHead.add(flxContent);
        return flxApprovalListHead;
    }
})