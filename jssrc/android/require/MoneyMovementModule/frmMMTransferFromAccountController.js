define("MoneyMovementModule/userfrmMMTransferFromAccountController", ['CampaignUtility'], function(CampaignUtility) {
    return {
        segmentData: null,
        sec: -1,
        row: -1,
...
define("MoneyMovementModule/frmMMTransferFromAccountControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_c4c2741d199b41368b2ea402a4578934: function AS_Form_c4c2741d199b41368b2ea402a4578934(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_e6fe5fb4c6d346698ae8a3e5a9532bc6: function AS_Form_e6fe5fb4c6d346698ae8a3e5a9532bc6(eventobject) {
        var self = this;
        this.postShow();
    },
    AS_Form_f003a03f47534ef08e771c4bafb290ea: function AS_Form_f003a03f47534ef08e771c4bafb290ea(eventobject) {
        var self = this;
        this.preShow();
    },
    AS_BarButtonItem_i29d1b88650e4fcbaf952792446e168a: function AS_BarButtonItem_i29d1b88650e4fcbaf952792446e168a(eventobject) {
        var self = this;
        this.navigateCustomBack();
    },
    AS_BarButtonItem_fe0cdac43e0c493797ad23d4563b56b0: function AS_BarButtonItem_fe0cdac43e0c493797ad23d4563b56b0(eventobject) {
        var self = this;
        this.cancelOnClick();
    },
    AS_Segment_cc4f28d50dd24f19bf87dc758efea4a9: function AS_Segment_cc4f28d50dd24f19bf87dc758efea4a9(eventobject, sectionNumber, rowNumber) {
        var self = this;
        this.onRowClick();
    }
});
define("MoneyMovementModule/frmMMTransferFromAccountController", ["MoneyMovementModule/userfrmMMTransferFromAccountController", "MoneyMovementModule/frmMMTransferFromAccountControllerActions"], function() {
    var controller = require("MoneyMovementModule/userfrmMMTransferFromAccountController");
    var controllerActions = ["MoneyMovementModule/frmMMTransferFromAccountControllerActions"];
