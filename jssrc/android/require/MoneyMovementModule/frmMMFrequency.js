define("MoneyMovementModule/frmMMFrequency", function() {
    return function(controller) {
        function addWidgetsfrmMMFrequency() {
            ...
            var segOptions = new kony.ui.SegmentedUI2({
                ...
                "data": [{
                    ...
                    "lblFrequency": kony.i18n.getLocalizedString("kony.mb.MM.HalfYearly")
                }, {
        ...
        return [{
            "addWidgets": addWidgetsfrmMMFrequency,
            "bounces": false,
            "enableScrolling": true,
            "enabledForIdleTimeout": true,
            "id": "frmMMFrequency",
            "init": controller.AS_Form_d7d3b56876634362bfc2905c9f1387e8,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": function(eventobject) {
                controller.AS_Form_fb9fa1a1bc104f8881ee7b9d25f64747(eventobject);
            },
            "skin": "sknFrmffffff",
