        ...
        if (transactionData.transactionType == "BlockedFund") {
            ...
            if (attachments && attachments.length > 0) {
                for (var i = 0; i < attachments.length; i++) {
                    ...
                    if (i !== attachments.length - 1) this.view.lblAttachmentsValue.text += ", ";
                }
...
define("AccountModule/frmAccountsTransactionDetailsControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_g952f3a171db431bb76a892178198f5e: function AS_Form_g952f3a171db431bb76a892178198f5e(eventobject) {
        var self = this;
        this.init();
    },
});
define("AccountModule/frmAccountsTransactionDetailsController", ["AccountModule/userfrmAccountsTransactionDetailsController", "AccountModule/frmAccountsTransactionDetailsControllerActions"], function() {
    var controller = require("AccountModule/userfrmAccountsTransactionDetailsController");
    var controllerActions = ["AccountModule/frmAccountsTransactionDetailsControllerActions"];
