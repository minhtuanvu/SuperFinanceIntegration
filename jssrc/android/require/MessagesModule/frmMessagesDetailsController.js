define("MessagesModule/userfrmMessagesDetailsController", {
    base64: null,
    fileNames: [],
    fileContents: [],
    requestPayload: {},
    ...
    uploadNativeFile: function(documentObject) {
        ...
        if (base64 !== null && base64 !== undefined && base64 !== "") {
            ...
            if (fileSize > maxFileSize * 1000) {
                ...
                MessageModule.presentationController.uploadMedia(fileContent, requestid.requestid, scopeObj.setAttachmentsDataToSegment.bind(scopeObj), scopeObj.uploadMediaFailureCallback.bind(scopeObj), scopeObj.fileContents.length - 1);
            }
        }
    },
...
define("MessagesModule/frmMessagesDetailsControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_h1a356b7bfe6472bb278ba6d80bb6597: function AS_Form_h1a356b7bfe6472bb278ba6d80bb6597(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_f543b1684e5d430fbee513e54acf894c: function AS_Form_f543b1684e5d430fbee513e54acf894c(eventobject) {
        var self = this;
        this.frmMessagesDetailsPreShow();
    },
    AS_TextArea_f46f54d200254863a89d1683d947698e: function AS_TextArea_f46f54d200254863a89d1683d947698e(eventobject) {
        var self = this;
    }
});
define("MessagesModule/frmMessagesDetailsController", ["MessagesModule/userfrmMessagesDetailsController", "MessagesModule/frmMessagesDetailsControllerActions"], function() {
