define("ChequeManagementModule/userfrmChequeTransactionDetailsController", ['CommonUtilities'], function(CommonUtilities) {
    return {
        bankDate: "",
        chequeTypeId: "",
        ...
        preShow: function() {
            ...
            navMan.setCustomInfo("frmChequeManagement", {
                "TAB": details.tabSelection
            });
        ...
        renderChequeBookView: function(data) {
            ...
            if (data.description) this.view.lblAccountType.text = data.description;
            else this.view.lblAccountType.text = "";
            if (data.lblDate) this.view.lblRequestDateValue.text = data.lblDate;
            else this.view.lblRequestDateValue.text = "-";
            this.view.lblRefValue.text = data.chequeIssueId;
            if (data.notes) this.view.lblNotesValue.text = data.notes;
            else this.view.lblNotesValue.text = "-";
            if (data.address) this.view.lblAddressValue.text = data.address;
            else this.view.lblAddressValue.text = "-";
            if (data.fees) this.view.lblFeeValue.text = data.fees;
            else this.view.lblFeeValue.text = "-";
            if (data.deliveryType) this.view.lblDeliveryTypeValue.text = data.deliveryType;
            else this.view.lblDeliveryTypeValue.text = "-";
        ...
        renderStopChequeView: function(data) {
            ...
            if (data.accountType) this.view.lblAccTypeTrans.text = data.accountType;
            else this.view.lblAccTypeTrans.text = "";
            if (data.payeeName) this.view.lblTransferredToValueP2P.text = data.payeeName;
            else this.view.lblTransferredToValueP2P.text = "-";
            if (data.lblDate) this.view.lblTransferredFromValueTrans.text = data.lblDate;
            else this.view.lblTransferredFromValueTrans.text = "-";
            if (data.checkDateOfIssue) this.view.lblDescValueTrans.text = data.checkDateOfIssue;
            else this.view.lblDescValueTrans.text = "-";
            this.view.lblTransDateValueTrans.text = data.lblAccountNo;
            this.view.lblFreqTransValue.text = data.checkReason;
            if (data.amount) this.view.lblRecurrenceValueTrans.text = data.amount;
            else this.view.lblRecurrenceValueTrans.text = "-";
            ...
            } else this.view.lblReferenceNoValueTrans.text = "-";
            if (data.fee) this.view.lblIBANValue.text = data.fee;
            else this.view.lblIBANValue.text = "-";
            if (data.notes) this.view.lblNotesValueTrans.text = data.notes;
            else this.view.lblNotesValueTrans.text = "-";
        ...
        renderMyChequeView: function(data) {
            ...
            if (data.accountType) this.view.lblAcType.text = data.accountType;
            else this.view.lblAcType.text = "";
            if (data.lblAccountNo) this.view.lblPayeeValue.text = data.lblAccountNo;
            else this.view.lblPayeeValue.text = data.lblAccountNo = "-";
        ...
        navigateToRevokeStopCheck: function(paramObj) {
            ...
            var navMan = applicationManager.getNavigationManager();
            navMan.setCustomInfo("frmChequeRevokeAckn", {
                "referenceId": refId
            });
...
define("ChequeManagementModule/frmChequeTransactionDetailsControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_aeae676807da468bb4e7b97b954244fb: function AS_Form_aeae676807da468bb4e7b97b954244fb(eventobject) {
        var self = this;
        this.initActions();
    },
    AS_Form_ad3ec0882b864af094dcfe64bd6811f7: function AS_Form_ad3ec0882b864af094dcfe64bd6811f7(eventobject) {
        var self = this;
        this.postShow();
    },
    AS_Form_dc633fef173b4c1cb542b1ca5282e62f: function AS_Form_dc633fef173b4c1cb542b1ca5282e62f(eventobject) {
        var self = this;
        this.preShow();
    },
    AS_BarButtonItem_jf13b61fed314228b9c52a22552eb887: function AS_BarButtonItem_jf13b61fed314228b9c52a22552eb887(eventobject) {
        var self = this;
        var navMan = applicationManager.getNavigationManager();
        navMan.goBack();
    },
});
define("ChequeManagementModule/frmChequeTransactionDetailsController", ["ChequeManagementModule/userfrmChequeTransactionDetailsController", "ChequeManagementModule/frmChequeTransactionDetailsControllerActions"], function() {
    var controller = require("ChequeManagementModule/userfrmChequeTransactionDetailsController");
    var controllerActions = ["ChequeManagementModule/frmChequeTransactionDetailsControllerActions"];
