define("ChequeManagementModule/frmSCTermsAndCondition", function() {
    return function(controller) {
        function addWidgetsfrmSCTermsAndCondition() {
            ...
            flxMainContainer.add(lbltxt, flxRememberMyDevice, flxButton);
            ...
            this.add(flxHeader, flxMainContainer, flxTermsConditions, flxPopup);
        };
        return [{
            "addWidgets": addWidgetsfrmSCTermsAndCondition,
            "enabledForIdleTimeout": true,
            "id": "frmSCTermsAndCondition",
            "init": controller.AS_Form_ca5795768039452db3323d7582cdf150,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": true,
            "postShow": controller.AS_Form_d244a503632243799af150a152c7e54f,
            "preShow": function(eventobject) {
                controller.AS_Form_eb3d6d7d394142f9a4f971298ab31c39(eventobject);
            },
            "skin": "sknFrmffffff",
            "title": kony.i18n.getLocalizedString("kony.mb.TermsAndConditions.Title")
        }, {
