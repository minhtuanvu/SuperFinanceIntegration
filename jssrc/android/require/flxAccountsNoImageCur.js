define("flxAccountsNoImageCur", function() {
    return function(controller) {
        var flxAccountsNoImageCur = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "focusSkin": "slFbox",
            "height": "70dp",
            "id": "flxAccountsNoImageCur",
            "isVisible": true,
            "layoutType": kony.flex.FLOW_HORIZONTAL,
            "isModalContainer": false,
            "skin": "f9f9"
        }, {}, {});
        flxAccountsNoImageCur.setDefaultUnit(kony.flex.DP);
        ...
        flxMain.add(lblAccountBalValue2, lblAccountBalValue, lblAccountBal2, lblAccountBal, flxSeparator, flxAccountName, flxcontent);
        ...
        flxAccountsNoImageCur.add(flxMain, flxDelete, flxRefresh);
        return flxAccountsNoImageCur;
    }
})