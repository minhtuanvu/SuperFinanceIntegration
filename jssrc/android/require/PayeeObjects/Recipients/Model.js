...
define([], function() {
    ...
    function Recipients(defaultValues) {
        ...
        context["field"] = "noOfCustomersLinked";
        context["metadata"] = (objectMetadata ? objectMetadata["noOfCustomersLinked"] : null);
        privateState.noOfCustomersLinked = defaultValues ? (defaultValues["noOfCustomersLinked"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["noOfCustomersLinked"], context) : null) : null;
