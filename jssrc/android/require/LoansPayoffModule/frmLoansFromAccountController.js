define("LoansPayoffModule/userfrmLoansFromAccountController", ['CampaignUtility'], function(CampaignUtility) {
    return {
        segmentData: null,
        sec: -1,
        row: -1,
...
define("LoansPayoffModule/frmLoansFromAccountControllerActions", {
    /*
    ...
    */
    ...
    AS_BarButtonItem_c1f5ff18d94d461a80e36d4d4ee50a99: function AS_BarButtonItem_c1f5ff18d94d461a80e36d4d4ee50a99(eventobject) {
        var self = this;
        this.navigateCustomBack();
    },
    AS_BarButtonItem_d755ac46c0484d239c6cbe4f53d5cd0c: function AS_BarButtonItem_d755ac46c0484d239c6cbe4f53d5cd0c(eventobject) {
        var self = this;
        this.cancelOnClick();
    },
});
define("LoansPayoffModule/frmLoansFromAccountController", ["LoansPayoffModule/userfrmLoansFromAccountController", "LoansPayoffModule/frmLoansFromAccountControllerActions"], function() {
    var controller = require("LoansPayoffModule/userfrmLoansFromAccountController");
    var controllerActions = ["LoansPayoffModule/frmLoansFromAccountControllerActions"];
