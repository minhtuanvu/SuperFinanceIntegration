define("TransferModuleEurope/userfrmEuropeTransactionDetailsController", {
    customerId: "",
    accountId: "",
    transactionType: "",
    mediaType: "pdf",
    ...
    preShow: function(obj) {
        ...
        if (downloadAttachments && downloadAttachments.length > 0) {
            for (var i = 0; i < downloadAttachments.length; i++) {
                ...
                if (i !== downloadAttachments.length - 1) this.view.lblAttachmentsValue.text += ", ";
            }
    ...
    bindDataForTransfer: function(transactionData) {
        ...
        if (transactionData.transactionType == "P2P") {
            ...
            if (transactionData.toAccountNumber) this.view.lblTransferredToValueTrans.text = applicationManager.getPresentationUtility().formatText(transactionData.toAccountName, 10, transactionData.toAccountNumber, 4);
            else this.view.lblTransferredToValueTrans.text = applicationManager.getPresentationUtility().formatText(transactionData.toAccountName, 10, transactionData.ExternalAccountNumber, 4);
    ...
    setIconType: function(transactionData) {
        ...
        if (serviceName.includes("TRANSFER_BETWEEN_OWN_ACCOUNT")) {
            ...
            if (transactionData.isBusinessPayee === "0") this.view.ImageToAccountType.src = "personalaccount.png";
            else this.view.ImageToAccountType.src = "businessaccount.png";
        } else {
            this.view.flxToAccountType.isVisible = false;
            this.view.lblTransferredToValueTrans.left = "20dp";
        }
...
define("TransferModuleEurope/frmEuropeTransactionDetailsControllerActions", {
    /*
...
define("TransferModuleEurope/frmEuropeTransactionDetailsController", ["TransferModuleEurope/userfrmEuropeTransactionDetailsController", "TransferModuleEurope/frmEuropeTransactionDetailsControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmEuropeTransactionDetailsController");
    var controllerActions = ["TransferModuleEurope/frmEuropeTransactionDetailsControllerActions"];
