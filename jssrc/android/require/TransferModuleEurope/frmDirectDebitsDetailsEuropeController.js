define("TransferModuleEurope/userfrmDirectDebitsDetailsEuropeController", {
    init: function() {
        var scope = this;
    ...
    onCancelDirectDebitSuccess: function(response) {
        var navMan = applicationManager.getNavigationManager();
        navMan.setCustomInfo("frmTransferActivitiesDirectDebitsEurope", {
            "DELETE": response
        });
...
define("TransferModuleEurope/frmDirectDebitsDetailsEuropeControllerActions", {
    /*
...
define("TransferModuleEurope/frmDirectDebitsDetailsEuropeController", ["TransferModuleEurope/userfrmDirectDebitsDetailsEuropeController", "TransferModuleEurope/frmDirectDebitsDetailsEuropeControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmDirectDebitsDetailsEuropeController");
    var controllerActions = ["TransferModuleEurope/frmDirectDebitsDetailsEuropeControllerActions"];
