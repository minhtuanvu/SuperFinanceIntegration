define("TransferModuleEurope/userfrmEuropeManageBeneficiariesController", ['CampaignUtility'], function(CampaignUtility) {
    return {
        segmentData: [],
            ...
            if (externalAccountsData.length > 0) {
                ...
                for (var i = 0; i < externalAccountsData.length; i++) {
                    if (this.isDeletePermitted(externalAccountsData[i])) {
                        ...
                        this.segmentData[i].flximage = {
                            isVisible: false
                        };
                        this.segmentData[i].flxAccountType = {
                            isVisible: false
                        };
                        this.segmentData[i].flxCancel = {};
                        this.segmentData[i].imgCancel = "deleteicon.png";
                        this.segmentData[i].lblCancel = {
                            "text": applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.common.Delete")
                        }
...
define("TransferModuleEurope/frmEuropeManageBeneficiariesControllerActions", {
    /*
    ...
    */
    ...
    AS_BarButtonItem_i0a5f5f7f5bb4a47b8a17e9a1dbad848: function AS_BarButtonItem_i0a5f5f7f5bb4a47b8a17e9a1dbad848(eventobject) {
        var self = this;
        this.backNavigation();
    }
});
define("TransferModuleEurope/frmEuropeManageBeneficiariesController", ["TransferModuleEurope/userfrmEuropeManageBeneficiariesController", "TransferModuleEurope/frmEuropeManageBeneficiariesControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmEuropeManageBeneficiariesController");
    var controllerActions = ["TransferModuleEurope/frmEuropeManageBeneficiariesControllerActions"];
