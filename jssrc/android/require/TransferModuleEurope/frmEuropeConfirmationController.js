define("TransferModuleEurope/userfrmEuropeConfirmationController", {
    init: function() {
        var scope = this;
    ...
    setupUI: function() {
        ...
        if (!kony.sdk.isNullOrUndefined(transferObject.errmsg)) {
            ...
            if (approvalStatus && approvalStatus === "Pending") {
                ...
                if (transferObject.isScheduled === "0") this.view.lblSuccessMessage.text = applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.TransfersEurope.successfulTransfer");
...
define("TransferModuleEurope/frmEuropeConfirmationControllerActions", {
    /*
...
define("TransferModuleEurope/frmEuropeConfirmationController", ["TransferModuleEurope/userfrmEuropeConfirmationController", "TransferModuleEurope/frmEuropeConfirmationControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmEuropeConfirmationController");
    var controllerActions = ["TransferModuleEurope/frmEuropeConfirmationControllerActions"];
