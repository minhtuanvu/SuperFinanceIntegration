define("TransferModuleEurope/userfrmTransferEuropeSearchSwiftCodeController", {
    init: function() {
    ...
    enableordisableButton: function() {
        if ((this.view.lblSelect.text && this.view.lblSelect.text.length > 0) || (this.view.tbxCity.text && this.view.tbxCity.text.length > 0) || (this.view.txtBankName.text && this.view.txtBankName.text.length > 0)) {
...
define("TransferModuleEurope/frmTransferEuropeSearchSwiftCodeControllerActions", {
    /*
...
define("TransferModuleEurope/frmTransferEuropeSearchSwiftCodeController", ["TransferModuleEurope/userfrmTransferEuropeSearchSwiftCodeController", "TransferModuleEurope/frmTransferEuropeSearchSwiftCodeControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmTransferEuropeSearchSwiftCodeController");
    var controllerActions = ["TransferModuleEurope/frmTransferEuropeSearchSwiftCodeControllerActions"];
