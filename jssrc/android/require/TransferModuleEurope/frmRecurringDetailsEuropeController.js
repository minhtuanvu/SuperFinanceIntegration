define("TransferModuleEurope/userfrmRecurringDetailsEuropeController", {
    init: function() {
        var scope = this;
    ...
    onCancelSeriesSuccess: function(response) {
        var navMan = applicationManager.getNavigationManager();
        navMan.setCustomInfo("frmTransferActivitiesRecurringEurope", {
            "DELETE": response
        });
...
define("TransferModuleEurope/frmRecurringDetailsEuropeControllerActions", {
    /*
...
define("TransferModuleEurope/frmRecurringDetailsEuropeController", ["TransferModuleEurope/userfrmRecurringDetailsEuropeController", "TransferModuleEurope/frmRecurringDetailsEuropeControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmRecurringDetailsEuropeController");
    var controllerActions = ["TransferModuleEurope/frmRecurringDetailsEuropeControllerActions"];
