define("WealthModule/userfrmToCurrencyController", {
    index: "",
    existing: "",
    todata: {},
        ...
        if (currencydetails.length > 0) {
            ...
            for (var num in currencydetails) {
                ...
                var storeData = {
                    ...
                    lblseparator: "",
                    imgFlag: {
                        "src": this.flagPaths[data.CurrencyCode] || "defaultflag.png",
                        "isVisible": true
                    }
                };
...
define("WealthModule/frmToCurrencyControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_cfbc5fe84e5e4295bdeb8091028dc4ef: function AS_Form_cfbc5fe84e5e4295bdeb8091028dc4ef(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_h9ac8580580e48aca96868b046e6b297: function AS_Form_h9ac8580580e48aca96868b046e6b297(eventobject) {
        var self = this;
        this.postShow();
    },
    AS_Form_ce3d204eb4374028b9f8393e5922893a: function AS_Form_ce3d204eb4374028b9f8393e5922893a(eventobject) {
        var self = this;
        this.preShow();
    },
    AS_BarButtonItem_g2191205a83c4b1dbc46b29fc9f61374: function AS_BarButtonItem_g2191205a83c4b1dbc46b29fc9f61374(eventobject) {
        var self = this;
        this.onBack();
    }
});
define("WealthModule/frmToCurrencyController", ["WealthModule/userfrmToCurrencyController", "WealthModule/frmToCurrencyControllerActions"], function() {
    var controller = require("WealthModule/userfrmToCurrencyController");
    var controllerActions = ["WealthModule/frmToCurrencyControllerActions"];
