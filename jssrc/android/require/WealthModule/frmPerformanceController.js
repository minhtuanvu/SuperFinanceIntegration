define("WealthModule/userfrmPerformanceController", {
    dateRange: [],
    performanceData: [],
    segCounter: "",
    segData: "",
    ...
    setDataToChart: function() {
        ...
        if (selectedValue == "1 Year") {
            ...
            if (diffDays > 365) period = "Inception";
        }
...
define("WealthModule/frmPerformanceControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_d62bf75fa41747a8a0401bc053c8f1fe: function AS_Form_d62bf75fa41747a8a0401bc053c8f1fe(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_acc61c362bb64b5689dd87de65f50b9f: function AS_Form_acc61c362bb64b5689dd87de65f50b9f(eventobject) {
        var self = this;
        this.preShow();
    }
});
define("WealthModule/frmPerformanceController", ["WealthModule/userfrmPerformanceController", "WealthModule/frmPerformanceControllerActions"], function() {
    var controller = require("WealthModule/userfrmPerformanceController");
    var controllerActions = ["WealthModule/frmPerformanceControllerActions"];
