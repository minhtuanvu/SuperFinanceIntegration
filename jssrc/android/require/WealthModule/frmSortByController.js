define("WealthModule/userfrmSortByController", {
    sortingData: [],
    segData: [],
    dateRange: [],
    selectedRow: "",
    ...
    setUpData: function() {
        ...
        this.segData.forEach(function(e) {
            if (e.sortIndex === selectedColumn) e.isSelected = true;
...
define("WealthModule/frmSortByControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_ica2675f5ebd442a866b689eae7d3441: function AS_Form_ica2675f5ebd442a866b689eae7d3441(eventobject) {
        var self = this;
        this.init();
    }
});
define("WealthModule/frmSortByController", ["WealthModule/userfrmSortByController", "WealthModule/frmSortByControllerActions"], function() {
    var controller = require("WealthModule/userfrmSortByController");
    var controllerActions = ["WealthModule/frmSortByControllerActions"];
