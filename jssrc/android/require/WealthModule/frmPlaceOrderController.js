define("WealthModule/userfrmPlaceOrderController", ["CommonUtilities"], function(CommonUtilities) {
    return {
        ricCode: "",
        isinCode: "",
        lastPrice: "",
        ...
        setDetails: function(productDetails, refresh) {
            ...
            if (productDetails.instrumentDetails) instrumentDetailsDate = {
            ...
            if (applicationManager.getPresentationFormUtility().getDeviceName() === "iPhone") this.view.lblInstrument.text = CommonUtilities.truncateStringWithGivenLength(this.instrumentMinimal.instrumentName, 30);
            else this.view.lblInstrument.text = this.instrumentMinimal.instrumentName;
            ...
            if (instrumentDetails.lastPrice === 0 || instrumentDetails.lastPrice === "0.0") this.view.lblAmount.text = formatUtil.formatAmountandAppendCurrencySymbol(this.closeRate, instrumentDetails.priceCurrency);
            else this.view.lblAmount.text = formatUtil.formatAmountandAppendCurrencySymbol(instrumentDetails.lastPrice, instrumentDetails.priceCurrency);
...
define("WealthModule/frmPlaceOrderControllerActions", {
    /*
...
define("WealthModule/frmPlaceOrderController", ["WealthModule/userfrmPlaceOrderController", "WealthModule/frmPlaceOrderControllerActions"], function() {
    var controller = require("WealthModule/userfrmPlaceOrderController");
    var controllerActions = ["WealthModule/frmPlaceOrderControllerActions"];
