define("AuthModule/userfrmSelectUserIdController", {
    ...
    mappingUserIdData: function(userDetails, index, selectedUser) {
        ...
        if (selectedUser) {
            selectedIcon = selectedUser === userId ? "radiobtn.png" : "radiobuttoninactive.png";
    ...
    setFlowActions: function() {
        ...
        this.view.btnDone.onClick = function() {
            ...
            const navManager = applicationManager.getNavigationManager();
            const userListObj = navManager.getCustomInfo("frmSelectUserId");
            navManager.setCustomInfo("frmSelectUserId", {...userListObj,
    ...
    navigateToPreviousForm: function() {
        const naviagteObj = new kony.mvc.Navigation(kony.application.getPreviousForm().id);
        naviagteObj.navigate();
    },
});
define("AuthModule/frmSelectUserIdControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_e9dec8a39b9245cb9aefd0776354a9ce: function AS_Form_e9dec8a39b9245cb9aefd0776354a9ce(eventobject) {
        var self = this;
        return self.preShow.call(this);
    }
});
define("AuthModule/frmSelectUserIdController", ["AuthModule/userfrmSelectUserIdController", "AuthModule/frmSelectUserIdControllerActions"], function() {
    var controller = require("AuthModule/userfrmSelectUserIdController");
    var controllerActions = ["AuthModule/frmSelectUserIdControllerActions"];
