define("AuthModule/frmForgotEnterDOB", function() {
    return function(controller) {
        function addWidgetsfrmForgotEnterDOB() {
            ...
            var flxEnterDOB = new kony.ui.FlexContainer({
            ...
            flxEnterDOB.add(lblEnterInfoTitle);
            flxMainContainer.add(flxInputDOB, btnVerify, flxEnterDOB);
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_i727c94db9924ff1910384bdcd323404(eventobject);
            },
            "skin": "sknFrmffffff",
