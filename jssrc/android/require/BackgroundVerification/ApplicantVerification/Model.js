...
define([], function() {
    ...
    var objectMetadata;
    var context = {
        "object": "ApplicantVerification",
        "objectService": "BackgroundVerification"
    };
    var setterFunctions = {
        ...
        id_number: function(val, state) {
            context["field"] = "id_number";
            context["metadata"] = (objectMetadata ? objectMetadata["id_number"] : null);
            state['id_number'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        results_message: function(val, state) {
            context["field"] = "results_message";
            context["metadata"] = (objectMetadata ? objectMetadata["results_message"] : null);
            state['results_message'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        summary_result_message: function(val, state) {
            context["field"] = "summary_result_message";
            context["metadata"] = (objectMetadata ? objectMetadata["summary_result_message"] : null);
            state['summary_result_message'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        results_key: function(val, state) {
            context["field"] = "results_key";
            context["metadata"] = (objectMetadata ? objectMetadata["results_key"] : null);
            state['results_key'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        summary_result_key: function(val, state) {
            context["field"] = "summary_result_key";
            context["metadata"] = (objectMetadata ? objectMetadata["summary_result_key"] : null);
            state['summary_result_key'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        invoice: function(val, state) {
            context["field"] = "invoice";
            context["metadata"] = (objectMetadata ? objectMetadata["invoice"] : null);
            state['invoice'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        restriction_key: function(val, state) {
            context["field"] = "restriction_key";
            context["metadata"] = (objectMetadata ? objectMetadata["restriction_key"] : null);
            state['restriction_key'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        restriction_message: function(val, state) {
            context["field"] = "restriction_message";
            context["metadata"] = (objectMetadata ? objectMetadata["restriction_message"] : null);
            state['restriction_message'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        pa_list: function(val, state) {
            context["field"] = "pa_list";
            context["metadata"] = (objectMetadata ? objectMetadata["pa_list"] : null);
            state['pa_list'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
        pa_score: function(val, state) {
            context["field"] = "pa_score";
            context["metadata"] = (objectMetadata ? objectMetadata["pa_score"] : null);
            state['pa_score'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    };
    //Create the Model Class
    function ApplicantVerification(defaultValues) {
        var privateState = {};
        context["field"] = "addressLine1";
        context["metadata"] = (objectMetadata ? objectMetadata["addressLine1"] : null);
        ...
        context["field"] = "annualIncome";
        context["metadata"] = (objectMetadata ? objectMetadata["annualIncome"] : null);
        privateState.annualIncome = defaultValues ? (defaultValues["annualIncome"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["annualIncome"], context) : null) : null;
        context["field"] = "assets";
        context["metadata"] = (objectMetadata ? objectMetadata["assets"] : null);
        privateState.assets = defaultValues ? (defaultValues["assets"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["assets"], context) : null) : null;
        context["field"] = "city";
        context["metadata"] = (objectMetadata ? objectMetadata["city"] : null);
        ...
        context["field"] = "company";
        context["metadata"] = (objectMetadata ? objectMetadata["company"] : null);
        privateState.company = defaultValues ? (defaultValues["company"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["company"], context) : null) : null;
        context["field"] = "country";
        context["metadata"] = (objectMetadata ? objectMetadata["country"] : null);
        ...
        context["field"] = "creditCheck";
        context["metadata"] = (objectMetadata ? objectMetadata["creditCheck"] : null);
        privateState.creditCheck = defaultValues ? (defaultValues["creditCheck"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["creditCheck"], context) : null) : null;
        context["field"] = "dateOfBirth";
        context["metadata"] = (objectMetadata ? objectMetadata["dateOfBirth"] : null);
        ...
        context["field"] = "experience";
        context["metadata"] = (objectMetadata ? objectMetadata["experience"] : null);
        privateState.experience = defaultValues ? (defaultValues["experience"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["experience"], context) : null) : null;
        context["field"] = "gender";
        context["metadata"] = (objectMetadata ? objectMetadata["gender"] : null);
        ...
        context["field"] = "informationType";
        context["metadata"] = (objectMetadata ? objectMetadata["informationType"] : null);
        privateState.informationType = defaultValues ? (defaultValues["informationType"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["informationType"], context) : null) : null;
        context["field"] = "jobProfile";
        context["metadata"] = (objectMetadata ? objectMetadata["jobProfile"] : null);
        privateState.jobProfile = defaultValues ? (defaultValues["jobProfile"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["jobProfile"], context) : null) : null;
        context["field"] = "maritalStatus";
        context["metadata"] = (objectMetadata ? objectMetadata["maritalStatus"] : null);
        ...
        context["field"] = "montlyExpenditure";
        context["metadata"] = (objectMetadata ? objectMetadata["montlyExpenditure"] : null);
        privateState.montlyExpenditure = defaultValues ? (defaultValues["montlyExpenditure"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["montlyExpenditure"], context) : null) : null;
        context["field"] = "noOfDependents";
        context["metadata"] = (objectMetadata ? objectMetadata["noOfDependents"] : null);
        ...
        context["field"] = "signatureImage";
        context["metadata"] = (objectMetadata ? objectMetadata["signatureImage"] : null);
        privateState.signatureImage = defaultValues ? (defaultValues["signatureImage"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["signatureImage"], context) : null) : null;
        context["field"] = "spouseFirstName";
        context["metadata"] = (objectMetadata ? objectMetadata["spouseFirstName"] : null);
        ...
        context["field"] = "userEmploymentInfo";
        context["metadata"] = (objectMetadata ? objectMetadata["userEmploymentInfo"] : null);
        privateState.userEmploymentInfo = defaultValues ? (defaultValues["userEmploymentInfo"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["userEmploymentInfo"], context) : null) : null;
        context["field"] = "userFinancialInfo";
        context["metadata"] = (objectMetadata ? objectMetadata["userFinancialInfo"] : null);
        privateState.userFinancialInfo = defaultValues ? (defaultValues["userFinancialInfo"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["userFinancialInfo"], context) : null) : null;
        context["field"] = "userfirstname";
        context["metadata"] = (objectMetadata ? objectMetadata["userfirstname"] : null);
        ...
        context["field"] = "userPersonalInfo";
        context["metadata"] = (objectMetadata ? objectMetadata["userPersonalInfo"] : null);
        privateState.userPersonalInfo = defaultValues ? (defaultValues["userPersonalInfo"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["userPersonalInfo"], context) : null) : null;
        context["field"] = "userProducts";
        context["metadata"] = (objectMetadata ? objectMetadata["userProducts"] : null);
        privateState.userProducts = defaultValues ? (defaultValues["userProducts"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["userProducts"], context) : null) : null;
        context["field"] = "userSecurityQuestions";
        context["metadata"] = (objectMetadata ? objectMetadata["userSecurityQuestions"] : null);
        privateState.userSecurityQuestions = defaultValues ? (defaultValues["userSecurityQuestions"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["userSecurityQuestions"], context) : null) : null;
        context["field"] = "zipcode";
        context["metadata"] = (objectMetadata ? objectMetadata["zipcode"] : null);
        ...
        context["field"] = "id_number";
        context["metadata"] = (objectMetadata ? objectMetadata["id_number"] : null);
        privateState.id_number = defaultValues ? (defaultValues["id_number"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["id_number"], context) : null) : null;
        context["field"] = "results_message";
        context["metadata"] = (objectMetadata ? objectMetadata["results_message"] : null);
        privateState.results_message = defaultValues ? (defaultValues["results_message"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["results_message"], context) : null) : null;
        context["field"] = "summary_result_message";
        context["metadata"] = (objectMetadata ? objectMetadata["summary_result_message"] : null);
        privateState.summary_result_message = defaultValues ? (defaultValues["summary_result_message"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["summary_result_message"], context) : null) : null;
        context["field"] = "results_key";
        context["metadata"] = (objectMetadata ? objectMetadata["results_key"] : null);
        privateState.results_key = defaultValues ? (defaultValues["results_key"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["results_key"], context) : null) : null;
        context["field"] = "summary_result_key";
        context["metadata"] = (objectMetadata ? objectMetadata["summary_result_key"] : null);
        privateState.summary_result_key = defaultValues ? (defaultValues["summary_result_key"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["summary_result_key"], context) : null) : null;
        context["field"] = "invoice";
        context["metadata"] = (objectMetadata ? objectMetadata["invoice"] : null);
        privateState.invoice = defaultValues ? (defaultValues["invoice"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["invoice"], context) : null) : null;
        context["field"] = "restriction_key";
        context["metadata"] = (objectMetadata ? objectMetadata["restriction_key"] : null);
        privateState.restriction_key = defaultValues ? (defaultValues["restriction_key"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["restriction_key"], context) : null) : null;
        context["field"] = "restriction_message";
        context["metadata"] = (objectMetadata ? objectMetadata["restriction_message"] : null);
        privateState.restriction_message = defaultValues ? (defaultValues["restriction_message"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["restriction_message"], context) : null) : null;
        context["field"] = "pa_list";
        context["metadata"] = (objectMetadata ? objectMetadata["pa_list"] : null);
        privateState.pa_list = defaultValues ? (defaultValues["pa_list"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["pa_list"], context) : null) : null;
        context["field"] = "pa_score";
        context["metadata"] = (objectMetadata ? objectMetadata["pa_score"] : null);
        privateState.pa_score = defaultValues ? (defaultValues["pa_score"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["pa_score"], context) : null) : null;
        ...
        Object.defineProperties(this, {
            ...
            "id_number": {
                get: function() {
                    context["field"] = "id_number";
                    context["metadata"] = (objectMetadata ? objectMetadata["id_number"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.id_number, context);
                },
                set: function(val) {
                    setterFunctions['id_number'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "results_message": {
                get: function() {
                    context["field"] = "results_message";
                    context["metadata"] = (objectMetadata ? objectMetadata["results_message"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.results_message, context);
                },
                set: function(val) {
                    setterFunctions['results_message'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "summary_result_message": {
                get: function() {
                    context["field"] = "summary_result_message";
                    context["metadata"] = (objectMetadata ? objectMetadata["summary_result_message"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.summary_result_message, context);
                },
                set: function(val) {
                    setterFunctions['summary_result_message'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "results_key": {
                get: function() {
                    context["field"] = "results_key";
                    context["metadata"] = (objectMetadata ? objectMetadata["results_key"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.results_key, context);
                },
                set: function(val) {
                    setterFunctions['results_key'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "summary_result_key": {
                get: function() {
                    context["field"] = "summary_result_key";
                    context["metadata"] = (objectMetadata ? objectMetadata["summary_result_key"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.summary_result_key, context);
                },
                set: function(val) {
                    setterFunctions['summary_result_key'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "invoice": {
                get: function() {
                    context["field"] = "invoice";
                    context["metadata"] = (objectMetadata ? objectMetadata["invoice"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.invoice, context);
                },
                set: function(val) {
                    setterFunctions['invoice'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "restriction_key": {
                get: function() {
                    context["field"] = "restriction_key";
                    context["metadata"] = (objectMetadata ? objectMetadata["restriction_key"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.restriction_key, context);
                },
                set: function(val) {
                    setterFunctions['restriction_key'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "restriction_message": {
                get: function() {
                    context["field"] = "restriction_message";
                    context["metadata"] = (objectMetadata ? objectMetadata["restriction_message"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.restriction_message, context);
                },
                set: function(val) {
                    setterFunctions['restriction_message'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "pa_list": {
                get: function() {
                    context["field"] = "pa_list";
                    context["metadata"] = (objectMetadata ? objectMetadata["pa_list"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.pa_list, context);
                },
                set: function(val) {
                    setterFunctions['pa_list'].call(this, val, privateState);
                },
                enumerable: true,
            },
            "pa_score": {
                get: function() {
                    context["field"] = "pa_score";
                    context["metadata"] = (objectMetadata ? objectMetadata["pa_score"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.pa_score, context);
                },
                set: function(val) {
                    setterFunctions['pa_score'].call(this, val, privateState);
                },
                enumerable: true,
            },
        });
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.id_number = value ? (value["id_number"] ? value["id_number"] : null) : null;
            privateState.results_message = value ? (value["results_message"] ? value["results_message"] : null) : null;
            privateState.summary_result_message = value ? (value["summary_result_message"] ? value["summary_result_message"] : null) : null;
            privateState.results_key = value ? (value["results_key"] ? value["results_key"] : null) : null;
            privateState.summary_result_key = value ? (value["summary_result_key"] ? value["summary_result_key"] : null) : null;
            privateState.invoice = value ? (value["invoice"] ? value["invoice"] : null) : null;
            privateState.restriction_key = value ? (value["restriction_key"] ? value["restriction_key"] : null) : null;
            privateState.restriction_message = value ? (value["restriction_message"] ? value["restriction_message"] : null) : null;
            privateState.pa_list = value ? (value["pa_list"] ? value["pa_list"] : null) : null;
            privateState.pa_score = value ? (value["pa_score"] ? value["pa_score"] : null) : null;
        };
    }
    //Setting BaseModel as Parent to this Model
    BaseModel.isParentOf(ApplicantVerification);
    //Create new class level validator object
    BaseModel.Validator.call(ApplicantVerification);
    var registerValidatorBackup = ApplicantVerification.registerValidator;
    ApplicantVerification.registerValidator = function() {
            var propName = arguments[0];
            if (!setterFunctions[propName].changed) {
                var setterBackup = setterFunctions[propName];
                setterFunctions[arguments[0]] = function() {
                    if (ApplicantVerification.isValid(this, propName, val)) {
    ...
    ApplicantVerification.verifyExistingUserByEmail = function(params, onCompletion) {
        return ApplicantVerification.customVerb('verifyExistingUserByEmail', params, onCompletion);
    };
    //For Operation 'verifyPatroitAct' with service id 'ExpectIDPA4934'
    ApplicantVerification.verifyPatroitAct = function(params, onCompletion) {
        return ApplicantVerification.customVerb('verifyPatroitAct', params, onCompletion);
    };
    //For Operation 'verifyUserByGeotrace' with service id 'ExpectIDGeotrace4717'
    ApplicantVerification.verifyUserByGeotrace = function(params, onCompletion) {
        return ApplicantVerification.customVerb('verifyUserByGeotrace', params, onCompletion);
    };
    //For Operation 'verifyExistingUserName' with service id 'ExpectIDIQ1108'
    ApplicantVerification.verifyExistingUserName = function(params, onCompletion) {
        return ApplicantVerification.customVerb('verifyExistingUserName', params, onCompletion);
    };
    var relations = [];
    ApplicantVerification.relations = relations;
    ApplicantVerification.prototype.isValid = function() {
        return ApplicantVerification.isValid(this);
    };
    ApplicantVerification.prototype.objModelName = "ApplicantVerification";
     ...
     */
    ApplicantVerification.registerProcessors = function(options, successCallback, failureCallback) {
        if (!options) {
            options = {};
        }
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("BackgroundVerification", "ApplicantVerification", options, metaDataSuccess, metaDataFailure);
    };
    //clone the object provided in argument.
    ApplicantVerification.clone = function(objectToClone) {
        var clonedObj = new ApplicantVerification();
