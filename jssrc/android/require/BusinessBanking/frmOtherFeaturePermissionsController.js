define("BusinessBanking/userfrmOtherFeaturePermissionsController", {
    ...
    bindevents: function() {
        try {
            ...
            kony.print("Exception in bindevents" + e);
        }
    },
    /*
    ...
    getDataOtherFeatureList: function() {
        try {
            ...
            for (var j = 0; j < headerTitles.length; j++) {
                ...
                for (var k = 0; k < featureData.Actions.length; k++) {
                    var rowObj = {
                        ...
                        "lblNameVal": {
                            "text": "" + featureData.Actions[k].actionName
                        },
                        "imgDotIcon": (featureData.Actions[k].isSelected) ? {
            ...
            kony.print("exception setDatainSegment" + e);
        }
    },
...
define("BusinessBanking/frmOtherFeaturePermissionsControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_BarButtonItem_bbf572c118ac4680bc692abf7cf824cf: function AS_BarButtonItem_bbf572c118ac4680bc692abf7cf824cf(eventobject) {
        var self = this;
        this.navigateBack();
    }
});
define("BusinessBanking/frmOtherFeaturePermissionsController", ["BusinessBanking/userfrmOtherFeaturePermissionsController", "BusinessBanking/frmOtherFeaturePermissionsControllerActions"], function() {
    var controller = require("BusinessBanking/userfrmOtherFeaturePermissionsController");
    var controllerActions = ["BusinessBanking/frmOtherFeaturePermissionsControllerActions"];
