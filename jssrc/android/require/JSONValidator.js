        ...
        if (typeof jsonString === 'string') {
            try {
                ...
                if (jsonString.includes("i.") || jsonString.includes("$.")) {
                    if (kony.string.startsWith(jsonString, "{i.", true) || kony.string.startsWith(jsonString, "{$.", true) || kony.string.startsWith(jsonString, "i.", true) || kony.string.startsWith(jsonString, "$.", true)) {
