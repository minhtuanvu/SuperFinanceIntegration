define(["CommonUtilities"], function(CommonUtilities) {
    ...
    ApprovalsReqModule_PresentationController.prototype.getGeneralTransactionsPendingForMyApprovals = function(navObj) {
        ...
        approvalsReqManager.fetchGeneralTransactionsPendingForMyApprovals(navObj.requestData, scopeObj.onFetchGeneralTransactionsPendingForMyApprovalsSuccess.bind(scopeObj, navObj), scopeObj.onFetchGeneralTransactionsPendingForMyApprovalsFailure, );
    };
    /**
    ...
    ApprovalsReqModule_PresentationController.prototype.getGeneralTransactionsPullDownDashboard = function(navObj) {
        ...
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.fetchGeneralTransactionsPendingForMyApprovals(navObj.requestData, scopeObj.onFetchGetGeneralTransactionsPullDownDashboardSuccess.bind(scopeObj, navObj), scopeObj.onFetchGetGeneralTransactionsPullDownDashboardFailure, );
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.getPendingApprovals = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchAllMyPendingApprovals(navObj, scopeObj.onFetchPendingApprovalsTransSuccess.bind(scopeObj, navObj), scopeObj.onFetchPendingApprovalsFailure, );
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
                ...
                resGenTrans.forEach(function(responseObj) {
                    ...
                    if (statusCheck === "Pending") { // this condtion used for fliter only pending status for approvals 
                        var rowObj = {
                            ...
                            "data": responseObj,
                            "requiredApprovals": {
                                "text": kony.sdk.isNullOrUndefined(responseObj.requiredApprovals) ? "0" : responseObj.requiredApprovals
                            },
                            "featureActionName": {
                                "text": kony.sdk.isNullOrUndefined(responseObj.featureActionName) ? "0" : responseObj.featureActionName
                            },
                            "lblTransactionAP": {
                                "text": kony.sdk.isNullOrUndefined(responseObj.featureName) ? "N/A" : responseObj.featureName
                            },
                            "lblTransactionAmountAP": {
                                "text": kony.sdk.isNullOrUndefined(responseObj.sentBy) ? "N/A" : responseObj.sentBy
                            },
                            "lblDateAP": {
                                "text": kony.sdk.isNullOrUndefined(responseObj.featureActionName) ? "N/A" : responseObj.featureActionName
                            },
                            "flxApprovalsList": {
                                "isVisible": true,
                                "height": "70dp"
                            ...
                            "lblPayment": {
                                "text": CommonUtilities.getFrontendDateString(sentDate, "mm/dd/yyyy")
                            },
                            "sentDate": {
                                "text": CommonUtilities.getFrontendDateString(sentDate, "mm/dd/yyyy")
                            },
                            "processingDate": {
                                "text": CommonUtilities.getFrontendDateString(processingDate, "mm/dd/yyyy")
                            },
                            "flxRejectAP": {
                            ...
                            "imgRejectAP": {
                                "src": constantsSkin.imgReject
                            },
                            "imgApproveAP": {
                                "src": constantsSkin.imgApprove
                            },
                        };
    ...
    ApprovalsReqModule_PresentationController.prototype.getPendingRequests = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchAllMyPendingRequests(navObj, scopeObj.onFetchPendingRequestsTransSuccess.bind(scopeObj, navObj), scopeObj.onFetchPendingRequestsFailure, );
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
        ...
        try {
            ...
            if (resGenTrans.length > 0) {
                ...
                var rowObj2 = {
                    "template": "flxNoPending",
                    "lblTransactionPending": {
                        "text": kony.i18n.getLocalizedString("kony.mb.ApprovalRequests.NoPendingTransactionsRequest")
                    },
                    "flxNoPending": {
                        "isVisible": true,
                        "height": "80dp"
    ...
    ApprovalsReqModule_PresentationController.prototype.getACHTransactionsPendingForMyApprovals = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchACHTransactionsPendingForMyApprovals(navObj.requestData, scopeObj.onFetchACHTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onFetchACHTransactionsFailure, );
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
        ...
        try {
            ...
            if (resOfACHTrans.length > 0) {
                resOfACHTrans.forEach(function(responseObj) {
                    ...
                    if (statusCheck === "pending") { // this condtion used for fliter only pending status for approvals 
                        var rowObj = {
                            ...
                            "lblTransactionAmountAP": {
                                "text": configManager.getCurrencyCode() + "" + CommonUtilities.formatCurrencyWithCommas(responseObj.TotalAmount, true)
                            },
                            "lblDateAP": {
                                "text": CommonUtilities.getFrontendDateString(responseObj.CreatedOn, "mm/dd/yyyy")
                            },
                            "flxApprovalsList": {
                                "isVisible": true,
                                "height": "70dp"
                ...
                var rowObj2 = {
                    "template": "flxNoPending",
                    "lblTransactionPending": {
                        "text": kony.i18n.getLocalizedString("kony.mb.ApprovalRequests.NoPendingACHTransApprovals")
                    },
                    "flxNoPending": {
                        "isVisible": true,
                        "height": "80dp"
    ...
    ApprovalsReqModule_PresentationController.prototype.getACHFilesPendingForMyApprovals = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchACHFilesPendingForMyApprovals(navObj.requestData, scopeObj.onFetchACHFilesSuccess.bind(scopeObj, navObj), scopeObj.onFetchACHFilesFailure);
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
            ...
            if (Array.isArray(response))
                if (response.length > 0) {
                    response.forEach(function(responseObj) {
                        ...
                        if (statusCheck === "pending") { // this condtion used for fliter only pending status for approvals  
                            var rowObj = {
                                ...
                                "lblTransactionAmountAP": {
                                    "text": configManager.getCurrencyCode() + "" + CommonUtilities.formatCurrencyWithCommas(responseObj.TotalDebitAmount, true)
                                },
                                "lblDateAP": {
                                    "text": CommonUtilities.getFrontendDateString(responseObj.UpdatedDateAndTime, "mm/dd/yyyy")
                                },
                                "flxApprovalsList": {
                                    "isVisible": true,
                                    "height": "70dp"
                    ...
                    var rowObj2 = {
                        "template": "flxNoPending",
                        "lblTransactionPending": {
                            "text": kony.i18n.getLocalizedString("kony.mb.ApprovalRequests.NoPendingACHFileApprovals")
                        },
                        "flxNoPending": {
                            "isVisible": true,
                            "height": "80dp"
    ...
    ApprovalsReqModule_PresentationController.prototype.fetchTransactionRequests = function(navObj) {
        try {
            ...
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchAllTransactionRequests(navObj.requestData, scopeObj.transactionRequestsSuccess.bind(scopeObj, navObj), scopeObj.showTransactionRequestsFailure);
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
    ...
    ApprovalsReqModule_PresentationController.prototype.fetchACHTransactionRequests = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchAllACHTransactionRequests(navObj.requestData, scopeObj.ACHTransactionRequestsSuccess.bind(scopeObj, navObj), scopeObj.ACHTransactionRequestsFailure);
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
            ...
            if (resOfACHTrans.length > 0) {
                resOfACHTrans.forEach(function(achTransactionObj) {
                    ...
                    var rowObj = {
                        ...
                        "lblTransactionAmount": {
                            "text": configManager.getCurrencyCode() + "" + CommonUtilities.formatCurrencyWithCommas(achTransactionObj.TotalAmount, true)
                        },
                        "lblDate": {
                            "text": CommonUtilities.getFrontendDateString(achTransactionObj.CreatedOn, "mm/dd/yyyy")
                        },
                        "flxRequestList": {
                            "isVisible": true,
                            "height": "70dp"
                ...
                var rowObj2 = {
                    "template": "flxNoPending",
                    "lblTransactionPending": {
                        "text": kony.i18n.getLocalizedString("kony.mb.ApprovalRequests.NoACHTransactionRequests")
                    },
                    "flxNoPending": {
                        "isVisible": true,
                        "height": "80dp"
    ...
    ApprovalsReqModule_PresentationController.prototype.fetchACHFileRequests = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchAllACHFileRequests(navObj.requestData, scopeObj.ACHFileRequestsSuccess.bind(scopeObj, navObj), scopeObj.ACHFileRequestsFailure);
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
            kony.print("Exception in getACHFilesPendingForMyApprovals" + e);
        }
                ...
                if (response.length > 0) {
                    response.forEach(function(achFileReq) {
                        ...
                        var rowObj = {
                            ...
                            "lblTransactionAmount": {
                                "text": configManager.getCurrencyCode() + "" + CommonUtilities.formatCurrencyWithCommas(achFileReq.TotalCreditAmount, true)
                            },
                            "lblDate": {
                                "text": CommonUtilities.getFrontendDateString(achFileReq.UpdatedDateAndTime, "mm/dd/yyyy")
                            },
                            "flxRequestList": {
                                "isVisible": true,
                                "height": "70dp"
                    ...
                    var rowObj2 = {
                        "template": "flxNoPending",
                        "lblTransactionPending": {
                            "text": kony.i18n.getLocalizedString("kony.mb.ApprovalRequests.NoACHFileRequests")
                        },
                        "flxNoPending": {
                            "isVisible": true,
                            "height": "80dp"
        ...
        try {
            ...
            if (response.length > 0) {
                ...
                response.forEach(function(transaction) {
                    ...
                    if (statusCheck === "pending") { // this condtion used for fliter only pending status for approvals  
                        ...
                        var rowObj = {
                            ...
                            "lblTransactionAmountAP": {
                                "text": configManager.getCurrencyCode() + "" + CommonUtilities.formatCurrencyWithCommas(transaction.Amount, true)
                            }, //"$" + transArr[i].Amount + ".00"},
                            "lblDateAP": {
                                "text": "" + CommonUtilities.getFrontendDateString(transaction.TransactionDate, "mm/dd/yyyy")
                            },
                            "flxApprovalsList": {
                                "isVisible": true,
                                "height": "70dp"
                ...
                var rowObj2 = {
                    "template": "flxNoPending",
                    "lblTransactionPending": {
                        "text": kony.i18n.getLocalizedString("kony.mb.ApprovalRequests.NoPendingApprovals")
                    },
                    "flxNoPending": {
                        "isVisible": true,
                        "height": "80dp"
        ...
        try {
            ...
            if (response.length > 0) {
                ...
                var rowObj2 = {
                    "template": "flxNoPending",
                    "lblTransactionPending": {
                        "text": kony.i18n.getLocalizedString("kony.mb.ApprovalRequests.NoTransactionRequests")
                    },
                    "flxNoPending": {
                        "isVisible": true,
                        "height": "80dp"
    ...
    ApprovalsReqModule_PresentationController.prototype.dataFormToSegMyApprovals = function(responseofGenTrans, resOfACHTrans, resOfACHFiles) {
        try {
            ...
            var headerTitles = [];
            if (responseofGenTrans !== undefined && responseofGenTrans !== null) headerTitles.push("Transactions");
            if (resOfACHTrans !== undefined && resOfACHTrans !== null) headerTitles.push("ACH Transactions");
            if (resOfACHFiles !== undefined && resOfACHFiles !== null) headerTitles.push("ACH Files");
                    ...
                    if (Array.isArray(response)) {
                        if (response.length > 0) {
                            for (var i = 0; i < totalArraylength; i++) {
                                ...
                                var jsonData = {
                                    "lblRecipientname": {
                                        "text": kony.sdk.isNullOrUndefined(response[i].Action) ? "-" : response[i].Action,
                                        "skin": skin
                                    },
                                    "lblAccountnumber": {
                                        "text": kony.sdk.isNullOrUndefined(response[i].userName) ? "-" : response[i].userName,
                                        "skin": "sknlbl424242ssp40px"
                                    },
                                    ...
                                    "lblCommentsVal": {
                                        "text": kony.sdk.isNullOrUndefined(response[i].Comments) ? "-" : response[i].Comments
                                    },
                                    "flxSep": {
                                        isVisible: true
                                    },
    ...
    ApprovalsReqModule_PresentationController.prototype.approvePendingTransactions = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.Approve(navObj.requestData, scopeObj.onApproveBBGeneralTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onApproveBBGeneralTransactionsFailure.bind(scopeObj, navObj));
    };
    /**
    ...
    ApprovalsReqModule_PresentationController.prototype.approveBBGeneralTransactions = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.approveBBGeneralTransactions(navObj.requestData, scopeObj.onApproveBBGeneralTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onApproveBBGeneralTransactionsFailure.bind(scopeObj, navObj));
    };
    /**
  ...
  *********************************************************/
    ApprovalsReqModule_PresentationController.prototype.approveACHTransactions = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.approveACHTransactions(navObj.requestData, scopeObj.onApproveACHTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onApproveACHTransactionsFailure.bind(scopeObj, navObj));
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.approveACHFiles = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.approveACHFiles(navObj.requestData, scopeObj.onApproveACHFilesSuccess.bind(scopeObj, navObj), scopeObj.onApproveACHFilesFailure.bind(scopeObj, navObj));
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.getCancellationReasons = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchBulkCancellationReason(navObj, scopeObj.onFetchCancellationReasonsSuccess.bind(scopeObj, navObj), scopeObj.onFetchCancellationReasonsFailure, );
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
            ...
            if (resCancelation.length > 0) {
                resCancelation.forEach(function(responseObj) {
                    ...
                    var rowObj = {
                        ...
                        "data": responseObj,
                        "lblName": {
                            text: kony.sdk.isNullOrUndefined(reason) ? "-" : reason
                        },
                        "imgSelection": {
                            "src": "transparent.png"
                        },
    ...
    ApprovalsReqModule_PresentationController.prototype.rejectPendingTransaction = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.Reject(navObj.requestData, scopeObj.onRejectPendingTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onRejectPendingTransactionsFailure.bind(scopeObj, navObj));
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.rejectBulkPaymentRecord = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.rejectBulkPaymentRecord(navObj.requestData, scopeObj.onRejectPendingTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onRejectPendingTransactionsFailure.bind(scopeObj, navObj));
    };
    /**
    ...
    ApprovalsReqModule_PresentationController.prototype.rejectBBGeneralTransactions = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.rejectBBGeneralTransactions(navObj.requestData, scopeObj.onRejectBBGeneralTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onRejectBBGeneralTransactionsFailure.bind(scopeObj, navObj));
    };
    /**
    ...
    ApprovalsReqModule_PresentationController.prototype.rejectACHTransaction = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.rejectACHTransactions(navObj.requestData, scopeObj.onRejectACHTransactionsSuccess.bind(scopeObj, navObj), scopeObj.onRejectACHTransactionsFailure.bind(scopeObj, navObj));
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.rejectACHFile = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.rejectACHFiles(navObj.requestData, scopeObj.onRejectACHFilesSuccess.bind(scopeObj, navObj), scopeObj.onRejectACHFilesFailure.bind(scopeObj, navObj));
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.withdrawPendingRequest = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.withdraw(navObj.requestData, scopeObj.transactionWithdrawlSuccess.bind(scopeObj, navObj), scopeObj.transactionWithdrawlFailure.bind(scopeObj, navObj), );
    };
    /**
     * withdrawTransactionRequest :  This method is used to withdraw a transaction request made by the user 
     * @member of {ApprovalsReqModule_PresentationController}
    ...
    ApprovalsReqModule_PresentationController.prototype.withdrawTransactionRequest = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.withdrawTransactionRequest(navObj.requestData, scopeObj.transactionWithdrawlSuccess.bind(scopeObj, navObj), scopeObj.transactionWithdrawlFailure.bind(scopeObj, navObj), );
    };
    /**
  ...
  ****************************************************************************88	*/
    ApprovalsReqModule_PresentationController.prototype.withdrawACHTransaction = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.withdrawACHTransactionRequest(navObj.requestData, scopeObj.achTransactionWithdrawlSuccess.bind(scopeObj, navObj), scopeObj.achTransactionWithdrawlFailure.bind(scopeObj, navObj));
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.withdrawACHFileRequests = function(navObj) {
        var scopeObj = this;
        var approvalsReqManager = applicationManager.getApprovalsReqManager();
        approvalsReqManager.withdrawACHFileRequest(navObj.requestData, scopeObj.achFileWithdrawlSuccess.bind(scopeObj, navObj), scopeObj.achFileWithdrawlFailure.bind(scopeObj, navObj));
    };
    ...
    ApprovalsReqModule_PresentationController.prototype.getApprovalsHistory = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.FetchAllMyApprovalHistory(navObj, scopeObj.onFetchApprovalsHistorySuccess, scopeObj.onFetchApprovalsHistoryFailure, );
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
    ...
    ApprovalsReqModule_PresentationController.prototype.getRequestAllHistory = function(navObj) {
        try {
            var scopeObj = this;
            var approvalsReqManager = applicationManager.getApprovalsReqManager();
            approvalsReqManager.fetchAllMyRequestHistory(navObj, scopeObj.onFetchRequestAllHistorySuccess, scopeObj.onFetchRequestAllHistoryFailure, );
        } catch (e) {
            applicationManager.getPresentationUtility().dismissLoadingScreen();
