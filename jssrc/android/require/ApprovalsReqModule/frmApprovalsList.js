define("ApprovalsReqModule/frmApprovalsList", function() {
    return function(controller) {
        function addWidgetsfrmApprovalsList() {
            ...
            flxExpandCollapseView.add(expandCollapseView, segApprovalList);
            ...
            this.add(filter, flxHeader, flxGradientBG, flxShadow, flxMainContainer, flxFooterMenu, flxRejectMenu, flxPopup, flxHamburger);
        };
        return [{
            "addWidgets": addWidgetsfrmApprovalsList,
            "enabledForIdleTimeout": true,
            "id": "frmApprovalsList",
            "init": controller.AS_Form_ea1dc06ebd0749bd8aadb21f6d20b892,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": true,
            "skin": "sknFrmffffff",
