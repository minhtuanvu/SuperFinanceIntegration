define("FeedBackModule/userfrmInAppFeedbackRatingController", ['CampaignUtility'], function(CampaignUtility) {
    return {
        preShow: function() {
        ...
        showRatingAction: function(val) {
            ...
            if (rating != this.feedbackRating) this.clearFeedbackSelection();
        ...
        SubmituserFeedback: function() {
            KNYMetricsService.sendCustomMetrics("frmInAppFeedbackRating", {
                "Submit Feedback": "Users Submited InAppFeedback"
            });
            applicationManager.getPresentationUtility().showLoadingScreen();
        ...
        animateRatings: function() {
            this.view.flexStarRating.animate(kony.ui.createAnimation({
                "100": {
                    "top": "0%",
                    "stepConfig": {
            ...
            this.view.forceLayout();
            this.view.flxTopContainer.animate(kony.ui.createAnimation({
                "100": {
                    "top": "0%",
                    "stepConfig": {
                        "timingFunction": kony.anim.EASE
...
define("FeedBackModule/frmInAppFeedbackRatingControllerActions", {
    /*
...
define("FeedBackModule/frmInAppFeedbackRatingController", ["FeedBackModule/userfrmInAppFeedbackRatingController", "FeedBackModule/frmInAppFeedbackRatingControllerActions"], function() {
    var controller = require("FeedBackModule/userfrmInAppFeedbackRatingController");
    var controllerActions = ["FeedBackModule/frmInAppFeedbackRatingControllerActions"];
