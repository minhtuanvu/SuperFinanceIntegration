define("userflxApprovalsListController", {
    ...
    "onViewCreated": function() {
        try {
            ...
            kony.print("Exception in onViewCreated" + e);
        }
    },
    animateLeft: function(rowNumber, sectionNumber) {
        try {
            ...
            kony.application.getCurrentForm().expandCollapseView.segList.animateRows({
                rows: [{
            ...
            kony.print("Exception in animateLeft" + e);
        }
    },
    animateRight: function(rowNumber, sectionNumber) {
        try {
            ...
            kony.print("Exception in animateRight" + e);
        }
    },
    ...
    btnApproveOnClick: function(eventobject, context) {
        try {
            ...
            this.executeOnParent("rejectBtnOnClick", {
                section: secIndex,
                row: rowIndex
            });
        } catch (e) {
            kony.print("Exception in btnApproveOnClick" + e);
        }
    },
...
define("flxApprovalsListControllerActions", {
    /* 
    This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("flxApprovalsListController", ["userflxApprovalsListController", "flxApprovalsListControllerActions"], function() {
    var controller = require("userflxApprovalsListController");
    var controllerActions = ["flxApprovalsListControllerActions"];
