    ...
    return function(controller) {
        function addWidgetsfrmDepositAmountCD() {
            ...
            var customHeader = new com.kmb.common.customHeader({
                ...
                "overrides": {
                    ...
                    "lblLocateUs": {
                        "text": kony.i18n.getLocalizedString("kony.mb.checkDeposit.depositAmount")
                    }
                }
            }, {
                "overrides": {}
            ...
            flxFromAccount.add(lblToAccount, lblFromAccountValue, lblBalanceValue, lblBank, lblavailableBalance, flxSeparator, btnChange, flxSeparator1, imgBankType);
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_h1074a6ee5a548b49360e672c3be2b8c(eventobject);
            },
            "skin": "sknFrmffffff",
