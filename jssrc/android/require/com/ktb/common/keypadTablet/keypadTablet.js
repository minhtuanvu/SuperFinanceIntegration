define(function() {
    return function(controller) {
        var keypadTablet = new kony.ui.FlexContainer(extendConfig({
            ...
            "preShow": function(eventobject) {
                controller.AS_FlexContainer_g9a14789945343509c09857d0d1ff89b(eventobject);
            },
            "skin": "sknFlxF5F6FBTab",
            "top": "0dp",
            "width": "100%"
        }, controller.args[0], "keypadTablet"), extendConfig({}, controller.args[1], "keypadTablet"), extendConfig({}, controller.args[2], "keypadTablet"));
        keypadTablet.setDefaultUnit(kony.flex.DP);
        ...
        keypadTablet.add(flxShadowTwo, flxKeypad, flxVerticalSeparatorOne, flxVerticalSeparatorTwo);
        return keypadTablet;
    }
})