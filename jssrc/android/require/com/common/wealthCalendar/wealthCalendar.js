define(function() {
    return function(controller) {
        var wealthCalendar = new kony.ui.FlexContainer(extendConfig({
            ...
            "preShow": function(eventobject) {
                controller.AS_FlexContainer_f2be88c5f6ae499fb715a504e6f0df00(eventobject);
            },
            "skin": "f9f9",
            "top": "0dp",
            "width": "100%"
        }, controller.args[0], "wealthCalendar"), extendConfig({}, controller.args[1], "wealthCalendar"), extendConfig({}, controller.args[2], "wealthCalendar"));
        wealthCalendar.setDefaultUnit(kony.flex.DP);
        ...
        wealthCalendar.add(flxHeader, flxWeek, flxMonth, flxMonthDummy, flxHighlight);
        return wealthCalendar;
    }
})