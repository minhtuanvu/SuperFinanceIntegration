define(function() {
    return function(controller) {
        var customCalendarWithContract = new kony.ui.FlexContainer(extendConfig({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "isMaster": true,
            "height": "280dp",
            "id": "customCalendarWithContract",
            "isVisible": true,
            ...
            "top": "0dp",
            "width": "100%"
        }, controller.args[0], "customCalendarWithContract"), extendConfig({}, controller.args[1], "customCalendarWithContract"), extendConfig({}, controller.args[2], "customCalendarWithContract"));
        customCalendarWithContract.setDefaultUnit(kony.flex.DP);
        ...
        customCalendarWithContract.add(flxHeader, flxWeek, flxMonth, flxMonthDummy, flxHighlight);
        return customCalendarWithContract;
    }
})