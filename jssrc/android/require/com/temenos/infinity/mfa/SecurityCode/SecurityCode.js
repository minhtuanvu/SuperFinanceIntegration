define(function() {
    return function(controller) {
        var SecurityCode = new kony.ui.FlexContainer(extendConfig({
            ...
            "top": "0dp",
            "width": "100%"
        }, controller.args[0], "SecurityCode"), extendConfig({}, controller.args[1], "SecurityCode"), extendConfig({}, controller.args[2], "SecurityCode"));
        SecurityCode.setDefaultUnit(kony.flex.DP);
        ...
        var rtxNewDevice = new kony.ui.RichText(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "rtxNewDevice"), extendConfig({}, controller.args[2], "rtxNewDevice"));
        ...
        var btnSend = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSend"), extendConfig({}, controller.args[2], "btnSend"));
        ...
        var btnReSend = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnReSend"), extendConfig({}, controller.args[2], "btnReSend"));
        ...
        flxMainContent.add(flxSecurityCode, lblEnterInfoSubtitle, flxDetails, lblError, flxCode, btnReSend, flxInputSecurityCode, flxResendTimer, flxBottomContainer);
        ...
        var btnVerify = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnVerify"), extendConfig({}, controller.args[2], "btnVerify"));
        ...
        flxSecurityCodeScreen.add(flxHeader, flxMainContainer, flxKeypad);
        SecurityCode.add(flxMFAOption3Screen, flxSecurityCodeScreen);
        return SecurityCode;
    }
})