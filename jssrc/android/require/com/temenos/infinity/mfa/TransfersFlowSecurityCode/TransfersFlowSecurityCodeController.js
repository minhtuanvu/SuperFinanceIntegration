define("com/temenos/infinity/mfa/TransfersFlowSecurityCode/userTransfersFlowSecurityCodeController", ['./TransferFlowSecurityCodeDAO'], function(TransferFlowSecurityCodeDAO) {
    return {
        constructor: function(baseConfig, layoutConfig, pspConfig) {
            ...
            this.TransferFlowSecurityCodeDAO = new TransferFlowSecurityCodeDAO();
        ...
        initGettersSetters: function() {
            ...
            defineSetter(this, "screen2HeaderText", function(val) {
                if ((typeof val === 'string') && (val !== "")) {
                    this._screen2HeaderText = val;
                }
            });
            defineGetter(this, "screen2HeaderText", function() {
                return this._screen2HeaderText;
            });
        },
        ...
        initMFAFlow: function(mfaJSON) {
            this.setMFAResponse(mfaJSON);
            this.setMFAFlowType(mfaJSON.flowType);
            this.setServiceId(mfaJSON.serviceName);
            this.setServicekey(mfaJSON.MFAAttributes.serviceKey);
            this.setMFAType(mfaJSON.MFAAttributes.MFAType);
            // this.setUserName(mfaJSON.userName);
            this.setCommunicationType(mfaJSON.MFAAttributes.communicationType);
            this.setDefaultSettings();
        ...
        requestOTPUtility: function(params) {
            this.TransferFlowSecurityCodeDAO.requestLoginMFAOtp(this._objectServiceName1, this._objectName1, this._operationName1, params, this.requestOTPSuccess.bind(this), this.requestOTPFailure.bind(this));
        },
        ...
        setCustomerCommunicationInfo: function(customerCommunicationInfo) {
            if (customerCommunicationInfo.phone && customerCommunicationInfo.email) {
                this.view.lblSecurityCode.text = "Select registered phone and email to receive secure access code.";
                ...
                this.view.lblSecurityCode.text = "Select registered phone to get a  Secure Access Code";
                this.view.flxModeOfContactPhone.setVisibility(true);
                this.view.flxModeOfContactEmail.setVisibility(false);
                this.view.lbxRegisteredModePhone.masterData = this.setDataForPhoneListBox(customerCommunicationInfo.phone);
                this.view.lbxRegisteredModePhone.selectedKey = this.view.lbxRegisteredModePhone.masterData[0][0];
            } else if (customerCommunicationInfo.email) {
                this.view.lblSecurityCode.text = "Select registered email to get a Secure Access Code";
        ...
        mfaDeviceBack: function() {
            ...
            if (this.view.flxSecurityCodeScreen.isVisible === true && this.view.flxSecurityCodeScreen !== undefined) {
                this.view.flxMFAOption3Screen.setVisibility(true);
                this.view.flxSecurityCodeScreen.setVisibility(false);
            }
        },
        ...
        setFlowActionsSecurityCodeScreen: function() {
            ...
            this.view.btnSecurityCodeCancel.onClick = this.onCancelClick;
            this.view.flxSecurityCodeBack.onTouchEnd = this.onBackClick;
        ...
        setFormUI: function(mfaResponse) {
            ...
            this.view.lblSecurityCodeHeader.text = this._screen2HeaderText;
            this.view.lblSecurityCodeHeader.setVisibility(true);
            this.view.flxSecurityCodeBack.setVisibility(false);
            this.view.btnVerify.skin = this._screen2SubmitBtnDisabledSkin;
            this.view.flxResendTimer.setVisibility(false);
            if (mfaResponse.MFAAttributes.isOTPExpired) {
                this.view.lblError.text = "Your OTP has expired";
        ...
        verifyOTP: function(data) {
            ...
            data.Action = this.MFAResponse.action;
            this.verifyOTPUtility(data);
        },
        verifyOTPUtility: function(params) {
            this.TransferFlowSecurityCodeDAO.verifyLoginMFAOtp(this._objectServiceName2, this._objectName2, this._operationName2, params, this.verifyOTPSuccess.bind(this), this.verifyOTPFailure.bind(this));
        },
        ...
        showIncorrectOTPError: function(response) {
            if (response.MFAAttributes && response.MFAAttributes.remainingFailedAttempts && response.MFAAttributes.remainingFailedAttempts > 0) {
                this.view.lblError.text = "Invalid access code." + " " + "You have only" + " " + response.MFAAttributes.remainingFailedAttempts + " " + " more attempt(s) left.";
                this.view.lblError.setVisibility(true);
                this.clearKeypad();
                //this.onRequestEnd();
            } else if (response.MFAAttributes && response.MFAAttributes.remainingFailedAttempts === "0" && response.MFAAttributes.lockUser === "true") {
                let msg = "Authentication failed. Your profile is locked for " + response.MFAAttributes.lockoutTime + "minutes(s)";
...
define("com/temenos/infinity/mfa/TransfersFlowSecurityCode/TransfersFlowSecurityCodeControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_dcb6bf221d7a4ea298892e276b1e8770: function AS_FlexContainer_dcb6bf221d7a4ea298892e276b1e8770(eventobject) {
        var self = this;
        return self.preShow.call(this);
    }
});
define("com/temenos/infinity/mfa/TransfersFlowSecurityCode/TransfersFlowSecurityCodeController", ["com/temenos/infinity/mfa/TransfersFlowSecurityCode/userTransfersFlowSecurityCodeController", "com/temenos/infinity/mfa/TransfersFlowSecurityCode/TransfersFlowSecurityCodeControllerActions"], function() {
    var controller = require("com/temenos/infinity/mfa/TransfersFlowSecurityCode/userTransfersFlowSecurityCodeController");
    var actions = require("com/temenos/infinity/mfa/TransfersFlowSecurityCode/TransfersFlowSecurityCodeControllerActions");
