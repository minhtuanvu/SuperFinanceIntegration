define(function() {
    return function(controller) {
        ...
        var btnSecurityQuestionCancel = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSecurityQuestionCancel"), extendConfig({}, controller.args[2], "btnSecurityQuestionCancel"));
        ...
        var segSecurityQuestions = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segSecurityQuestions"), extendConfig({}, controller.args[2], "segSecurityQuestions"));
