define("com/temenos/infinity/segmentDetailsWealth/usersegmentDetailsWealthController", ['./ParserUtilsManager', './FormatUtils', './WealthDetailsListDAO'], function(ParserUtilsManager, FormatUtils, WealthDetailsListDAO) {
    return {
...
define("com/temenos/infinity/segmentDetailsWealth/segmentDetailsWealthControllerActions", {
    /*
...
define("com/temenos/infinity/segmentDetailsWealth/segmentDetailsWealthController", ["com/temenos/infinity/segmentDetailsWealth/usersegmentDetailsWealthController", "com/temenos/infinity/segmentDetailsWealth/segmentDetailsWealthControllerActions"], function() {
    var controller = require("com/temenos/infinity/segmentDetailsWealth/usersegmentDetailsWealthController");
    var actions = require("com/temenos/infinity/segmentDetailsWealth/segmentDetailsWealthControllerActions");
    ...
    controller.AS_preShow_fdde45de24a04b9aab1ddac29d88537e = function() {
        if (this.preShow) {
            this.preShow.apply(this, arguments);
        } else if (this.AS_FlexContainer_b0eda21152804e1f940ffaf86b59386d) {
            this.AS_FlexContainer_b0eda21152804e1f940ffaf86b59386d.apply(this, arguments);
        }
    }
    return controller;
});
