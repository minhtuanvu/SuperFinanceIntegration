define("com/temenos/infinity/autoDataFill/userautoDataFillController", ['./countryCodeControllerIC', './AddPayeeDAO', './AddPayeeUtility'], function(countryCodeControllerIC, AddPayeeDAO, AddPayeeUtility) {
    return {
                ...
                for (var i = 0; i < tempCountryList.countryCodeList.countries.length; i++) {
                    if (!this.isEmptyNullUndefined(searchString)) {
                        if (tempCountryList.countryCodeList.countries[i].name.includes(searchString) || tempCountryList.countryCodeList.countries[i].code.includes(searchString)) {
                            recordCountryCode = {
                                "lblCountryCode": this.countryCodeControllerIC.countryCodeList.countries[i].name + " (" + this.countryCodeControllerIC.countryCodeList.countries[i].code + ")",
                                code: this.countryCodeControllerIC.countryCodeList.countries[i].code
                            };
        ...
        setDataList: function() {
            ...
            for (var i = 0; i < this.countryCodeControllerIC.CountryCode.length; i++) {
                recordCountryCodeNo = {
                    "lblCountryCodeNo": this.countryCodeControllerIC.CountryCode[i]
                };
        ...
        setScrolling: function() {
            try {
                ...
                if (selectedCodeNo !== null) {
                    ...
                    this.view.flx3.setContentOffset({
                        x: 0,
                        y: contentOffsetY
                    });
                }
...
define("com/temenos/infinity/autoDataFill/autoDataFillControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_b7b1d950d3d34207959f8e4d8053424a: function AS_FlexContainer_b7b1d950d3d34207959f8e4d8053424a(eventobject) {
        var self = this;
        return self.preShow.call(this);
    }
});
define("com/temenos/infinity/autoDataFill/autoDataFillController", ["com/temenos/infinity/autoDataFill/userautoDataFillController", "com/temenos/infinity/autoDataFill/autoDataFillControllerActions"], function() {
    var controller = require("com/temenos/infinity/autoDataFill/userautoDataFillController");
    var actions = require("com/temenos/infinity/autoDataFill/autoDataFillControllerActions");
