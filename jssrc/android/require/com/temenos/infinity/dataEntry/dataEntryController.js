define("com/temenos/infinity/dataEntry/userdataEntryController", ['InfinityComponents/DataValidationFramework/DataValidationHandler', './AddPayeeDAO', './ParserUtilsManager'], function(DataValidationHandler, AddPayeeDAO, ParserUtilsManager) {
    return {
        ...
        initActions: function() {
            ...
            this.view.tbxInputWord.onTextChange = this.minFillValidation.bind(this, "tbxInputWord");
        ...
        setDynamicFieldBasedOnCategory: function(categoryId) {
            ...
            if (dynamicLabel) {
                dynamicLabel = dynamicLabel.filter((function(record) {
                    if (record["category"]) {
                        ...
                        if (categories.includes(categoryId)) return true;
                        return false;
                    }
                }));
            }
            ...
            if (dynamicValue.length > 0) {
                ...
                if (inputModeValue === "Numeric" && isMaskingEnabled === true) {
                    inputModeValue = constants.TEXTBOX_INPUT_MODE_NUMERIC;
                    this.view.tbxInputWord.restrictCharactersSet = "abcdefghijklmnopqrstuvwxyzABCDEFGHIJKLMNOPQRSTUVWXYZ~!@#$%^&*()_-\\?/+={[]}:;,.<>'`|\"";
                } else if (inputModeValue === "Numeric" && isMaskingEnabled === false) {
                    inputModeValue = constants.TEXTBOX_INPUT_MODE_NUMERIC
                } else {
                    inputModeValue = constants.TEXTBOX_INPUT_MODE_ANY;
        ...
        customServiceCall: function() {
            ...
            this.addPayeeDAO.customPayee(objSvcName, objName, operationName, criteria, this.onSuccessCustomService, identifier, self.customServiceError);
        },
...
define("com/temenos/infinity/dataEntry/dataEntryControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_c41d8b21cf794c9699bad0efb5bedd8e: function AS_FlexContainer_c41d8b21cf794c9699bad0efb5bedd8e(eventobject) {
        var self = this;
        return self.preShow.call(this);
    },
});
define("com/temenos/infinity/dataEntry/dataEntryController", ["com/temenos/infinity/dataEntry/userdataEntryController", "com/temenos/infinity/dataEntry/dataEntryControllerActions"], function() {
    var controller = require("com/temenos/infinity/dataEntry/userdataEntryController");
    var actions = require("com/temenos/infinity/dataEntry/dataEntryControllerActions");
