define(function() {
    return function(controller) {
        var SearchAndFilterWealth = new kony.ui.FlexContainer(extendConfig({
            ...
            "preShow": function(eventobject) {
                controller.AS_FlexContainer_jb37f4617984420984dee552f7db3a63(eventobject);
            },
            "skin": "slFbox",
            "top": "0dp",
            "width": "100%"
        }, controller.args[0], "SearchAndFilterWealth"), extendConfig({}, controller.args[1], "SearchAndFilterWealth"), extendConfig({}, controller.args[2], "SearchAndFilterWealth"));
        SearchAndFilterWealth.setDefaultUnit(kony.flex.DP);
        ...
        var txtSearchBox = new kony.ui.TextBox2(extendConfig({
            ...
            "left": "10.95%",
            "onDone": controller.AS_TextField_fb837041634445eeb9f5eb83a38b01b5,
            "onTextChange": controller.AS_TextField_c29876b94f274b029b09f487374bc2fc,
        ...
        var flxCollapseFilter = new kony.ui.FlexContainer(extendConfig({
            ...
            "left": "80%",
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_ca4974ef932b4aaaac42e6e5f41236e4,
            "skin": "slFbox",
            "top": "0dp",
            "width": "20%",
            "zIndex": 1
        ...
        var sgmtFilterOptions = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "sgmtFilterOptions"), extendConfig({}, controller.args[2], "sgmtFilterOptions"));
        ...
        SearchAndFilterWealth.add(flxSearchAndFilter, flxFilteredListHeader, flxFiltersList);
        return SearchAndFilterWealth;
    }
})