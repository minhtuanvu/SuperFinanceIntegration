define(function() {
    return function(controller) {
        ...
        var btnTouchId = new kony.ui.Button(extendConfig({
            ...
            "padding": [1, 0, 1, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnTouchId"), extendConfig({}, controller.args[2], "btnTouchId"));
        var btnFaceId = new kony.ui.Button(extendConfig({
            ...
            "padding": [1, 0, 1, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnFaceId"), extendConfig({}, controller.args[2], "btnFaceId"));
        var btnPinId = new kony.ui.Button(extendConfig({
            ...
            "padding": [1, 0, 1, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnPinId"), extendConfig({}, controller.args[2], "btnPinId"));
