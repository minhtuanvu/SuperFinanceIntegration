define("com/temenos/infinity/payeeVerifyAck/userpayeeVerifyAckController", ['./AddPayeeDAO', 'InfinityComponents/DataValidationFramework/DataValidationHandler'], function(AddPayeeDAO, DataValidationHandler) {
    return {
        ...
        confirmBtnRight1OnClick: function() {
            ...
            //   }
            if (typeof(this.ParserUtilsManager.context['cif']) !== "string") criteria['cif'] = JSON.stringify(this.ParserUtilsManager.context['cif']);
            var identifier = this.getValue(this._payeeCREATEIdentifier);
            this.addPayeeDAO.createPayee(objSvcName, objName, operationName, criteria, this.onSuccessCreatePayee, identifier, self.onError);
        },
...
define("com/temenos/infinity/payeeVerifyAck/payeeVerifyAckControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_h73be2b52f874c43815714538cb3d001: function AS_FlexContainer_h73be2b52f874c43815714538cb3d001(eventobject) {
        var self = this;
        return self.postShow.call(this);
    },
    AS_FlexContainer_fb1508d3c7734caf814fd4ef95872628: function AS_FlexContainer_fb1508d3c7734caf814fd4ef95872628(eventobject) {
        var self = this;
        return self.preShow.call(this);
    }
});
define("com/temenos/infinity/payeeVerifyAck/payeeVerifyAckController", ["com/temenos/infinity/payeeVerifyAck/userpayeeVerifyAckController", "com/temenos/infinity/payeeVerifyAck/payeeVerifyAckControllerActions"], function() {
    var controller = require("com/temenos/infinity/payeeVerifyAck/userpayeeVerifyAckController");
    var actions = require("com/temenos/infinity/payeeVerifyAck/payeeVerifyAckControllerActions");
