define(function() {
    return function(controller) {
        ...
        var segNotifications = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segNotifications"), extendConfig({}, controller.args[2], "segNotifications"));
        ...
        var btnCheckNewNotification = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnCheckNewNotification"), extendConfig({}, controller.args[2], "btnCheckNewNotification"));
