define(function() {
    return function(controller) {
        ...
        var rtxRulesPin = new kony.ui.RichText(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "rtxRulesPin"), extendConfig({}, controller.args[2], "rtxRulesPin"));
        ...
        var btnSetPin = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSetPin"), extendConfig({}, controller.args[2], "btnSetPin"));
        ...
        var btnSignIn = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSignIn"), extendConfig({}, controller.args[2], "btnSignIn"));
