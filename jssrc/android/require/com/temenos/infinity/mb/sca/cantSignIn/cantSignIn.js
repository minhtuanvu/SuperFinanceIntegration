define(function() {
    return function(controller) {
        ...
        var segUsersList = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segUsersList"), extendConfig({}, controller.args[2], "segUsersList"));
        ...
        var btnActivateProfile = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnActivateProfile"), extendConfig({}, controller.args[2], "btnActivateProfile"));
