define(function() {
    return function(controller) {
        ...
        var segRegisteredDevices = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segRegisteredDevices"), extendConfig({}, controller.args[2], "segRegisteredDevices"));
        ...
        var btnRegisterNewDevice = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnRegisterNewDevice"), extendConfig({}, controller.args[2], "btnRegisterNewDevice"));
        ...
        var btnDecisionNo = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnDecisionNo"), extendConfig({}, controller.args[2], "btnDecisionNo"));
        ...
        var btnDecisionYes = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnDecisionYes"), extendConfig({}, controller.args[2], "btnDecisionYes"));
        ...
        var btnSuspendDevice = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSuspendDevice"), extendConfig({}, controller.args[2], "btnSuspendDevice"));
        var btnUnsuspendDevice = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnUnsuspendDevice"), extendConfig({}, controller.args[2], "btnUnsuspendDevice"));
        ...
        var btnRemoveDevice = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnRemoveDevice"), extendConfig({}, controller.args[2], "btnRemoveDevice"));
