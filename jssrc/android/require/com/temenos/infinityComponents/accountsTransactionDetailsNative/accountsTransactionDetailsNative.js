define(function() {
    return function(controller) {
        ...
        var btnViewAttachments = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnViewAttachments"), extendConfig({}, controller.args[2], "btnViewAttachments"));
        ...
        var segCheckImages = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segCheckImages"), extendConfig({}, controller.args[2], "segCheckImages"));
        var flxButtons = new kony.ui.FlexContainer(extendConfig({
            ...
            "left": "0dp",
            "isModalContainer": false,
            "skin": "CopyslFbox0jc01506ef7064a",
            "top": "0dp",
            "width": "100%",
            "zIndex": 1
        ...
        var btnContextualAction1 = new kony.ui.Button(extendConfig({
            "focusSkin": "CopyICSknBtn0f92738462b374d",
            "height": "48dp",
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnContextualAction1"), extendConfig({}, controller.args[2], "btnContextualAction1"));
        var btnContextualAction2 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnContextualAction2"), extendConfig({}, controller.args[2], "btnContextualAction2"));
        var btnContextualAction3 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnContextualAction3"), extendConfig({}, controller.args[2], "btnContextualAction3"));
        var btnContextualAction4 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnContextualAction4"), extendConfig({}, controller.args[2], "btnContextualAction4"));
        var btnContextualAction5 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnContextualAction5"), extendConfig({}, controller.args[2], "btnContextualAction5"));
