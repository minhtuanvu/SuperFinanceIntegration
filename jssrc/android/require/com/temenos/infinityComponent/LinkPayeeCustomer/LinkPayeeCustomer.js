define(function() {
    return function(controller) {
        ...
        var btnSelectAllContract = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSelectAllContract"), extendConfig({}, controller.args[2], "btnSelectAllContract"));
        var btnDeselectAllContract = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnDeselectAllContract"), extendConfig({}, controller.args[2], "btnDeselectAllContract"));
        ...
        var btnSelectAllCustomer = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSelectAllCustomer"), extendConfig({}, controller.args[2], "btnSelectAllCustomer"));
        var btnDeselectAllCustomer = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnDeselectAllCustomer"), extendConfig({}, controller.args[2], "btnDeselectAllCustomer"));
        ...
        var segLinkPayeeContract = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segLinkPayeeContract"), extendConfig({}, controller.args[2], "segLinkPayeeContract"));
        var segLinkPayeeCustomers = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segLinkPayeeCustomers"), extendConfig({}, controller.args[2], "segLinkPayeeCustomers"));
