...
define([], function() {
    ...
    function DirectMarketing(defaultValues) {
        ...
        context["field"] = "adType";
        context["metadata"] = (objectMetadata ? objectMetadata["adType"] : null);
        privateState.adType = defaultValues ? (defaultValues["adType"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["adType"], context) : null) : null;
        context["field"] = "buttonType";
        context["metadata"] = (objectMetadata ? objectMetadata["buttonType"] : null);
        privateState.buttonType = defaultValues ? (defaultValues["buttonType"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["buttonType"], context) : null) : null;
        context["field"] = "colour";
        context["metadata"] = (objectMetadata ? objectMetadata["colour"] : null);
        privateState.colour = defaultValues ? (defaultValues["colour"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["colour"], context) : null) : null;
        context["field"] = "description";
        context["metadata"] = (objectMetadata ? objectMetadata["description"] : null);
        ...
        context["field"] = "model";
        context["metadata"] = (objectMetadata ? objectMetadata["model"] : null);
        privateState.model = defaultValues ? (defaultValues["model"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["model"], context) : null) : null;
        context["field"] = "navigationId";
        context["metadata"] = (objectMetadata ? objectMetadata["navigationId"] : null);
        privateState.navigationId = defaultValues ? (defaultValues["navigationId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["navigationId"], context) : null) : null;
        context["field"] = "navigationType";
        context["metadata"] = (objectMetadata ? objectMetadata["navigationType"] : null);
        privateState.navigationType = defaultValues ? (defaultValues["navigationType"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["navigationType"], context) : null) : null;
        context["field"] = "navigationURL";
        context["metadata"] = (objectMetadata ? objectMetadata["navigationURL"] : null);
        privateState.navigationURL = defaultValues ? (defaultValues["navigationURL"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["navigationURL"], context) : null) : null;
        context["field"] = "result";
        context["metadata"] = (objectMetadata ? objectMetadata["result"] : null);
        ...
        context["field"] = "sessionId";
        context["metadata"] = (objectMetadata ? objectMetadata["sessionId"] : null);
        privateState.sessionId = defaultValues ? (defaultValues["sessionId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["sessionId"], context) : null) : null;
        context["field"] = "text";
        context["metadata"] = (objectMetadata ? objectMetadata["text"] : null);
        privateState.text = defaultValues ? (defaultValues["text"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["text"], context) : null) : null;
        context["field"] = "visible";
        context["metadata"] = (objectMetadata ? objectMetadata["visible"] : null);
        privateState.visible = defaultValues ? (defaultValues["visible"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["visible"], context) : null) : null;
        context["field"] = "flowposition";
        context["metadata"] = (objectMetadata ? objectMetadata["flowposition"] : null);
        privateState.flowposition = defaultValues ? (defaultValues["flowposition"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["flowposition"], context) : null) : null;
        context["field"] = "navId";
        context["metadata"] = (objectMetadata ? objectMetadata["navId"] : null);
        privateState.navId = defaultValues ? (defaultValues["navId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["navId"], context) : null) : null;
