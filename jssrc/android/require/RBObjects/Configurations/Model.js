...
define([], function() {
    ...
    function Configurations(defaultValues) {
        ...
        context["field"] = "key";
        context["metadata"] = (objectMetadata ? objectMetadata["key"] : null);
        privateState.key = defaultValues ? (defaultValues["key"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["key"], context) : null) : null;
        context["field"] = "value";
        context["metadata"] = (objectMetadata ? objectMetadata["value"] : null);
        ...
        context["field"] = "configuration_id";
        context["metadata"] = (objectMetadata ? objectMetadata["configuration_id"] : null);
        privateState.configuration_id = defaultValues ? (defaultValues["configuration_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["configuration_id"], context) : null) : null;
