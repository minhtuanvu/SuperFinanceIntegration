...
define([], function() {
    ...
    function InterestRates(defaultValues) {
        ...
        context["field"] = "APY";
        context["metadata"] = (objectMetadata ? objectMetadata["APY"] : null);
        privateState.APY = defaultValues ? (defaultValues["APY"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["APY"], context) : null) : null;
        context["field"] = "CDTerm";
        context["metadata"] = (objectMetadata ? objectMetadata["CDTerm"] : null);
        privateState.CDTerm = defaultValues ? (defaultValues["CDTerm"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["CDTerm"], context) : null) : null;
        context["field"] = "errmsg";
        context["metadata"] = (objectMetadata ? objectMetadata["errmsg"] : null);
        ...
        context["field"] = "minimumDeposit";
        context["metadata"] = (objectMetadata ? objectMetadata["minimumDeposit"] : null);
        privateState.minimumDeposit = defaultValues ? (defaultValues["minimumDeposit"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["minimumDeposit"], context) : null) : null;
