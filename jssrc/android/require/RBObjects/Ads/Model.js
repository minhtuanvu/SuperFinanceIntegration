...
define([], function() {
    ...
    function Ads(defaultValues) {
        ...
        context["field"] = "action1";
        context["metadata"] = (objectMetadata ? objectMetadata["action1"] : null);
        privateState.action1 = defaultValues ? (defaultValues["action1"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["action1"], context) : null) : null;
        context["field"] = "action2";
        context["metadata"] = (objectMetadata ? objectMetadata["action2"] : null);
        privateState.action2 = defaultValues ? (defaultValues["action2"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["action2"], context) : null) : null;
        context["field"] = "actionType";
        context["metadata"] = (objectMetadata ? objectMetadata["actionType"] : null);
