...
define([], function() {
    ...
    function p2pregistration(defaultValues) {
        ...
        context["field"] = "isNpp";
        context["metadata"] = (objectMetadata ? objectMetadata["isNpp"] : null);
        privateState.isNpp = defaultValues ? (defaultValues["isNpp"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isNpp"], context) : null) : null;
        context["field"] = "isP2PRegistered";
        context["metadata"] = (objectMetadata ? objectMetadata["isP2PRegistered"] : null);
        privateState.isP2PRegistered = defaultValues ? (defaultValues["isP2PRegistered"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isP2PRegistered"], context) : null) : null;
        context["field"] = "isZell";
        context["metadata"] = (objectMetadata ? objectMetadata["isZell"] : null);
        privateState.isZell = defaultValues ? (defaultValues["isZell"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isZell"], context) : null) : null;
        context["field"] = "p2pRegId";
        context["metadata"] = (objectMetadata ? objectMetadata["p2pRegId"] : null);
        privateState.p2pRegId = defaultValues ? (defaultValues["p2pRegId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["p2pRegId"], context) : null) : null;
        context["field"] = "phone";
        context["metadata"] = (objectMetadata ? objectMetadata["phone"] : null);
