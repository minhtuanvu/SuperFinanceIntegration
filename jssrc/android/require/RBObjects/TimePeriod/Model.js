...
define([], function() {
    ...
    function TimePeriod(defaultValues) {
        ...
        context["field"] = "timePeriodId";
        context["metadata"] = (objectMetadata ? objectMetadata["timePeriodId"] : null);
        privateState.timePeriodId = defaultValues ? (defaultValues["timePeriodId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["timePeriodId"], context) : null) : null;
