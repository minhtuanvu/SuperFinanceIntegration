...
define([], function() {
    ...
    function DigitalProfile(defaultValues) {
        ...
        context["field"] = "CreditScore";
        context["metadata"] = (objectMetadata ? objectMetadata["CreditScore"] : null);
        privateState.CreditScore = defaultValues ? (defaultValues["CreditScore"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["CreditScore"], context) : null) : null;
        context["field"] = "NumberOfInquiries_6M";
        context["metadata"] = (objectMetadata ? objectMetadata["NumberOfInquiries_6M"] : null);
        privateState.NumberOfInquiries_6M = defaultValues ? (defaultValues["NumberOfInquiries_6M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["NumberOfInquiries_6M"], context) : null) : null;
        context["field"] = "NumberOfInquiries_12M";
        context["metadata"] = (objectMetadata ? objectMetadata["NumberOfInquiries_12M"] : null);
        privateState.NumberOfInquiries_12M = defaultValues ? (defaultValues["NumberOfInquiries_12M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["NumberOfInquiries_12M"], context) : null) : null;
        context["field"] = "NumberOfInquiries_24M";
        context["metadata"] = (objectMetadata ? objectMetadata["NumberOfInquiries_24M"] : null);
        privateState.NumberOfInquiries_24M = defaultValues ? (defaultValues["NumberOfInquiries_24M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["NumberOfInquiries_24M"], context) : null) : null;
        context["field"] = "TotalRevolvingOpenToBuyBalance";
        context["metadata"] = (objectMetadata ? objectMetadata["TotalRevolvingOpenToBuyBalance"] : null);
        privateState.TotalRevolvingOpenToBuyBalance = defaultValues ? (defaultValues["TotalRevolvingOpenToBuyBalance"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TotalRevolvingOpenToBuyBalance"], context) : null) : null;
        context["field"] = "UtilizationPercentOfRevolvingTrades";
        context["metadata"] = (objectMetadata ? objectMetadata["UtilizationPercentOfRevolvingTrades"] : null);
        privateState.UtilizationPercentOfRevolvingTrades = defaultValues ? (defaultValues["UtilizationPercentOfRevolvingTrades"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["UtilizationPercentOfRevolvingTrades"], context) : null) : null;
        context["field"] = "SinceRecentDelinquency_M";
        context["metadata"] = (objectMetadata ? objectMetadata["SinceRecentDelinquency_M"] : null);
        privateState.SinceRecentDelinquency_M = defaultValues ? (defaultValues["SinceRecentDelinquency_M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["SinceRecentDelinquency_M"], context) : null) : null;
        context["field"] = "TotalNumberOfDerogatory";
        context["metadata"] = (objectMetadata ? objectMetadata["TotalNumberOfDerogatory"] : null);
        privateState.TotalNumberOfDerogatory = defaultValues ? (defaultValues["TotalNumberOfDerogatory"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TotalNumberOfDerogatory"], context) : null) : null;
        context["field"] = "SinceRecentlyFiledCollection_M";
        context["metadata"] = (objectMetadata ? objectMetadata["SinceRecentlyFiledCollection_M"] : null);
        privateState.SinceRecentlyFiledCollection_M = defaultValues ? (defaultValues["SinceRecentlyFiledCollection_M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["SinceRecentlyFiledCollection_M"], context) : null) : null;
        context["field"] = "TotalNumberOfTrades";
        context["metadata"] = (objectMetadata ? objectMetadata["TotalNumberOfTrades"] : null);
        privateState.TotalNumberOfTrades = defaultValues ? (defaultValues["TotalNumberOfTrades"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TotalNumberOfTrades"], context) : null) : null;
        context["field"] = "TotalNumberOfActiveTrades";
        context["metadata"] = (objectMetadata ? objectMetadata["TotalNumberOfActiveTrades"] : null);
        privateState.TotalNumberOfActiveTrades = defaultValues ? (defaultValues["TotalNumberOfActiveTrades"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TotalNumberOfActiveTrades"], context) : null) : null;
        context["field"] = "NumberOfTradesOpened_24M";
        context["metadata"] = (objectMetadata ? objectMetadata["NumberOfTradesOpened_24M"] : null);
        privateState.NumberOfTradesOpened_24M = defaultValues ? (defaultValues["NumberOfTradesOpened_24M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["NumberOfTradesOpened_24M"], context) : null) : null;
        context["field"] = "NumberOfTradeswithUtilization";
        context["metadata"] = (objectMetadata ? objectMetadata["NumberOfTradeswithUtilization"] : null);
        privateState.NumberOfTradeswithUtilization = defaultValues ? (defaultValues["NumberOfTradeswithUtilization"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["NumberOfTradeswithUtilization"], context) : null) : null;
        context["field"] = "OldestOpenPersonalFinanceTrade_M";
        context["metadata"] = (objectMetadata ? objectMetadata["OldestOpenPersonalFinanceTrade_M"] : null);
        privateState.OldestOpenPersonalFinanceTrade_M = defaultValues ? (defaultValues["OldestOpenPersonalFinanceTrade_M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["OldestOpenPersonalFinanceTrade_M"], context) : null) : null;
        context["field"] = "LoanToIncomeRatio";
        context["metadata"] = (objectMetadata ? objectMetadata["LoanToIncomeRatio"] : null);
        privateState.LoanToIncomeRatio = defaultValues ? (defaultValues["LoanToIncomeRatio"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["LoanToIncomeRatio"], context) : null) : null;
        context["field"] = "NumberOfLoanAapplications_24M";
        context["metadata"] = (objectMetadata ? objectMetadata["NumberOfLoanAapplications_24M"] : null);
        privateState.NumberOfLoanAapplications_24M = defaultValues ? (defaultValues["NumberOfLoanAapplications_24M"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["NumberOfLoanAapplications_24M"], context) : null) : null;
        context["field"] = "DebtToIncomeRatio";
        context["metadata"] = (objectMetadata ? objectMetadata["DebtToIncomeRatio"] : null);
        privateState.DebtToIncomeRatio = defaultValues ? (defaultValues["DebtToIncomeRatio"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["DebtToIncomeRatio"], context) : null) : null;
        context["field"] = "PrequalifyScore";
        context["metadata"] = (objectMetadata ? objectMetadata["PrequalifyScore"] : null);
        privateState.PrequalifyScore = defaultValues ? (defaultValues["PrequalifyScore"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["PrequalifyScore"], context) : null) : null;
        context["field"] = "YearsOfMembership";
        context["metadata"] = (objectMetadata ? objectMetadata["YearsOfMembership"] : null);
        privateState.YearsOfMembership = defaultValues ? (defaultValues["YearsOfMembership"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["YearsOfMembership"], context) : null) : null;
        context["field"] = "AccountsBalance";
        context["metadata"] = (objectMetadata ? objectMetadata["AccountsBalance"] : null);
        privateState.AccountsBalance = defaultValues ? (defaultValues["AccountsBalance"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["AccountsBalance"], context) : null) : null;
        context["field"] = "Age";
        context["metadata"] = (objectMetadata ? objectMetadata["Age"] : null);
        privateState.Age = defaultValues ? (defaultValues["Age"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Age"], context) : null) : null;
        context["field"] = "City";
        context["metadata"] = (objectMetadata ? objectMetadata["City"] : null);
        ...
        context["field"] = "HomeOwnership";
        context["metadata"] = (objectMetadata ? objectMetadata["HomeOwnership"] : null);
        privateState.HomeOwnership = defaultValues ? (defaultValues["HomeOwnership"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["HomeOwnership"], context) : null) : null;
        context["field"] = "GrossMonthlyIncome";
        context["metadata"] = (objectMetadata ? objectMetadata["GrossMonthlyIncome"] : null);
        privateState.GrossMonthlyIncome = defaultValues ? (defaultValues["GrossMonthlyIncome"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["GrossMonthlyIncome"], context) : null) : null;
        context["field"] = "AnnualIncome";
        context["metadata"] = (objectMetadata ? objectMetadata["AnnualIncome"] : null);
