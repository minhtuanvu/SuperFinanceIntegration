...
define([], function() {
    ...
    function SecurityQuestions(defaultValues) {
        ...
        context["field"] = "SecurityID";
        context["metadata"] = (objectMetadata ? objectMetadata["SecurityID"] : null);
        privateState.SecurityID = defaultValues ? (defaultValues["SecurityID"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["SecurityID"], context) : null) : null;
        context["field"] = "userName";
        context["metadata"] = (objectMetadata ? objectMetadata["userName"] : null);
