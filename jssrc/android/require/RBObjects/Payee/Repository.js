define([], function() {
    ...
    PayeeRepository.prototype.LinkPayeetoTransaction = function(params, onCompletion) {
        return PayeeRepository.prototype.customVerb('LinkPayeetoTransaction', params, onCompletion);
    };
