...
define([], function() {
    ...
    function QrCode(defaultValues) {
        ...
        context["field"] = "AtmId";
        context["metadata"] = (objectMetadata ? objectMetadata["AtmId"] : null);
        privateState.AtmId = defaultValues ? (defaultValues["AtmId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["AtmId"], context) : null) : null;
        context["field"] = "id";
        context["metadata"] = (objectMetadata ? objectMetadata["id"] : null);
