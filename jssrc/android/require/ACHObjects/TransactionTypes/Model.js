...
define([], function() {
    ...
    function TransactionTypes(defaultValues) {
        ...
        context["field"] = "TransactionTypeName";
        context["metadata"] = (objectMetadata ? objectMetadata["TransactionTypeName"] : null);
        privateState.TransactionTypeName = defaultValues ? (defaultValues["TransactionTypeName"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TransactionTypeName"], context) : null) : null;
        context["field"] = "dbpErrCode";
        context["metadata"] = (objectMetadata ? objectMetadata["dbpErrCode"] : null);
