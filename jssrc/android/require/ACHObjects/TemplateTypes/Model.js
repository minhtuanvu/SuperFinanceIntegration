...
define([], function() {
    ...
    function TemplateTypes(defaultValues) {
        ...
        context["field"] = "TemplateTypeName";
        context["metadata"] = (objectMetadata ? objectMetadata["TemplateTypeName"] : null);
        privateState.TemplateTypeName = defaultValues ? (defaultValues["TemplateTypeName"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TemplateTypeName"], context) : null) : null;
        context["field"] = "dbpErrCode";
        context["metadata"] = (objectMetadata ? objectMetadata["dbpErrCode"] : null);
