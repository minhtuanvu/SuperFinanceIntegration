...
define([], function() {
    ...
    function CashPositions(defaultValues) {
        ...
        context["field"] = "span";
        context["metadata"] = (objectMetadata ? objectMetadata["span"] : null);
        privateState.span = defaultValues ? (defaultValues["span"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["span"], context) : null) : null;
        context["field"] = "credit";
        context["metadata"] = (objectMetadata ? objectMetadata["credit"] : null);
        privateState.credit = defaultValues ? (defaultValues["credit"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["credit"], context) : null) : null;
        context["field"] = "debit";
        context["metadata"] = (objectMetadata ? objectMetadata["debit"] : null);
        privateState.debit = defaultValues ? (defaultValues["debit"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["debit"], context) : null) : null;
        context["field"] = "total_balance";
        context["metadata"] = (objectMetadata ? objectMetadata["total_balance"] : null);
        privateState.total_balance = defaultValues ? (defaultValues["total_balance"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["total_balance"], context) : null) : null;
        context["field"] = "Duration";
        context["metadata"] = (objectMetadata ? objectMetadata["Duration"] : null);
        ...
        context["field"] = "startYear";
        context["metadata"] = (objectMetadata ? objectMetadata["startYear"] : null);
        privateState.startYear = defaultValues ? (defaultValues["startYear"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["startYear"], context) : null) : null;
        context["field"] = "endYear";
        context["metadata"] = (objectMetadata ? objectMetadata["endYear"] : null);
        privateState.endYear = defaultValues ? (defaultValues["endYear"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["endYear"], context) : null) : null;
        context["field"] = "month";
        context["metadata"] = (objectMetadata ? objectMetadata["month"] : null);
