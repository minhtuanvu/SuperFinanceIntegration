...
define([], function() {
    ...
    function ApprovalMode(defaultValues) {
        ...
        context["field"] = "isGroupLevel";
        context["metadata"] = (objectMetadata ? objectMetadata["isGroupLevel"] : null);
        privateState.isGroupLevel = defaultValues ? (defaultValues["isGroupLevel"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isGroupLevel"], context) : null) : null;
