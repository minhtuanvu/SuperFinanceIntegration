define("ManageCustomgroup/userfrmSelectAccountsController", ["CommonUtilities"], function(CommonUtilities) {
    return {
                ...
                for (var i = 0; i < data.length; i++) {
                    ...
                    for (var j = 0; j < data[i][1].length; j++) {
                        if (data[i][1][j].imgSelectAccounts.src === "activebox.png") {
                            ...
                            selrowjson = {
                                "accountID": data[i][1][j].accountID
                            };
                            selectedRowValue.push(selrowjson);
                        }
                    }
                    var keyjson = {
                        "selectedTitle": data[i][0].lblHeader,
                    ...
                    var headerJson = {
                        ...
                        "flxSelectall": {
                            onClick: function(eventObject, context) {
                                ...
                                scopeobj.view.managecustomexpandCollapseView.onclickSelectedAllDetected({
                                    section: secIndex,
                                    row: rowIndex
                                });
                            }
                        ...
                        "flxContent": {
                            onClick: function(eventObject, context) {
                                var secIndex = context["sectionIndex"];
                                var rowIndex = context["rowIndex"];
                                scopeobj.view.managecustomexpandCollapseView.headerSelectionDetected({
                                    section: secIndex,
                                    row: rowIndex
                                });
                            }
...
define("ManageCustomgroup/frmSelectAccountsControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_de37280b759f41eb9a96af31d8a72838: function AS_Form_de37280b759f41eb9a96af31d8a72838(eventobject) {
        var self = this;
        this.onInit();
    },
    AS_BarButtonItem_d0d89c72ed734bd6893ea4f099f81354: function AS_BarButtonItem_d0d89c72ed734bd6893ea4f099f81354(eventobject) {
        var self = this;
        this.backNavigation();
    }
});
define("ManageCustomgroup/frmSelectAccountsController", ["ManageCustomgroup/userfrmSelectAccountsController", "ManageCustomgroup/frmSelectAccountsControllerActions"], function() {
    var controller = require("ManageCustomgroup/userfrmSelectAccountsController");
    var controllerActions = ["ManageCustomgroup/frmSelectAccountsControllerActions"];
