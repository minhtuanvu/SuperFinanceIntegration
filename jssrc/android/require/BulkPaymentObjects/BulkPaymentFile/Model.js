...
define([], function() {
    ...
    function BulkPaymentFile(defaultValues) {
        ...
        context["field"] = "content";
        context["metadata"] = (objectMetadata ? objectMetadata["content"] : null);
        privateState.content = defaultValues ? (defaultValues["content"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["content"], context) : null) : null;
        context["field"] = "fileSize";
        context["metadata"] = (objectMetadata ? objectMetadata["fileSize"] : null);
        ...
        context["field"] = "uploadedDate";
        context["metadata"] = (objectMetadata ? objectMetadata["uploadedDate"] : null);
        privateState.uploadedDate = defaultValues ? (defaultValues["uploadedDate"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["uploadedDate"], context) : null) : null;
        context["field"] = "status";
        context["metadata"] = (objectMetadata ? objectMetadata["status"] : null);
        ...
        context["field"] = "sysGeneratedFileName";
        context["metadata"] = (objectMetadata ? objectMetadata["sysGeneratedFileName"] : null);
        privateState.sysGeneratedFileName = defaultValues ? (defaultValues["sysGeneratedFileName"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["sysGeneratedFileName"], context) : null) : null;
        context["field"] = "batchMode";
        context["metadata"] = (objectMetadata ? objectMetadata["batchMode"] : null);
        ...
        context["field"] = "requestStatus";
        context["metadata"] = (objectMetadata ? objectMetadata["requestStatus"] : null);
        privateState.requestStatus = defaultValues ? (defaultValues["requestStatus"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["requestStatus"], context) : null) : null;
