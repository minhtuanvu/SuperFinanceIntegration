...
function initializeWebSocketHandler() {
    ...
    // Creates an instance of Publish Callback
    kony.sdk.KonyWebSocketClasses.createPublishCallback = function(onPublishCallback, publishLog) {
        kony.sdk.KonyWebSocketClasses.init();
        onPublishMethod = function(res) {
            kony.sdk.logsdk.debug(publishLog);
            onPublishCallback(res);
        };
        var publishCallback = new KonyWebSocketClasses.PublishCallback();
        publishCallback.onPublishCallback = onPublishMethod;
        publishCallback.onPublishLog = publishLog;
    ...
    kony.sdk.websocket.setupServerEvents = function(url, onMessage, onError, onClose, setupOptions) {
        ...
        kony.sdk.KonyWebSocketClasses.init();
        var setupServerEvents = "SetupServerEvents: ";
        var messageCallback = kony.sdk.KonyWebSocketClasses.createMessageCallback(onMessage, setupServerEvents + "onMessage Callback");
        var errorCallback = kony.sdk.KonyWebSocketClasses.createErrorCallback(onError, setupServerEvents + "onError Callback");
        var closeCallback = kony.sdk.KonyWebSocketClasses.createCloseCallback(onClose, setupServerEvents + "onClose Callback");
        var setupOptionsMap = kony.sdk.KonyWebSocketClasses.createHashMapFromJSONObject(setupOptions, "setupOptions");
        KonyWebSocketClasses.KonyWebSocketInterface.setupServerEvents(url, messageCallback, errorCallback, closeCallback, setupOptionsMap);
    };
    kony.sdk.websocket.publishServerEvents = function(events, onPublish, publishOptions) {
        ...
        kony.sdk.logsdk.trace(" Entering " + LOG_PREFIX);
        kony.sdk.KonyWebSocketClasses.init();
        var publishServerEvents = "PublishServerEvents: ";
        var publishCallback = kony.sdk.KonyWebSocketClasses.createPublishCallback(onPublish, publishServerEvents + "onPublish Callback");
        var publishOptionsMap = kony.sdk.KonyWebSocketClasses.createHashMapFromJSONObject(publishOptions, "publishOptions");
        KonyWebSocketClasses.KonyWebSocketInterface.publishServerEvents(events, publishCallback, publishOptionsMap);
    };
    kony.sdk.websocket.subscribeServerEvents = function(events, onSubscribe, subscribeOptions) {
        ...
        KonyWebSocketClasses.KonyWebSocketInterface.subscribeServerEvents(events, subscribeCallback, subscribeOptionsMap);
    };
    kony.sdk.websocket.unSubscribeServerEvents = function(events, onUnSubscribe, unSubscribeOptions) {
        ...
        var unSubscribeCallback = kony.sdk.KonyWebSocketClasses.createUnSubscribeCallback(onUnSubscribe, unSubscribeEvents + "onUnSubscribe Callback");
