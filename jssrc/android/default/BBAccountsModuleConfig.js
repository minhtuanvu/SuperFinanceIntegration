BBAccountsModuleConfig = {
    ...
    "Forms": {
        "mobile": {
            ...
            "frmAccountSelector": {
                "Controller": "BBAccountsModule/frmAccountSelectorController",
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
                "FormName": "BBAccountsModule/frmAccountSelector",
                "friendlyName": "frmAccountSelector"
            },
            ...
            "frmDashboardSelector": {
                "Controller": "BBAccountsModule/frmDashboardSelectorController",
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
                "FormName": "BBAccountsModule/frmDashboardSelector",
                "friendlyName": "frmDashboardSelector"
            }
        }
    },
