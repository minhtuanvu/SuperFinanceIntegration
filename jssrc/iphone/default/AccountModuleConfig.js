AccountModuleConfig = {
    ...
    "Forms": {
        "mobile": {
            ...
            "frmViewCombinedStatements": {
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
                "Controller": "AccountModule/frmViewCombinedStatementsController",
                "FormName": "AccountModule/frmViewCombinedStatements",
                "friendlyName": "frmViewCombinedStatements"
            },
            "frmDownLoadCombinedstatement": {
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
                "Controller": "AccountModule/frmDownLoadCombinedstatementController",
                "FormName": "AccountModule/frmDownLoadCombinedstatement",
                "friendlyName": "frmDownLoadCombinedstatement"
            }
        },
        "tablet": {
            "frmDashboardAggregated": {
            ...
            "frmTransactionDetails": {
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
                "Controller": "AccountModule/frmTransactionDetailsController",
                "FormName": "AccountModule/frmTransactionDetails",
            ...
            "frmStatementStartDate": {
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
                "Controller": "AccountModule/frmStatementStartDateController",
                "FormName": "AccountModule/frmStatementStartDate",
                "friendlyName": "frmStatementStartDate"
            },
            "frmStatementsEndDate": {
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
                "Controller": "AccountModule/frmStatementsEndDateController",
                "FormName": "AccountModule/frmStatementsEndDate",
                "friendlyName": "frmStatementsEndDate"
            },
            "frmAccInfoEdit": {
                "ControllerExtensions": [],
                "FormController": "kony.mvc.MDAFormController",
    ...
    "PresentationControllerConfig": {
        ...
        "Tablet": {
            "PresentationControllerClass": "AccountModule/PresentationControllers/PresentationController_Tablet",
            "PresentationExtensions": []
        }
    }
};