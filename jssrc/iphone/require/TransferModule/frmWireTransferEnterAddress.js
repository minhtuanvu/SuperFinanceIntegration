define("TransferModule/frmWireTransferEnterAddress", function() {
    return function(controller) {
        function addWidgetsfrmWireTransferEnterAddress() {
            ...
            var customHeader = new com.kmb.common.customHeader({
                ...
                "overrides": {
                    ...
                    "lblLocateUs": {
                        "text": kony.i18n.getLocalizedString("kony.mb.cardManage.enterAddress")
                    }
                }
            }, {
                "overrides": {}
            ...
            flxMainContainer.add(flxEnterAddress, flxSearch);
            ...
            flxBg.add();
            this.add(flxHeader, flxMainContainer, flxSearchAddress, flxPopup, flxBg);
        };
        var RBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_h0ecd0f4d44745b1a02d83c12891cd01,
            "metaData": {
                "title": "Close"
            },
            "id": "RBarBtnItem0"
        ...
        return [{
            "addWidgets": addWidgetsfrmWireTransferEnterAddress,
            "enabledForIdleTimeout": true,
            "id": "frmWireTransferEnterAddress",
            "init": controller.AS_Form_ba31713ba34c47a99b6d95f379175fb3,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": true,
            "preShow": function(eventobject) {
                controller.AS_Form_a48930fcedd44d9882cf97315aaded49(eventobject);
            },
            "skin": "sknFrmffffff",
            "title": kony.i18n.getLocalizedString("kony.mb.cardManage.enterAddress")
        }, {
