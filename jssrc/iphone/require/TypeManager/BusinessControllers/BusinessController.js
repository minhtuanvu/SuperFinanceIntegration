define([], function() {
    ...
    TypeManager.prototype.getAccountTypeBackendValue = function(applicationValue) {
            if (this.accountTypesMap.hasOwnProperty(applicationValue)) return this.accountTypesMap[applicationValue].backendValue;
            return null;
        }
        /**
    ...
    TypeManager.prototype.getAccountType = function(backendValue) {
        if (this.accountTypesBackendMap.hasOwnProperty(backendValue)) return this.accountTypesBackendMap[backendValue].applicationValue;
        return 'Other';
    }
    ...
    TypeManager.prototype.getTransactionTypeBackendValue = function(applicationValue) {
            if (this.transactionTypesMap.hasOwnProperty(applicationValue)) return this.transactionTypesMap[applicationValue].backendValue;
            return null;
        }
        /**
    ...
    TypeManager.prototype.getTransactionTypeDisplayValue = function(applicationValue) {
            if (this.transactionTypesMap.hasOwnProperty(applicationValue)) return this.transactionTypesMap[applicationValue].displayValue;
            return null;
        }
        /**
    ...
    TypeManager.prototype.getTransactionType = function(backendValue) {
        if (this.transactionTypesBackendMap.hasOwnProperty(backendValue)) return this.transactionTypesBackendMap[backendValue].applicationValue;
        return null;
    }
    ...
    TypeManager.prototype.getPfmTypeBackendValue = function(applicationValue) {
            if (this.pfmTypesMap.hasOwnProperty(applicationValue)) return this.pfmTypesMap[applicationValue].backendValue;
            return null;
        }
        /**
    ...
    TypeManager.prototype.getPfmTypeDisplayValue = function(applicationValue) {
            if (this.pfmTypesMap.hasOwnProperty(applicationValue)) return this.pfmTypesMap[applicationValue].displayValue;
            return null;
        }
        /**
    ...
    TypeManager.prototype.getPfmType = function(backendValue) {
        if (this.pfmTypesBackendMap.hasOwnProperty(backendValue)) return this.pfmTypesBackendMap[backendValue].applicationValue;
        return null;
    }
    return TypeManager;
});