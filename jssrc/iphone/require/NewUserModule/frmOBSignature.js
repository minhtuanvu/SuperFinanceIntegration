define("NewUserModule/frmOBSignature", function() {
    return function(controller) {
        function addWidgetsfrmOBSignature() {
            ...
            var customHeader = new com.kmb.common.customHeader({
                ...
                "overrides": {
                    ...
                    "lblLocateUs": {
                        "text": kony.i18n.getLocalizedString("kony.mb.OBSignature.Title")
                    }
                }
            }, {
                "overrides": {}
        ...
        var RBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_d0102b70511b49b894eb38172f670b69,
            "metaData": {
                "title": "Cancel"
            },
            "id": "RBarBtnItem0"
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_ad2797c9e26b432298394bd16789c681(eventobject);
            },
            "skin": "sknFrmffffff",
