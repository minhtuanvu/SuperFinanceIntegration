define([], function() {
    function NewUser_PresentationController() {
        ...
        scope_NewUserPresentationController.email = null;
    ...
    NewUser_PresentationController.prototype.verifyEmail = function(email) {
        ...
        if (validationUtility.isValidEmail(email)) {
            scope_NewUserPresentationController.email = email;
            scope_NewUserPresentationController.getUsernameAndPasswordRulesAndPolicies();
    ...
    NewUser_PresentationController.prototype.checkUserAvailability = function(userName) {
        ...
        var newUserBM = applicationManager.getNewUserBusinessManager();
        var validationUtility = applicationManager.getValidationUtilManager();
        if (validationUtility.isUsernameValidForPolicy(userName)) {
    ...
    NewUser_PresentationController.prototype.createNewUser = function(userName, password, reenter, formContext) {
        ...
        var newUserBM = applicationManager.getNewUserBusinessManager();
        var controller = applicationManager.getPresentationUtility().getController('frmOBsetUserNamePwd', true);
        var isValidUserName = validationUtility.isUsernameValidForPolicy(userName);
    ...
    NewUser_PresentationController.prototype.getAllProducts = function() {
        ...
        if (products && products.allProducts) navMan.setCustomInfo("frmOBSelectProducts", {
            "products": products
        });
        else {
            scope_NewUserPresentationController.fetchAllProducts();
        }
    };
    NewUser_PresentationController.prototype.fetchAllProducts = function() {
     ...
     */
    NewUser_PresentationController.prototype.productsSuccessCallback = function(res) {
        var proMan = applicationManager.getProductManager();
     ...
     */
    NewUser_PresentationController.prototype.productsErrorCallback = function(error) {
        applicationManager.getPresentationUtility().dismissLoadingScreen();
        ...
        else kony.ui.Alert(error.errorMessage);
    };
    ...
    NewUser_PresentationController.prototype.navigateFromProductsBasedOnStatePresentationSuccessCallback = function(res) {
        ...
        if (res[0].userPersonalInfo == "true") {
            ...
            BC.updateNewUserInfo(data);
            var navMan = applicationManager.getNavigationManager();
            navMan.navigateTo("frmOBEditFirstLastName");
            //  applicationManager.getPresentationUtility().dismissLoadingScreen();
        }
    };
    ...
    NewUser_PresentationController.prototype.NUOLogin = function(newUserJSON, formContext) {
        ...
        if (validationManager.isUsernameValidForPolicy(newUserJSON.username) && validationManager.isPasswordValidForPolicy(newUserJSON.password)) {
            var userPreferencesManager = applicationManager.getUserPreferencesManager();
            if (userPreferencesManager.isNewUser(newUserJSON.username)) userPreferencesManager.clearUserData(formContext);
            var nuoMan = applicationManager.getNewUserBusinessManager();
    ...
    NewUser_PresentationController.prototype.getUsernameAndPasswordRulesAndPolicies = function() {
        var userObj = applicationManager.getUserPreferencesManager();
        userObj.getUsernameAndPasswordRulesAndPolicies(scope_NewUserPresentationController.getUsernameAndPasswordRulesAndPoliciesSuccessCallback, scope_NewUserPresentationController.getUsernameAndPasswordRulesAndPoliciesErrorCallback);
    };
    NewUser_PresentationController.prototype.getUsernameAndPasswordRulesAndPoliciesSuccessCallback = function(res) {
        var navManager = applicationManager.getNavigationManager();
        var data = navManager.getCustomInfo("frmOBEmail");
        if (data && data !== null) {
        ...
        navManager.setCustomInfo("frmOBEmail", data);
        var validationUtility = applicationManager.getValidationUtilManager();
        ...
        scope_NewUserPresentationController.userData.email = scope_NewUserPresentationController.email;
        // navManager.navigateTo("frmEnrollSignUp");
    };
    NewUser_PresentationController.prototype.getUsernameAndPasswordRulesAndPoliciesErrorCallback = function(errRes) {
        if (errRes["isServerUnreachable"]) {
            applicationManager.getPresentationInterruptHandler().showErrorMessage("preLogin", errRes);
        }
        applicationManager.getPresentationUtility().dismissLoadingScreen();
    };
    NewUser_PresentationController.prototype.getUsernameAndPasswordRules = function() {
        var userObj = applicationManager.getUserPreferencesManager();
        userObj.getUsernameAndPasswordRulesAndPolicies(scope_NewUserPresentationController.getUsernameAndPasswordRulesSuccessCallback, scope_NewUserPresentationController.getUsernameAndPasswordRulesErrorCallback);
    };
    NewUser_PresentationController.prototype.getUsernameAndPasswordRulesSuccessCallback = function(res) {
        var validationUtility = applicationManager.getValidationUtilManager();
        validationUtility.createRegexForUsernameValidation(res.usernamerules);
        validationUtility.createRegexForPasswordValidation(res.passwordrules);
        var NUOMod = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule("NewUserModule");
    ...
    NewUser_PresentationController.prototype.getUsernameAndPasswordRulesErrorCallback = function(errRes) {
        if (errRes["isServerUnreachable"]) {
            applicationManager.getPresentationInterruptHandler().showErrorMessage("preLogin", errRes);
        }
        applicationManager.getPresentationUtility().dismissLoadingScreen();
    };
    NewUser_PresentationController.prototype.isValidZipCode = function(zipCode, form) {
        var validationManager = applicationManager.getValidationUtilManager();
        ...
        if (isValidZipCode === true) {
            ...
            controller.bindViewError(applicationManager.getPresentationUtility().getStringFromi18n("i18n.common.invalidZipCode"));
        }
    };
