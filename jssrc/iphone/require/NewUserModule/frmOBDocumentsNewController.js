define("NewUserModule/userfrmOBDocumentsNewController", {
    //clickedDocType : null,
    documentType: null,
    flowType: null,
    base64: null,
    ...
    onDeleteDocument: function(documentType) {
        if (documentType === "address") {
            this.view.flxAddressProof.height = "60dp"
        ...
        if (documentType === "employee") {
            this.view.flxEmploymentProof.height = "60dp"
        ...
        if (documentType === "income") {
            this.view.flxIncomeProof.height = "60dp"
    ...
    openPopupDocument: function() {
        if (applicationManager.getDeviceUtilManager().isIPhone()) {
            ...
            var actionTakeAPicture = new kony.ui.ActionItem({
                "title": applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.Messages.TakeAPicture"),
                "style": constants.ACTION_STYLE_DEFAULT,
                "action": this.takePictureIphone
            });
            var actionViewDocument = new kony.ui.ActionItem({
                "title": applicationManager.getPresentationUtility().getStringFromi18n("kony.ob.viewDocument"),
                "style": constants.ACTION_STYLE_DEFAULT,
                "action": this.view.btnTakeAPicture.onClick
            });
            var actionDeleteDocument = new kony.ui.ActionItem({
                "title": applicationManager.getPresentationUtility().getStringFromi18n("kony.ob.deleteDocument"),
                "style": constants.ACTION_STYLE_DEFAULT,
                "action": this.view.btnChooseFromGallery.onClick
            });
            var actionChooseFromGallery = new kony.ui.ActionItem({
                "title": applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.OnBoarding.ChooseFromGallery"),
                "style": constants.ACTION_STYLE_DEFAULT,
                "action": this.view.btnChooseFromGallery.onClick
            });
            ...
            if (this.flowType === "add") {
                ...
                this.view.btnChooseFromGallery.text = applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.OnBoarding.ChooseFromGallery");
            } else {
    ...
    gallerySelectionCallback: function(rawBytes, permissionStatus) {
        ...
        if (rawBytes !== null) {
            ...
            if ((this.base64 !== null) && (this.base64 !== undefined) && (this.base64 !== "")) {
                ...
                kony.ui.Alert("Permission Denied to Access the Photo Gallery");
            } else {
                kony.ui.Alert("No Image Selected !");
            }
        }
    ...
    setThumbNailImage: function() {
        ...
        if (this.view.lblDoc1.isVisible === true) {
            this.view.flxAddressProof.height = "125dp";
            ...
            this.view.flxEmploymentProof.height = "125dp";
            ...
            this.view.flxIncomeProof.height = "125dp";
...
define("NewUserModule/frmOBDocumentsNewControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_b7afcd319b6441a094d590e41a9fbf0a: function AS_FlexContainer_b7afcd319b6441a094d590e41a9fbf0a(eventobject) {
        var self = this;
        this.closeAttachment();
    },
    AS_Form_c090961e4fb54452bfb59f3aad05f4e7: function AS_Form_c090961e4fb54452bfb59f3aad05f4e7(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_j571d78723ca42fe9c27641c0eb12321: function AS_Form_j571d78723ca42fe9c27641c0eb12321(eventobject) {
        var self = this;
        this.preShow();
    },
    AS_BarButtonItem_dab426696aa14a6186f3a0117693c7c2: function AS_BarButtonItem_dab426696aa14a6186f3a0117693c7c2(eventobject) {
        var self = this;
        this.onClose();
    }
});
define("NewUserModule/frmOBDocumentsNewController", ["NewUserModule/userfrmOBDocumentsNewController", "NewUserModule/frmOBDocumentsNewControllerActions"], function() {
