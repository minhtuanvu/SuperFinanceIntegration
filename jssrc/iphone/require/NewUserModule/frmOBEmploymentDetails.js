define("NewUserModule/frmOBEmploymentDetails", function() {
    return function(controller) {
        function addWidgetsfrmOBEmploymentDetails() {
            ...
            flxBtnWrapper.add(btnContinueEmploymentInfo);
            flxEnterPersonalInfo.add(flxEnterPersonalInfoHeader, flxEmploymentInfo, flxBtnWrapper);
            flxMainContainer.add(flxProgress, flxEnterPersonalInfo);
        ...
        var RBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_h65040c2ef6e49549cefae99050b14e3,
            "metaData": {
                "title": "Close"
            },
            "id": "RBarBtnItem0"
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_d3700a78d41c453f944bd1b87a563eea(eventobject);
            },
            "skin": "sknFrmffffff",
