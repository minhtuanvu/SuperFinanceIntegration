define("NewUserModule/frmOBEditFirstLastName", function() {
    return function(controller) {
        function addWidgetsfrmOBEditFirstLastName() {
            ...
            var flxRetailWarning = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "clipBounds": false,
                "height": "20dp",
                "id": "flxRetailWarning",
            ...
            flxRetailWarning.setDefaultUnit(kony.flex.DP);
            var imgRetailWarning = new kony.ui.Image2({
                "centerY": "50%",
                "height": "20dp",
                "id": "imgRetailWarning",
                "isVisible": true,
            ...
            var lblRetailWarning = new kony.ui.Label({
                "centerY": "50%",
                "id": "lblRetailWarning",
                "isVisible": true,
                "left": "0.30%",
                "skin": "sknlbl424242SSPR15px",
                "text": kony.i18n.getLocalizedString("kony.mb.NUO.NoteEnrollmentIsOnlyForRetailBanking"),
                "textStyle": {},
                "width": "95%"
            }, {
                "contentAlignment": constants.CONTENT_ALIGN_MIDDLE_LEFT,
            ...
            flxRetailWarning.add(imgRetailWarning, lblRetailWarning);
            var flxBtnWrapper = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "bottom": "20dp",
                "clipBounds": true,
                "height": "45dp",
            ...
            flxBtnWrapper.setDefaultUnit(kony.flex.DP);
            ...
            flxBtnWrapper.add(btnContinueEnterPersonalInfo);
            flxFirstLastName.add(lblEnterPersonalInfoFirstNameTitle, flxFirstName, lblEnterPersonalInfoLastNameTitle, flxLastName, flxRetailWarning, flxBtnWrapper);
            flxMainContainer.add(flxEnterPersonalInfoHeader, flxFirstLastName);
        ...
        var RBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_b02662aa84d04a1a85de397d2d183806,
            "metaData": {
                "title": "Close"
            },
            "id": "RBarBtnItem0"
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_a2a758fa063f4f7db87211719d2fb227(eventobject);
            },
            "skin": "sknFrmffffff",
