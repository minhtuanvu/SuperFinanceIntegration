define("NewUserModule/userfrmOBSelectProductsController", {
    ...
    searchProducts: function() {
        ...
        if (this.view.flxHeaderSearchbox.isVisible === true) {
            ...
            this.view.flxSearch.isVisible = true;
            if (applicationManager.getPresentationFormUtility().getDeviceName() === "iPhone") {
                this.view.flxSelectProductsWrapper.top = "0dp";
                this.view.flxHeaderSelectProductsMain.isVisible = false;
            ...
            //this.view.flxSeg.skin = "sknFlxScrlffffff";
            this.view.flxSelectProductsWrapper.top = "0dp";
...
define("NewUserModule/frmOBSelectProductsControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_a821bf4e8e1548d6b291810155826455: function AS_Form_a821bf4e8e1548d6b291810155826455(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_be7faa8ed40e4c50bc9626a7babc28ec: function AS_Form_be7faa8ed40e4c50bc9626a7babc28ec(eventobject) {
        var self = this;
        this.preShow();
    },
    AS_BarButtonItem_e340180a6a3f4854b89b1a06f5d1b830: function AS_BarButtonItem_e340180a6a3f4854b89b1a06f5d1b830(eventobject) {
        var self = this;
        this.onCloseClick();
    }
});
define("NewUserModule/frmOBSelectProductsController", ["NewUserModule/userfrmOBSelectProductsController", "NewUserModule/frmOBSelectProductsControllerActions"], function() {
