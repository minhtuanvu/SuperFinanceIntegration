define("NewUserModule/userfrmOBsetUserNamePwdController", {
    flag: '0',
    timerCounter: 0,
    init: function() {
    ...
    initActions: function() {
        ...
        scope.view.txtPassword.onEndEditing = function() {
            if (scope.isValidPassword()) scope.matchPassword();
                ...
                if (scope.view.txtPassword.text.length > 0) scope.bindError("invalidpassword");
                scope.hideFlxRequirementsPassword();
            }
        };
...
define("NewUserModule/frmOBsetUserNamePwdControllerActions", {
    /*
...
define("NewUserModule/frmOBsetUserNamePwdController", ["NewUserModule/userfrmOBsetUserNamePwdController", "NewUserModule/frmOBsetUserNamePwdControllerActions"], function() {
