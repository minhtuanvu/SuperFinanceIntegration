define([], function() {
    ...
    CampaignManagement_PresentationController.prototype.createLoanAccount = function() {
        ...
        var userId = userManager.getUserId();
        var data = {
            "amount": this.cleanAmount(this.segData[2].value),
    ...
    CampaignManagement_PresentationController.prototype.createFinancialHelpAccountFailure = function(err) {
        ...
        applicationManager.getPresentationUtility().dismissLoadingScreen();
        if (err["isServerUnreachable"]) applicationManager.getPresentationInterruptHandler().showErrorMessage("postLogin", err.errorMessage);
        else {
            controller.bindViewError(err.errorMessage);
        }
    };
    ...
    CampaignManagement_PresentationController.prototype.createDeposit = function() {
        ...
        var data = {
            "amount": amount,
            "productId": "PRODUCT9",
            "payingAccount": this.segData[2].value.accountID,
            "campaignId": "",
            "payoutAccount": this.segData[5].value.accountID,
            "userId": "",
            "productType": ""
        };
        var userManager = applicationManager.getUserPreferencesManager();
    ...
    CampaignManagement_PresentationController.prototype.updateCampaigningAndNavToAccounts = function(flowType) {
        ...
        if (flowType == "deposits" || flowType == "FinancialHelp") dmManager.getAds("accountDashboardCampaigns", this.creatDepositAndNavToAccountsSuccess.bind(this), this.updateCampaigningAndNavToAccountsFailure.bind(this));
        else if (flowType == "specialBonus") dmManager.getAds("accountDashboardCampaigns", this.creatDepositAndNavToAccountsSuccess.bind(this), this.updateCampaigningAndNavToAccountsFailure.bind(this));
        else dmManager.getAds("accountDashboardCampaigns", this.updateCampaigningAndNavToAccountsSuccess.bind(this), this.updateCampaigningAndNavToAccountsFailure.bind(this));
