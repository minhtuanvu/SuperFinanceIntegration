define("CampaignManagement/userfrmLoadingController", {
    numOfAds: 0,
    currentFlex: 1,
    xOffset: 0,
    ...
    onAdDownloadComplete: function(issuccess, adNumber) {
        ...
        if (this.imageObjArray.length >= 1 && (this.imageObjArray.length + this.imageDownloadFailureCount) === this.numOfAds) {
    ...
    onAdTap: function(widget, gestureInfo, context) {
        ...
        var navUrl = postLoginCampaigns[currAd - 1].destinationURL;
        if (!this.isTapDone) {
            this.isTapDone = true;
        }
...
define("CampaignManagement/frmLoadingControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("CampaignManagement/frmLoadingController", ["CampaignManagement/userfrmLoadingController", "CampaignManagement/frmLoadingControllerActions"], function() {
    var controller = require("CampaignManagement/userfrmLoadingController");
    var controllerActions = ["CampaignManagement/frmLoadingControllerActions"];
