define("ManageCardsModule/frmManageSelectNewCards", function() {
    return function(controller) {
        function addWidgetsfrmManageSelectNewCards() {
            ...
            var segSelectProducts = new kony.ui.SegmentedUI2({
                ...
                "data": [{
                    ...
                    "imgCard": "atmcardred.png",
                    "lblAccess": "Label",
                    "lblBankName": "Label",
                    "lblCardName": "Golden Rewards Card",
                    "rtxCardDetails": "RichText"
                }, {
                    "btnApply": "Learn More",
                    "btnLearnMore": "Learn More",
                    "imgCard": "atmcardred.png",
                ...
                "widgetDataMap": {
                    ...
                    "flxCardImg": "flxCardImg",
                    "flxMain": "flxMain",
                    "flxSelectNewCards": "flxSelectNewCards",
                    "imgCard": "imgCard",
                    "lblAccess": "lblAccess",
                    "lblBankName": "lblBankName",
                    "lblCardName": "lblCardName",
                    "rtxCardDetails": "rtxCardDetails"
                },
            ...
            flxRememberMyDevice.add(flxSeparator, flxCheckBox, lblagreetc, btntermsandconditions, lblRichTxt);
            flxSelectProducts.add(flxSearch, flxProgress, flxHeaderSelectProducts, segSelectProducts, flxRememberMyDevice);
        ...
        var RBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_afafe2daf72740b0a5c539bcc7a66f01,
            "metaData": {
        ...
        return [{
            "addWidgets": addWidgetsfrmManageSelectNewCards,
            "enabledForIdleTimeout": true,
            "id": "frmManageSelectNewCards",
            "init": controller.AS_Form_a0e2ad783177417f9d9cdb03beda6915,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": true,
            "preShow": function(eventobject) {
                controller.AS_Form_c8d0e5c0d3004220bc2be77d2ed412ac(eventobject);
            },
            "skin": "sknFrmf9f9f9",
