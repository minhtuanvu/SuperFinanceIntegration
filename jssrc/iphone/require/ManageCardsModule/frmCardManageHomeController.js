define("ManageCardsModule/userfrmCardManageHomeController", ['CommonUtilities', 'CampaignUtility'], function(CommonUtilities, CampaignUtility) {
    return {
        timerCounter: 0,
        dialPadNo: "",
        lengthOfDialNo: 0,
        ...
        setDataForCards: function() {
            ...
            try {
                ...
                this.cardListImages = ["atmcardgold.png", "atmcardplatinum.png", "atmcardblack.png", "atmcardgold.png", "atmcardplatinum.png", "atmcardblack.png", "atmcardplatinum.png", "atmcardblack.png", ];
            } catch (err) {
                throw GlobalExceptionHandler.addMessageAndActionForException(err, "kony.error.LoadingFormFailed", GlobalExceptionHandler.ActionConstants.ALERT, arguments.callee.name);
            }
        },
        ...
        cardListGetCards: function() {
            ...
            try {
                ...
                if (!kony.sdk.isNullOrUndefined(this.view) && !kony.sdk.isNullOrUndefined(this.view.flxCardList) && !kony.sdk.isNullOrUndefined(this.view.flxCardList.widgets()) && !kony.sdk.isNullOrUndefined(this.view.flxCard.frame)) {
        ...
        cardListScroll: function() {
            ...
            try {
                ...
                if (kony.sdk.isNullOrUndefined(this.view) || kony.sdk.isNullOrUndefined(this.view.flxCardList) || kony.sdk.isNullOrUndefined(this.view.flxCardList.widgets())) {
                    return;
                }
        ...
        showTransactions: function(showOnlyCardDetails) {
            ...
            var transactions;
            if (!kony.sdk.isNullOrUndefined(cardTransactionDetails)) transactions = cardTransactionDetails.cardTransactions;
        ...
        hideTransactions: function() {
            ...
            if (cardStatus == "Cancelled") {
                ...
                if (cardType == applicationManager.getConfigurationManager().OLBConstants.CARD_TYPE.Credit) {
                    ...
                    this.view.flxManageTravelPlanButton.setVisibility(true);
                } else this.view.flxOptionsContainer.setVisibility(false);
                this.setViewForStolenCard(cardType);
            } else if (cardStatus === "Replace Request Sent") {
                this.setViewForReplacedCard(cardType);
            } else {
            ...
            if (cardType == applicationManager.getConfigurationManager().OLBConstants.CARD_TYPE.Credit) this.view.flxCancelCard.setVisibility(true);
            else this.view.flxCancelCard.setVisibility(false);
            ...
            if (!kony.sdk.isNullOrUndefined(transactions) && transactions.length > 0) {
                ...
                if (this.cardTypeFlag === applicationManager.getConfigurationManager().OLBConstants.CARD_TYPE.Credit) {
                    if (unbilled.length > 0) {
                        data.push([{
                            "lblHeader": applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.CardMng.UnBilledTransactions")
                        }, unbilled]);
                    }
                    if (billed.length > 0) {
                        data.push([{
                            "lblHeader": applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.CardMng.BilledTransactions")
                        }, billed]);
                    }
                } else {
                    if (unbilled.length > 0) {
                ...
                if (!this.isAppendData) {
                    ...
                    if (data.length !== 0) this.isAppendData = true;
                } else {
                    for (var i = 0; i < this.view.segTransactionsScreen.data.length; i++) {
        ...
        navigateToFilterOrApplyCard: function() {
            ...
            } else this.view.flxPopupApplyForCard.setVisibility(true);
        },
...
define("ManageCardsModule/frmCardManageHomeControllerActions", {
    /*
    ...
    */
    ...
    AS_BarButtonItem_a5d38c337107466abacb644cd404d7f9: function AS_BarButtonItem_a5d38c337107466abacb644cd404d7f9(eventobject) {
        var self = this;
        this.navigateToFilterOrApplyCard();
    }
});
define("ManageCardsModule/frmCardManageHomeController", ["ManageCardsModule/userfrmCardManageHomeController", "ManageCardsModule/frmCardManageHomeControllerActions"], function() {
