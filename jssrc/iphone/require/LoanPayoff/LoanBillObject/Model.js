...
define([], function() {
    ...
    var objectMetadata;
    var context = {
        "object": "LoanBillObject",
        "objectService": "LoanPayoff"
    };
    var setterFunctions = {
    ...
    function LoanBillObject(defaultValues) {
        ...
        context["field"] = "billType";
        context["metadata"] = (objectMetadata ? objectMetadata["billType"] : null);
        privateState.billType = defaultValues ? (defaultValues["billType"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["billType"], context) : null) : null;
        context["field"] = "paymentDate";
        context["metadata"] = (objectMetadata ? objectMetadata["paymentDate"] : null);
        ...
        context["field"] = "backendOverride";
        context["metadata"] = (objectMetadata ? objectMetadata["backendOverride"] : null);
        privateState.backendOverride = defaultValues ? (defaultValues["backendOverride"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["backendOverride"], context) : null) : null;
        context["field"] = "backendError";
        context["metadata"] = (objectMetadata ? objectMetadata["backendError"] : null);
        privateState.backendError = defaultValues ? (defaultValues["backendError"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["backendError"], context) : null) : null;
