define([], function() {
    ...
    ACHTransactionsRepository.prototype.getAllACHTransactions = function(params, onCompletion) {
        return ACHTransactionsRepository.prototype.customVerb('getAllACHTransactions', params, onCompletion);
    };
