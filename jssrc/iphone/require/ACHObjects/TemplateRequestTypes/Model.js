...
define([], function() {
    ...
    function TemplateRequestTypes(defaultValues) {
        ...
        context["field"] = "TemplateRequestTypeName";
        context["metadata"] = (objectMetadata ? objectMetadata["TemplateRequestTypeName"] : null);
        privateState.TemplateRequestTypeName = defaultValues ? (defaultValues["TemplateRequestTypeName"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TemplateRequestTypeName"], context) : null) : null;
        context["field"] = "dbpErrCode";
        context["metadata"] = (objectMetadata ? objectMetadata["dbpErrCode"] : null);
