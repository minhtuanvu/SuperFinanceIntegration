...
define([], function() {
    ...
    DataProcessorUtility.prototype.showToast = function(skin, image, message, func, scope) {
        ...
        var previousTop = "0dp";
        if (scope.view.flxMainContainer != undefined && scope.view.flxMainContainer != null) previousTop = scope.view.flxMainContainer.top;
            ...
            kony.timer.schedule(timerId, function() {
                ...
                if (deviceUtilManager.isIPhone()) {
                    ...
                    if (scope.view.flxHeaderSearchbox != undefined && scope.view.flxHeaderSearchbox != null) {
                        if (scope.view.flxMainContainer != undefined && scope.view.flxMainContainer != null) scope.view.flxMainContainer.top = previousTop;
                    }
                }
    ...
    DataProcessorUtility.prototype.maskAccountNumber = function(accountNumber) {
        ...
        var digitsRegex = /^\d+$/;
        if (accountNumber.match(digitsRegex)) accountNumber = accountNumber.replace(/\d(?=\d{4})/g, "X");
