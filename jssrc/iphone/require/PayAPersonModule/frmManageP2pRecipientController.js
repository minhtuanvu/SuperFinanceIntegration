define("PayAPersonModule/userfrmManageP2pRecipientController", {
    ...
    editOptionsForIphone: function() {
        ...
        if (applicationManager.getDeviceUtilManager().isIPhone()) {
            ...
            if (scope.isEditLinkedCustomerAvailable) actionSheetObject.addAction(actionLinkedCustomer);
...
define("PayAPersonModule/frmManageP2pRecipientControllerActions", {
    ...
    */
    ...
    AS_BarButtonItem_a088dffc52224c9390faf089e783c2af: function AS_BarButtonItem_a088dffc52224c9390faf089e783c2af(eventobject) {
        var self = this;
        var navMan = applicationManager.getNavigationManager();
        navMan.goBack();
    },
