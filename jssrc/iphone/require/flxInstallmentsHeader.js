define("flxInstallmentsHeader", function() {
    return function(controller) {
        var flxInstallmentsHeader = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "height": "60dp",
            "id": "flxInstallmentsHeader",
            "isVisible": true,
        ...
        flxInstallmentsHeader.setDefaultUnit(kony.flex.DP);
        var flximgUp = new kony.ui.FlexContainer({
            ...
            "layoutType": kony.flex.FREE_FORM,
            "isModalContainer": false,
            "onClick": controller.AS_FlexContainer_a6205b0ec0a04b53861cbb516c98108b,
            "right": "16dp",
            "skin": "slFbox",
            "top": "17dp",
            "width": "30dp",
        ...
        flxShadowBottom.add();
        flxInstallmentsHeader.add(flximgUp, lblHeader, flxTypeOneShadow, flxShadowBottom);
        return flxInstallmentsHeader;
    }
})