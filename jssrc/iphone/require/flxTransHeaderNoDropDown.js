define("flxTransHeaderNoDropDown", function() {
    return function(controller) {
        var flxTransHeaderNoDropDown = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "height": "60dp",
            "id": "flxTransHeaderNoDropDown",
            "isVisible": true,
        ...
        flxTransHeaderNoDropDown.setDefaultUnit(kony.flex.DP);
        ...
        flxShadowBottom.add();
        flxTransHeaderNoDropDown.add(lblHeader, flxTypeOneShadow, flxShadowBottom);
        return flxTransHeaderNoDropDown;
    }
})