define("flxAccountsNoImageMM", function() {
    return function(controller) {
        var flxAccountsNoImageMM = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "focusSkin": "slFbox",
            "height": "70dp",
            "id": "flxAccountsNoImageMM",
            "isVisible": true,
            "layoutType": kony.flex.FLOW_HORIZONTAL,
            "isModalContainer": false,
            "skin": "f9f9"
        }, {}, {});
        flxAccountsNoImageMM.setDefaultUnit(kony.flex.DP);
        ...
        flxAccountsNoImageMM.add(flxMain, flxDelete);
        return flxAccountsNoImageMM;
    }
})