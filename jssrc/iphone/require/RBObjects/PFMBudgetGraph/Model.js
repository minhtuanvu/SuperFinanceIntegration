...
define([], function() {
    ...
    function PFMBudgetGraph(defaultValues) {
        ...
        context["field"] = "allocatedAmount";
        context["metadata"] = (objectMetadata ? objectMetadata["allocatedAmount"] : null);
        privateState.allocatedAmount = defaultValues ? (defaultValues["allocatedAmount"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["allocatedAmount"], context) : null) : null;
        context["field"] = "amountSpent";
        context["metadata"] = (objectMetadata ? objectMetadata["amountSpent"] : null);
        privateState.amountSpent = defaultValues ? (defaultValues["amountSpent"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["amountSpent"], context) : null) : null;
        context["field"] = "budgetId";
        context["metadata"] = (objectMetadata ? objectMetadata["budgetId"] : null);
        privateState.budgetId = defaultValues ? (defaultValues["budgetId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["budgetId"], context) : null) : null;
        context["field"] = "categoryId";
        context["metadata"] = (objectMetadata ? objectMetadata["categoryId"] : null);
