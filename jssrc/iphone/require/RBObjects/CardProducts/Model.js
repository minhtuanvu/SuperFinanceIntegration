...
define([], function() {
    ...
    function CardProducts(defaultValues) {
        ...
        context["field"] = "featureOverview";
        context["metadata"] = (objectMetadata ? objectMetadata["featureOverview"] : null);
        privateState.featureOverview = defaultValues ? (defaultValues["featureOverview"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["featureOverview"], context) : null) : null;
        context["field"] = "featureDescription";
        context["metadata"] = (objectMetadata ? objectMetadata["featureDescription"] : null);
        ...
        context["field"] = "representativeLabel1";
        context["metadata"] = (objectMetadata ? objectMetadata["representativeLabel1"] : null);
        privateState.representativeLabel1 = defaultValues ? (defaultValues["representativeLabel1"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["representativeLabel1"], context) : null) : null;
        context["field"] = "representativeLabel2";
        context["metadata"] = (objectMetadata ? objectMetadata["representativeLabel2"] : null);
        privateState.representativeLabel2 = defaultValues ? (defaultValues["representativeLabel2"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["representativeLabel2"], context) : null) : null;
        context["field"] = "representativeLabel3";
        context["metadata"] = (objectMetadata ? objectMetadata["representativeLabel3"] : null);
        privateState.representativeLabel3 = defaultValues ? (defaultValues["representativeLabel3"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["representativeLabel3"], context) : null) : null;
        context["field"] = "representativeValue1";
        context["metadata"] = (objectMetadata ? objectMetadata["representativeValue1"] : null);
        privateState.representativeValue1 = defaultValues ? (defaultValues["representativeValue1"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["representativeValue1"], context) : null) : null;
        context["field"] = "representativeValue2";
        context["metadata"] = (objectMetadata ? objectMetadata["representativeValue2"] : null);
        privateState.representativeValue2 = defaultValues ? (defaultValues["representativeValue2"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["representativeValue2"], context) : null) : null;
        context["field"] = "representativeValue3";
        context["metadata"] = (objectMetadata ? objectMetadata["representativeValue3"] : null);
        privateState.representativeValue3 = defaultValues ? (defaultValues["representativeValue3"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["representativeValue3"], context) : null) : null;
        context["field"] = "errmsg";
        context["metadata"] = (objectMetadata ? objectMetadata["errmsg"] : null);
