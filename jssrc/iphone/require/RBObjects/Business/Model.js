...
define([], function() {
    ...
    function Business(defaultValues) {
        ...
        context["field"] = "businessTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["businessTypeId"] : null);
        privateState.businessTypeId = defaultValues ? (defaultValues["businessTypeId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["businessTypeId"], context) : null) : null;
