...
define([], function() {
    ...
    function uploadDocuments(defaultValues) {
        ...
        context["field"] = "document";
        context["metadata"] = (objectMetadata ? objectMetadata["document"] : null);
        privateState.document = defaultValues ? (defaultValues["document"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["document"], context) : null) : null;
        context["field"] = "documentType";
        context["metadata"] = (objectMetadata ? objectMetadata["documentType"] : null);
        privateState.documentType = defaultValues ? (defaultValues["documentType"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["documentType"], context) : null) : null;
        context["field"] = "errmsg";
        context["metadata"] = (objectMetadata ? objectMetadata["errmsg"] : null);
