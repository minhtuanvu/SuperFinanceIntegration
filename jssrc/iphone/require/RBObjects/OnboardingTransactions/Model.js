...
define([], function() {
    ...
    function OnboardingTransactions(defaultValues) {
        ...
        context["field"] = "debitAccountId";
        context["metadata"] = (objectMetadata ? objectMetadata["debitAccountId"] : null);
        privateState.debitAccountId = defaultValues ? (defaultValues["debitAccountId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["debitAccountId"], context) : null) : null;
        context["field"] = "creditAccountId";
        context["metadata"] = (objectMetadata ? objectMetadata["creditAccountId"] : null);
        privateState.creditAccountId = defaultValues ? (defaultValues["creditAccountId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["creditAccountId"], context) : null) : null;
        context["field"] = "paymentCurrencyId";
        context["metadata"] = (objectMetadata ? objectMetadata["paymentCurrencyId"] : null);
        privateState.paymentCurrencyId = defaultValues ? (defaultValues["paymentCurrencyId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["paymentCurrencyId"], context) : null) : null;
        context["field"] = "amount";
        context["metadata"] = (objectMetadata ? objectMetadata["amount"] : null);
