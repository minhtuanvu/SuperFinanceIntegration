...
define([], function() {
    ...
    function AllLocations(defaultValues) {
        ...
        context["field"] = "Country_id";
        context["metadata"] = (objectMetadata ? objectMetadata["Country_id"] : null);
        privateState.Country_id = defaultValues ? (defaultValues["Country_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Country_id"], context) : null) : null;
        context["field"] = "Region_id";
        context["metadata"] = (objectMetadata ? objectMetadata["Region_id"] : null);
        privateState.Region_id = defaultValues ? (defaultValues["Region_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Region_id"], context) : null) : null;
     ...
     */
    AllLocations.registerProcessors = function(options, successCallback, failureCallback) {
        if (!options) {
            options = {};
        }
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("RBObjects", "AllLocations", options, metaDataSuccess, metaDataFailure);
    };
    //clone the object provided in argument.
    AllLocations.clone = function(objectToClone) {
        var clonedObj = new AllLocations();
