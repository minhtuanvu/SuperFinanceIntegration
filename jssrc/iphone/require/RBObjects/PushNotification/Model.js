...
define([], function() {
    ...
    function PushNotification(defaultValues) {
        ...
        context["field"] = "appid";
        context["metadata"] = (objectMetadata ? objectMetadata["appid"] : null);
        privateState.appid = defaultValues ? (defaultValues["appid"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["appid"], context) : null) : null;
        context["field"] = "lat";
        context["metadata"] = (objectMetadata ? objectMetadata["lat"] : null);
        privateState.lat = defaultValues ? (defaultValues["lat"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["lat"], context) : null) : null;
        context["field"] = "lon";
        context["metadata"] = (objectMetadata ? objectMetadata["lon"] : null);
        privateState.lon = defaultValues ? (defaultValues["lon"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["lon"], context) : null) : null;
        context["field"] = "msgtext";
        context["metadata"] = (objectMetadata ? objectMetadata["msgtext"] : null);
        privateState.msgtext = defaultValues ? (defaultValues["msgtext"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["msgtext"], context) : null) : null;
        context["field"] = "password";
        context["metadata"] = (objectMetadata ? objectMetadata["password"] : null);
        ...
        context["field"] = "ufid";
        context["metadata"] = (objectMetadata ? objectMetadata["ufid"] : null);
        privateState.ufid = defaultValues ? (defaultValues["ufid"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["ufid"], context) : null) : null;
        context["field"] = "userid";
        context["metadata"] = (objectMetadata ? objectMetadata["userid"] : null);
        ...
        context["field"] = "XKonyAuthorization";
        context["metadata"] = (objectMetadata ? objectMetadata["XKonyAuthorization"] : null);
        privateState.XKonyAuthorization = defaultValues ? (defaultValues["XKonyAuthorization"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["XKonyAuthorization"], context) : null) : null;
