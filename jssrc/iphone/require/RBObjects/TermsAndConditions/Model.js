...
define([], function() {
    ...
    function TermsAndConditions(defaultValues) {
        ...
        context["field"] = "termsAndConditionsCode";
        context["metadata"] = (objectMetadata ? objectMetadata["termsAndConditionsCode"] : null);
        privateState.termsAndConditionsCode = defaultValues ? (defaultValues["termsAndConditionsCode"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["termsAndConditionsCode"], context) : null) : null;
        context["field"] = "languageCode";
        context["metadata"] = (objectMetadata ? objectMetadata["languageCode"] : null);
        ...
        context["field"] = "termsAndConditionsContent";
        context["metadata"] = (objectMetadata ? objectMetadata["termsAndConditionsContent"] : null);
        privateState.termsAndConditionsContent = defaultValues ? (defaultValues["termsAndConditionsContent"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["termsAndConditionsContent"], context) : null) : null;
        context["field"] = "contentTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["contentTypeId"] : null);
        privateState.contentTypeId = defaultValues ? (defaultValues["contentTypeId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["contentTypeId"], context) : null) : null;
        context["field"] = "versionId";
        context["metadata"] = (objectMetadata ? objectMetadata["versionId"] : null);
        privateState.versionId = defaultValues ? (defaultValues["versionId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["versionId"], context) : null) : null;
        context["field"] = "alreadySigned";
        context["metadata"] = (objectMetadata ? objectMetadata["alreadySigned"] : null);
        privateState.alreadySigned = defaultValues ? (defaultValues["alreadySigned"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["alreadySigned"], context) : null) : null;
        context["field"] = "id";
        context["metadata"] = (objectMetadata ? objectMetadata["id"] : null);
