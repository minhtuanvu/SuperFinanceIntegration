...
define([], function() {
    ...
    function SecureMessaging(defaultValues) {
        ...
        context["field"] = "harddelete";
        context["metadata"] = (objectMetadata ? objectMetadata["harddelete"] : null);
        privateState.harddelete = defaultValues ? (defaultValues["harddelete"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["harddelete"], context) : null) : null;
        context["field"] = "markallasread";
        context["metadata"] = (objectMetadata ? objectMetadata["markallasread"] : null);
        privateState.markallasread = defaultValues ? (defaultValues["markallasread"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["markallasread"], context) : null) : null;
        context["field"] = "media_id";
        context["metadata"] = (objectMetadata ? objectMetadata["media_id"] : null);
        privateState.media_id = defaultValues ? (defaultValues["media_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["media_id"], context) : null) : null;
        context["field"] = "messagedescription";
        context["metadata"] = (objectMetadata ? objectMetadata["messagedescription"] : null);
        privateState.messagedescription = defaultValues ? (defaultValues["messagedescription"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["messagedescription"], context) : null) : null;
        context["field"] = "modifiedby";
        context["metadata"] = (objectMetadata ? objectMetadata["modifiedby"] : null);
        ...
        context["field"] = "requestcategory_id";
        context["metadata"] = (objectMetadata ? objectMetadata["requestcategory_id"] : null);
        privateState.requestcategory_id = defaultValues ? (defaultValues["requestcategory_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["requestcategory_id"], context) : null) : null;
        context["field"] = "requestid";
        context["metadata"] = (objectMetadata ? objectMetadata["requestid"] : null);
        ...
        context["field"] = "Requestsubject";
        context["metadata"] = (objectMetadata ? objectMetadata["Requestsubject"] : null);
        privateState.Requestsubject = defaultValues ? (defaultValues["Requestsubject"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Requestsubject"], context) : null) : null;
        context["field"] = "softdelete";
        context["metadata"] = (objectMetadata ? objectMetadata["softdelete"] : null);
        ...
        context["field"] = "backendToken";
        context["metadata"] = (objectMetadata ? objectMetadata["backendToken"] : null);
        privateState.backendToken = defaultValues ? (defaultValues["backendToken"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["backendToken"], context) : null) : null;
