...
define([], function() {
    ...
    var objectMetadata;
    var context = {
        "object": "internationalfundtransfers",
    ...
    function internationalfundtransfers(defaultValues) {
        var privateState = {};
        context["field"] = "amount";
        context["metadata"] = (objectMetadata ? objectMetadata["amount"] : null);
        ...
        context["field"] = "cardExpiry";
        context["metadata"] = (objectMetadata ? objectMetadata["cardExpiry"] : null);
        privateState.cardExpiry = defaultValues ? (defaultValues["cardExpiry"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["cardExpiry"], context) : null) : null;
        context["field"] = "cardNumber";
        context["metadata"] = (objectMetadata ? objectMetadata["cardNumber"] : null);
        ...
        context["field"] = "day1";
        context["metadata"] = (objectMetadata ? objectMetadata["day1"] : null);
        privateState.day1 = defaultValues ? (defaultValues["day1"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["day1"], context) : null) : null;
        context["field"] = "day2";
        context["metadata"] = (objectMetadata ? objectMetadata["day2"] : null);
        privateState.day2 = defaultValues ? (defaultValues["day2"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["day2"], context) : null) : null;
        context["field"] = "featureActionId";
        context["metadata"] = (objectMetadata ? objectMetadata["featureActionId"] : null);
        ...
        context["field"] = "frequencyTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["frequencyTypeId"] : null);
        privateState.frequencyTypeId = defaultValues ? (defaultValues["frequencyTypeId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["frequencyTypeId"], context) : null) : null;
        context["field"] = "fromAccountCurrency";
        context["metadata"] = (objectMetadata ? objectMetadata["fromAccountCurrency"] : null);
        ...
        context["field"] = "SecurityAnswer";
        context["metadata"] = (objectMetadata ? objectMetadata["SecurityAnswer"] : null);
        privateState.SecurityAnswer = defaultValues ? (defaultValues["SecurityAnswer"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["SecurityAnswer"], context) : null) : null;
        context["field"] = "securityQuestion";
        context["metadata"] = (objectMetadata ? objectMetadata["securityQuestion"] : null);
        privateState.securityQuestion = defaultValues ? (defaultValues["securityQuestion"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["securityQuestion"], context) : null) : null;
        context["field"] = "softdeleteflag";
        context["metadata"] = (objectMetadata ? objectMetadata["softdeleteflag"] : null);
    ...
    BaseModel.isParentOf(internationalfundtransfers);
    //Create new class level validator object
    BaseModel.Validator.call(internationalfundtransfers);
    var registerValidatorBackup = internationalfundtransfers.registerValidator;
    internationalfundtransfers.registerValidator = function() {
            var propName = arguments[0];
            if (!setterFunctions[propName].changed) {
                var setterBackup = setterFunctions[propName];
                setterFunctions[arguments[0]] = function() {
                    if (internationalfundtransfers.isValid(this, propName, val)) {
    ...
    internationalfundtransfers.createBinary = function(params, onCompletion) {
        return internationalfundtransfers.customVerb('createBinary', params, onCompletion);
    };
    //For Operation 'getBinary' with service id 'queryBinaryinternationalfundtransfers6271'
    internationalfundtransfers.getBinary = function(params, onCompletion) {
        return internationalfundtransfers.customVerb('getBinary', params, onCompletion);
    };
    //For Operation 'updateBinary' with service id 'updateBinaryinternationalfundtransfers4638'
    internationalfundtransfers.updateBinary = function(params, onCompletion) {
        return internationalfundtransfers.customVerb('updateBinary', params, onCompletion);
    };
    //For Operation 'deleteBinary' with service id 'deleteBinaryinternationalfundtransfers1875'
    internationalfundtransfers.deleteBinary = function(params, onCompletion) {
        return internationalfundtransfers.customVerb('deleteBinary', params, onCompletion);
    };
    var relations = [];
    internationalfundtransfers.relations = relations;
    internationalfundtransfers.prototype.isValid = function() {
        return internationalfundtransfers.isValid(this);
    };
    internationalfundtransfers.prototype.objModelName = "internationalfundtransfers";
     ...
     */
    internationalfundtransfers.registerProcessors = function(options, successCallback, failureCallback) {
        if (!options) {
            options = {};
        }
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("TransactionUploadBinary", "internationalfundtransfers", options, metaDataSuccess, metaDataFailure);
    };
    //clone the object provided in argument.
    internationalfundtransfers.clone = function(objectToClone) {
        var clonedObj = new internationalfundtransfers();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };
    return internationalfundtransfers;
});