...
define([], function() {
    ...
    function ownaccounttransfers(defaultValues) {
        var privateState = {};
        context["field"] = "amount";
        context["metadata"] = (objectMetadata ? objectMetadata["amount"] : null);
    ...
    BaseModel.isParentOf(ownaccounttransfers);
    //Create new class level validator object
    BaseModel.Validator.call(ownaccounttransfers);
    var registerValidatorBackup = ownaccounttransfers.registerValidator;
    ownaccounttransfers.registerValidator = function() {
            var propName = arguments[0];
            if (!setterFunctions[propName].changed) {
                var setterBackup = setterFunctions[propName];
                setterFunctions[arguments[0]] = function() {
                    if (ownaccounttransfers.isValid(this, propName, val)) {
    ...
    ownaccounttransfers.createBinary = function(params, onCompletion) {
        return ownaccounttransfers.customVerb('createBinary', params, onCompletion);
    };
    //For Operation 'getBinary' with service id 'queryBinaryownaccounttransfers9194'
    ownaccounttransfers.getBinary = function(params, onCompletion) {
        return ownaccounttransfers.customVerb('getBinary', params, onCompletion);
    };
    //For Operation 'updateBinary' with service id 'updateBinaryownaccounttransfers7374'
    ownaccounttransfers.updateBinary = function(params, onCompletion) {
        return ownaccounttransfers.customVerb('updateBinary', params, onCompletion);
    };
    //For Operation 'deleteBinary' with service id 'deleteBinaryownaccounttransfers9700'
    ownaccounttransfers.deleteBinary = function(params, onCompletion) {
        return ownaccounttransfers.customVerb('deleteBinary', params, onCompletion);
    };
    var relations = [];
    ownaccounttransfers.relations = relations;
    ownaccounttransfers.prototype.isValid = function() {
        return ownaccounttransfers.isValid(this);
    };
    ownaccounttransfers.prototype.objModelName = "ownaccounttransfers";
     ...
     */
    ownaccounttransfers.registerProcessors = function(options, successCallback, failureCallback) {
        if (!options) {
            options = {};
        }
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("TransactionUploadBinary", "ownaccounttransfers", options, metaDataSuccess, metaDataFailure);
    };
    //clone the object provided in argument.
    ownaccounttransfers.clone = function(objectToClone) {
        var clonedObj = new ownaccounttransfers();
        clonedObj.fromJsonInternal(objectToClone.toJsonInternal());
        return clonedObj;
    };
    return ownaccounttransfers;
});