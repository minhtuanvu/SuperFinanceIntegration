...
define([], function() {
    ...
    function intrabanktransfers(defaultValues) {
        var privateState = {};
        context["field"] = "amount";
        context["metadata"] = (objectMetadata ? objectMetadata["amount"] : null);
    ...
    BaseModel.isParentOf(intrabanktransfers);
    //Create new class level validator object
    BaseModel.Validator.call(intrabanktransfers);
    var registerValidatorBackup = intrabanktransfers.registerValidator;
    intrabanktransfers.registerValidator = function() {
            var propName = arguments[0];
            if (!setterFunctions[propName].changed) {
                var setterBackup = setterFunctions[propName];
                setterFunctions[arguments[0]] = function() {
                    if (intrabanktransfers.isValid(this, propName, val)) {
    ...
    intrabanktransfers.createBinary = function(params, onCompletion) {
        return intrabanktransfers.customVerb('createBinary', params, onCompletion);
    };
    //For Operation 'getBinary' with service id 'queryBinaryintrabanktransfers1072'
    intrabanktransfers.getBinary = function(params, onCompletion) {
        return intrabanktransfers.customVerb('getBinary', params, onCompletion);
    };
    //For Operation 'updateBinary' with service id 'updateBinaryintrabanktransfers3474'
    intrabanktransfers.updateBinary = function(params, onCompletion) {
        return intrabanktransfers.customVerb('updateBinary', params, onCompletion);
    };
    //For Operation 'deleteBinary' with service id 'deleteBinaryintrabanktransfers8713'
    intrabanktransfers.deleteBinary = function(params, onCompletion) {
        return intrabanktransfers.customVerb('deleteBinary', params, onCompletion);
    };
    var relations = [];
    intrabanktransfers.relations = relations;
    intrabanktransfers.prototype.isValid = function() {
        return intrabanktransfers.isValid(this);
    };
    intrabanktransfers.prototype.objModelName = "intrabanktransfers";
     ...
     */
    intrabanktransfers.registerProcessors = function(options, successCallback, failureCallback) {
        if (!options) {
            options = {};
        }
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("TransactionUploadBinary", "intrabanktransfers", options, metaDataSuccess, metaDataFailure);
    };
    //clone the object provided in argument.
    intrabanktransfers.clone = function(objectToClone) {
        var clonedObj = new intrabanktransfers();
