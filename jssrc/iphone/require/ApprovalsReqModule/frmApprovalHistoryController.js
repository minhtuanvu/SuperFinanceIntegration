define("ApprovalsReqModule/userfrmApprovalHistoryController", ["CommonUtilities"], function(CommonUtilities) {
    return {
        timerCounter: 0,
        ...
        showflxAdvSearch: function() {
            ...
            if (presenter.presentationController.isSingleApprovalsPendingAvailable) {
                ...
                for (i = 0; i < segSingleData.length; i++) {
                    if (this.selectedFilter !== "") {
                        if (segSingleData[i]["lblText"] === this.selectedFilter) segSingleData[i]["imgSelect"] = "tickmark_green.png";
                        else segSingleData[i]["imgSelect"] = "transparent.png";
                    } else {
            ...
            if (presenter.presentationController.isBulkApprovalsPendingAvailable) {
                ...
                for (i = 0; i < segBulkData.length; i++) {
                    if (this.selectedFilter !== "") {
                        if (segBulkData[i]["lblText"] === this.selectedFilter) segBulkData[i]["imgSelect"] = "tickmark_green.png";
                        else segBulkData[i]["imgSelect"] = "transparent.png";
                    } else {
            ...
            if (presenter.presentationController.isOtherApprovalsPendingAvailable) {
                ...
                for (i = 0; i < segOtherData.length; i++) {
                    if (this.selectedFilter !== "") {
                        if (segOtherData[i]["lblText"] === this.selectedFilter) segOtherData[i]["imgSelect"] = "tickmark_green.png";
                        else segOtherData[i]["imgSelect"] = "transparent.png";
                    } else {
        ...
        fetchCounts: function() {
            var presenter = kony.mvc.MDAApplication.getSharedInstance().getModuleManager().getModule('ACHModule');
            if (presenter.presentationController.hasCountsServiceFailed === 0) presenter.presentationController.getAllCounts();
        },
...
define("ApprovalsReqModule/frmApprovalHistoryControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_d6c6974a6fde4caeb3788096c9eaed28: function AS_FlexContainer_d6c6974a6fde4caeb3788096c9eaed28(eventobject) {
        var self = this;
        var ntf = new kony.mvc.Navigation("frmApprovalsAndRequestsFilters");
        ntf.navigate({
            "_meta_": {
                "eventName": "onClick",
                "widgetId": "flxShowfilter"
            }
        });
    },
    AS_Form_c723364f0fb847109c50089490d865d8: function AS_Form_c723364f0fb847109c50089490d865d8(eventobject) {
        var self = this;
        this.init();
    },
    AS_BarButtonItem_cbeed36595b04ec7ae0aec7dd289776c: function AS_BarButtonItem_cbeed36595b04ec7ae0aec7dd289776c(eventobject) {
        var self = this;
        this.navToPrevForm();
    }
});
define("ApprovalsReqModule/frmApprovalHistoryController", ["ApprovalsReqModule/userfrmApprovalHistoryController", "ApprovalsReqModule/frmApprovalHistoryControllerActions"], function() {
    var controller = require("ApprovalsReqModule/userfrmApprovalHistoryController");
    var controllerActions = ["ApprovalsReqModule/frmApprovalHistoryControllerActions"];
