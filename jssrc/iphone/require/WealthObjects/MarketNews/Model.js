...
define([], function() {
    ...
    function MarketNews(defaultValues) {
        ...
        context["field"] = "Topic";
        context["metadata"] = (objectMetadata ? objectMetadata["Topic"] : null);
        privateState.Topic = defaultValues ? (defaultValues["Topic"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Topic"], context) : null) : null;
        context["field"] = "HL";
        context["metadata"] = (objectMetadata ? objectMetadata["HL"] : null);
        privateState.HL = defaultValues ? (defaultValues["HL"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["HL"], context) : null) : null;
        context["field"] = "ID";
        context["metadata"] = (objectMetadata ? objectMetadata["ID"] : null);
        ...
        context["field"] = "PR";
        context["metadata"] = (objectMetadata ? objectMetadata["PR"] : null);
        privateState.PR = defaultValues ? (defaultValues["PR"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["PR"], context) : null) : null;
        context["field"] = "LT";
        context["metadata"] = (objectMetadata ? objectMetadata["LT"] : null);
        privateState.LT = defaultValues ? (defaultValues["LT"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["LT"], context) : null) : null;
        context["field"] = "HT";
        context["metadata"] = (objectMetadata ? objectMetadata["HT"] : null);
        privateState.HT = defaultValues ? (defaultValues["HT"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["HT"], context) : null) : null;
        context["field"] = "TE";
        context["metadata"] = (objectMetadata ? objectMetadata["TE"] : null);
        privateState.TE = defaultValues ? (defaultValues["TE"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["TE"], context) : null) : null;
        context["field"] = "pageSize";
        context["metadata"] = (objectMetadata ? objectMetadata["pageSize"] : null);
