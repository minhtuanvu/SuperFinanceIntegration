...
*/
define("AccountModule/userfrmDashboardAggregated2Controller", {
    //mobile controller
    accountDetails: null,
    segLength: 0,
    totalLength: 0,
    ...
    RotateLables: function(labelWidget) {
        ...
        trans100.rotate(45);
        labelWidget.animate(kony.ui.createAnimation({
            "100": {
                "stepConfig": {
    ...
    chartSizeToggleOnClick: function() {
        ...
        if (this.isChartCollapsed) { //Expand animation
            trans100.rotate(180);
            this.view.imgChartSizeToggle.animate(kony.ui.createAnimation({
                100: {
                    stepConfig: {
                        "timingFunction": kony.anim.EASE
                    },
            ...
            scope.view.flxHScroll.animate(kony.ui.createAnimation({
                0: {
                    height: "250dp",
                    "stepConfig": {}
                },
            ...
            scope.view.flxShadow.animate(kony.ui.createAnimation({
                0: {
                    top: "225dp",
                    "stepConfig": {}
                },
            ...
            scope.view.flxChartSizeToggle.animate(kony.ui.createAnimation({
                0: {
                    top: "250dp",
                    "stepConfig": {}
                },
            ...
            scope.view.flxSelectAccount.animate(kony.ui.createAnimation({
                0: {
                    top: "285dp",
                    "stepConfig": {}
                },
            ...
            scope.view.flxGradient.animate(kony.ui.createAnimation({
                0: {
                    height: "260dp",
                    "stepConfig": {}
                },
...
define("AccountModule/frmDashboardAggregated2ControllerActions", {
    /*
...
define("AccountModule/frmDashboardAggregated2Controller", ["AccountModule/userfrmDashboardAggregated2Controller", "AccountModule/frmDashboardAggregated2ControllerActions"], function() {
    var controller = require("AccountModule/userfrmDashboardAggregated2Controller");
    var controllerActions = ["AccountModule/frmDashboardAggregated2ControllerActions"];
