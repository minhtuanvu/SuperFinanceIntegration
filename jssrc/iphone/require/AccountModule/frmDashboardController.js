define("AccountModule/userfrmDashboardController", {
    adsHided: false,
    currAdFlex: 1,
    ...
    mapDataToBar: function() {
        ...
        if (!result) {
            kony.ui.Alert("Error in creating chart");
        }
    },
    mapDataToChart: function() {
        ...
        if (!x) {
            kony.ui.Alert("Error in creating PFM chart");
        }
    ...
    onAdTap: function() {
        var adNumber = this.imageObjArray[this.currAdFlex - 1];
        var adData = this.accountDashboardCampaignData[adNumber - 1];
        var navUrl = adData.destinationURL;
        if (navUrl) {
...
define("AccountModule/frmDashboardControllerActions", {
    /*
...
define("AccountModule/frmDashboardController", ["AccountModule/userfrmDashboardController", "AccountModule/frmDashboardControllerActions"], function() {
