...
define([], function() {
    ...
    function Campaigns(defaultValues) {
        ...
        context["field"] = "eventCode";
        context["metadata"] = (objectMetadata ? objectMetadata["eventCode"] : null);
        privateState.eventCode = defaultValues ? (defaultValues["eventCode"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["eventCode"], context) : null) : null;
        context["field"] = "placeholderCode";
        context["metadata"] = (objectMetadata ? objectMetadata["placeholderCode"] : null);
        privateState.placeholderCode = defaultValues ? (defaultValues["placeholderCode"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["placeholderCode"], context) : null) : null;
        context["field"] = "scale";
        context["metadata"] = (objectMetadata ? objectMetadata["scale"] : null);
