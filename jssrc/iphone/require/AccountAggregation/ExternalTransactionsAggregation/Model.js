...
define([], function() {
    ...
    var objectMetadata;
    var context = {
        "object": "ExternalTransactionsAggregation",
    ...
    function ExternalTransactionsAggregation(defaultValues) {
        ...
        context["field"] = "allowed_attempts";
        context["metadata"] = (objectMetadata ? objectMetadata["allowed_attempts"] : null);
        privateState.allowed_attempts = defaultValues ? (defaultValues["allowed_attempts"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["allowed_attempts"], context) : null) : null;
        context["field"] = "challenge_id";
        context["metadata"] = (objectMetadata ? objectMetadata["challenge_id"] : null);
        privateState.challenge_id = defaultValues ? (defaultValues["challenge_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["challenge_id"], context) : null) : null;
        context["field"] = "challenge_type";
        context["metadata"] = (objectMetadata ? objectMetadata["challenge_type"] : null);
        privateState.challenge_type = defaultValues ? (defaultValues["challenge_type"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["challenge_type"], context) : null) : null;
        context["field"] = "charged_amount";
        context["metadata"] = (objectMetadata ? objectMetadata["charged_amount"] : null);
        privateState.charged_amount = defaultValues ? (defaultValues["charged_amount"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["charged_amount"], context) : null) : null;
        context["field"] = "charged_currency_type";
        context["metadata"] = (objectMetadata ? objectMetadata["charged_currency_type"] : null);
        privateState.charged_currency_type = defaultValues ? (defaultValues["charged_currency_type"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["charged_currency_type"], context) : null) : null;
        context["field"] = "charge_policy";
        context["metadata"] = (objectMetadata ? objectMetadata["charge_policy"] : null);
        privateState.charge_policy = defaultValues ? (defaultValues["charge_policy"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["charge_policy"], context) : null) : null;
        context["field"] = "charge_summary";
        context["metadata"] = (objectMetadata ? objectMetadata["charge_summary"] : null);
        privateState.charge_summary = defaultValues ? (defaultValues["charge_summary"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["charge_summary"], context) : null) : null;
        context["field"] = "PayeeId";
        context["metadata"] = (objectMetadata ? objectMetadata["PayeeId"] : null);
        ...
        context["field"] = "payee_account_id";
        context["metadata"] = (objectMetadata ? objectMetadata["payee_account_id"] : null);
        privateState.payee_account_id = defaultValues ? (defaultValues["payee_account_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["payee_account_id"], context) : null) : null;
        context["field"] = "payee_bank_id";
        context["metadata"] = (objectMetadata ? objectMetadata["payee_bank_id"] : null);
        privateState.payee_bank_id = defaultValues ? (defaultValues["payee_bank_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["payee_bank_id"], context) : null) : null;
        context["field"] = "payer_account_id";
        context["metadata"] = (objectMetadata ? objectMetadata["payer_account_id"] : null);
        privateState.payer_account_id = defaultValues ? (defaultValues["payer_account_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["payer_account_id"], context) : null) : null;
        context["field"] = "payer_bank_id";
        context["metadata"] = (objectMetadata ? objectMetadata["payer_bank_id"] : null);
        privateState.payer_bank_id = defaultValues ? (defaultValues["payer_bank_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["payer_bank_id"], context) : null) : null;
        context["field"] = "start_date";
        context["metadata"] = (objectMetadata ? objectMetadata["start_date"] : null);
        ...
        context["field"] = "transacted_amount";
        context["metadata"] = (objectMetadata ? objectMetadata["transacted_amount"] : null);
        privateState.transacted_amount = defaultValues ? (defaultValues["transacted_amount"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transacted_amount"], context) : null) : null;
        context["field"] = "transacted_currency_type";
        context["metadata"] = (objectMetadata ? objectMetadata["transacted_currency_type"] : null);
        privateState.transacted_currency_type = defaultValues ? (defaultValues["transacted_currency_type"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transacted_currency_type"], context) : null) : null;
        context["field"] = "transaction_description";
        context["metadata"] = (objectMetadata ? objectMetadata["transaction_description"] : null);
        privateState.transaction_description = defaultValues ? (defaultValues["transaction_description"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transaction_description"], context) : null) : null;
        context["field"] = "TransactionId";
        context["metadata"] = (objectMetadata ? objectMetadata["TransactionId"] : null);
        ...
        context["field"] = "transaction_ids";
        context["metadata"] = (objectMetadata ? objectMetadata["transaction_ids"] : null);
        privateState.transaction_ids = defaultValues ? (defaultValues["transaction_ids"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transaction_ids"], context) : null) : null;
        context["field"] = "transaction_type";
        context["metadata"] = (objectMetadata ? objectMetadata["transaction_type"] : null);
        privateState.transaction_type = defaultValues ? (defaultValues["transaction_type"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transaction_type"], context) : null) : null;
        context["field"] = "transation_status";
        context["metadata"] = (objectMetadata ? objectMetadata["transation_status"] : null);
        privateState.transation_status = defaultValues ? (defaultValues["transation_status"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["transation_status"], context) : null) : null;
        context["field"] = "currency_type";
        context["metadata"] = (objectMetadata ? objectMetadata["currency_type"] : null);
        privateState.currency_type = defaultValues ? (defaultValues["currency_type"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["currency_type"], context) : null) : null;
        context["field"] = "account";
        context["metadata"] = (objectMetadata ? objectMetadata["account"] : null);
        privateState.account = defaultValues ? (defaultValues["account"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["account"], context) : null) : null;
        context["field"] = "bank_name";
        context["metadata"] = (objectMetadata ? objectMetadata["bank_name"] : null);
        privateState.bank_name = defaultValues ? (defaultValues["bank_name"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["bank_name"], context) : null) : null;
        context["field"] = "main_user";
        context["metadata"] = (objectMetadata ? objectMetadata["main_user"] : null);
        ...
        context["field"] = "no_of_transactions";
        context["metadata"] = (objectMetadata ? objectMetadata["no_of_transactions"] : null);
        privateState.no_of_transactions = defaultValues ? (defaultValues["no_of_transactions"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["no_of_transactions"], context) : null) : null;
        context["field"] = "isSearch";
        context["metadata"] = (objectMetadata ? objectMetadata["isSearch"] : null);
        privateState.isSearch = defaultValues ? (defaultValues["isSearch"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isSearch"], context) : null) : null;
        context["field"] = "keyword";
        context["metadata"] = (objectMetadata ? objectMetadata["keyword"] : null);
        privateState.keyword = defaultValues ? (defaultValues["keyword"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["keyword"], context) : null) : null;
        context["field"] = "startDate";
        context["metadata"] = (objectMetadata ? objectMetadata["startDate"] : null);
        ...
        context["field"] = "minAmount";
        context["metadata"] = (objectMetadata ? objectMetadata["minAmount"] : null);
        privateState.minAmount = defaultValues ? (defaultValues["minAmount"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["minAmount"], context) : null) : null;
        context["field"] = "maxAmount";
        context["metadata"] = (objectMetadata ? objectMetadata["maxAmount"] : null);
        ...
        context["field"] = "orderby";
        context["metadata"] = (objectMetadata ? objectMetadata["orderby"] : null);
        privateState.orderby = defaultValues ? (defaultValues["orderby"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["orderby"], context) : null) : null;
