...
define([], function() {
    ...
    var setterFunctions = {
        ...
        InternalAccount: function(val, state) {
            context["field"] = "InternalAccount";
            context["metadata"] = (objectMetadata ? objectMetadata["InternalAccount"] : null);
            state['InternalAccount'] = kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, val, context);
        },
    ...
    function RefreshAccountsFromDB(defaultValues) {
        ...
        context["field"] = "BankLogo";
        context["metadata"] = (objectMetadata ? objectMetadata["BankLogo"] : null);
        privateState.BankLogo = defaultValues ? (defaultValues["BankLogo"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["BankLogo"], context) : null) : null;
        context["field"] = "TypeDescription";
        context["metadata"] = (objectMetadata ? objectMetadata["TypeDescription"] : null);
        ...
        context["field"] = "InternalAccount";
        context["metadata"] = (objectMetadata ? objectMetadata["InternalAccount"] : null);
        privateState.InternalAccount = defaultValues ? (defaultValues["InternalAccount"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["InternalAccount"], context) : null) : null;
        context["field"] = "Username";
        context["metadata"] = (objectMetadata ? objectMetadata["Username"] : null);
        ...
        Object.defineProperties(this, {
            ...
            "InternalAccount": {
                get: function() {
                    context["field"] = "InternalAccount";
                    context["metadata"] = (objectMetadata ? objectMetadata["InternalAccount"] : null);
                    return kony.mvc.util.ProcessorUtils.applyFunction(postProcessorCallback, privateState.InternalAccount, context);
                },
                set: function(val) {
        ...
        this.fromJsonInternal = function(value) {
            ...
            privateState.InternalAccount = value ? (value["InternalAccount"] ? value["InternalAccount"] : null) : null;
     ...
     */
    RefreshAccountsFromDB.registerProcessors = function(options, successCallback, failureCallback) {
        if (!options) {
            options = {};
        }
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("AccountAggregation", "RefreshAccountsFromDB", options, metaDataSuccess, metaDataFailure);
    };
    //clone the object provided in argument.
    RefreshAccountsFromDB.clone = function(objectToClone) {
        var clonedObj = new RefreshAccountsFromDB();
