...
define([], function() {
    ...
    function ExternalBanks(defaultValues) {
        ...
        context["field"] = "IdentityProvider";
        context["metadata"] = (objectMetadata ? objectMetadata["IdentityProvider"] : null);
        privateState.IdentityProvider = defaultValues ? (defaultValues["IdentityProvider"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["IdentityProvider"], context) : null) : null;
        context["field"] = "Scheme";
        context["metadata"] = (objectMetadata ? objectMetadata["Scheme"] : null);
        ...
        context["field"] = "Oauth2";
        context["metadata"] = (objectMetadata ? objectMetadata["Oauth2"] : null);
        privateState.Oauth2 = defaultValues ? (defaultValues["Oauth2"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["Oauth2"], context) : null) : null;
        context["field"] = "logo";
        context["metadata"] = (objectMetadata ? objectMetadata["logo"] : null);
        privateState.logo = defaultValues ? (defaultValues["logo"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["logo"], context) : null) : null;
