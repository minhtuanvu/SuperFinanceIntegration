...
define([], function() {
     ...
     */
    RefreshAccounts.registerProcessors = function(options, successCallback, failureCallback) {
        if (!options) {
            options = {};
        }
        ...
        kony.mvc.util.ProcessorUtils.getMetadataForObject("AccountAggregation", "RefreshAccounts", options, metaDataSuccess, metaDataFailure);
    };
    //clone the object provided in argument.
    RefreshAccounts.clone = function(objectToClone) {
        var clonedObj = new RefreshAccounts();
