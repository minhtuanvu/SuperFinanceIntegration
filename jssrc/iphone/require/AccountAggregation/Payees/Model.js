...
define([], function() {
    ...
    function Payees(defaultValues) {
        ...
        context["field"] = "counterparty_id";
        context["metadata"] = (objectMetadata ? objectMetadata["counterparty_id"] : null);
        privateState.counterparty_id = defaultValues ? (defaultValues["counterparty_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["counterparty_id"], context) : null) : null;
        context["field"] = "created_by_user_id";
        context["metadata"] = (objectMetadata ? objectMetadata["created_by_user_id"] : null);
        privateState.created_by_user_id = defaultValues ? (defaultValues["created_by_user_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["created_by_user_id"], context) : null) : null;
        context["field"] = "is_beneficiary";
        context["metadata"] = (objectMetadata ? objectMetadata["is_beneficiary"] : null);
        privateState.is_beneficiary = defaultValues ? (defaultValues["is_beneficiary"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["is_beneficiary"], context) : null) : null;
        context["field"] = "name";
        context["metadata"] = (objectMetadata ? objectMetadata["name"] : null);
        ...
        context["field"] = "other_account_routing_address";
        context["metadata"] = (objectMetadata ? objectMetadata["other_account_routing_address"] : null);
        privateState.other_account_routing_address = defaultValues ? (defaultValues["other_account_routing_address"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["other_account_routing_address"], context) : null) : null;
        context["field"] = "other_account_routing_scheme";
        context["metadata"] = (objectMetadata ? objectMetadata["other_account_routing_scheme"] : null);
        privateState.other_account_routing_scheme = defaultValues ? (defaultValues["other_account_routing_scheme"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["other_account_routing_scheme"], context) : null) : null;
        context["field"] = "other_bank_routing_address";
        context["metadata"] = (objectMetadata ? objectMetadata["other_bank_routing_address"] : null);
        privateState.other_bank_routing_address = defaultValues ? (defaultValues["other_bank_routing_address"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["other_bank_routing_address"], context) : null) : null;
        context["field"] = "other_bank_routing_scheme";
        context["metadata"] = (objectMetadata ? objectMetadata["other_bank_routing_scheme"] : null);
        privateState.other_bank_routing_scheme = defaultValues ? (defaultValues["other_bank_routing_scheme"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["other_bank_routing_scheme"], context) : null) : null;
        context["field"] = "other_branch_routing_address";
        context["metadata"] = (objectMetadata ? objectMetadata["other_branch_routing_address"] : null);
        privateState.other_branch_routing_address = defaultValues ? (defaultValues["other_branch_routing_address"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["other_branch_routing_address"], context) : null) : null;
        context["field"] = "other_branch_routing_scheme";
        context["metadata"] = (objectMetadata ? objectMetadata["other_branch_routing_scheme"] : null);
        privateState.other_branch_routing_scheme = defaultValues ? (defaultValues["other_branch_routing_scheme"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["other_branch_routing_scheme"], context) : null) : null;
        context["field"] = "this_account_id";
        context["metadata"] = (objectMetadata ? objectMetadata["this_account_id"] : null);
        privateState.this_account_id = defaultValues ? (defaultValues["this_account_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["this_account_id"], context) : null) : null;
        context["field"] = "this_bank_id";
        context["metadata"] = (objectMetadata ? objectMetadata["this_bank_id"] : null);
        privateState.this_bank_id = defaultValues ? (defaultValues["this_bank_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["this_bank_id"], context) : null) : null;
        context["field"] = "this_view_id";
        context["metadata"] = (objectMetadata ? objectMetadata["this_view_id"] : null);
        privateState.this_view_id = defaultValues ? (defaultValues["this_view_id"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["this_view_id"], context) : null) : null;
