...
define([], function() {
    ...
    function PasswordPolicy(defaultValues) {
        ...
        context["field"] = "PasswordPolicy";
        context["metadata"] = (objectMetadata ? objectMetadata["PasswordPolicy"] : null);
        privateState.PasswordPolicy = defaultValues ? (defaultValues["PasswordPolicy"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["PasswordPolicy"], context) : null) : null;
