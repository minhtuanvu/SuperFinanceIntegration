define("ExternalAccounts/frmSelectExternalBanks", function() {
    return function(controller) {
        function addWidgetsfrmSelectExternalBanks() {
            ...
            var customHeader = new com.kmb.common.customHeader({
                ...
                "overrides": {
                    ...
                    "lblLocateUs": {
                        ...
                        "text": kony.i18n.getLocalizedString("kony.mb.SelectExternalBank.Title")
                    }
                }
            }, {
                "overrides": {}
        ...
        return [{
            "addWidgets": addWidgetsfrmSelectExternalBanks,
            "enabledForIdleTimeout": true,
            "id": "frmSelectExternalBanks",
            "init": controller.AS_Form_f0b20cf8fdfa4a8d804264b01445b1a0,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": function(eventobject) {
                controller.AS_Form_h5d78c8f29d145de80bd0be43e28f2c7(eventobject);
            },
