...
define([], function() {
    ...
    function Banks(defaultValues) {
        ...
        context["field"] = "supportedAccountNaturess";
        context["metadata"] = (objectMetadata ? objectMetadata["supportedAccountNaturess"] : null);
        privateState.supportedAccountNaturess = defaultValues ? (defaultValues["supportedAccountNaturess"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supportedAccountNaturess"], context) : null) : null;
        context["field"] = "internalBankId";
        context["metadata"] = (objectMetadata ? objectMetadata["internalBankId"] : null);
        privateState.internalBankId = defaultValues ? (defaultValues["internalBankId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["internalBankId"], context) : null) : null;
        context["field"] = "supportedFetchScopess";
        context["metadata"] = (objectMetadata ? objectMetadata["supportedFetchScopess"] : null);
        privateState.supportedFetchScopess = defaultValues ? (defaultValues["supportedFetchScopess"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supportedFetchScopess"], context) : null) : null;
        context["field"] = "timeZone";
        context["metadata"] = (objectMetadata ? objectMetadata["timeZone"] : null);
        ...
        context["field"] = "isActive";
        context["metadata"] = (objectMetadata ? objectMetadata["isActive"] : null);
        privateState.isActive = defaultValues ? (defaultValues["isActive"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isActive"], context) : null) : null;
        context["field"] = "supportedAccountTypess";
        context["metadata"] = (objectMetadata ? objectMetadata["supportedAccountTypess"] : null);
        privateState.supportedAccountTypess = defaultValues ? (defaultValues["supportedAccountTypess"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["supportedAccountTypess"], context) : null) : null;
        context["field"] = "logoUrl";
        context["metadata"] = (objectMetadata ? objectMetadata["logoUrl"] : null);
        ...
        context["field"] = "mode";
        context["metadata"] = (objectMetadata ? objectMetadata["mode"] : null);
        privateState.mode = defaultValues ? (defaultValues["mode"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["mode"], context) : null) : null;
        context["field"] = "homeUrl";
        context["metadata"] = (objectMetadata ? objectMetadata["homeUrl"] : null);
        privateState.homeUrl = defaultValues ? (defaultValues["homeUrl"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["homeUrl"], context) : null) : null;
        context["field"] = "provider";
        context["metadata"] = (objectMetadata ? objectMetadata["provider"] : null);
        privateState.provider = defaultValues ? (defaultValues["provider"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["provider"], context) : null) : null;
        context["field"] = "loginUrl";
        context["metadata"] = (objectMetadata ? objectMetadata["loginUrl"] : null);
        privateState.loginUrl = defaultValues ? (defaultValues["loginUrl"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["loginUrl"], context) : null) : null;
        context["field"] = "countryCode";
        context["metadata"] = (objectMetadata ? objectMetadata["countryCode"] : null);
        ...
        context["field"] = "providerStatus";
        context["metadata"] = (objectMetadata ? objectMetadata["providerStatus"] : null);
        privateState.providerStatus = defaultValues ? (defaultValues["providerStatus"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["providerStatus"], context) : null) : null;
