define("flxDetailsList", function() {
    return function(controller) {
        var flxDetailsList = new kony.ui.FlexContainer({
        ...
        flxDetailsList.setDefaultUnit(kony.flex.DP);
        ...
        flxDetailsList.add(flxMain);
        return flxDetailsList;
    }
})