...
define([], function() {
    ...
    var context = {
        ...
        "objectService": "DocumentStorageObjects"
    };
    var setterFunctions = {
    ...
    function DocumentStorage(defaultValues) {
        ...
        context["field"] = "documentId";
        context["metadata"] = (objectMetadata ? objectMetadata["documentId"] : null);
        privateState.documentId = defaultValues ? (defaultValues["documentId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["documentId"], context) : null) : null;
        context["field"] = "documentName";
        context["metadata"] = (objectMetadata ? objectMetadata["documentName"] : null);
        privateState.documentName = defaultValues ? (defaultValues["documentName"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["documentName"], context) : null) : null;
        context["field"] = "content";
        context["metadata"] = (objectMetadata ? objectMetadata["content"] : null);
        ...
        context["field"] = "version";
        context["metadata"] = (objectMetadata ? objectMetadata["version"] : null);
        privateState.version = defaultValues ? (defaultValues["version"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["version"], context) : null) : null;
        context["field"] = "userId";
        context["metadata"] = (objectMetadata ? objectMetadata["userId"] : null);
        ...
        context["field"] = "fileInfo";
        context["metadata"] = (objectMetadata ? objectMetadata["fileInfo"] : null);
        privateState.fileInfo = defaultValues ? (defaultValues["fileInfo"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["fileInfo"], context) : null) : null;
        context["field"] = "category";
        context["metadata"] = (objectMetadata ? objectMetadata["category"] : null);
        ...
        context["field"] = "documentGroup";
        context["metadata"] = (objectMetadata ? objectMetadata["documentGroup"] : null);
        privateState.documentGroup = defaultValues ? (defaultValues["documentGroup"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["documentGroup"], context) : null) : null;
        context["field"] = "ownerSystemId";
        context["metadata"] = (objectMetadata ? objectMetadata["ownerSystemId"] : null);
        privateState.ownerSystemId = defaultValues ? (defaultValues["ownerSystemId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["ownerSystemId"], context) : null) : null;
