define("TransferModuleEurope/userfrmEuropeTransferAmountController", {
    keypadString: '0',
    currencyValue: 'EUR',
    isPeriodUsed: false,
    selectedTab: null,
        ...
        if (transferPresentationController.getEuropeFlowType() === "INTERNAL" || transferPresentationController.transactionMode === applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.transfer.OtherBankAccounts") || transferPresentationController.transactionMode === applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.transfer.OtherKonyBankMembers")) {
            ...
            if (transferPresentationController.isLoansAccountType) {
                ...
                if (transObj.amount) {
                    ...
                    if (transObj.paymentDue === undefined || transObj.paymentDue === null) transObj.paymentDue = "0";
                    var totalPayment = "" + (Number(transObj.nextPaymentAmount) + Number(transObj.paymentDue));
                    if (totalPayment === "0" || totalPayment === "0.00") sendAmount = null;
                    else sendAmount = totalPayment;
    ...
    initActions: function() {
        ...
        var transferPresentationController = applicationManager.getModulesPresentationController("TransferModule");
        var transObj = transferPresentationController.getTransObject();
        if (transObj.nextPaymentAmount === undefined || transObj.nextPaymentAmount === null) transObj.nextPaymentAmount = "0";
        if (transObj.paymentDue === undefined || transObj.paymentDue === null) transObj.paymentDue = "0";
...
define("TransferModuleEurope/frmEuropeTransferAmountControllerActions", {
    /*
    ...
    */
    ...
    AS_Button_d78eda181d3641e69b234607168dd2e1: function AS_Button_d78eda181d3641e69b234607168dd2e1(eventobject) {
        var self = this;
        this.setKeypadChar(',')
    },
...
define("TransferModuleEurope/frmEuropeTransferAmountController", ["TransferModuleEurope/userfrmEuropeTransferAmountController", "TransferModuleEurope/frmEuropeTransferAmountControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmEuropeTransferAmountController");
    var controllerActions = ["TransferModuleEurope/frmEuropeTransferAmountControllerActions"];
