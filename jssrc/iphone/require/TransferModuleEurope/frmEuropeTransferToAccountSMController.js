define("TransferModuleEurope/userfrmEuropeTransferToAccountSMController", {
    sec: -1,
    row: -1,
    segmentHeight: 0,
    payeesList: 0,
...
define("TransferModuleEurope/frmEuropeTransferToAccountSMControllerActions", {
    /*
    ...
    */
    ...
    AS_BarButtonItem_j4aa8a540e4b4abbb882b8a8988f0fb1: function AS_BarButtonItem_j4aa8a540e4b4abbb882b8a8988f0fb1(eventobject) {
        var self = this;
        this.cancelOnClick();
    }
});
define("TransferModuleEurope/frmEuropeTransferToAccountSMController", ["TransferModuleEurope/userfrmEuropeTransferToAccountSMController", "TransferModuleEurope/frmEuropeTransferToAccountSMControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmEuropeTransferToAccountSMController");
    var controllerActions = ["TransferModuleEurope/frmEuropeTransferToAccountSMControllerActions"];
