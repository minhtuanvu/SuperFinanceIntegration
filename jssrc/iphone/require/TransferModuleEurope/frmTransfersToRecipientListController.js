  define("TransferModuleEurope/userfrmTransfersToRecipientListController", {
      recipientType: '',
      deletesegData: [],
      segmentData: null,
      timerCounter: 0,
      ...
      setTransfersSegmentData: function() {
          ...
          for (var i = 0; i < segmentData.length; i++) {
              ...
              if (segmentData[i].IBAN) segmentData[i].IBAN = applicationManager.getFormatUtilManager().formatIBAN(segmentData[i].IBAN);
          }
...
define("TransferModuleEurope/frmTransfersToRecipientListControllerActions", {
    /*
...
define("TransferModuleEurope/frmTransfersToRecipientListController", ["TransferModuleEurope/userfrmTransfersToRecipientListController", "TransferModuleEurope/frmTransfersToRecipientListControllerActions"], function() {
    var controller = require("TransferModuleEurope/userfrmTransfersToRecipientListController");
    var controllerActions = ["TransferModuleEurope/frmTransfersToRecipientListControllerActions"];
