define("LocateUsModule/userfrmLocationMapController", ['CampaignUtility'], function(CampaignUtility) {
    return {
        timerCounter: 0,
        isFromBack: false,
        init: function() {
        ...
        frmLocationPreshow: function() {
            ...
            if (configManager.appLaunchedMode === "shortcut") {
                if (applicationManager.getPresentationFormUtility().getDeviceName() !== "iPhone") {
                    ...
                    this.view.setTitleBarRightSideButtonSkin("Close", "sknBtnffffffSSPSemiBold30px", this.onClose);
                }
            } else {
                if (applicationManager.getPresentationFormUtility().getDeviceName() !== "iPhone") {
            ...
            if (applicationManager.getPresentationFormUtility().getDeviceName() !== "iPhone") this.view.customSearch.flxHeaderSeparator.setVisibility(true);
            else this.view.customSearch.flxHeaderSeparator.setVisibility(false);
            this.setFlowActions();
        ...
        showMapView: function() {
            if (this.view.flxHeaderSearchbox.height === "40dp") {
                ...
                if (applicationManager.getPresentationFormUtility().getDeviceName() !== "iPhone") this.view.flxMap.top = "110dp";
                else this.view.flxMap.top = "54dp";
            }
            this.view.flxMap.setVisibility(true);
            this.view.flxCurrentLocation.setVisibility(true);
            this.view.flxFilters.isVisible = false;
        ...
        showListView: function() {
            if (this.view.flxHeaderSearchbox.height === "40dp") {
                ...
                if (applicationManager.getPresentationFormUtility().getDeviceName() !== "iPhone") this.view.flxBranchesList.top = "110dp";
                else this.view.flxBranchesList.top = "54dp";
            }
            //       this.resetCustomSearch();
            //     }
...
define("LocateUsModule/frmLocationMapControllerActions", {
    /*
...
define("LocateUsModule/frmLocationMapController", ["LocateUsModule/userfrmLocationMapController", "LocateUsModule/frmLocationMapControllerActions"], function() {
