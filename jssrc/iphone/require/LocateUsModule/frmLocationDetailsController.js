define("LocateUsModule/userfrmLocationDetailsController", {
    timerCounter: 0,
    init: function() {
    ...
    setDetailsData: function() {
        ...
        if (details && details.workingHours) {
            ...
            for (var i = 0; i < days.length; i++) days[i] = days[i].trim();
...
define("LocateUsModule/frmLocationDetailsControllerActions", {
    /*
...
define("LocateUsModule/frmLocationDetailsController", ["LocateUsModule/userfrmLocationDetailsController", "LocateUsModule/frmLocationDetailsControllerActions"], function() {
