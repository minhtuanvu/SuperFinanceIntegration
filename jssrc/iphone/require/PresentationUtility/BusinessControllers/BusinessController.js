...
*/
    ...
    PresentationUtility.prototype.MFA = {
        ...
        getDisplayNameBasedOnTransactionMode: function(moduleName) {
            ...
            if (moduleName) transferModulePresentationController = applicationManager.getModulesPresentationController(moduleName);
            else transferModulePresentationController = applicationManager.getModulesPresentationController("TransferModule");
            var mfaManager = applicationManager.getMFAManager();
            var displayName = "";
