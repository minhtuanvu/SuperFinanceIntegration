define("UnifiedTransferFlow/userflxDomesticNewAccountAckController", {
    onNavigate: function() {
        var scope = this;
...
define("UnifiedTransferFlow/flxDomesticNewAccountAckControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("UnifiedTransferFlow/flxDomesticNewAccountAckController", ["UnifiedTransferFlow/userflxDomesticNewAccountAckController", "UnifiedTransferFlow/flxDomesticNewAccountAckControllerActions"], function() {
    var controller = require("UnifiedTransferFlow/userflxDomesticNewAccountAckController");
    var controllerActions = ["UnifiedTransferFlow/flxDomesticNewAccountAckControllerActions"];
