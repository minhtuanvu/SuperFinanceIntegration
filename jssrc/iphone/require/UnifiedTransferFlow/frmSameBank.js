define("UnifiedTransferFlow/frmSameBank", function() {
    return function(controller) {
        function addWidgetsfrmSameBank() {
            ...
            MakeATransfer.transOperationName = "{\"withinAccounts\":\"TransferToOwnAccounts\",\"withinBank\":\"IntraBankAccFundTransfer\"}";
            MakeATransfer.getCountriesOperation = "getAllCountries";
            MakeATransfer.ValCriteria = "{\"amount\":\"{$.c.transferAmount}\",\"transactionId\":\"\",\"frequencyType\":\"{$.c.frequency}\",\"fromAccountNumber\":\"{$.c.fromAccountNumber}\",\"isScheduled\":\"0\",\"frequencyStartDate\":\"{$.c.ISOStartDate}\",\"frequencyEndDate\":\"{$.c.ISOEndDate}\",\"scheduledDate\":\"{$.c.ISOSendOn}\",\"toAccountNumber\":\"{$.c.toAccountNumber}\",\"paymentType\":\"\",\"paidBy\":\"\",\"swiftCode\":\"\",\"serviceName\":\"\",\"beneficiaryName\":\"{$.c.beneficiaryName}\",\"beneficiaryNickname\":\"{$.c.nickName}\",\"transactionsNotes\":\"{$.c.notes}\",\"transactionType\":\"{$.c.transactionType}\",\"transactionCurrency\":\"{$.c.transactionCurrency}\",\"fromAccountCurrency\":\"{$.c.fromAccountCurrency}\",\"toAccountCurrency\":\"USD\",\"numberOfRecurrences\":\"{$.c.numberOfRecurrences}\",\"ExternalAccountNumber\":\"{$.c.externalAccountNumber}\",\"uploadedattachments\":\"{$.c.supportingDocuments}\",\"userId\":\"{$.c.Id}\",\"routingNumber\":\"{$.c.routingNumber}\",\"deletedDocuments\":\"\",\"transactionAmount\":\"{$.c.transferAmount}\",\"validate\":\"true\"}";
            ...
            MakeATransfer.transCriteria = "{\"amount\":\"{$.c.transferAmount}\",\"transactionId\":\"\",\"frequencyType\":\"{$.c.frequency}\",\"fromAccountNumber\":\"{$.c.fromAccountNumber}\",\"isScheduled\":\"0\",\"frequencyStartDate\":\"{$.c.ISOStartDate}\",\"frequencyEndDate\":\"{$.c.ISOEndDate}\",\"scheduledDate\":\"{$.c.ISOSendOn}\",\"toAccountNumber\":\"{$.c.toAccountNumber}\",\"paymentType\":\"\",\"paidBy\":\"\",\"swiftCode\":\"\",\"serviceName\":\"\",\"beneficiaryName\":\"{$.c.beneficiaryName}\",\"beneficiaryNickname\":\"{$.c.nickName}\",\"transactionsNotes\":\"{$.c.notes}\",\"transactionType\":\"{$.c.transactionType}\",\"transactionCurrency\":\"{$.c.transactionCurrency}\",\"fromAccountCurrency\":\"{$.c.fromAccountCurrency}\",\"toAccountCurrency\":\"{$.c.transactionCurrency}\",\"numberOfRecurrences\":\"{$.c.numberOfRecurrences}\",\"ExternalAccountNumber\":\"{$.c.externalAccountNumber}\",\"uploadedattachments\":\"{$.c.supportingDocuments}\",\"userId\":\"{$.c.Id}\",\"routingNumber\":\"{$.c.routingNumber}\",\"deletedDocuments\":\"\",\"transactionAmount\":\"{$.c.transferAmount}\"}";
            MakeATransfer.recipientRestrictChars = "!@#&*_'-.,";
            MakeATransfer.ValOperationName = "{\"withinAccounts\":\"TransferToOwnAccounts\",\"withinBank\":\"IntraBankAccFundTransfer\"}";
            ...
            MakeATransfer.lblReadOnlyField5Label = "{i.kony.i18n.verifyDetails.totalDebitAmount}";
            MakeATransfer.lblReadOnlyField5Value = "{\"text\":\"{$.c.totalAmount}\",\"fieldType\":\"label\"}";
        ...
        var LBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_e6c3e865e72d43b5a3a9efb0a75fc5c8,
            "metaData": {
                "image": "backicon.png"
            },
            "id": "LBarBtnItem0"
        ...
        return [{
            "addWidgets": addWidgetsfrmSameBank,
            ...
            "titleBar": true,
            "titleBarAttributes": {
                "shadowImage": "transparentbox.png",
                "backIndicatorImage": "backicon.png",
