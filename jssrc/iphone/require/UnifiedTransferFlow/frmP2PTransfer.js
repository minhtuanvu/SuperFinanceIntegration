define("UnifiedTransferFlow/frmP2PTransfer", function() {
    return function(controller) {
        function addWidgetsfrmP2PTransfer() {
            this.setDefaultUnit(kony.flex.DP);
            var flxP2PTransferMain = new kony.ui.FlexScrollContainer({
            ...
            flxP2PTransferMain.setDefaultUnit(kony.flex.DP);
            ...
            MakeATransfer.requiredCodeLbl = "You can fill any one of the field provided below out of 2 (or) you can fill all of the three fields as well.";
            ...
            MakeATransfer.toField1Value = "{\"default\":{\"mapping\":[{\"internal\":{\"creditcard\":{\"fieldMap\":\"name\"},\"Loan\":{\"fieldMap\":\"name\"},\"other\":{\"fieldMap\":\"name\"}},\"external\":{\"fieldMap\":\"name\"},\"format\":{\"truncateLength\":22,\"appendString\":\"....\"}},{\"internal\":{\"creditcard\":{\"fieldMap\":\"PayPersonId\"},\"Loan\":{\"fieldMap\":\"PayPersonId\"},\"other\":{\"fieldMap\":\"PayPersonId\"}},\"external\":{\"fieldMap\":\"PayPersonId\"},\"format\":{\"sliceLength\":-4}}],\"fieldType\":\"AccountName\",\"labelType\":\"value\"},\"ST1\":{\"text\":\"{$.L1.beneficiaryName}\",\"mapping\":[{\"fieldMap\":\"{$.L1.beneficiaryName}\",\"format\":{\"truncateLength\":22,\"appendString\":\"....\"}},{\"fieldMap\":\"{$.L1.accountNumber}\",\"format\":{\"sliceLength\":-4}}],\"fieldType\":\"AccountName\",\"labelType\":\"value\"},\"ST2\":{\"text\":\"{$.L1.beneficiaryName}\",\"mapping\":[{\"fieldMap\":\"{$.L1.beneficiaryName}\",\"format\":{\"truncateLength\":22,\"appendString\":\"....\"}},{\"fieldMap\":\"{$.L1.accountNumber}\",\"format\":{\"sliceLength\":-4}}],\"fieldType\":\"AccountName\",\"labelType\":\"value\"}}";
            ...
            MakeATransfer.toAccOperationName = "getP2PPayee";
            ...
            MakeATransfer.transOperationName = "P2PTransfer";
            MakeATransfer.getCountriesOperation = "getAllCountries";
            MakeATransfer.ValCriteria = "{\"amount\":\"{$.c.transferAmount}\",\"beneficiaryId\":null,\"frequencyEndDate\":\"{$.c.ISOStartDate}\",\"frequencyType\":\"{$.c.frequency}\",\"fromAccountNumber\":\"{$.c.fromAccountNumber}\",\"isScheduled\":\"0\",\"scheduledDate\":\"{$.c.ISOSendOn}\",\"transactionsNotes\":\"{$.c.notes}\",\"transactionType\":\"P2P\",\"transactionCurrency\":\"{$.c.transactionCurrency}\",\"fromAccountCurrency\":\"{$.c.fromAccountCurrency}\",\"toAccountCurrency\":null,\"numberOfRecurrences\":null,\"ExternalAccountNumber\":null,\"personId\":\"{$.c.PayPersonId}\",\"validate\":\"true\"}";
            ...
            MakeATransfer.transCriteria = "{\"amount\":\"{$.c.transferAmount}\",\"beneficiaryId\":null,\"frequencyEndDate\":\"{$.c.ISOStartDate}\",\"frequencyType\":\"{$.c.frequency}\",\"fromAccountNumber\":\"{$.c.fromAccountNumber}\",\"isScheduled\":\"0\",\"scheduledDate\":\"{$.c.ISOSendOn}\",\"transactionsNotes\":\"{$.c.notes}\",\"transactionType\":\"P2P\",\"transactionCurrency\":\"{$.c.transactionCurrency}\",\"fromAccountCurrency\":\"{$.c.fromAccountCurrency}\",\"toAccountCurrency\":null,\"numberOfRecurrences\":null,\"ExternalAccountNumber\":null,\"personId\":\"{$.c.PayPersonId}\"}";
            MakeATransfer.recipientRestrictChars = "!@#&*_'-.,";
            MakeATransfer.ValOperationName = "P2PTransfer";
            ...
            MakeATransfer.toField3Value = "{\"mapping\":[{\"internal\":{\"creditcard\":{\"fieldMap\":\"phone,email\"},\"Loan\":{\"fieldMap\":\"phone,email\"},\"other\":{\"fieldMap\":\"phone,email\"}},\"external\":{\"fieldMap\":\"phone,email\"}}],\"fieldType\":\"Label\"}";
            ...
            MakeATransfer.CCcriteria = "{\"amount\":\"{$.c.transferAmount}\",\"transactionId\":\"\",\"frequencyType\":\"{$.c.frequency}\",\"fromAccountNumber\":\"{$.c.fromAccountNumber}\",\"isScheduled\":\"0\",\"frequencyStartDate\":\"{$.c.ISOStartDate}\",\"frequencyEndDate\":\"{$.c.ISOEndDate}\",\"scheduledDate\":\"{$.c.ISOSendOn}\",\"toAccountNumber\":\"{$.c.toAccountNumber}\",\"paymentType\":\"{$.c.selectedServicePayment}\",\"paidBy\":\"{$.c.selectedServiceFeesPaidBy}\",\"swiftCode\":\"{$.c.swiftCode}\",\"serviceName\":\"\",\"beneficiaryName\":\"{$.c.beneficiaryName}\",\"beneficiaryNickname\":\"{$.c.beneficiaryNickName}\",\"transactionsNotes\":\"{$.c.notes}\",\"transactionType\":\"InternalTransfer\",\"transactionCurrency\":\"{$.c.transactionCurrency}\",\"fromAccountCurrency\":\"{$.c.fromAccountCurrency}\",\"toAccountCurrency\":\"USD\",\"numberOfRecurrences\":\"{$.c.numberOfRecurrences}\",\"ExternalAccountNumber\":\"\",\"uploadedattachments\":\"{$.c.supportingDocuments}\",\"userId\":\"{$.c.Id}\",\"deletedDocuments\":\"\",\"transactionAmount\":\"{$.c.transferAmount}\"}";
            ...
            MakeATransfer.verifyField3Label = "kony.i18n.verifyDetails.phoneNumber";
            ...
            MakeATransfer.verifyField3Value = "{\"text\":\"{$.c.mobileNumber}\",\"fieldType\":\"Label\",\"optional\":false}";
            ...
            MakeATransfer.verifyField11Label = "kony.i18n.verifyDetails.emailAddress";
            MakeATransfer.textBoxErrorSkin = "ICSknTxtF54B5EBorder";
            MakeATransfer.hdfcBankImg = "business.png";
            MakeATransfer.verifyField11Value = "{\"text\":\"{$.c.emailId}\",\"fieldType\":\"Label\",\"optional\":false}";
            ...
            MakeATransfer.verifyField12Label = "";
            ...
            MakeATransfer.verifyField17Label = "";
            MakeATransfer.sknSelectOption = "ICSkn007AFFSFReg45px";
            MakeATransfer.verifyField17Value = "";
            ...
            MakeATransfer.lblReadOnlyField2Label = "{i.kony.i18n.verifyDetails.totalDebitAmount}";
            MakeATransfer.lblReadOnlyField2Value = "{\"text\":\"{$.c.totalAmount}\",\"fieldType\":\"label\"}";
            MakeATransfer.lblReadOnlyField3Label = "{i.kony.i18n.verifyDetails.transferCharges}:";
            MakeATransfer.lblReadOnlyField3Value = "{\"text\":\"{$.c.AUDITFEE}\",\"fieldType\":\"label\"}";
            ...
            flxContents.add(MakeATransfer);
            flxP2PTransferMain.add(flxContents);
            ...
            flxBlue.add();
            this.add(flxP2PTransferMain, flxBlue);
        };
        var LBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_e1344a030aa74af6ac403234ed94a0af,
            "metaData": {
                "image": "backicon.png"
            },
            "id": "LBarBtnItem0"
        ...
        return [{
            "addWidgets": addWidgetsfrmP2PTransfer,
