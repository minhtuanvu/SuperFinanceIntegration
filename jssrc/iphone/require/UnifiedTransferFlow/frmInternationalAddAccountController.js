define("UnifiedTransferFlow/userfrmInternationalAddAccountController", {
    // Global Parameters.
    flxStack: [],
    nativeTitle: "",
    onNavigate: function() {
        ...
        var params = navMan.getCustomInfo("frmInternationalAddAccount");
    ...
    initActions: function() {
        ...
        scope.view.AddNewAccount.createAccountCallback = function(response) {
            ...
            if (!response["MFAAttributes"]) {
                // var ntf = new kony.mvc.Navigation("flxInternationalNewAccountAck");
                //ntf.navigate(response);   
                navMan.setCustomInfo("flxInternationalNewAccountAck", response);
                navMan.navigateTo("UnifiedTransferFlow/flxInternationalNewAccountAck");
            } else {
...
define("UnifiedTransferFlow/frmInternationalAddAccountControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_BarButtonItem_ad937dfa65774b12831e6a34ddc3f213: function AS_BarButtonItem_ad937dfa65774b12831e6a34ddc3f213(eventobject) {
        var self = this;
        return self.iPhoneBackNavigation.call(this);
    }
});
define("UnifiedTransferFlow/frmInternationalAddAccountController", ["UnifiedTransferFlow/userfrmInternationalAddAccountController", "UnifiedTransferFlow/frmInternationalAddAccountControllerActions"], function() {
    var controller = require("UnifiedTransferFlow/userfrmInternationalAddAccountController");
    var controllerActions = ["UnifiedTransferFlow/frmInternationalAddAccountControllerActions"];
