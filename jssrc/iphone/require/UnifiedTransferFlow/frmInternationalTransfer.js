define("UnifiedTransferFlow/frmInternationalTransfer", function() {
    return function(controller) {
        function addWidgetsfrmInternationalTransfer() {
            this.setDefaultUnit(kony.flex.DP);
            var flxInternationalTransfer = new kony.ui.FlexScrollContainer({
            ...
            flxInternationalTransfer.setDefaultUnit(kony.flex.DP);
            ...
            MakeATransfer.requiredCodeLbl = "You can fill any one of the field provided below out of 2 (or) you can fill all of the two fields as well.";
            ...
            MakeATransfer.transOperationName = "InternationalAccFundTransfer";
            ...
            MakeATransfer.ValOperationName = "InternationalAccFundTransfer";
            ...
            flxInternationalTransfer.add(flxContent);
            ...
            flxBlue.add();
            this.add(flxInternationalTransfer, flxBlue);
        };
        var LBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_g9486bbf51be4b37be4e533a060012d2,
            "metaData": {
                "image": "backicon.png"
            },
            "id": "LBarBtnItem0"
        ...
        return [{
            "addWidgets": addWidgetsfrmInternationalTransfer,
            "enabledForIdleTimeout": false,
            "id": "frmInternationalTransfer",
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false
        }, {
