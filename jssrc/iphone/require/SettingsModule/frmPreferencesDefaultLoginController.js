define("SettingsModule/userfrmPreferencesDefaultLoginController", ['CommonUtilities'], function(CommonUtilities) {
    return {
        init: function() {
        ...
        setTouchId: function(flags) {
            ...
            if (flags.isTouchIdSupported) {
                if (isIphone) this.view.lblOption2.text = kony.i18n.getLocalizedString("kony.mb.devReg.TouchId");
                else this.view.lblOption2.text = kony.i18n.getLocalizedString("kony.mb.devReg.Biometric");
            ...
            if (tempLoginMode == "touchid") this.view.lblStatus2.text = kony.i18n.getLocalizedString("kony.mb.common.enabled");
            else this.view.lblStatus2.text = kony.i18n.getLocalizedString("kony.mb.common.enable");
        },
        setFaceId: function(flags) {
            ...
            if (flags.isFaceIdSupported) {
                if (flags.isFaceIdAvailable) {
                    ...
                    if (tempLoginMode == "faceid") this.view.lblStatus4.text = kony.i18n.getLocalizedString("kony.mb.common.enabled");
                    else this.view.lblStatus4.text = kony.i18n.getLocalizedString("kony.mb.common.enable");
                } else {
        ...
        setPinLogin: function(flags) {
            ...
            if (userMan.isAppLoginPinSet()) this.view.lblStatus3.text = kony.i18n.getLocalizedString("kony.mb.Generated");
...
define("SettingsModule/frmPreferencesDefaultLoginControllerActions", {
    /*
...
define("SettingsModule/frmPreferencesDefaultLoginController", ["SettingsModule/userfrmPreferencesDefaultLoginController", "SettingsModule/frmPreferencesDefaultLoginControllerActions"], function() {
