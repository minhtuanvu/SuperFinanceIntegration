define("SettingsModule/userfrmSettingsChangeLanguageController", {
    selectedLanguage: -1,
    init: function() {
    ...
    setDataToLanguage: function() {
        ...
        this.view.segLanguages.selectedRowIndices = [
            [0, [index]]
        ];
...
define("SettingsModule/frmSettingsChangeLanguageControllerActions", {
    /*
...
define("SettingsModule/frmSettingsChangeLanguageController", ["SettingsModule/userfrmSettingsChangeLanguageController", "SettingsModule/frmSettingsChangeLanguageControllerActions"], function() {
    var controller = require("SettingsModule/userfrmSettingsChangeLanguageController");
    var controllerActions = ["SettingsModule/frmSettingsChangeLanguageControllerActions"];
