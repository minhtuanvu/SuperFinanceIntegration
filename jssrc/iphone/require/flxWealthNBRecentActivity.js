define("flxWealthNBRecentActivity", function() {
    return function(controller) {
        var flxWealthNBRecentActivity = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "height": "77dp",
            "id": "flxWealthNBRecentActivity",
            "isVisible": true,
        ...
        flxWealthNBRecentActivity.setDefaultUnit(kony.flex.DP);
        ...
        flxWealthNBRecentActivity.add(flxMainActivity);
        return flxWealthNBRecentActivity;
    }
})