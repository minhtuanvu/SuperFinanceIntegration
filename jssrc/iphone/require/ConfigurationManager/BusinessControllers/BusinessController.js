...
define(['CommonUtilities'], function(CommonUtilities) {
    ...
    function ConfigurationManager() {
        ...
        this.accountsTypeMetaData = [{
            ...
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.Checking'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.Checking'),
        }, {
            applicationValue: this.accountTypes.SAVINGS,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.Savings'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.Savings'),
        }, {
            applicationValue: this.accountTypes.CREDITCARD,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.CreditCard'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.CreditCard'),
        }, {
            applicationValue: this.accountTypes.DEPOSIT,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.Deposit'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.Deposit'),
        }, {
            applicationValue: this.accountTypes.MORTGAGE,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.Mortgage'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.Mortgage'),
        }, {
            applicationValue: this.accountTypes.LOAN,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.Loan'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.Loan'),
        }, {
            applicationValue: this.accountTypes.CURRENT,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.Current'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.Current'),
        }, {
            applicationValue: this.accountTypes.LINE_OF_CREDIT,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.LineOfCredit'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.LineOfCredit'),
        }, {
            applicationValue: this.accountTypes.EXTERNAL,
            backendValue: kony.i18n.getLocalizedString('kony.mb.Accounts.backend.External'),
            displayValue: kony.i18n.getLocalizedString('kony.mb.Accounts.display.External'),
        }, ];
        ...
        this.constants = {
            ...
            MENUTRANSFERSACTIVITY: kony.i18n.getLocalizedString('kony.mb.transfers.ManageTransactions'),
            MENUMANAGERECIPIENTS: kony.i18n.getLocalizedString('kony.mb.TransfersEurope.ManageBeneficiaries'),
        ...
        this.OLBConstants = {
            ...
            CONFIG: {
                ACCOUNTS_QUICK_ACTIONS: {
                    ...
                    Checking: ['Transfer Money', 'Pay Money', 'Send Money', 'Pay a Bill', 'Request Cheque Book', 'Stop Cheque Payment', 'My Cheques', 'Manage Cards', 'View Statements', 'Account Alerts', 'Refresh Account', 'Remove Account'],
                    CreditCard: ['Pay a Bill', 'View Statements', 'Account Alerts'
                        //"Pay Due Amount" Not in scope
                    ],
                    Loan: ['Pay Due Amount', 'View Statements', 'Update Account Settings', 'Account Alerts', 'Payoff Loan'],
                    'Line of Credit': [
                        //"Pay Due Amount",
                        'View Statements', 'Update Account Settings', 'Account Alerts'
                    ],
                    Mortgage: [
                        //"Pay Due Amount",
                        'View Statements', 'Update Account Settings', 'Account Alerts'
                ...
                EXTERNAL_ACCOUNT_QUICK_ACTIONS: ['Remove Account',
                    //'Account Preferences',
                    'Edit Account', 'Refresh Account', 'Delete Account'
                ],
                ...
                ACCOUNTS_SECONDARY_ACTIONS: {
                    Savings: ['View Statements', 'Request Cheque Book', 'Stop Cheque Payment', 'My Cheques', 'Update Account Settings', 'Scheduled Transactions', 'Disputed Transactions'
                        //"Order Checks", //Post R4
                        //"Manage Card" //Post R4
                    ],
                    Checking: ['Send Money', 'View Statements', 'Request Cheque Book', 'Stop Cheque Payment', 'My Cheques', 'Update Account Settings', 'Scheduled Transactions', 'Disputed Transactions'
                        //"Order Checks", //Post R4
                        //"Manage Card" //Post R4
                    ],
                    CreditCard: ['Pay a Bill', 'Update Account Settings', 'Disputed Transactions'
                        //"Manage Card", //Post R4
    ...
    ConfigurationManager.prototype.resetConfigurationObject = function() {
        this.hamburgerMenuItems = JSON.parse(JSON.stringify(this.masterHamburgerData));
        this.moreMenuItems = JSON.parse(JSON.stringify(this.mastermoreMenuItems));
    ...
    ConfigurationManager.prototype.fetchApplicationProperties = function(presentationSuccess, presentationError) {
        ...
        function applicationRepoCompletionCallBack(status, data, error) {
            ...
            if (res['status']) {
                ...
                config.configurations.setItem('isAlertAccountIDLevel', res['data'].isAlertAccountIDLevel);
                ...
                if (res['data'].isprofileImageAvailable !== undefined) {
                    config.configurations.setItem('isprofileImageAvailable', res['data'].isprofileImageAvailable);
                }
                ...
                if (res['data'].isFeedbackEnabled !== undefined) {
                    config.configurations.setItem('isFeedbackEnabled', res['data'].isFeedbackEnabled);
                    config.configurations.setItem('showFeedBackPostLogout', res['data'].isFeedbackEnabled);
                }
                ...
                if (res['data'].stopReasons !== undefined) {
                    config.configurations.setItem('stopReasons', config.getStopReasonsList(JSON.parse(res['data'].stopReasons)));
                }
    ...
    ConfigurationManager.prototype.fetchLimitsForAnAction = function(action, presentationSuccess, presentationError) {
            ...
            var CustomerLimitsRepo = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository('CustomerLimits');
            CustomerLimitsRepo.customVerb("getCustomerActionLimits", {
                action: action
            }, completionCallback)
        }
        /**
    ...
    ConfigurationManager.prototype.checkAccountAction = function(accountId, action) {
            if (!kony.sdk.isNullOrUndefined(this.accountPermissions[accountId])) return this.accountPermissions[accountId].actions.indexOf(action) > -1;
            else return false;
        }
        /**
    ...
    ConfigurationManager.prototype.getProfileImageAvailabilityFlag = function() {
        return this.configurations.getItem('isprofileImageAvailable') == 'true' ? true : false;
    };
    /**
    ...
    ConfigurationManager.prototype.getAccountIDLevelAlertsFlag = function() {
        return this.configurations.getItem('isAlertAccountIDLevel') == 'true' ? true : false;
    };
    /**
     * Get is sort code visibility enabled from configurations
     * @returns {boolean} - value associated with given key
    ...
    ConfigurationManager.prototype.getCurrencyCode = function() {
        ...
        return (this.configurations.getItem('CURRENCYCODE') !== undefined && this.configurations.getItem('CURRENCYCODE')) ? this.configurations.getItem('CURRENCYCODE') : '$';
    };
    /**
     * Get currency method.
     *@returns {String} - returns the currency.
    ...
    ConfigurationManager.prototype.getHamburgerMenuItems = function() {
        if (this.features.indexOf("MANAGE_ACCOUNT_STATEMENTS") < 0) {
            for (i = 0; i < this.hamburgerMenuItems.length; i++) {
                if (this.hamburgerMenuItems[i].text === this.constants.MENUACCOUNTSTATEMENTS) break;
            }
            this.hamburgerMenuItems.splice(i, 1);
        }
        if (this.AggregatedExternalAccountEnabled) return this.hamburgerMenuItems;
        else {
            for (i = 0; i < this.hamburgerMenuItems.length; i++)
                if (this.hamburgerMenuItems[i].text == this.constants.MENUMANAGEOTHERBANKACCOUNTS) break;
            this.hamburgerMenuItems.splice(i, 1);
    ...
    ConfigurationManager.prototype.getIOSAppMoreMenuItems = function() {
        if (this.AggregatedExternalAccountEnabled) return this.moreMenuItems;
        else {
            for (i = 0; i < this.moreMenuItems.length; i++)
                if (this.moreMenuItems[i].text == this.constants.MENUMANAGEOTHERBANKACCOUNTS) break;
    ...
    ConfigurationManager.prototype.rearrangeHamburgerAccordingToEntitements = function() {
        ...
        self.hamburgerMenuItems = self.hamburgerMenuItems.filter(function(data) {
            ...
            switch (data.text) {
                ...
                case self.constants.MENUMANAGERECIPIENTS:
                    return ["INTER_BANK_ACCOUNT_FUND_TRANSFER_VIEW_RECEPIENT", "INTRA_BANK_FUND_TRANSFER_VIEW_RECEPIENT", "INTERNATIONAL_ACCOUNT_FUND_TRANSFER_VIEW_RECEPIENT", "P2P_VIEW_RECEPIENT"].some(self.checkUserPermission.bind(self));
        ...
        self.moreMenuItems = self.moreMenuItems.filter(function(data) {
            if ((self.isBillPayEnabled === 'false' && data.text === self.constants.MENUSETTINGS) || (self.isRDCEnabled === 'false' && data.text === self.constants.MENUCHECKDEPOSIT)) return false;
            switch (data.text) {
                case self.constants.MENUACH:
                    return (self.checkUserFeature("ACH_COLLECTION") || self.checkUserFeature("ACH_PAYMENT") || self.checkUserFeature("ACH_FILES"));
                case self.constants.MENUAPPROVALREQUEST:
        ...
        if (self.getDeploymentGeography() === "EUROPE") {
            ...
            var transferFeatures = ["INTER_BANK_ACCOUNT_FUND_TRANSFER", "INTRA_BANK_FUND_TRANSFER", "INTERNATIONAL_ACCOUNT_FUND_TRANSFER", "P2P", "TRANSFER_BETWEEN_OWN_ACCOUNT"];
    ...
    ConfigurationManager.prototype.isFastTransfersFlowEnabled = function() {
        var scope = this;
        if (scope.getDeploymentGeography() && scope.getDeploymentGeography() == "EUROPE") return false;
        return this.fastTransfersFlowEnabled === "true";
    };
    ConfigurationManager.prototype.isEuroFlow = function() {
        var scope = this;
        if (scope.getDeploymentGeography() && scope.getDeploymentGeography() == "EUROPE") return true;
        return false;
    };
    ...
    ConfigurationManager.prototype.getACHTransactionApprovalsFeaturePermissionsList = function() {
        return ['ACH_COLLECTION_APPROVE', 'ACH_COLLECTION_SELF_APPROVAL', 'ACH_PAYMENT_APPROVE', 'ACH_PAYMENT_SELF_APPROVAL'];
    };
    /**
    ...
    ConfigurationManager.prototype.getACHFileApprovalsFeaturePermissionsList = function() {
        return ['ACH_FILE_APPROVE', 'ACH_FILE_SELF_APPROVAL'];
    };
    /**
    ...
    ConfigurationManager.prototype.getGeneralTransactionApprovalFeaturePermissionsList = function() {
        return ['BILL_PAY_APPROVE', 'BILL_PAY_SELF_APPROVAL', 'DOMESTIC_WIRE_TRANSFER_APPROVE', 'DOMESTIC_WIRE_TRANSFER_SELF_APPROVAL', 'INTER_BANK_ACCOUNT_FUND_TRANSFER_APPROVE', 'INTER_BANK_ACCOUNT_FUND_TRANSFER_SELF_APPROVAL', 'INTERNATIONAL_ACCOUNT_FUND_TRANSFER_APPROVE', 'INTERNATIONAL_ACCOUNT_FUND_TRANSFER_SELF_APPROVAL', 'INTERNATIONAL_WIRE_TRANSFER_APPROVE', 'INTERNATIONAL_WIRE_TRANSFER_SELF_APPROVAL', 'INTRA_BANK_FUND_TRANSFER_APPROVE', 'INTRA_BANK_FUND_TRANSFER_SELF_APPROVAL', 'P2P_APPROVE', 'P2P_SELF_APPROVAL', 'TRANSFER_BETWEEN_OWN_ACCOUNT_APPROVE', 'TRANSFER_BETWEEN_OWN_ACCOUNT_SELF_APPROVAL'];
    };
    /**
    ...
    ConfigurationManager.prototype.getCreateACHTransactionPermissionsList = function() {
        return ['ACH_COLLECTION_CREATE', 'ACH_PAYMENT_CREATE'];
    };
    ConfigurationManager.prototype.getEditACHTemplatePermissionsList = function() {
        return ['ACH_COLLECTION_EDIT_TEMPLATE', 'ACH_PAYMENT_EDIT_TEMPLATE'];
    };
    ConfigurationManager.prototype.getDeleteACHTemplatePermissionsList = function() {
        return ['ACH_COLLECTION_DELETE_TEMPLATE', 'ACH_PAYMENT_DELETE_TEMPLATE'];
    };
    /**
    ...
    ConfigurationManager.prototype.getCreateACHTemplatePermissionsList = function() {
        return ['ACH_COLLECTION_CREATE_TEMPLATE', 'ACH_PAYMENT_CREATE_TEMPLATE'];
    };
    /**
    ...
    ConfigurationManager.prototype.getCreateGeneralTransactionPermissionsList = function() {
        return ['BILL_PAY_CREATE', 'DOMESTIC_WIRE_TRANSFER_CREATE', 'INTER_BANK_ACCOUNT_FUND_TRANSFER_CREATE', 'INTERNATIONAL_ACCOUNT_FUND_TRANSFER_CREATE', 'INTERNATIONAL_WIRE_TRANSFER_CREATE', 'INTRA_BANK_FUND_TRANSFER_CREATE', 'P2P_CREATE', 'TRANSFER_BETWEEN_OWN_ACCOUNT_CREATE'];
    };
    /**
    ...
    ConfigurationManager.prototype.getBulkPaymentRequestPermissionsList = function() {
        return ['BULK_PAYMENT_REQUEST_SUBMIT'];
    };
    /**
    ...
    ConfigurationManager.prototype.getViewACHTransactionPermissionsList = function() {
        return ['ACH_COLLECTION_VIEW', 'ACH_PAYMENT_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getViewACHTemplatePermissionsList = function() {
        return ['ACH_COLLECTION_VIEW_TEMPLATE', 'ACH_PAYMENT_VIEW_TEMPLATE'];
    };
    /**
    ...
    ConfigurationManager.prototype.getViewGeneralTransactionPermissionsList = function() {
        return ['BILL_PAY_VIEW', 'BILL_PAY_VIEW_PAYMENTS', 'DOMESTIC_WIRE_TRANSFER_VIEW', 'INTERNATIONAL_ACCOUNT_FUND_TRANSFER_VIEW', 'INTERNATIONAL_WIRE_TRANSFER_VIEW', 'INTER_BANK_ACCOUNT_FUND_TRANSFER_VIEW', 'INTRA_BANK_FUND_TRANSFER_VIEW', 'P2P_VIEW', 'TRANSFER_BETWEEN_OWN_ACCOUNT_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getPortfolioPermissionsList = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_SUMMARY_VIEW', 'WEALTH_PORTFOLIO_DETAILS_ASSET_ALLOCATION_VIEW', 'WEALTH_PORTFOLIO_DETAILS_CASH_BALANCE_VIEW', 'WEALTH_PRODUCT_DETAILS_INSTRUMENT_VIEW', 'WEALTH_PORTFOLIO_DETAILS_ACCOUNT_INFO_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getTransferCashPermission = function() {
        return ['WEALTH_CASH_MGMT_TRANSFER_CASH_CREATE'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getConvertCurrencyPermission = function() {
        return ['WEALTH_CASH_MGMT_CURRENCY_COVERSION_CREATE'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getCashBalanceViewPermission = function() {
        return ['WEALTH_CASH_MGMT_CARD_BALANCE_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getHoldingsdetailsPermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_HOLDINGS_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getOpenOrderViewPermissions = function() {
        return ['WEALTH_ORDER_MGMT_OPEN_ORDER_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getHistoryOrderViewPermissions = function() {
        return ['WEALTH_ORDER_MGMT_ORDER_HISTORY_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getTransactionDetailViewPermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_TRANSACTIONS_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getPortfolioDetailViewPermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_SUMMARY_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getPortfolioAssetAllocationViewPermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_ASSET_ALLOCATION_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getPortfolioCashBalanceViewPermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_CASH_BALANCE_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getPortfolioProductSearchViewPermissions = function() {
        return ['WEALTH_PRODUCT_DETAILS_INSTRUMENT_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getPortfolioAccountInfoViewPermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_ACCOUNT_INFO_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getAccountSummaryViewPermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_ACCOUNT_SUMMARY_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getWealthReportPermissions = function() {
        return ['WEALTH_REPORT_MANAGEMENT_REPORT_CREATE', 'WEALTH_REPORT_MANAGEMENT_REPORT_DOWNLOAD'];
    };
    /**
    ...
    ConfigurationManager.prototype.getRecentActivityPermissionsList = function() {
        return ['WEALTH_INVESTMENT_DETAILS_RECENT_ACTIVITY_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getMarketIndexPermissionsList = function() {
        return ['WEALTH_MARKET_AND_NEWS_MARKET_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getTopNewsPermissionsList = function() {
        return ['WEALTH_MARKET_AND_NEWS_TOP_NEWS_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getNewsDetailsPermissionsList = function() {
        return ['WEALTH_MARKET_AND_NEWS_TOP_NEWS_DETAILS_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getTotalAssetsPermissionsList = function() {
        return ['WEALTH_INVESTMENT_DETAILS_TOTAL_ASSETS_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getInvestmentSummaryPermissionsList = function() {
        return ['WEALTH_INVESTMENT_DETAILS_INVESTMENT_SUMMARY_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getOrderBlotterFeature = function() {
        return ['WEALTH_ORDER_MANAGEMENT'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getWealthPortfolioFeature = function() {
        return ['WEALTH_PORTFOLIO_DETAILS'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getWealthReportFeature = function() {
        return ['WEALTH_REPORT_MANAGEMENT'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getPortfolioPerformancePermissions = function() {
        return ['WEALTH_PORTFOLIO_DETAILS_PERFORMANCE_VIEW'];
    };
    /**
  ...
  **/
    ConfigurationManager.prototype.getInstrumentCurrentPositionPermissions = function() {
        return ['WEALTH_PRODUCT_DETAILS_CURRENT_POSITION_VIEW'];
    };
    /**
  ...
  **/
    ConfigurationManager.prototype.getInstrumentPricingDataPermissions = function() {
        return ['WEALTH_PRODUCT_DETAILS_PRICING_DATA_VIEW'];
    };
    /**
  ...
  **/
    ConfigurationManager.prototype.getInstrumentNewsPermissions = function() {
        return ['WEALTH_NEWS_AND_DOCUMENTS_STOCK_NEWS_VIEW'];
    };
    /**
  ...
  **/
    ConfigurationManager.prototype.getInstrumentDocumentsPermissions = function() {
        return ['WEALTH_NEWS_AND_DOCUMENTS_DOCUMENTS_VIEW'];
    };
    /**
          This method returns the list of permissions required to view General Transactions
      **/
    ...
    ConfigurationManager.prototype.getBulkPaymentFileUploadPermissionsList = function() {
        return ['BULK_PAYMENT_FILES_MULTI_UPLOAD_CSV', 'BULK_PAYMENT_FILES_MULTI_UPLOAD_XML', 'BULK_PAYMENT_FILES_SINGLE_UPLOAD_CSV', 'BULK_PAYMENT_FILES_SINGLE_UPLOAD_XML'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getBulkPaymentRequestViewPermissionsList = function() {
        return ['BULK_PAYMENT_REQUEST_VIEW'];
    };
    /**
    ...
    **/
    ConfigurationManager.prototype.getBulkPaymentFilesViewPermissionsList = function() {
        return ['BULK_PAYMENT_FILES_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getBulkPaymentTemplateViewPermissionsList = function() {
        return ['BULK_PAYMENT_TEMPLATE_VIEW'];
    };
    /**
    ...
    ConfigurationManager.prototype.getBulkPaymentTemplateCreatePermissionsList = function() {
        return ['BULK_PAYMENT_TEMPLATE_SINGLE_CREATE', 'BULK_PAYMENT_TEMPLATE_MULTIPLE_CREATE'];
    };
    /**
    ...
    **/
    ...
    ConfigurationManager.prototype.fetchDisputeConfigurations = function(params, presentationSuccess, presentationError) {
        ...
        var ConfigurationsRepo = kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository('Configurations');
