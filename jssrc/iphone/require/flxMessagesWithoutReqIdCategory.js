define("flxMessagesWithoutReqIdCategory", function() {
    return function(controller) {
        var flxMessagesWithoutReqIdCategory = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_HEIGHT,
            "clipBounds": false,
            "id": "flxMessagesWithoutReqIdCategory",
            "isVisible": true,
        ...
        flxMessagesWithoutReqIdCategory.setDefaultUnit(kony.flex.DP);
        ...
        flxShadowBottom.add();
        flxRight.add(flxFrom, flxMessage, flxAttachmentMain, flxAttachmentMain2, flxAttachmentMain3, flxAttachmentMain4, flxAttachmentMain5, flxShadowBottom);
        ...
        flxShadow.add();
        flxMessagesWithoutReqIdCategory.add(flxMain, flxShadow);
        return flxMessagesWithoutReqIdCategory;
    }
})