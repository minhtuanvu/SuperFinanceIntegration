...
define([], function() {
    ...
    function ApprovalMatrix(defaultValues) {
        ...
        context["field"] = "approvalRuleId";
        context["metadata"] = (objectMetadata ? objectMetadata["approvalRuleId"] : null);
        privateState.approvalRuleId = defaultValues ? (defaultValues["approvalRuleId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["approvalRuleId"], context) : null) : null;
        context["field"] = "companyId";
        context["metadata"] = (objectMetadata ? objectMetadata["companyId"] : null);
        ...
        context["field"] = "limitTypeId";
        context["metadata"] = (objectMetadata ? objectMetadata["limitTypeId"] : null);
        privateState.limitTypeId = defaultValues ? (defaultValues["limitTypeId"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["limitTypeId"], context) : null) : null;
        context["field"] = "lowerlimit";
        context["metadata"] = (objectMetadata ? objectMetadata["lowerlimit"] : null);
        privateState.lowerlimit = defaultValues ? (defaultValues["lowerlimit"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["lowerlimit"], context) : null) : null;
        context["field"] = "upperlimit";
        context["metadata"] = (objectMetadata ? objectMetadata["upperlimit"] : null);
        privateState.upperlimit = defaultValues ? (defaultValues["upperlimit"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["upperlimit"], context) : null) : null;
        context["field"] = "cif";
        context["metadata"] = (objectMetadata ? objectMetadata["cif"] : null);
        ...
        context["field"] = "isDisabled";
        context["metadata"] = (objectMetadata ? objectMetadata["isDisabled"] : null);
        privateState.isDisabled = defaultValues ? (defaultValues["isDisabled"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["isDisabled"], context) : null) : null;
        context["field"] = "disable";
        context["metadata"] = (objectMetadata ? objectMetadata["disable"] : null);
        privateState.disable = defaultValues ? (defaultValues["disable"] ? kony.mvc.util.ProcessorUtils.applyFunction(preProcessorCallback, defaultValues["disable"], context) : null) : null;
