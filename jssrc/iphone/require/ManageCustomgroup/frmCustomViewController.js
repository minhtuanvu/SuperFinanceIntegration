define("ManageCustomgroup/userfrmCustomViewController", ["CommonUtilities"], function(CommonUtilities) {
    return {
        _prevFormData: {},
        timerCounter: 0,
                    ...
                    for (var key in processedAccounts) {
                        ...
                        for (var i = 0; i < processedAccounts[key].length; i++) {
                            ...
                            var rowJson = {
                                ...
                                "lblAccountName": {
                                    text: CommonUtilities.truncateStringWithGivenLength(processedAccounts[key][i].nickName + "....", 20) + (processedAccounts[key][i].accountID).substr((processedAccounts[key][i].accountID).length - 4)
                                },
                                "imgAccountType": {
                                    "src": imgIcon
                                },
                                ...
                                "imgBank": {
                                    "src": (processedAccounts[key][i].logoURL) ? processedAccounts[key][i].logoURL : "",
                                    "isVisible": (processedAccounts[key][i].logoURL) ? true : false
                                },
                                "flximgBank": {
                                    "isVisible": (processedAccounts[key][i].logoURL) ? true : false
                                },
...
define("ManageCustomgroup/frmCustomViewControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_h7a52da219284d508e5a09b4bdd13f27: function AS_Form_h7a52da219284d508e5a09b4bdd13f27(eventobject) {
        var self = this;
        this.init();
    },
    AS_BarButtonItem_a9dd7bb6a58740a284af891a1a509b4b: function AS_BarButtonItem_a9dd7bb6a58740a284af891a1a509b4b(eventobject) {
        var self = this;
        this.navToPrevForm();
    },
    AS_BarButtonItem_i5af5b97922540bc9f0970b5cfaf9e79: function AS_BarButtonItem_i5af5b97922540bc9f0970b5cfaf9e79(eventobject) {
        var self = this;
        this.editCustomView();
    }
});
define("ManageCustomgroup/frmCustomViewController", ["ManageCustomgroup/userfrmCustomViewController", "ManageCustomgroup/frmCustomViewControllerActions"], function() {
    var controller = require("ManageCustomgroup/userfrmCustomViewController");
    var controllerActions = ["ManageCustomgroup/frmCustomViewControllerActions"];
