define("com/temenos/infinityComponents/accountsTransactionDetailsNative/useraccountsTransactionDetailsNativeController", ['./transactionDetailsDAO', './ParserUtilsManager', './FormatUtils', './EntitlementUtils', 'JSONValidator'], function(transactionDetailsDAO, ParserUtilsManager, FormatUtils, EntitlementUtils, JSONValidator) {
    return {
        ...
        successResponse: function(response) {
            ...
            if (response.fileNames.length > 0) {
                for (i in response.fileNames) files.push(response.fileNames[i].fileName);
                if (files.toString().length > 30) files = files.toString().substring(0, 30) + '...';
        ...
        getTransactionTypeValue: function(contractJSON) {
            try {
                if (typeof(this._transactionTypes) === "string") this._transactionTypes = JSON.parse(this._transactionTypes);
        ...
        updateTransactionDetails: function(transactionData) {
            ...
            if (this.currentTransactionType === "Cheque" || this.currentTransactionType === "Draft" || this.currentTransactionType === "CheckWithdrawal" || this.currentTransactionType === "CheckDeposit") {
                ...
                if (value == null || value == undefined || value == "") this.view.lblCheckNumberValue.text = "NA"
                else this.view.lblCheckNumberValue.text = value;
...
define("com/temenos/infinityComponents/accountsTransactionDetailsNative/accountsTransactionDetailsNativeControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_a8eea95aae654f4c95ff8cd5c884f1dd: function AS_FlexContainer_a8eea95aae654f4c95ff8cd5c884f1dd(eventobject) {
        var self = this;
        this.preShow();
    },
    AS_Button_c4d03fbc5e444077ad09df894b0dd3bb: function AS_Button_c4d03fbc5e444077ad09df894b0dd3bb(eventobject) {
        var self = this;
        return self.navigateToAttachments.call(this);
    }
});
define("com/temenos/infinityComponents/accountsTransactionDetailsNative/accountsTransactionDetailsNativeController", ["com/temenos/infinityComponents/accountsTransactionDetailsNative/useraccountsTransactionDetailsNativeController", "com/temenos/infinityComponents/accountsTransactionDetailsNative/accountsTransactionDetailsNativeControllerActions"], function() {
    var controller = require("com/temenos/infinityComponents/accountsTransactionDetailsNative/useraccountsTransactionDetailsNativeController");
    var actions = require("com/temenos/infinityComponents/accountsTransactionDetailsNative/accountsTransactionDetailsNativeControllerActions");
