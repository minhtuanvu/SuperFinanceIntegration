define("com/temenos/infinityComponents/Acknowledgement/userAcknowledgementController", ['JSONValidator', './FormatUtils', './ParserUtilsManager', './EntitlementUtils', './DataProcessorUtility'], function(JSONValidator, FormatUtils, ParserUtilsManager, EntitlementUtils, DataProcessorUtility) {
    return {
        ...
        getFormattedData: function(value, type, currencyCode) {
            var self = this;
            try {
                if (this.isEmptyNullUndefined(currencyCode)) currencyCode = this.getFieldValue(currencyCode);
...
define("com/temenos/infinityComponents/Acknowledgement/AcknowledgementControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_f8ea97813c8d4810a7e95f0b7be598f2: function AS_FlexContainer_f8ea97813c8d4810a7e95f0b7be598f2(eventobject) {
        var self = this;
        return self.preshow.call(this);
    }
});
define("com/temenos/infinityComponents/Acknowledgement/AcknowledgementController", ["com/temenos/infinityComponents/Acknowledgement/userAcknowledgementController", "com/temenos/infinityComponents/Acknowledgement/AcknowledgementControllerActions"], function() {
    var controller = require("com/temenos/infinityComponents/Acknowledgement/userAcknowledgementController");
    var actions = require("com/temenos/infinityComponents/Acknowledgement/AcknowledgementControllerActions");
