 ...
 */
define("com/temenos/infinity/donutchart/userdonutchartController", function() {
    var konyLoggerModule = require('com/temenos/infinity/donutchart/konyLogger');
    konymp = {};
        ...
        createChart: function(dataSet) {
            ...
            try {
                ...
                if (this.validateAllParams(this._chartTitle, data, labels, colors)) {
                    this.view.doughnutBrowser.evaluateJavaScript('var x = new konymp.charts.donut();x.Generate_DoughnutChart(' + JSON.stringify(this._chartTitle) + ',' + JSON.stringify(labels) + ',' + JSON.stringify(data) + ',' + JSON.stringify(colors) + ',' + JSON.stringify(this._chartProperties) + ');');
                }
            } catch (exception) {
                konymp.logger.error(JSON.stringify(exception), konymp.logger.EXCEPTION);
...
define("com/temenos/infinity/donutchart/donutchartControllerActions", {
    /* 
    This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("com/temenos/infinity/donutchart/donutchartController", ["com/temenos/infinity/donutchart/userdonutchartController", "com/temenos/infinity/donutchart/donutchartControllerActions"], function() {
    var controller = require("com/temenos/infinity/donutchart/userdonutchartController");
    var actions = require("com/temenos/infinity/donutchart/donutchartControllerActions");
