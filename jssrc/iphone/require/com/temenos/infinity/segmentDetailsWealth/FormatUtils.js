    ...
    */
    ...
    FormatUtils.prototype.formatAmountandAppendCurrencySymbol = function(amount, currencySymbolCode, FormatData, formatSkins) {
        ...
        if ((Number(amount)) >= 0) {
            ...
            if (formatSkins.POSITIVE_AMOUNT_SKIN) formattedAmount.skin = formatSkins.POSITIVE_AMOUNT_SKIN;
            ...
            if (formatSkins.NEGATIVE_AMOUNT_SKIN) formattedAmount.skin = formatSkins.NEGATIVE_AMOUNT_SKIN;
            return formattedAmount;
        }
    };
    /**
    ...
    FormatUtils.prototype.formatText = function(text, type, formatSkins, FormatvalueJSON, currencyCode) {
        ...
        if (fieldValue) {
            if (fieldType == "Amount") {
                ...
                } else formattedText.text = fieldValue;
