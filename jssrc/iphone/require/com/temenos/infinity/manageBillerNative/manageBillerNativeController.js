define("com/temenos/infinity/manageBillerNative/usermanageBillerNativeController", ['./manageBillerDAO', './ParserUtilsManager', './FormatUtils', './EntitlementUtils', './CacheUtils'], function(manageBillerDAO, ParserUtilsManager, FormatUtils, EntitlementUtils, CacheUtils) {
    return {
        ...
        onSearch: function() {
            try {
                ...
                if (this._inPlaceHandling === true) {
                    ...
                    scope.ManageBillerDAO.fetchPayeeList(this._payeeSearchObjectService, this._payeeSEARCHOperation, this._payeeSearchObject, criteria, scope.fetchPayeeDataCallBack, scope.onError);
                }
            } catch (err) {
                var errObj = {
        ...
        fetchPayeeData: function() {
            try {
                ...
                this.noMoreRecordsInCache = false;
                scope.ManageBillerDAO.fetchPayeeList(this._payeeObjectService, this._payeeGETOperation, this._payeeObject, JSON.parse(this._payeeGETCriteria), scope.fetchPayeeDataCallBack, scope.onError);
                this.clearSearchText();
            } catch (err) {
                var errObj = {
            ...
            try {
                ...
                for (var i = 0; i < serviceResponse.length; i++) {
                    ...
                    if (Column1Visibility) {
                        record["lblField1"] = {
                            "text": this.getFormattedData(this.getResponseValue(JSON.parse(this._field1)["mapping"], i), JSON.parse(this._field1)["fieldType"]),
                    ...
                    if (Column2Visibility) {
                        record["lblField2"] = {
                            "text": this.getFormattedData(this.getResponseValue(JSON.parse(this._field2)["mapping"], i), JSON.parse(this._field2)["fieldType"]),
        ...
        deleteHandler: function(data, index, response) {
            try {
                if (response === true) {
                    ...
                    scope.ManageBillerDAO.deletePayee(this._payeeObjectService, this._payeeDELETEOperation, this._payeeObject, payload, scope.showDeleteConfirmationPopup, scope.onError);
                }
            } catch (err) {
                var errObj = {
...
define("com/temenos/infinity/manageBillerNative/manageBillerNativeControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_g6f6b392e7f2438880d4a28075d06610: function AS_FlexContainer_g6f6b392e7f2438880d4a28075d06610(eventobject) {
        var self = this;
        return self.preShow.call(this);
    },
});
define("com/temenos/infinity/manageBillerNative/manageBillerNativeController", ["com/temenos/infinity/manageBillerNative/usermanageBillerNativeController", "com/temenos/infinity/manageBillerNative/manageBillerNativeControllerActions"], function() {
    var controller = require("com/temenos/infinity/manageBillerNative/usermanageBillerNativeController");
    var actions = require("com/temenos/infinity/manageBillerNative/manageBillerNativeControllerActions");
