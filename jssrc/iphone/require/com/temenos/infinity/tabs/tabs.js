define(function() {
    return function(controller) {
        ...
        }, controller.args[1], "btnTab1"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnTab1"));
        ...
        var btnTab2 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnTab2"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnTab2"));
        ...
        var btnTab3 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnTab3"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnTab3"));
        ...
        var btnTab4 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnTab4"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnTab4"));
