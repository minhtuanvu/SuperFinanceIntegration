define("com/temenos/infinity/accountsummary/donutChartNative/userdonutChartNativeController", ['./AccountsDAO', './ParserUtilsManager'], function(AccountsDAO, ParserUtilsManager) {
    return {
        ...
        parseJsonAndGetValue: function(Value) {
            try {
                ...
                if (valueJson[this.default]) {
                    if (typeof(valueJson[this.default]) == "string") return this.getProcessedText(valueJson[this.default]);
                    else {
                        return "";
                    }
                }
        ...
        postShow: function() {
            ...
            if (this._objectServiceName1 && this._operationName1 && this._objectName1) {
                //         this.requestStart();
                scopeObj.accountsDAO.fetchAccountDetails(this._objectServiceName1, this._operationName1, this._objectName1, this.getCriteria(this._criteria1), scopeObj._identifier1, scopeObj.prepareObjectForTheView, scopeObj.errorCallback);
            } else {
...
define("com/temenos/infinity/accountsummary/donutChartNative/donutChartNativeControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_f893f10d00404743834fc4c2fc8fd028: function AS_FlexContainer_f893f10d00404743834fc4c2fc8fd028(eventobject) {
        var self = this;
        return self.postShow.call(this);
    }
});
define("com/temenos/infinity/accountsummary/donutChartNative/donutChartNativeController", ["com/temenos/infinity/accountsummary/donutChartNative/userdonutChartNativeController", "com/temenos/infinity/accountsummary/donutChartNative/donutChartNativeControllerActions"], function() {
    var controller = require("com/temenos/infinity/accountsummary/donutChartNative/userdonutChartNativeController");
    var actions = require("com/temenos/infinity/accountsummary/donutChartNative/donutChartNativeControllerActions");
