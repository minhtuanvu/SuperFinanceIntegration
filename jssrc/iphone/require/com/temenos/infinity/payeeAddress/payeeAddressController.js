define("com/temenos/infinity/payeeAddress/userpayeeAddressController", ['InfinityComponents/DataValidationFramework/DataValidationHandler', './AddPayeeDAO', './ParserUtilsManager'], function(DataValidationHandler, AddPayeeDAO, ParserUtilsManager) {
    return {
        ...
        initActions: function() {
            ...
            this.view.txtValue1.onTextChange = this.minFillValidation.bind(this, "txtValue1");
            this.view.txtValue2.onTextChange = this.minFillValidation.bind(this, "txtValue2");
            this.view.txtValue3.onTextChange = this.minFillValidation.bind(this, "txtValue3");
            this.view.txtValue4.onTextChange = this.minFillValidation.bind(this, "txtValue4");
            this.view.txtValue5.onTextChange = this.minFillValidation.bind(this, "txtValue5");
            this.view.txtValue6.onTextChange = this.minFillValidation.bind(this, "txtValue6");
        },
        ...
        minFillValidation: function(tbxWidget) {
            ...
            var dataValidator = this.dataValidationHandler.validateMinFill(tempJson, object, minFillconfig);
        ...
        editServiceCall: function() {
            ...
            this.addPayeeDAO.updatePayee(objSvcName, objName, operationName, criteria, this.onSuccessEditPayee, identifier, self.onEditError);
        },
...
define("com/temenos/infinity/payeeAddress/payeeAddressControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_d9406264882140a38d762d1ba734a43a: function AS_FlexContainer_d9406264882140a38d762d1ba734a43a(eventobject) {
        var self = this;
        return self.preShow.call(this);
    }
});
define("com/temenos/infinity/payeeAddress/payeeAddressController", ["com/temenos/infinity/payeeAddress/userpayeeAddressController", "com/temenos/infinity/payeeAddress/payeeAddressControllerActions"], function() {
    var controller = require("com/temenos/infinity/payeeAddress/userpayeeAddressController");
    var actions = require("com/temenos/infinity/payeeAddress/payeeAddressControllerActions");
