 ...
 * @author KH2704
 */
define("com/temenos/infinity/accountdetails/information/userinformationController", ['./AccountsDAO', './ParseUtilsManager', 'FormatValueUtils'], function(AccountsDAO, ParseUtilsManager, FormatValueUtils) {
    return {
        ...
        postShow: function() {
            ...
            try {
                ...
                if (scopeObj._objectServiceName && scopeObj._operationName && scopeObj._objectName) {
                    ...
                    scopeObj.accountsDAO.fetchAccountDetails(scopeObj._objectServiceName, scopeObj._operationName, scopeObj._objectName, scopeObj.getCriteria(scopeObj._criteria), scopeObj._serviceIdentifier, scopeObj.prepareObjectForTheView, scopeObj.errorCallback);
                } else {
        ...
        bindServiceResponse: function() {
            var scope = this;
            try {
                scope._tab1field1backendmapping = scope.parseJsonAndGetValue(scope._tab1field1backendmapping);
                scope._tab1field2backendmapping = scope.parseJsonAndGetValue(scope._tab1field2backendmapping);
                scope._tab1field3backendmapping = scope.parseJsonAndGetValue(scope._tab1field3backendmapping);
                scope._tab1field4backendmapping = scope.parseJsonAndGetValue(scope._tab1field4backendmapping);
                scope._tab1field5backendmapping = scope.parseJsonAndGetValue(scope._tab1field5backendmapping);
                scope._tab1field6backendmapping = scope.parseJsonAndGetValue(scope._tab1field6backendmapping);
                scope._tab1field7backendmapping = scope.parseJsonAndGetValue(scope._tab1field7backendmapping);
                scope._tab1field8backendmapping = scope.parseJsonAndGetValue(scope._tab1field8backendmapping);
                scope._tab1field9backendmapping = scope.parseJsonAndGetValue(scope._tab1field9backendmapping);
                scope._tab1field10backendmapping = scope.parseJsonAndGetValue(scope._tab1field10backendmapping);
                if (scope._visibleTab2) {
                    scope._tab2field1backendmapping = scope.parseJsonAndGetValue(scope._tab2field1backendmapping);
                    scope._tab2field2backendmapping = scope.parseJsonAndGetValue(scope._tab2field2backendmapping);
                    scope._tab2field3backendmapping = scope.parseJsonAndGetValue(scope._tab2field3backendmapping);
                    scope._tab2field4backendmapping = scope.parseJsonAndGetValue(scope._tab2field4backendmapping);
                    scope._tab2field5backendmapping = scope.parseJsonAndGetValue(scope._tab2field5backendmapping);
                    scope._tab2field6backendmapping = scope.parseJsonAndGetValue(scope._tab2field6backendmapping);
                    scope._tab2field7backendmapping = scope.parseJsonAndGetValue(scope._tab2field7backendmapping);
                    scope._tab2field8backendmapping = scope.parseJsonAndGetValue(scope._tab2field8backendmapping);
                    scope._tab2field9backendmapping = scope.parseJsonAndGetValue(scope._tab2field9backendmapping);
                    scope._tab2field10backendmapping = scope.parseJsonAndGetValue(scope._tab2field10backendmapping);
                }
                if (scope._visibleTab3) {
                    scope._tab3field1backendmapping = scope.parseJsonAndGetValue(scope._tab3field1backendmapping);
                    scope._tab3field2backendmapping = scope.parseJsonAndGetValue(scope._tab3field2backendmapping);
                    scope._tab3field3backendmapping = scope.parseJsonAndGetValue(scope._tab3field3backendmapping);
                    scope._tab3field4backendmapping = scope.parseJsonAndGetValue(scope._tab3field4backendmapping);
                    scope._tab3field5backendmapping = scope.parseJsonAndGetValue(scope._tab3field5backendmapping);
                    scope._tab3field6backendmapping = scope.parseJsonAndGetValue(scope._tab3field6backendmapping);
                    scope._tab3field7backendmapping = scope.parseJsonAndGetValue(scope._tab3field7backendmapping);
                    scope._tab3field8backendmapping = scope.parseJsonAndGetValue(scope._tab3field8backendmapping);
                    scope._tab3field9backendmapping = scope.parseJsonAndGetValue(scope._tab3field9backendmapping);
                    scope._tab3field10backendmapping = scope.parseJsonAndGetValue(scope._tab3field10backendmapping);
                }
                if (scope._visibleTab4) {
                    scope._tab4field1backendmapping = scope.parseJsonAndGetValue(scope._tab4field1backendmapping);
                    scope._tab4field2backendmapping = scope.parseJsonAndGetValue(scope._tab4field2backendmapping);
                    scope._tab4field3backendmapping = scope.parseJsonAndGetValue(scope._tab4field3backendmapping);
                    scope._tab4field4backendmapping = scope.parseJsonAndGetValue(scope._tab4field4backendmapping);
                    scope._tab4field5backendmapping = scope.parseJsonAndGetValue(scope._tab4field5backendmapping);
                    scope._tab4field6backendmapping = scope.parseJsonAndGetValue(scope._tab4field6backendmapping);
                    scope._tab4field7backendmapping = scope.parseJsonAndGetValue(scope._tab4field7backendmapping);
                    scope._tab4field8backendmapping = scope.parseJsonAndGetValue(scope._tab4field8backendmapping);
                    scope._tab4field9backendmapping = scope.parseJsonAndGetValue(scope._tab4field9backendmapping);
                    scope._tab4field10backendmapping = scope.parseJsonAndGetValue(scope._tab4field10backendmapping);
                }
            ...
            try {
                ...
                if (scope._visibleTab3) {
                    ...
                    if (scope._tab3field7backendmapping) {
                        ...
                        count++;
                    } else scope.view.flxTab3Field7.setVisibility(false);
...
define("com/temenos/infinity/accountdetails/information/informationControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_dd3ef7b2d399455ebcd2a66ae23cdc4c: function AS_FlexContainer_dd3ef7b2d399455ebcd2a66ae23cdc4c(eventobject) {
        var self = this;
        return self.postShow.call(this);
    }
});
define("com/temenos/infinity/accountdetails/information/informationController", ["com/temenos/infinity/accountdetails/information/userinformationController", "com/temenos/infinity/accountdetails/information/informationControllerActions"], function() {
    var controller = require("com/temenos/infinity/accountdetails/information/userinformationController");
    var actions = require("com/temenos/infinity/accountdetails/information/informationControllerActions");
