define(function() {
    return function(controller) {
        ...
        var button1 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "button1"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "button1"));
        var button2 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "button2"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "button2"));
        var button3 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "button3"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "button3"));
        var button4 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "button4"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "button4"));
        var button5 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "button5"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "button5"));
