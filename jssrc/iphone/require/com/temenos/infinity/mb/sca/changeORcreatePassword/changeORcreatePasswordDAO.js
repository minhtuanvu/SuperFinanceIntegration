define(function() {
    ...
    changeORcreatePasswordDAO.prototype.callPasswordService = function({
        objServiceName,
        objName,
        operationName,
        payload,
        ...
        try {
            ...
            if (operationName === "getPasswordRulesAndPolicy") {
                kony.mvc.MDAApplication.getSharedInstance().getRepoManager().getRepository(objName).setHeaderParams({
