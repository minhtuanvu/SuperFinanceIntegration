define(function() {
    return function(controller) {
        ...
        var btnGenerateCode = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnGenerateCode"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnGenerateCode"));
        ...
        var btnCreateNewSignature = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnCreateNewSignature"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnCreateNewSignature"));
