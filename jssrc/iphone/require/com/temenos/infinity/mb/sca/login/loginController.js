define("com/temenos/infinity/mb/sca/login/userloginController", ['./LoginUtility', './LoginDAO'], function(LoginUtility, LoginDAO) {
    var SDKConstants = {
        "PIN_REQUEST": 100,
        "OTP_GENERATED": 106
    };
    return {
        ...
        */
        ...
        btnLoginOnClick: function() {
            ...
            var userId = "";
            if (this.usersListObj.usersList !== null && this.usersListObj.usersList.length === 1) {
        ...
        onLoginFailureCallback: function(resError) {
            ...
            this.view.lblErrorMessage.text = errMsg;
...
define("com/temenos/infinity/mb/sca/login/loginControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_c38ba148e1f74878bcc7e3a440504855: function AS_FlexContainer_c38ba148e1f74878bcc7e3a440504855(eventobject) {
        var self = this;
        return self.preShow.call(this);
    }
});
define("com/temenos/infinity/mb/sca/login/loginController", ["com/temenos/infinity/mb/sca/login/userloginController", "com/temenos/infinity/mb/sca/login/loginControllerActions"], function() {
    var controller = require("com/temenos/infinity/mb/sca/login/userloginController");
    var actions = require("com/temenos/infinity/mb/sca/login/loginControllerActions");
