define("com/temenos/infinity/mb/sca/registeredDevices/userregisteredDevicesController", ['./registeredDevicesDAO', 'SCAUtility'], function(registeredDevicesDAO, SCAUtility) {
    const SDKConstants = {
        "PIN_REQUEST": 100,
    ...
    return {
        ...
        populateCustomPopupData: function({
            title,
            description
        }) {
        ...
        mappingSegmentData: function({
            ...
            const scopeObj = this;
            const deviceStatusVisibility = (status && status !== "" && status !== undefined) ? true : false;
            let imgDeviceStatus = "";
...
define("com/temenos/infinity/mb/sca/registeredDevices/registeredDevicesControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_g7659685c0ed4656ac8168d06e807d5e: function AS_FlexContainer_g7659685c0ed4656ac8168d06e807d5e(eventobject) {
        var self = this;
        return self.preShowRegisteredDevices.call(this);
    }
});
define("com/temenos/infinity/mb/sca/registeredDevices/registeredDevicesController", ["com/temenos/infinity/mb/sca/registeredDevices/userregisteredDevicesController", "com/temenos/infinity/mb/sca/registeredDevices/registeredDevicesControllerActions"], function() {
    var controller = require("com/temenos/infinity/mb/sca/registeredDevices/userregisteredDevicesController");
    var actions = require("com/temenos/infinity/mb/sca/registeredDevices/registeredDevicesControllerActions");
