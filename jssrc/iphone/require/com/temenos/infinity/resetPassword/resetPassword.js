define(function() {
    return function(controller) {
        ...
        var rtxSelectOptionInfo = new kony.ui.RichText(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "rtxSelectOptionInfo"), extendConfig({
            "wrapping": constants.WIDGET_TEXT_WORD_WRAP
        }, controller.args[2], "rtxSelectOptionInfo"));
        ...
        var btnProceed = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnProceed"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnProceed"));
