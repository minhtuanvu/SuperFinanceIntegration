define("com/temenos/infinity/resetPassword/userresetPasswordController", function() {
    return {
        userName: "",
        servicekey: "",
        securityKey: "",
        ...
        setFlowActions: function() {
            ...
            scopeObj.view.btnProceed.onClick = function() {
                if (scopeObj.onSuccessCallback) scopeObj.onSuccessCallback();
            };
        ...
        resendMFAOTP: function() {
            let scopeObj = this;
            applicationManager.getPresentationUtility().showLoadingScreen();
            if (scopeObj.MFAResponse && scopeObj.MFAResponse.MFAAttributes.remainingResendAttempts < 1) scopeObj.view.lblResend.isVisible = false;
            else scopeObj.view.lblResend.isVisible = true;
            var inputJSON = {
                "UserName": scopeObj.userName,
                "MFAAttributes": {
                    "serviceKey": scopeObj.serviceKey,
        ...
        displaySelectionScreen: function() {
            ...
            if (scopeObj.MFAResponse.MFAAttributes && scopeObj.MFAResponse.MFAAttributes.customerCommunication) {
                for (var i in scopeObj.MFAResponse.MFAAttributes.customerCommunication.phone) scopeObj.MFAResponse.MFAAttributes.customerCommunication.phone[i].unmasked = scopeObj.MFAResponse.MFAAttributes.customerCommunication.phone[i].referenceId;
                for (var j in scopeObj.MFAResponse.MFAAttributes.customerCommunication.email) scopeObj.MFAResponse.MFAAttributes.customerCommunication.email[j].unmasked = scopeObj.MFAResponse.MFAAttributes.customerCommunication.email[j].referenceId;
            }
...
define("com/temenos/infinity/resetPassword/resetPasswordControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_adbd3f829c0d43dcaa5c0a81352adf1a: function AS_FlexContainer_adbd3f829c0d43dcaa5c0a81352adf1a(eventobject) {
        var self = this;
        return self.preshow.call(this);
    }
});
define("com/temenos/infinity/resetPassword/resetPasswordController", ["com/temenos/infinity/resetPassword/userresetPasswordController", "com/temenos/infinity/resetPassword/resetPasswordControllerActions"], function() {
    var controller = require("com/temenos/infinity/resetPassword/userresetPasswordController");
    var actions = require("com/temenos/infinity/resetPassword/resetPasswordControllerActions");
