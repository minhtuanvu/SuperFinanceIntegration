define(function() {
    return function(controller) {
        ...
        var btnViewBill = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnViewBill"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnViewBill"));
        var btnPayBill = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnPayBill"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnPayBill"));
        ...
        var btnAction = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnAction"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnAction"));
        ...
        var btnEditPayeeAddress = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnEditPayeeAddress"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnEditPayeeAddress"));
        ...
        var btnEditNickName = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnEditNickName"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnEditNickName"));
