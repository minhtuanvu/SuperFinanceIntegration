define("com/temenos/infinity/updatePassword/userupdatePasswordController", function() {
    return {
        ...
        getPasswordPoliciesSuccessCallback: function(data) {
            ...
            if (passwordrules.atleastOneNumber) policyData += "\nAtleast One Number";
            if (passwordrules.atleastOneSymbol) policyData += "\nAtleast One Symbol";
            if (passwordrules.atleastOneUpperCase) policyData += "\nAtleast One Uppercase";
            if (passwordrules.atleastOneLowerCase) policyData += "\nAtleast One Lowercase";
        ...
        validateExistingPassword: function() {
            ...
            let scopeObj = this;
            let params = {
                "password": scopeObj.view.txtCurrentPassword.text
            };
                ...
                if (obj.status && !obj.isServerUnreachable) {
                    if (data.result === "The user is verified") {
                        ...
                        scopeObj.showErrorMessage({
                            "errorMessage": scopeObj.getStringFromi18n("kony.profile.currentpasswordWrong")
                        });
                    } else {
                        scopeObj.showErrorMessage({
                            "errorMessage": scopeObj.getStringFromi18n("kony.error.StandardErrorMessage")
                        });
                    }
                } else {
                    scopeObj.showErrorMessage(obj);
...
define("com/temenos/infinity/updatePassword/updatePasswordControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_e564d53257be4972858358a31615c321: function AS_FlexContainer_e564d53257be4972858358a31615c321(eventobject) {
        var self = this;
        return self.preshow.call(this);
    }
});
define("com/temenos/infinity/updatePassword/updatePasswordController", ["com/temenos/infinity/updatePassword/userupdatePasswordController", "com/temenos/infinity/updatePassword/updatePasswordControllerActions"], function() {
    var controller = require("com/temenos/infinity/updatePassword/userupdatePasswordController");
    var actions = require("com/temenos/infinity/updatePassword/updatePasswordControllerActions");
