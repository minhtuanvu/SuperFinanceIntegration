define("com/temenos/infinityComponent/BillPay/userBillPayController", ['./ParserUtilsManager', 'InfinityComponents/DataValidationFramework/DataValidationHandler', './BillPaymentsDAO', './FormatUtils'], function(ParserUtilsManager, DataValidationHandler, BillPaymentsDAO, FormatUtils) {
    return {
        ...
        onEditBillPayerDetailsTextChange: function(tbxkey) {
            try {
                ...
                if ((Object.keys(minlength).length === 0 && minlength.constructor === Object) && (Object.keys(maxlength).length === 0 && maxlength.constructor === Object)) {
                    if ((scope.view.txtboxEnterPayerNameKeyValue.text !== "") && (scope.view.txtBoxEnterAddressKeyValue.text !== "") && (scope.view.txtBoxEnterPostalCodeValue.text !== "") && (scope.view.txtBoxEnterLocationValue.text !== "") && (scope.view.txtBoxEnterProvinceValue.text !== "")) {
                        scope.enableButton("btnContinueEditPayeeDetails");
                    } else {
                        scope.disableButton("btnContinueEditPayeeDetails");
                    }
 ...
 scope.view.lblAmountName.text = scope.getFieldValue(scope._billpayEdit)+ " "+scope.getFieldValue(scope._amntSectionTitle);
        ...
        rowExpandCollapse: function(context) {
            ...
            try {
                ...
                if (this.segmentData === '') this.segmentData = JSON.parse(JSON.stringify(this.view.segAccounts.data));
...
define("com/temenos/infinityComponent/BillPay/BillPayControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_FlexContainer_e496eb0297e74955ac117e8c2999c75b: function AS_FlexContainer_e496eb0297e74955ac117e8c2999c75b(eventobject) {
        var self = this;
        return self.preShow.call(this);
    },
});
define("com/temenos/infinityComponent/BillPay/BillPayController", ["com/temenos/infinityComponent/BillPay/userBillPayController", "com/temenos/infinityComponent/BillPay/BillPayControllerActions"], function() {
    var controller = require("com/temenos/infinityComponent/BillPay/userBillPayController");
    var actions = require("com/temenos/infinityComponent/BillPay/BillPayControllerActions");
