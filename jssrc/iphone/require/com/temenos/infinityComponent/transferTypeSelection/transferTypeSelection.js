define(function() {
    return function(controller) {
        ...
        var rtLearnMore = new kony.ui.RichText(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "rtLearnMore"), extendConfig({
            "wrapping": constants.WIDGET_TEXT_WORD_WRAP
        }, controller.args[2], "rtLearnMore"));
        ...
        var btnMoreLink = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnMoreLink"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnMoreLink"));
        ...
        var btnAction1 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnAction1"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnAction1"));
        ...
        var btnAction2 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnAction2"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnAction2"));
        ...
        var btnDescriptionActionBtn1 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnDescriptionActionBtn1"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnDescriptionActionBtn1"));
        var btnDescriptionActionBtn2 = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnDescriptionActionBtn2"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnDescriptionActionBtn2"));
