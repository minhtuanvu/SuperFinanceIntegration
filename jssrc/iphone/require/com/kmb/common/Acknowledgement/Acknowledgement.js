define(function() {
    return function(controller) {
        ...
        var segDetails = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segDetails"), extendConfig({
            "bounces": true,
        ...
        var btnDashboard = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnDashboard"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnDashboard"));
        ...
        var btnLoginAgain = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnLoginAgain"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnLoginAgain"));
        ...
        var btnTryAgain = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnTryAgain"), extendConfig({
            "showProgressIndicator": false
        }, controller.args[2], "btnTryAgain"));
