define("com/common/wealthCalendar/userwealthCalendarController", function() {
    return {
        ...
        preShow: function() {
            ...
            this.addHolidays();
            if (kony.application.getCurrentForm().id == "frmBillPayEndDate") this.setRangeSkins();
        },
...
define("com/common/wealthCalendar/wealthCalendarControllerActions", {
    /*
...
define("com/common/wealthCalendar/wealthCalendarController", ["com/common/wealthCalendar/userwealthCalendarController", "com/common/wealthCalendar/wealthCalendarControllerActions"], function() {
    var controller = require("com/common/wealthCalendar/userwealthCalendarController");
    var actions = require("com/common/wealthCalendar/wealthCalendarControllerActions");
