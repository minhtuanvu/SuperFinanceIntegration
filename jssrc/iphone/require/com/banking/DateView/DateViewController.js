define("com/banking/DateView/userDateViewController", function() {
    ...
    var isInvalidInput = function(char) {
        ...
        */
        ...
        return (length === 0 && digit > 1) || (length === 1 && (parseInt(this.enteredDateString + char) > 12 || parseInt(this.enteredDateString + char) === 0)) || (length === 2 && digit > 3) || (length === 3 && (parseInt(this.enteredDateString.charAt(2) + char) > 31 || parseInt(this.enteredDateString.charAt(2) + char) === 0)) || (length === 4 && (digit > 2 || digit < 1)) || (length === 5 && (parseInt(this.enteredDateString.charAt(4) + char) < 19 || parseInt(this.enteredDateString.charAt(4) + char) > 20));
    };
    return {
...
define("com/banking/DateView/DateViewControllerActions", {
    /*
      This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("com/banking/DateView/DateViewController", ["com/banking/DateView/userDateViewController", "com/banking/DateView/DateViewControllerActions"], function() {
    var controller = require("com/banking/DateView/userDateViewController");
    var actions = require("com/banking/DateView/DateViewControllerActions");
