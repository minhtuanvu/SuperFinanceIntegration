define("com/banking/inputPhoneNumber/userinputPhoneNumberController", function() {
        ...
        constructor: function(baseConfig, layoutConfig, pspConfig) {
            ...
            this.addDigit = function(char) {
                if (self.phoneNumberString.length < max) {
                    ...
                    if (self.phoneNumberString.length === max && isAPIAvailable(self.onPhoneNumberEntered)) {
            ...
            this.setPhoneNumber = function(number) {
                ...
                if (number.length === max && isAPIAvailable(self.onPhoneNumberEntered)) {
                    self.onPhoneNumberEntered();
                }
                updatePhoneView.call(self);
            };
...
define("com/banking/inputPhoneNumber/inputPhoneNumberControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
});
define("com/banking/inputPhoneNumber/inputPhoneNumberController", ["com/banking/inputPhoneNumber/userinputPhoneNumberController", "com/banking/inputPhoneNumber/inputPhoneNumberControllerActions"], function() {
    var controller = require("com/banking/inputPhoneNumber/userinputPhoneNumberController");
    var actions = require("com/banking/inputPhoneNumber/inputPhoneNumberControllerActions");
