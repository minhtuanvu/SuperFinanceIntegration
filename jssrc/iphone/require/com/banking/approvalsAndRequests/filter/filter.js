define(function() {
    return function(controller) {
        ...
        var btnSelectTransactionType = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSelectTransactionType"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnSelectTransactionType"));
        ...
        var imgAll = new kony.ui.Image2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "imgAll"), extendConfig({
            "cacheConfig": {
                "cachePolicy": "kony.net.cache.USE_PROTOCOL_CACHE_POLICY",
                "cacheStoragePolicy": "kony.net.cache.DISK_AND_MEMORY"
            }
        }, controller.args[2], "imgAll"));
        ...
        var btnAll = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnAll"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnAll"));
        ...
        var imgSingleTransactions = new kony.ui.Image2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "imgSingleTransactions"), extendConfig({
            "cacheConfig": {
                "cachePolicy": "kony.net.cache.USE_PROTOCOL_CACHE_POLICY",
                "cacheStoragePolicy": "kony.net.cache.DISK_AND_MEMORY"
            }
        }, controller.args[2], "imgSingleTransactions"));
        var btnSingleTransactions = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnSingleTransactions"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnSingleTransactions"));
        ...
        var segSingleTransactions = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segSingleTransactions"), extendConfig({
            "bounces": false,
        ...
        }, controller.args[2], "segSingleTransactions"));
        ...
        var imgBulkTransactionsSeperator = new kony.ui.Image2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "imgBulkTransactionsSeperator"), extendConfig({
            "cacheConfig": {
                "cachePolicy": "kony.net.cache.USE_PROTOCOL_CACHE_POLICY",
                "cacheStoragePolicy": "kony.net.cache.DISK_AND_MEMORY"
            }
        }, controller.args[2], "imgBulkTransactionsSeperator"));
        var btnBulkTransactionsSeperator = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnBulkTransactionsSeperator"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnBulkTransactionsSeperator"));
        ...
        var segBulkTransactions = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segBulkTransactions"), extendConfig({
            "bounces": false,
            "editStyle": constants.SEGUI_EDITING_STYLE_NONE,
            "enableDictionary": false,
            "indicator": constants.SEGUI_NONE,
            "progressIndicatorColor": constants.PROGRESS_INDICATOR_COLOR_WHITE,
            "showProgressIndicator": false
        }, controller.args[2], "segBulkTransactions"));
        ...
        var imgOtherRequests = new kony.ui.Image2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "imgOtherRequests"), extendConfig({
            "cacheConfig": {
                "cachePolicy": "kony.net.cache.USE_PROTOCOL_CACHE_POLICY",
                "cacheStoragePolicy": "kony.net.cache.DISK_AND_MEMORY"
            }
        }, controller.args[2], "imgOtherRequests"));
        var btnOtherRequests = new kony.ui.Button(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "btnOtherRequests"), extendConfig({
            "showProgressIndicator": true
        }, controller.args[2], "btnOtherRequests"));
        ...
        var segOtherRequests = new kony.ui.SegmentedUI2(extendConfig({
            ...
            "padding": [0, 0, 0, 0],
            "paddingInPixel": false
        }, controller.args[1], "segOtherRequests"), extendConfig({
            "bounces": false,
            "editStyle": constants.SEGUI_EDITING_STYLE_NONE,
            "enableDictionary": false,
            "indicator": constants.SEGUI_NONE,
            "progressIndicatorColor": constants.PROGRESS_INDICATOR_COLOR_WHITE,
            "showProgressIndicator": false
        }, controller.args[2], "segOtherRequests"));
