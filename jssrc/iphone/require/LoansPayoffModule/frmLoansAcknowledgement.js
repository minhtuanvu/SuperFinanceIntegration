define("LoansPayoffModule/frmLoansAcknowledgement", function() {
    return function(controller) {
        function addWidgetsfrmLoansAcknowledgement() {
            ...
            var lblDetails = new kony.ui.Label({
                ...
                "text": kony.i18n.getLocalizedString("kony.mb.loans.AckMessage"),
                "textStyle": {},
                "top": "10dp",
                "width": "312dp",
                "zIndex": 4
            ...
            flxSeparator.add();
            flxSuccess.add(imgGreenTick, lblSuccessMessage, lblDetails, flxSeparator);
        ...
        return [{
            "addWidgets": addWidgetsfrmLoansAcknowledgement,
            "enabledForIdleTimeout": true,
            "id": "frmLoansAcknowledgement",
            "init": controller.AS_Form_b65127e2fe21420a898afbecbb68c536,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "preShow": function(eventobject) {
                controller.AS_Form_fb0497b34a7d4284a894e44d226f3c4d(eventobject);
            },
            "skin": "sknFrmffffff",
