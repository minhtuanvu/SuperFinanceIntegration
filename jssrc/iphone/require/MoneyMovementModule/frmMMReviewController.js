define("MoneyMovementModule/userfrmMMReviewController", {
    init: function() {
        var scope = this;
    ...
    changeButtonText: function() {
        ...
        else this.view.btnTransfer.text = applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.transaction.transfer");
    }
});
define("MoneyMovementModule/frmMMReviewControllerActions", {
    /*
    ...
    */
    ...
    AS_Form_d35df4690f7449a195c45fc606409df2: function AS_Form_d35df4690f7449a195c45fc606409df2(eventobject) {
        var self = this;
        this.postShow();
    },
    ...
    AS_BarButtonItem_b16e10984eb246f3bfb5d217db5327f7: function AS_BarButtonItem_b16e10984eb246f3bfb5d217db5327f7(eventobject) {
        var self = this;
        this.navigateCustomBack();
    },
    AS_BarButtonItem_jec818ad8f8347329ab2319b4d66209c: function AS_BarButtonItem_jec818ad8f8347329ab2319b4d66209c(eventobject) {
        var self = this;
        this.cancelOnClick();
    }
});
define("MoneyMovementModule/frmMMReviewController", ["MoneyMovementModule/userfrmMMReviewController", "MoneyMovementModule/frmMMReviewControllerActions"], function() {
    var controller = require("MoneyMovementModule/userfrmMMReviewController");
    var controllerActions = ["MoneyMovementModule/frmMMReviewControllerActions"];
