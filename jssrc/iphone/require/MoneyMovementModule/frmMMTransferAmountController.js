define("MoneyMovementModule/userfrmMMTransferAmountController", {
    keypadString: '0.00',
    isPeriodUsed: false,
    ...
    preShow: function() {
        ...
        if (moneyMovementPresentationController.transactionMode !== applicationManager.getPresentationUtility().getStringFromi18n("kony.mb.transfer.InternationalTransfer")) {
            this.setLoanPayDue();
            if (this.isToLoanAccount === false) this.setAmount(transObj.amount);
        } else {
    ...
    setLoanPayDue: function() {
        ...
        if (toAccountData.toAccountType === "Loan") {
            ...
            if (transObj.paymentDue == null || transObj.paymentDue == undefined) transObj.paymentDue = "0";
            this.totalOverdue = transObj.paymentDue;
            this.view.flxMainContainer.bottom = "0%";
            if (transObj.nextPaymentAmount == null || transObj.nextPaymentAmount == undefined) transObj.nextPaymentAmount = "0";
    ...
    continueOnClick: function() {
        ...
        if (this.isToLoanAccount === true) {
            ...
            if (!moneyMovementPresentationController.haveLimitsBeenFetched) moneyMovementPresentationController.fetchLimits(amount);
            else this.executeAfterFetchingLimits(amount)
        }
    },
...
define("MoneyMovementModule/frmMMTransferAmountControllerActions", {
    /*
    ...
    */
    ...
    AS_Form_cf2e29191b3d448e96af62ea6976a3cc: function AS_Form_cf2e29191b3d448e96af62ea6976a3cc(eventobject) {
        var self = this;
        this.postShow();
    },
    ...
    AS_BarButtonItem_c0a4aa1f55ef44968ce69b917a8a4e4f: function AS_BarButtonItem_c0a4aa1f55ef44968ce69b917a8a4e4f(eventobject) {
        var self = this;
        this.navigateCustomBack();
    },
    AS_BarButtonItem_ce88ee48a90c454984d76648a921bf20: function AS_BarButtonItem_ce88ee48a90c454984d76648a921bf20(eventobject) {
        var self = this;
        this.cancelOnClick();
    },
...
define("MoneyMovementModule/frmMMTransferAmountController", ["MoneyMovementModule/userfrmMMTransferAmountController", "MoneyMovementModule/frmMMTransferAmountControllerActions"], function() {
    var controller = require("MoneyMovementModule/userfrmMMTransferAmountController");
    var controllerActions = ["MoneyMovementModule/frmMMTransferAmountControllerActions"];
