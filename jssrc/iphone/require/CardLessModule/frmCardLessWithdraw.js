define("CardLessModule/frmCardLessWithdraw", function() {
    return function(controller) {
        function addWidgetsfrmCardLessWithdraw() {
            ...
            var customHeader = new com.kmb.common.customHeader({
                ...
                "overrides": {
                    ...
                    "lblLocateUs": {
                        "text": kony.i18n.getLocalizedString("kony.mb.CardLessWithdraw.Title")
                    }
                }
            }, {
                "overrides": {}
            ...
            flxFromAccount.add(lblFromAccount, lblFromAccountValue, lblBalanceValue, lblBank, lblavailableBalance, flxSeparator, btnChange, flxSeparator1, imgBankType);
            ...
            var lblDenomination = new kony.ui.Label({
                ...
                "left": "20dp",
                "skin": "sknLbla0a0a022px",
                "text": kony.i18n.getLocalizedString("kony.mb.common.noteColon"),
                "textStyle": {},
                "top": "0dp",
                "width": kony.flex.USE_PREFFERED_SIZE,
                "zIndex": 1
        ...
        var RBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_b59e846c447046a2bdec65e17fecdf0d,
            "metaData": {
        ...
        return [{
            ...
            "preShow": function(eventobject) {
                controller.AS_Form_ebca9cba3258447983cbcce924d2974e(eventobject);
            },
            "skin": "sknFrmffffff",
