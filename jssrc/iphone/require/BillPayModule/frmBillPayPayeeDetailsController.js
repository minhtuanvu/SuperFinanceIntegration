define("BillPayModule/userfrmBillPayPayeeDetailsController", {
    ...
    onNavigate: function() {
        ...
        if (!kony.sdk.isNullOrUndefined(data.payeeData.cif) && cifData.length === 1) {
            ...
            if (coreCustomerIds.length < 2) this.view.quicklinksNative.setLinkVisibilityToContext("editLinkedIDs");
            else this.view.quicklinksNative.setLinkVisibilityToContext("");
        } else {
    ...
    onClickEdit: function() {
        if (applicationManager.getDeviceUtilManager().isIPhone()) {
            ...
            if (this.isEditLinkedCustomerAvailable) actionSheetObject.addAction(actionEditLinkRecipient);
...
define("BillPayModule/frmBillPayPayeeDetailsControllerActions", {
    /*
...
define("BillPayModule/frmBillPayPayeeDetailsController", ["BillPayModule/userfrmBillPayPayeeDetailsController", "BillPayModule/frmBillPayPayeeDetailsControllerActions"], function() {
