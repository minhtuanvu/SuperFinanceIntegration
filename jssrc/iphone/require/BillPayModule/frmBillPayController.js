define("BillPayModule/userfrmBillPayController", ['CampaignUtility'], function(CampaignUtility) {
    return {
        scheduledbills: null,
        postedbills: null,
        pendingbills: null,
        ...
        setSegmentData: function() {
            ...
            if (bills) {
                ...
                if (scheduledBills.length == 0 && postedBills.length == 0 && pendingBills.length == 0) {
                    ...
                    for (var i = 0; i < this.pendingbills.length; i++) {
                        ...
                        if (!isSingleCustomerProfile) {
                            if (profileAccess === "both") {
                                ...
                                this.segmentdata[j][1][i].flxAccountType = {
                                    isVisible: true
                                };
                                this.segmentdata[j][1][i].imgAccountType = {
                                    "src": (isBusinessAccount === "true" ? "personalaccount.png" : "businessaccount.png")
                                };
                            }
                        }
                    }
                    if (this.pendingbills.length > 0) j++;
                    ...
                    if (this.scheduledbills.length > 0) j++;
...
define("BillPayModule/frmBillPayControllerActions", {
    /*
        This is an auto generated file and any modifications to it may result in corruption of the action sequence.
    */
    AS_Form_ed0f6d7dc91b4701a029b6ba29509b49: function AS_Form_ed0f6d7dc91b4701a029b6ba29509b49(eventobject) {
        var self = this;
        this.init();
    },
    AS_Form_e9cffac3ba8b48a3be1c9762db1c32d6: function AS_Form_e9cffac3ba8b48a3be1c9762db1c32d6(eventobject) {
        var self = this;
        this.preShow();
    }
});
define("BillPayModule/frmBillPayController", ["BillPayModule/userfrmBillPayController", "BillPayModule/frmBillPayControllerActions"], function() {
