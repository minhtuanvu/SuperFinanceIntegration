define("ForeignExchange/frmBuyCurrency", function() {
    return function(controller) {
        function addWidgetsfrmBuyCurrency() {
            ...
            var customHeader = new com.kmb.common.customHeader({
                ...
                "overrides": {
                    ...
                    "lblLocateUs": {
                        ...
                        "text": kony.i18n.getLocalizedString("i18n.mob.ForeignExchange.BuyCurrency")
                    }
                }
            }, {
                "overrides": {}
            ...
            var txtSearch = new kony.ui.TextBox2({
                ...
                "left": "20dp",
                "placeholder": kony.i18n.getLocalizedString("kony.mb.foreignExchange.searchPlaceholder"),
                "right": "20dp",
            ...
            var flxRecentSegment = new kony.ui.FlexContainer({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "clipBounds": true,
                "height": "80%",
                "id": "flxRecentSegment",
            ...
            flxRecentSegment.setDefaultUnit(kony.flex.DP);
            var SegRecentCurrency = new kony.ui.SegmentedUI2({
                "autogrowMode": kony.flex.AUTOGROW_NONE,
                "data": [
                    [{
                            "imgUpArrow": "",
            ...
            flxRecentSegment.add(SegRecentCurrency);
            ...
            flxMainContainer.add(flxRecentSegment, flxNoResult, flxSeperator3, btnApply);
            flxBody.add(flxSearch, flxMainContainer);
        ...
        var LBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_ecf39a1089124361bd96710cbd0b7dc8,
            "metaData": {
        ...
        return [{
            "addWidgets": addWidgetsfrmBuyCurrency,
            "enableScrolling": false,
            "enabledForIdleTimeout": true,
            "id": "frmBuyCurrency",
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": false,
            "postShow": controller.AS_Form_b3d1a94d27f3400c9e598b844f7b1202,
            "preShow": function(eventobject) {
                controller.AS_Form_bbb4e25178464944973184cab23cb18b(eventobject);
            },
            "skin": "sknFrmffffff",
            "title": kony.i18n.getLocalizedString("i18n.mob.ForeignExchange.BuyCurrency")
        }, {
