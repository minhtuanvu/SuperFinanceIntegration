define([], function() {
    ...
    Forex_PresentationController.prototype.fetchDashboardCurrencyRatesSuccessCallback = function(response) {
        ...
        if (kony.sdk.isNullOrUndefined(this.quoteCurrencyCode)) this.quoteCurrencyCode = this.baseCurrencyCode;
        try {
    ...
    Forex_PresentationController.prototype.fetchCurrencyRates = function() {
        ...
        fetchCurrencyRates.customVerb("fetchCurrencyRates", params, function(status, data, error) {
    ...
    Forex_PresentationController.prototype.getCompanyCode = function() {
        ...
        try {
            ...
            if (!kony.sdk.isNullOrUndefined(companyID)) market = companyID;
        } catch (e) {}
        return market;
    };
