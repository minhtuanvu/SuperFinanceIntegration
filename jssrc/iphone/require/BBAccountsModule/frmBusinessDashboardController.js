 define("BBAccountsModule/userfrmBusinessDashboardController", ['CampaignUtility'], function(CampaignUtility) {
     return {
         /**
          * Description
          * @method preshow
         ...
         mapAccountsAndBanks: function() {
             try {
                 ...
                 this.view.segAccounts.onRowClick = function(seguiWidget, sectionNumber, rowNumber, selectedState) {
                     ...
                     var formflow = navManager.setCustomInfo("frmdashboardflow", "frmBusinessDashboard");
         ...
         initActions: function() {
             ...
             this.view.customSearchbox.btnCancel.onClick = function() {
                 ...
                 scope.filterAccountsSegment(kony.i18n.getLocalizedString("kony.mb.businessDashboard.viewAccountsByBusinessGroup"));
         ...
         filterAccountsSegment: function(selectedKey) {
             if (selectedKey !== kony.i18n.getLocalizedString("kony.mb.businessDashboard.viewAccountsByBusinessGroup") && selectedKey !== kony.i18n.getLocalizedString("kony.mb.businessDashboard.viewAccountsByAccountType")) {
                 ...
                 this.view.segAccounts.setData(this.getSegmentDataForAccounts(segData, 5));
             } else {
                 if (selectedKey === kony.i18n.getLocalizedString("kony.mb.businessDashboard.viewAccountsByAccountType")) {
                     ...
                     var acctSegData = this.getSegmentDataForAccounts(this.accountTypeFilterData, 5);
                     var scope = this;
                     ...
                     this.view.lblSelectedAccountType.text = kony.i18n.getLocalizedString("kony.mb.businessDashboard.viewByBusinessGroup");
                     var segData = this.getSegmentDataForAccounts(this.accountsData, 5);
         ...
         accountSegmentOnClick: function() {
             ...
             if (this.view.segAccounts.data[rowid].template === "flxViewAll") {
         ...
         getCounts: function() {
             try {
                 ...
                 var scopeObj = this;
                 var formName = "frmBusinessDashboard";
...
define("BBAccountsModule/frmBusinessDashboardControllerActions", {
    /*
...
define("BBAccountsModule/frmBusinessDashboardController", ["BBAccountsModule/userfrmBusinessDashboardController", "BBAccountsModule/frmBusinessDashboardControllerActions"], function() {
    var controller = require("BBAccountsModule/userfrmBusinessDashboardController");
    var controllerActions = ["BBAccountsModule/frmBusinessDashboardControllerActions"];
