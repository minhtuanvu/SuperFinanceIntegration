define("BBAccountsModule/frmCombinedDashboard", function() {
    return function(controller) {
        function addWidgetsfrmCombinedDashboard() {
            ...
            flxPageIndicators.add(flxPageIndicator1, flxPageIndicator2, flxPageIndicator3, flxPageIndicator4, flxPageIndicator5);
            ...
            var lblBalanceOverview = new kony.ui.Label({
                ...
                "left": "40%",
                "skin": "sknLblffffffSSPSemiBold26px",
                "text": kony.i18n.getLocalizedString("kony.mb.dashboard.balaceoverview"),
                "textStyle": {},
                "top": "0%",
                "width": kony.flex.USE_PREFFERED_SIZE,
                "zIndex": 2
            ...
            flxMonthlySpendingContainer.add(imgMonthlySpending, lblMonthlySpending);
            flxGraph.add(browserChart, lblTotalSpendingValue, lblTotalSpending, flxMonthlySpendingContainer);
            ...
            flxTotalAccountBalanceContainer.add(imgTotalAccountBalancesContainer, lblTotalAccountBalancesContainer);
            flxBarChart.add(lblBarTitle, browserBarChart, flxTotalAccountBalanceContainer);
            flxDashboardHeader.add(flxApprovalRequest, flxMultiLineBarChart, flxSummary, flxGraph, flxBarChart);
            ...
            var flxDummyHorizontalScroll = new kony.ui.FlexScrollContainer({
                ...
                "left": "0dp",
                "minHeight": "60dp",
                "onTouchStart": controller.AS_FlexScrollContainer_h9f63cbd7474459e88c437b8b585fcb4,
                "pagingEnabled": true,
                "scrollDirection": kony.flex.SCROLL_HORIZONTAL,
                "skin": "slFSbox",
                "top": "0dp",
            ...
            var segAccounts = new kony.ui.SegmentedUI2({
                ...
                "left": "0dp",
                "needPageIndicator": true,
                "onTouchStart": controller.AS_Segment_fce564f9427e4445a3e6abab2518ec20,
                "pageOffDotImage": "pageoffdot.png",
                "pageOnDotImage": "pageondot.png",
                "retainSelection": false,
                "rowFocusSkin": "seg2Focus",
            ...
            var imgAd1 = new kony.ui.Image2({
                ...
                "isVisible": true,
                "left": "0dp",
                "onDownloadComplete": controller.AS_Image_ed4fd7eae5b6483ea27c212c539acbfb,
                "skin": "slImage",
                "src": "imagedrag.png",
                "top": "0dp",
                "width": "100%",
            ...
            var imgAd2 = new kony.ui.Image2({
                ...
                "isVisible": true,
                "left": "0dp",
                "onDownloadComplete": controller.AS_Image_d054bb689782426ca843557e7fb9a2e7,
                "skin": "slImage",
                "src": "imagedrag.png",
                "top": "0dp",
                "width": "100%",
            ...
            var imgAd3 = new kony.ui.Image2({
                ...
                "isVisible": true,
                "left": "0dp",
                "onDownloadComplete": controller.AS_Image_edfee3cf1b694c3eb3b1b5960565a26c,
                "skin": "slImage",
                "src": "imagedrag.png",
                "top": "0dp",
                "width": "100%",
            ...
            var imgAd4 = new kony.ui.Image2({
                ...
                "isVisible": true,
                "left": "0dp",
                "onDownloadComplete": controller.AS_Image_d97d6fa2a1f04943865d7a6f89a65603,
                "skin": "slImage",
                "src": "imagedrag.png",
                "top": "0dp",
                "width": "100%",
            ...
            var imgAd5 = new kony.ui.Image2({
                ...
                "isVisible": true,
                "left": "0dp",
                "onDownloadComplete": controller.AS_Image_b36291cc64184f2094f37247e4cf8e86,
                "skin": "slImage",
                "src": "imagedrag.png",
                "top": "0dp",
                "width": "100%",
        ...
        var RBarBtnItem0 = new kony.ui.BarButtonItem({
            ...
            "enabled": true,
            "action": controller.AS_BarButtonItem_a2e75b17a28a4b9ebe80811633357d50,
            "metaData": {
        ...
        return [{
            "addWidgets": addWidgetsfrmCombinedDashboard,
            "allowVerticalBounce": false,
            "bounces": false,
            "enableScrolling": false,
            "enabledForIdleTimeout": true,
            "id": "frmCombinedDashboard",
            "init": controller.AS_Form_d5565ab84c334bf7bfb5c5498bf6ec09,
            "layoutType": kony.flex.FREE_FORM,
            "needAppMenu": true,
            "postShow": controller.AS_Form_d294f3984b074da48045b8a35f521cfd,
            "preShow": function(eventobject) {
                controller.AS_Form_d4e155095c454c8daab39d1e29f4bf5e(eventobject);
            },
