define("flxAccountsHeaderDashboardNew", function() {
    return function(controller) {
        var flxAccountsHeaderDashboardNew = new kony.ui.FlexContainer({
            "autogrowMode": kony.flex.AUTOGROW_NONE,
            "clipBounds": true,
            "height": "70dp",
            "id": "flxAccountsHeaderDashboardNew",
            "isVisible": true,
        ...
        flxAccountsHeaderDashboardNew.setDefaultUnit(kony.flex.DP);
        ...
        flxAccountsHeaderDashboardNew.add(lblTypeName, lblTypeValue, lblAccountBal, flxSeparator, flxHeaderSeperator, flxHeaderShadows);
        return flxAccountsHeaderDashboardNew;
    }
})