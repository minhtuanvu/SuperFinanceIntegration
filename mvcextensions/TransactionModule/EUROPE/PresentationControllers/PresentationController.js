...
*/
  ...
  Transaction_PresentationController.prototype.getUserScheduledTransactionsEuropeSuccessCallback = function (res) {
    ...
    for(var i=0;i<transactions.length;i++) {
      ...
      if(transactions[i]["isScheduled"] === "true")
      var trandateobj=formatUtil.getDateObjectfromString(transactions[i]["scheduledDate"],"YYYY-MM-DD");
      else
        var trandateobj=formatUtil.getDateObjectfromString(transactions[i]["transactionDate"],"YYYY-MM-DD");
      ...
      if(transactions[i]["transactionType"]==="P2P")
        transactions[i].image = "payapersonsmall.png";
      else
        transactions[i].image = "maketransfersmall.png";
      var name="";
