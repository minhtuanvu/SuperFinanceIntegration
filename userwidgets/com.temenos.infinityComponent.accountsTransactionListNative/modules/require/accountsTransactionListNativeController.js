define(['./TransactionListDAO', 'JSONValidator', './FormatUtils', './ParserUtilsManager', './CacheUtils'], function(TransactionListDAO, JSONValidator, FormatUtils, ParserUtilsManager, CacheUtils) {
    return {
