  	...
  	/**
        ...
        NativeControllerAndroid.prototype.onAndroidSpeechResult = function(speechText) {
            try {
                ...
                //alert("speechText"+speechText);
                kony.print("onAndroidSpeechResult");
               // var controller = kony.mvc.GetController('frmStep1', true);
                //controller.speechToTextSuccess(speechText);
               
                  //this.componentInstance.view.flxText.isVisible = true;
                 //this.componentInstance.view.lblProgress.text = speechText;
                this.stopRecognition();
                 kony.print("End onAndroidSpeechResult");
        ...
        NativeControllerAndroid.prototype.onReadyForSpeechAndroid = function(bundle) {
            try {
                ...
                kony.print("onReadyForSpeechAndroid");
                kony.application.dismissLoadingScreen();
