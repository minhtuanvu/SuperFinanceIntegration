       ...
       // this.stop();
        ...
        speech: function() {
            ...
            try {
                ...
                this.view.flxAnim.setVisibility(true);
                this.view.flxText.setVisibility(false);
        ...
        invokeCallback: function(text) {
            try {
                ...
                if (this.speechCallback !== undefined && this.speechCallback !== null && typeof this.speechCallback === 'function') {
                  ...
                  //var controller = kony.mvc.GetController('frmStep1', true);
                  
                }
             // var controller = kony.mvc.GetController('frmStep1', true);
            /// controller.speechToTextSuccess(text);
              
              
              // this.view.flxAnim.setVisibility(false);
              //this.view.flxText.setVisibility(true);
            //  this.view.lblProgress.text = text;
              
             
                kony.print("invokeCallback text = " +text);
