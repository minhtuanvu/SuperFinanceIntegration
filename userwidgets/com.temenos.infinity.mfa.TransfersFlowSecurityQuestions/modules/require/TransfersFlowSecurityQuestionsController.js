define(['./TransferFlowSecurityQuestionsDAO'],function(TransferFlowSecurityQuestionsDAO) {
  ...
  return {
    ...
    setFormUI: function (mfaAttributes) {
      ...
      if (mfaAttributes.remainingFailedAttempts > 0) {
        this.view.lblError.text = "Invalid answers. You have only " +
          " " + mfaAttributes.remainingFailedAttempts + " " + " more attempt(s) left!";
