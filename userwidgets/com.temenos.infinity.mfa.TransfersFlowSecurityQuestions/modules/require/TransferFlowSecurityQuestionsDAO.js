define(function () {
  function TransferFlowSecurityQuestionsDAO(){
  }
   TransferFlowSecurityQuestionsDAO.prototype.verifyLoginMFASecurityQuestions= function (objServiceName, objName, operationName, params, presentationSuccessCallback, presentationErrorCallback) {
  ...
  return TransferFlowSecurityQuestionsDAO;
});