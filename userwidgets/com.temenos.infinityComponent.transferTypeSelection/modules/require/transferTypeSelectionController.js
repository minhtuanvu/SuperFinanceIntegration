...
this.popupObj = "";
    ...
    bindFieldsData: function(){
      //Set transfer type icon
		var btn1Entitlement = "",btn2Entitlement = "",detailBtn1Entitlement="",detailBtn2Entitlement="";
    ...
    buttonActionHandling: function(clickedButton){
      var selectedTrasferType = { "transferType" : this.parseJsonAndGetValue(this._title),
